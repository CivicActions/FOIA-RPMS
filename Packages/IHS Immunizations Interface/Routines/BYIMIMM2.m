BYIMIMM2 ;IHS/CIM/THL - IMMUNIZATION DATA EXCHANGE;
 ;;3.0;BYIM IMMUNIZATION DATA EXCHANGE;**3,4,7**;AUG 20, 2020;Build 747
...
SDISP ;EP;SHOW DISPLAY OF PATIENT'S IMMUNIZATIONS EXPORTED
 ...
 .W !?5,DAT,?17,$E(INAM,1,20),?38,VIS
 .I '$D(^AUPNVIMM(IMM,0)) W:VIS]"" ! W "V IMMUNIZATION has been edited or deleted"
 .S J=J+1
 .I IOST["C-",J#15=0 D READ D:'$D(BYIMQUIT) SHEAD Q
 K BYIMQUIT
 ;=====
READ N XX
 I '$D(ZTQUEUED) D PAUSE^BYIMIMM6 S:$G(BYIMPAUS)="^" BYIMQUIT=""
 Q
 ;=====
...
T121 S KILL=$P(KILL,",94")_$P(KILL,",94",2)
 ...
 Q
 ;=====
P2 ;EP;PATCH 2 POST INSTALL PROCESSING
 D LOC^BYIMIMM3
...
NCNT ;COUNT NEW IMMS PRIOR TO NEW IMPORT
 ...
 Q
 ;=====
P4 ;EP;VERSION 2.0 PATCH 4
 D P4^BYIMPATC
 Q
 ;=====
P5 ;EP;VERSION 2.0 PATCH 5
 D P5^BYIMPATC
 Q
 ;=====
P6 ;EP;VERSION 2.0 PATCH 6
 D P6^BYIMPATC
 Q
 ;=====
P7 ;EP;VERSION 2.0 PATCH 7
 D P7^BYIMPATC
 Q
 ;=====
P8 ;EP;VERSION 2.0 PATCH 8
 D P8^BYIMPATC
 Q
 ;=====
P9 ;EP;VERSION 2.0 PATCH 9
 D P9^BYIMPATC
 Q
 ;=====
P10 ;EP;VERSION 2.0 PATCH 10
 D P10^BYIMPATC
 Q
 ;=====
P3 ;EP;VERSION 2.0 PATCH 3
 D P3^BYIMPATC
 Q
 ;=====
V3 ;EP;VERSION 3.0 POST INSTALL RE-INDEX
 D V3^BYIMPATC
 Q
 ;=====
 ;
DEMO(DFN) ;EP;FIND DEMO PATIENT
 ;PATCH 3 CR-12431 FIND AND EXCLUDE DEMO PATIENTS
 ;DEMO=0 NOT A DEMO PATIENT
 ;DEMO=1 DEMO PATIENT
 N X,Y,Z,DEMO
 S DFN=+$G(DFN)
 S DEMO=0
 S X=+$O(^DIBT("B","RPMS DEMO PATIENT NAMES",0))
 I $D(^DIBT(X,1,DFN)) S DEMO=1
 S X=$G(^DPT(DFN,0))
 I $P($P(X,U),",",2)["BABY"!($P(X,U,9)["00000")!$P(X,U,21)!(X["DEMO,PATIENT") S DEMO=1
 Q DEMO
