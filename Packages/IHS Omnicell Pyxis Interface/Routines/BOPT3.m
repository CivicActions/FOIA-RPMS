BOPT3 ;IHS/ILC/ALG/CIA/PLS - Transmitter ORC/OBX/RXE/RXR;15-Dec-2023 09:44;SM
 ...
 ; Modified - IHS/MSC/MIR - 12/15/2023 - RXC - patch 4 to contain Drug IEN and description
 Q
ORC ;EP - Common Order Segment
 ...
 Q
RXE ;EP - RXE SEGMENT
 N QT,GC1,GC2,GAMN,GAMX,GUNIT,GUNITXT,GDOSE,PRINST,QUAN,QUNIT
 ...
 S PRINST=$P(NODE5,"^",1)
 S QUAN=$P(NODE5,"^",2),QUNIT=$P(NODE5,"^",3)
 ...
 . S OUT6=OUT6_FLD_FLD_FLD_QUAN_FLD_QUNIT_"|||"_$C(13)
 . S CONT=CONT+1
 . S OUT(CONT)=OUT6
 S BOPMM=$$MINMAX(GAMN) S GAMN=$P(BOPMM,U),GUNIT=$P(BOPMM,U,2),GAMX=$P(BOPMM,U,3)
 ;
 ...
 S OUT6=OUT6_FLD_FLD_FLD_QUAN_FLD_QUNIT_"||||||||||"_PRINST
...
MINMAXQ Q AMT1_U_UNITS_U_AMT2
 ;
RXC ;EP - Modified for p4 IHS/MSC/MIR 12/15/2023
 N A,B,C,DRUGID,DRUGDSC S (A,B,C)="",A=$O(^BOP(90355.1,COUNTER,20,0)) I A D  ;
 . S B=0 F  S B=$O(^BOP(90355.1,COUNTER,20,B)) Q:'B  S C=$G(^BOP(90355.1,COUNTER,20,B,0)) Q:C=""  D  ;
 . . S CONT=CONT+1
 . . S DRUGID=$$GET1^DIQ(52.7,$P(C,U,1),1,"I"),DRUGDSC=$$GET1^DIQ(52.7,$P(C,U,1),1)
 . . S OUT(CONT)="RXC"_FLD_"B"_FLD_DRUGID_COM_DRUGDSC_FLD_$P(C,U,3)_FLD_$P(C,U,4)_$C(13)             ;$P(C,U,1)_COM_$P(C,U,2)_FLD_$P(C,U,3)_$C(13)
 ...
 . . S CONT=CONT+1
 . . S DRUGID=$$GET1^DIQ(52.6,$P(C,U,1),1,"I"),DRUGDSC=$$GET1^DIQ(52.6,$P(C,U,1),1)
 . . S OUT(CONT)="RXC"_FLD_"A"_FLD_DRUGID_COM_DRUGDSC_FLD_$P(C,U,3)_FLD_$P(C,U,4)_$C(13)             ;$P(C,U,1)_COM_$P(C,U,2)_FLD_$P(C,U,3)_$C(13)
 Q
