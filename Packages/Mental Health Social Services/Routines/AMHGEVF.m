AMHGEVF ; IHS/CMI/MAW - AMH GUI Visit Form Data Edits (frmVisitDataEntry) 2/13/2009 8:54:11 AM ; 18 Dec 2024  3:24 PM
 ;;4.0;IHS BEHAVIORAL HEALTH;**1,2,4,6,8,11,12**;JUN 02, 2010;Build 46
 ;
 ;
 ;
 Q
...
DELHF(REC,HF) ;EP -- delete a health factor if removed from the client side
 ...
 Q
 ;
SCREEN(D,RC,P,PP,A,AC,DP,DPC,IP,IPC,APRV,DPRV,IPRV,S,SC,SPRV,SS,SSC,SSPRV) ;EP -- file screening
 N AMHFDA,AMHIENS,AMHERRR
 S AMHIENS=RC_","
 ;I $G(IP)]"" D
 ...
 ;cmi/maw patch11 CR11044
 S AMHFDA(9002011,AMHIENS,1409)=SS
 S AMHFDA(9002011,AMHIENS,1410)=SSPRV
 S AMHFDA(9002011,AMHIENS,2001)=SSC
 D FILE^DIE("K","AMHFDA","AMHERRR(1)")
 I $D(AMHERRR) S AMHER="0~Edit Screening"
 Q
 ;
SCREENN(D,RC,ST,SR,SPI,SP,SC) ;EP -- file screening
 N AMHFDA,AMHIENS,AMHERRR
 S AMHIENS=RC_","
 I ST="Alcohol" D
 . S SRF=1403
 ...
 . S SRP=1408
 . S SRC=1901
 I ST="Suicide Screening" D
 . S SRF=1409
 . S SRP=1410
 . S SRC=2001
 I ST="Unhealthy Drug" D
 . S SRF=2201
 . S SRP=2202
 . S SRC=2301
 I ST="SDOH Food" D
 ...
 . S SRP=2206
 . S SRC=2501
 I ST="SDOH Transportation" D
 . S SRF=2207
 . S SRP=2208
 . S SRC=2601
 I ST="SDOH Utilities" D
 . S SRF=2209
 . S SRP=2210
 . S SRC=2701
 I ST="SDOH Interpersonal" D
 . S SRF=2211
 . S SRP=2212
 . S SRC=2801
 S AMHFDA(9002011,AMHIENS,SRF)=$$SCI^AMHGT(9002011,SRF,SR)
 S AMHFDA(9002011,AMHIENS,SRP)=SPI
 S AMHFDA(9002011,AMHIENS,SRC)=SC
 D FILE^DIE("K","AMHFDA","AMHERRR(1)")
 I $D(AMHERRR) S AMHER="0~Edit Screening"
 Q
 ;
