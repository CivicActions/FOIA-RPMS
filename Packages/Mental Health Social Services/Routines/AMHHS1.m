AMHHS1 ; IHS/CMI/LAB - BH HEALTH SUMMARY COMPONENT PART 2 ;
 ;;4.0;IHS BEHAVIORAL HEALTH;**2,5,12**;JUN 02, 2010;Build 46
 ;
 ;
PROB ;EP
...
EXAMS ;
 ...
 ..X APCHSCKP Q:$D(APCHSQIT)
 ..I $P($G(^AMHREC(AMHSX,14)),U)]"" W !,"IPV/DV SCREENING",?28,$$D((9999999-$P(AMHSIVD,"."))),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,1402),1,13)
 ..I $P($G(^AMHREC(AMHSX,14)),U,3)]"" W !,"ALCOHOL SCREENING",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,1403),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,1404),1,13)
 ..I $P($G(^AMHREC(AMHSX,14)),U,5)]"" W !,"DEPRESSION SCREENING ",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,1405),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,1406),1,13)
 ..I $P($G(^AMHREC(AMHSX,14)),U,7)]"" W !,"SUICIDE RISK ASSESSMENT",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,1407),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,1408),1,13)
 ..I $P($G(^AMHREC(AMHSX,14)),U,9)]"" W !,"SUICIDE SCREENING",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,1409),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,1410),1,13)
 ..I $P($G(^AMHREC(AMHSX,22)),U,1)]"" W !,"UNHEALTHY DRUG SCREEN",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,2201),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,2202),1,13)
 ..I $P($G(^AMHREC(AMHSX,22)),U,3)]"" W !,"SDOH FOOD",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,2203),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,2204),1,13)
 ..I $P($G(^AMHREC(AMHSX,22)),U,5)]"" W !,"SDOH HOUSING",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,2205),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,2206),1,13)
 ..I $P($G(^AMHREC(AMHSX,22)),U,7)]"" W !,"SDOH TRANSPORTATION ",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,2207),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,2208),1,13)
 ..I $P($G(^AMHREC(AMHSX,22)),U,9)]"" W !,"SDOH UTILITIES",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,2209),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,2210),1,13)
 ..I $P($G(^AMHREC(AMHSX,22)),U,11)]"" W !,"SDOH INTERPERSONAL SAFETY",?28,$$D((9999999-$P(AMHSIVD,"."))),?37,$$VAL^XBDIQ1(9002011,AMHSX,2211),?66,$E($$VAL^XBDIQ1(9002011,AMHSX,2212),1,13)
 Q
 ;
D(D) ;EP
 I D="" Q ""
