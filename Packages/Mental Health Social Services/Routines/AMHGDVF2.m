...
SCREEN(RETVAL,AMHSTR) ;-- retrieve visit screening
 ...
 S @RETVAL@(AMHI)=@RETVAL@(AMHI)_"^T00010Depression Provider IEN^T00030Depression Provider^T00010IPV Provider IEN^T00030IPV Provider^T00030SRAScreening^T00250SRAComment^T00010SRA Provider IEN^T00030SRA Provider"
 S @RETVAL@(AMHI)=@RETVAL@(AMHI)_"^T00030SuicideScreening^T00250SuicideComment^T00010Suicide Provider IEN^T00030Suicide Provider"_$C(30)
 ...
 S @RETVAL@(AMHI)=@RETVAL@(AMHI)_U_AMHSRA_U_AMHSRAC_U_AMHSPRVI_U_AMHSPRV_U_AMHSS_U_AMHSSC_U_AMHSSPI_U_AMHSSP_$C(30)
 S @RETVAL@(AMHI+1)=$C(31)
 Q
 ;
...
PCCWELL(B,E,PAT) ;-- vst pcc well listview for well tab
 ...
 .. I AMHEDU="",AMHHF="" Q
 .. S AMHI=AMHI+1
 .. S ^TMP($J,"AMHWELL",AMHDA,AMHI)=AMHIEN_U_AMHDT_U_AMHEDU_U_AMHHF_U_AMHAS_U_AMHDS_U_AMHIS_U_AMHS_U_$G(AMHSS)_U_AMHPRV_U_AMHVIEN
 Q
 ;
