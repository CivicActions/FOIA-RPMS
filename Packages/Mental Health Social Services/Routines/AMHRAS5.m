...
PROC ;
 S AMHRCNT=0
 S AMHRH=$H,AMHRJ=$J
 K ^XTMP("AMHRAS5",AMHRJ,AMHRH)
 D XTMP^AMHUTIL("AMHRAS5","ALCOHOL SCREENING REPORT")
 ;now go through BH
 ...
 ..S AMHSCR=$$BHSCR^AMHRAS2(AMHRBIEN)
 ..Q:AMHSCR=""
 ..S AMHRCNT=AMHRCNT+1
...
PCC ;
 ...
 ..Q:'$$ALLOWP^AMHUTIL(DUZ,DFN)
 ..Q:$$DEMO^AMHUTIL1(DFN,$G(AMHDEMO))
 ..S AMHSCR=$$PCCSCR^AMHRAS2(AMHRBIEN)
 ..Q:AMHSCR=""
 ..S AMHRCNT=AMHRCNT+1
 ..S ^XTMP("AMHRAS5",AMHRJ,AMHRH,"PTS",DFN,AMHRDATE)=""
 ..S ^XTMP("AMHRAS5",AMHRJ,AMHRH,"VSTS",AMHRCNT)=AMHSCR
 ...
 .Q:'$$ALLOWP^AMHUTIL(DUZ,DFN)
 .Q:'$D(^DIBT(AMHRSEAT,1,DFN))
 .I $D(^XTMP("AMHRAS5",AMHRJ,AMHRH,"PTS",DFN,AMHRDATE)) Q
 .S AMHRCNT=AMHRCNT+1
 .S ^XTMP("AMHRAS5",AMHRJ,AMHRH,"PTS",DFN,AMHRDATE)=""
 .S T=AMHRDATE
