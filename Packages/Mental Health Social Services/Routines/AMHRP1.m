AMHRP1 ; IHS/CMI/LAB - DETAILED/BRIEF LISTING OF RECORDS, REPORT 1 ;
 ;;4.0;IHS BEHAVIORAL HEALTH;**4,5,11**;JUN 02, 2010;Build 27
 ;
 ;
BDRL ;type of report
 ...
 Q
PRINT ;EP
 S AMHCW=$S(AMHRTYPE="B":80,1:132),AMHPTOT=0
 K ^TMP($J,"PATS")
 ;
 D COVPAGE^AMHRPTCP
 ...
 W !!,"TOTAL NUMBER OF VISITS: ",$$COM(AMHRCNT,0)
 W !!,"TOTAL NUMBER OF PATIENTS: ",$$COM(AMHPTOT,0)
DONE ;
...
PRINTB ;
 ...
 I $P(AMHR0,U,8)]""  D
 .I '$D(^TMP($J,"PATS",$P(AMHR0,U,8))) S AMHPTOT=AMHPTOT+1,^TMP($J,"PATS",$P(AMHR0,U,8))=""
