...
PROC ;
 ...
 D XTMP^AMHUTIL("AMHRAS1","ALCOHOL SCREENING REPORT")
 ;now go through BH
 ...
 .S AMHREFS="" I AMHREXPC S AMHREFS=$$REFUSAL(DFN,9999999.15,$O(^AUTTEXAM("C",35,0)),AMHRBD,AMHRED)
