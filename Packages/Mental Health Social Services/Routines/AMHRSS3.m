AMHRSS3 ; IHS/CMI/LAB - list SUICIDE SCREENING screenings ;
...
INFORM ;
 W !,$$CTR($$USR)
 W !,$$LOC()
 W !!,$$CTR("LISTING OF PATIENTS RECEIVING SUICIDE SCREENING,INCLUDING REFUSALS",80)
 W !!,"This report will tally and optionally list all patients who have had"
 W !,"Suicide Screenings or a refusal documented in the time frame specified"
...
RESULT ;result screenig
 ...
 W !?3,"1)  Negative"
 W !?3,"2)  Acute Positive"
 W !?3,"3)  Non-Acute Positive"
 W !?3,"4)  Refused"
...
ZIS ;
 ...
 S XBRP="PRINT^AMHRSS3P",XBRC="PROC^AMHRSS31",XBRX="XIT^AMHRSS3",XBNS="AMH"
 D ^XBDBQUE
 D XIT
 Q
BROWSE ;
 S XBRP="VIEWR^XBLM(""^AMHRSS3P"")"
 S XBNS="AMH",XBRC="PROC^AMHRSS31",XBRX="XIT^AMHRSS3",XBIOP=0 D ^XBDBQUE
 Q
XIT ;
 D EN^XBVK("AMHR")
 D ^XBFMK
