AMHRDV31 ; IHS/CMI/LAB - list IPV/DV screenings ;
 ;;4.0;IHS BEHAVIORAL HEALTH;**6,8,11,12**;JUN 02, 2010;Build 46
 ;
 ;
PROC ;
 S AMHRCNT=0
...
GETSCR1 ;
 ...
 ..Q:AMHRDATE<AMHRBD
 ..S AMHRCNT=AMHRCNT+1
 ..S AMHRRES=$$VAL^XBDIQ1(9002011,AMHRBIEN,1401)
 ..I AMHRESS="" Q
 ..S:AMHRRES["REFUSED" AMHRRES="REFUSED SCREENING" S:AMHRRES["NEGATIVE" AMHRRES="NEGATIVE"
 ..I AMHRRES="NEGATIVE",'$D(AMHRREST(1)) Q
 ..I AMHRRES="PRESENT",'$D(AMHRREST(2)) Q
 ..I AMHRRES="PAST",'$D(AMHRREST(3)) Q
 ..I AMHRRES="PRESENT AND PAST",'$D(AMHRREST(4)) Q
