...
SETTMP ;EP - CALLED FROM AMHPT4
 ...
 Q:$P(AMHR0,U,8)=""
 I '$D(^XTMP("AMHRAP2",AMHJOB,AMHBTH,"PATS",$P(AMHR0,U,8))) S ^XTMP("AMHRAP2",AMHJOB,AMHBTH,"TOTALUNIQUEPATS")=$G(^XTMP("AMHRAP2",AMHJOB,AMHBTH,"TOTALUNIQUEPATS"))+1
...
PROG ;
 S AMHPROG=$P(AMHR0,U,2) I AMHPROG="" S AMHPROG="NO PROGRAM ENTERED",AMHSRT2="--" Q
  S AMHSRT2=$P(AMHR0,U,2),AMHPROG=$S($P(AMHR0,U,2)="M":"MENTAL HEALTH",$P(AMHR0,U,2)="S":"SOCIAL SERVICES",$P(AMHR0,U,2)="C":"CHEMICAL DEPENDENCY",$P(AMHR0,U,2)="O":"OTHER",1:"NO PROGRAM ENTERED")
 Q
 ;
APWI ;
