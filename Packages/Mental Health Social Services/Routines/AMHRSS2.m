AMHRSS2 ; IHS/CMI/LAB - list refusals ;
...
ZIS ;
 ...
 S XBRP="PRINT^AMHRSS2P",XBRC="PROC^AMHRSS2",XBRX="XIT^AMHRSS2",XBNS="AMH"
 D ^XBDBQUE
 D XIT
 Q
BROWSE ;
 S XBRP="VIEWR^XBLM(""^AMHRSS2P"")"
 S XBNS="AMH",XBRC="PROC^AMHRSS2",XBRX="XIT^AMHRSS2",XBIOP=0 D ^XBDBQUE
 Q
XIT ;
 D EN^XBVK("AMHR")
 D ^XBFMK
...
PROC ;
 S AMHRCNT=0
 S AMHRH=$H,AMHRJ=$J
 K ^XTMP("AMHRSS2",AMHRJ,AMHRH)
 D XTMP^AMHUTIL("AMHRSS2","SUICIDE SCREENING REPORT")
 ;now go through BH
 ...
 ..;I $D(^XTMP("AMHRSS2",AMHRJ,AMHRH,"PTS",DFN,AMHRDATE)) Q
 ..S AMHRCNT=AMHRCNT+1
 ..S ^XTMP("AMHRSS2",AMHRJ,AMHRH,"PTS",DFN,AMHRDATE)=""
 ..S AMHRRES=$$VAL^XBDIQ1(9002011,AMHRBIEN,1409) S:AMHRRES["REFUSED" AMHRRES="REFUSED SCREENING"
 ..S ^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT)="BH"_U_$$BHPPNAME(AMHRBIEN)_U_AMHRRES_U_$$VAL^XBDIQ1(9002011,AMHRBIEN,2001)_U_$$AGE^AUPNPAT(DFN,AMHRDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_AMHRDATE_U_AMHRBIEN
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,9)=$$VAL^XBDIQ1(9002011,AMHRBIEN,.25)
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,15)=AMHRBIEN
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,16)=$S($P($G(^AMHREC(AMHRBIEN,14)),U,10):$$VAL^XBDIQ1(9002011,AMHRBIEN,1410),1:"UNKNOWN")
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,18)=$$VAL^XBDIQ1(9002011.55,DFN,.02)
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,19)=$$VAL^XBDIQ1(9002011.55,DFN,.03)
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,20)=$$VAL^XBDIQ1(9002011.55,DFN,.04)
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,21)=DFN
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,25)=$$RACE^AMHUTIL2(DFN)
 ..S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,26)=$$ETHN^AMHUTIL2(DFN)
 ...
 .S ^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT)="EX"_U_$$PPV(AMHRVIEN)_U_AMHRRES_U_$$VAL^XBDIQ1(9000010.13,AMHREIEN,81101)_U_$$AGE^AUPNPAT(DFN,AMHRDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_AMHRDATE_U_AMHREIEN
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,9)=$$VAL^XBDIQ1(9000010,AMHRVIEN,.08)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,15)=AMHRVIEN
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,16)=$$SPRV(AMHREIEN)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,18)=$$VAL^XBDIQ1(9002011.55,DFN,.02)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,19)=$$VAL^XBDIQ1(9002011.55,DFN,.03)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,20)=$$VAL^XBDIQ1(9002011.55,DFN,.04)
 ...
 .S ^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT)="REF"_U_"UNKNOWN"_U_AMHRRES_U_$$VAL^XBDIQ1(9000022,AMHRRIEN,1101)_U_$$AGE^AUPNPAT(DFN,AMHRDATE)_U_$$VAL^XBDIQ1(2,DFN,.02)_U_AMHRDATE_U_AMHRRIEN_U
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,15)=AMHRVIEN
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,16)=$$PRVREF(AMHRRIEN)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,17)=$$VAL^XBDIQ1(9000001,DFN,.14)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,18)=$$VAL^XBDIQ1(9002011.55,DFN,.02)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,19)=$$VAL^XBDIQ1(9002011.55,DFN,.03)
 .S $P(^XTMP("AMHRSS2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,20)=$$VAL^XBDIQ1(9002011.55,DFN,.04)
