AMHLENS1 ; IHS/CMI/LAB - NO DESCRIPTION PROVIDED ; [ 09/08/03  6:30 PM ]
 ;;3.0;IHS BEHAVIORAL HEALTH;**1,8**;JAN 27, 2003
 ;
 ;info/contact RDE mode
NS ;EP
 D HEADER^AMHLEA
 W !,"Entering NO SHOW Record type",!
 ...
 S DIE("NO^")="",DA=AMHR,DIE="^AMHREC(",DR="[AMH ADD NO SHOW]" D CALLDIE^AMHLEIN
 D GENPOV^AMHLENS
 I '$D(^AMHRPRO("AD",AMHR)) W !!,"No POV" D DEL^AMHLEA Q
