...
ZIS ;
 ...
 S XBRP="PRINT^AMHRDE5P",XBRC="PROC^AMHRDE5",XBRX="XIT^AMHRDE5",XBNS="AMH"
 D ^XBDBQUE
 D XIT
 Q
BROWSE ;
 S XBRP="VIEWR^XBLM(""^AMHRDE5P"")"
 S XBNS="AMH",XBRC="PROC^AMHRDE5",XBRX="XIT^AMHRDE5",XBIOP=0 D ^XBDBQUE
 Q
XIT ;
 D EN^XBVK("AMHR")
 D ^XBFMK
