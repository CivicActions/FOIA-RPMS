...
ZIS ;
 ...
 S XBRP="PRINT^AMHRDV2P",XBRC="PROC^AMHRDV2",XBRX="XIT^AMHRDV2",XBNS="AMH"
 D ^XBDBQUE
 D XIT
 Q
BROWSE ;
 S XBRP="VIEWR^XBLM(""^AMHRDV2P"")"
 S XBNS="AMH",XBRC="PROC^AMHRDV2",XBRX="XIT^AMHRDV2",XBIOP=0 D ^XBDBQUE
 Q
XIT ;
 D EN^XBVK("AMHR")
 D ^XBFMK
...
PROC ;
 ...
 ..S $P(^XTMP("AMHRDV2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,25)=$$RACE^AMHUTIL2(DFN)
 ..S $P(^XTMP("AMHRDV2",AMHRJ,AMHRH,"VSTS",AMHRCNT),U,26)=$$ETHN^AMHUTIL2(DFN)
