...
LIST1 ;
 S AMHRSORT=""
 W !
 S DIR(0)="S^H:Health Record Number;N:Patient Name;P:Provider who screened;C:Clinic;R:Result of Assessment;D:Date Screened;A:Age of Patient at Screening;G:Gender of Patient;T:Terminal Digit HRN;Q:Race;E:Ethnicity"
...
ZIS ;CALL TO XBDBQUE
 ...
 S XBRP="PRINT^AMHRSR1P",XBRC="PROC^AMHRSR1",XBRX="XIT^AMHRR1",XBNS="AMH"
 D ^XBDBQUE
 D XIT
 Q
BROWSE ;
...
PROC ;
 ...
 ..S $P(^XTMP("AMHRSR1",AMHRJ,AMHRH,"PTS",DFN,AMHRDATE),U,25)=$$RACE^AMHUTIL2(DFN)
 ..S $P(^XTMP("AMHRSR1",AMHRJ,AMHRH,"PTS",DFN,AMHRDATE),U,26)=$$ETHN^AMHUTIL2(DFN)
