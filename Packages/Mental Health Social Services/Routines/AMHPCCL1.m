AMHPCCL1 ; IHS/CMI/LAB - CONTINUATION OF AMHPCCL ; 19 Sep 2014  8:37 AM
 ;;4.0;IHS BEHAVIORAL HEALTH;**2,4,5,6,11,12**;JUN 02, 2010;Build 46
 ;
 ;
KILL ;
...
SRA ;
 ...
 .Q
SSCR ;
 I $P($G(^AMHREC(AMHR,14)),U,9)]"" D
 .Q:$O(^AUTTEXAM("C",44,0))=""
 .S AMHRES=$$VAL^XBDIQ1(9002011,AMHR,1409) I AMHRES["NEG" S AMHRES="N"
 .S AMHP=$P(^AMHREC(AMHR,14),U,10),AMHCOM=$P($G(^AMHREC(AMHR,20)),U) ;,AMHCOM=$TR(AMHCOM,";",":")
 .I AMHRES["REFUSED"!(AMHRES["UNABLE") S AMHEXCDE=44 D REF K AMHEXCDE Q
 .D KILL S APCDALVR("APCDVSIT")=AMHVSIT
 .S APCDALVR("APCDATMP")="[APCDALVR 9000010.13 (ADD)]"
 .S APCDALVR("APCDTEX")=44
 .S APCDALVR("APCDPAT")=$P(AMHR0,U,8)
 .S APCDALVR("APCDTRES")=AMHRES
 .S APCDALVR("APCDTCOM")=AMHCOM
 .S APCDALVR("APCDTEPR")="" I AMHP S APCDALVR("APCDTEPR")="`"_AMHP
