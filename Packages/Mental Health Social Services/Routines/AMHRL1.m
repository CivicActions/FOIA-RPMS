AMHRL1 ; IHS/CMI/LAB - TUCSON-OHPRD/LAB - PROCESS BH RECORD LIST ; [ 02/21/2007  3:53 PM ]
 ;;3.0;IHS BEHAVIORAL HEALTH;**1,7,8**;JAN 27, 2003
 ;
 ;
 ;
START ;
...
PROC ;
 ...
 I AMHPTVS="P",DFN="" Q
 I AMHPTVS="P"!(AMHPTVS="S"),'$$ALLOWP^AMHUTIL(DUZ,DFN) Q
