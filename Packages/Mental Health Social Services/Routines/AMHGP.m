AMHGP ; IHS/CMI/MAW - AMHG Patient Lookup 4/28/2009 12:43:21 PM ;
 ;;4.0;IHS BEHAVIORAL HEALTH;**1,4,11,12**;JUN 02, 2010;Build 46
 ;
 ;
 ;
 Q
GETPAT(RETVAL,AMHSTR) ;EP -- return patient in ADO table
 ...
 N AMHI,AMHERRR,AMHUIEN,P,AMHPRF
 S P="|"
 K ^AMHTMP($J)
 S RETVAL="^AMHTMP("_$J_")"
 S AMHI=0
 S AMHERRR=""
 S ^AMHTMP($J,AMHI)="T00010IEN^T00030PATIENTNAME^T00015DOB^T00001SEX^T00007CHART^T00009SSN^T00010REG^T00030MORE^T00030DOD^T00010AGE^T00001MESSAGEFLAG^T02500MESSAGE^T00001PRF"_$C(30)
...
PATNAM(AMHPATE,PAT,NPAT) ;lookup by name
 ...
 .... Q:$O(^DPT("B",AMHNAM,AMHIEN,0))  ;cmi/maw 8/21/2023 don't get dup PPN
 .... S AMHCNT=AMHCNT+1
 .... S:'$D(AMHPATE(AMHCNT)) AMHPATE(AMHCNT)=0
...
PATADO(PIEN) ;EP -- ado return
 ...
 . I AMHCNTR>AMHMT Q
 . S AMHCNTR=AMHCNTR+1
 . S AMHPRF=$$PRF^AMHGUVF(AMHPI)  ;p11
 . S AMHNM=$S(AMHAL]"":AMHAL_"  ",1:"")_$P($G(^DPT(AMHPI,0)),U)
 . S AMHNM=$$GETPREF^AUPNSOGI(AMHPI,"E",1)  ;20230308 p11 preferred name
 ...
 .. S AMHSSN=""  ;20231115 maw p11 105114
 ...
 . S AMHI=AMHI+1
 . S ^AMHTMP($J,AMHI)=AMHPI_U_AMHNM_U_AMHDB_U_AMHSX_U_AMHCT_U_AMHSSN_U_$G(AMHHD)_U_$G(AMHMORE)_U_AMHDOD_U_AMHAGE_U_$G(AMHFLAG)_U_$E(AMHDGMSG,1,2500)_U_$G(AMHPRF)_$C(30)
 Q
 ;
