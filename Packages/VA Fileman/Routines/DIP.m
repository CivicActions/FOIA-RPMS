DIP ;SFISC/XAK,TKW-GET SORT SPECS ;12/13/96  14:37 [ 09/09/1998  12:03 PM ]
 ;;21.0;VA Fileman;**1007**;SEP 8, 1998
 ;;21.0;VA FileMan;**2,35**;Dec 28, 1994
...
I ;
 ...
 F DJ=DJ:1:7 D DJ Q:X=""!($D(DTOUT))!($D(DUOUT))!'$D(DJ)  G FTEM^DIP1:X?1"[".E
