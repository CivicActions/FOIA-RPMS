DIEZ ;SFISC/GFT,TOAD-FileMan: Compile Input Template, Setup ;10/22/97  13:35 [ 09/09/1998  12:03 PM ]
...
UNC(DIEZ,DIFLAGS) ;
 ...
 . . S DIROU=DINAME_DISUF I '$D(^$R(DIROU)) S DIROU="" Q
 . . S X=DIROU X ^%ZOSF("DEL")
 Q
