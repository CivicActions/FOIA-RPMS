BTIUMED5 ; SLC/JM - Active/Recent Med Objects Routine ;13-Feb-2025 11:31
 ;;1.0;TEXT INTEGRATION UTILITIES;**1006,1011,1016,1029,1030**;NOV 10, 2004;Build 40
 ;Patch 1011 changed to use pharmacy APIS
 ; IHS/MSC/MIR 02/13/2025 Feature 119124 p1030 added STHOLD in LIST+39, LIST+173, LIST+258
 Q
LIST(DFN,TARGET,ACTVONLY,ONELIST,CLASSORT,SUPPLIES,CLININC) ; EP
 ...
 N %,%H,STOP,LSTFD,ALLMEDS,CLASS,DETAILED,DRUG,REASON,REFILLS,FILLS,NRXN,HIEN,ERX,HOLDSTTS
 N STHOLD S (NEXTLINE,TAB,HEADER,UNKNOWNS)=0,LLEN=47,PHARM=1,STHOLD=0
 ...
 .S KEEPMED=($L($P(NODE,U,2))>0) Q:'KEEPMED  ;Discard Blank Meds
 .S STATUS=$P(NODE,U,9)
 ...
 .S TYPE=$P($P(NODE,U),";",2)
 .S TYPE=$S(TYPE="O":"OP",TYPE="I":"UD",1:"") Q:TYPE=""
 ...
 ..I 'DRUGIDX D  ;Find orderable item
 ...
 ...S DATA=MED_U_$P(NODE,U,3)_U_$S($P(NODE,U,9)["HOLD":"ACTIVE",1:$P(NODE,U,9)),CNT=CNT+1
