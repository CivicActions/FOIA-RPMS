BTIUMED6 ; SLC/JM - Active/Recent Med Objects Routine ;13-Feb-2025 15:39
 ;;1.0;TEXT INTEGRATION UTILITIES;**1009,1010,1011,1012,1029,1030**;NOV 10, 2004;Build 40
 ;Patch 1011 changes to use new pharmacy APIS
 ; IHS/MSC/MIR 02/13/2025 Feature 119124 p1030 added STHOLD in LIST+20, LIST+185, LIST+234
 Q
LIST(DFN,TARGET,CLININC) ; EP
 ...
 N IFN,NVATYPE,NVAMED,NVASTR,TIUXSTAT,CLIN,HIEN,IEN,REASON,REFILLS,COUNTER,EVENT,HOLDSTTS
 ...
 ...S NODE=@TARGET@("B",MED,IDATE,XSTR) S:$P(NODE,U,4)["HOLD" STHOLD=1   ;added by MIR for 119124
 ...S DATA=MED_U_$P(NODE,U,3)_U_$P(NODE,U,5),CNT=CNT+1
 ...S STATUS=$S($P(NODE,U,4)["HOLD":"ACTIVE",1:$P(NODE,U,4))
