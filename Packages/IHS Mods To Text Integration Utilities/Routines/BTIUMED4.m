BTIUMED4 ; SLC/JM - Active/Recent Med Objects Routine ;13-Feb-2025 08:11
 ;;1.0;TEXT INTEGRATION UTILITIES;**1006,1007,1010,1011,1016,1029,1030**;NOV 10, 2004;Build 40
 ;Drugs sorted by clincial indication
 ;Patch 1011 changed to use new pharmacy APIs
 ; IHS/MSC/MIR 02/13/2025 Feature 119124 p1030 added STHOLD in LIST+17, LIST+160, LIST+218
 Q
LIST(DFN,TARGET) ; EP
 ;
 ;
 ...
 N %,%H,STOP,LSTFD,HIEN,IEN,REASON,REFILLS,X,X1,X2,SUPPLIES,HOLDSTTS,STHOLD S STHOLD=0
 S CLININC=0
 ...
 .I HIEN["P"!(HIEN["N")!(INDIC="") S INDIC="Clinical Indication Unknown"
 ...
 ..S STATUS=$P(NODE,U,4) S:STATUS["HOLD" STATUS="ACTIVE",STHOLD=1  ;added STHOLD by MIR for 119124
 ..S INDIC=$P(NODE,U,7)
