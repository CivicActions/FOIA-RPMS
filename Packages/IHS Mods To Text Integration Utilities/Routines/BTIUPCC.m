BTIUPCC ; IHS/ITSC/LJF - IHS PCC LINKS WITH TIU ;05-Feb-2019 13:41;DU
 ;;1.0;TEXT INTEGRATION UTILITIES;**1001,1003,1004,1005,1021*;NOV 04, 2004;Build 11
 ...
 ;IHS/MSC/MGH PATCH 1021 added to check 30 visits
...
SLAB(DFN,TIUTST,TIULAST,BRIEF) ;EP; -- returns most current lab result for single test  ;PATCH 1001
 ...
 NEW LAB,VDT,IEN,X,TIU,LINE,ARR,DATE,BTIUQ,CNT
 S LAB=$O(^LAB(60,"B",TIUTST,0)) I LAB="" Q ""
 S VDT=0,CNT=0
 F  S VDT=$O(^AUPNVLAB("AA",DFN,LAB,VDT)) Q:'VDT!($G(LINE)]"")!(CNT>30)  D
 .S IEN=0
 .;IHS/CIA/MGH
