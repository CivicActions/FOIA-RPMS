BTIUP28 ; IHS/MSC/MGH - ENV CHECK FOR PATCH 1027;14-Apr-2023 14:11
 ;;1.0;TEXT INTEGRATION UTILITIES;**1028**;SEPT 04, 2005;Build 13
 ;
ENV ;EP environment check
 N PATCH,IN,STAT,INSTDA
 S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 ;
 S PATCH="TIU*1.0*1027"
 I '$$PATCH(PATCH) D  Q
...
POST ;EP; beginning of post install code
 S DIK="^TIU(8925,",DIK(1)="1501^I"
 D ENALL^DIK
 S DIK="^TIU(8925,",DIK(1)="1611^H"
 D ENALL^DIK
 Q
