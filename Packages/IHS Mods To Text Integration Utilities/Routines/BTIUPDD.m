BTIUPDD ; IHS/MSC/MGH - Problem Objects ;04-Aug-2020 10:37;DU
 ;;1.0;TEXT INTEGRATION UTILITIES;**1012,1013,1014,1016,1017,1022**;MAR 20, 2013;Build 11
 ;4/13/13
 ;
 Q
 ;
...
GETDATA(ARRAY,PRIEN,VIEN) ;Get data for a problem
 ;IHS/MSC/MGH 3/3/2020 changes made to not display the |
 N NARR,STATUS,ICD,POVNAR,LINE
 S POVNAR=$$POV^BTIUPDD(VIEN,PRIEN)
 I $P(POVNAR,U,2)="" S $P(POVNAR,U,2)="S"
 S LINE=$P(POVNAR,U,1)
 S LINE=$TR(LINE,"|","-")
