BTIULMED ; SLC/JM - Active/Recent Med Objects Routine ;13-Feb-2025 10:18
 ;;1.0;TEXT INTEGRATION UTILITIES;**1006,1011,1016,1029,1030**;NOV 10, 2004;Build 40
 ;PATCH 1011 changed to use new pharmacy APIs
 ; IHS/MSC/MIR 02/13/2025 Feature 119124 p1030 added STHOLD in LIST+48, LIST+213, LIST+303
 Q
LIST(DFN,TARGET,ACTVONLY,DETAILED,ALLMEDS,ONELIST,CLASSORT,SUPPLIES,CLININC) ; EP
 ...
 N NVATYPE,NVAMED,NVASTR,TIUXSTAT,HODLSTTS,STHOLD S STHOLD=0
 ...
 I ACTVONLY=3 D HOLD^BTIUMED1 G LISTX
 S (EMPTY,HEADER)=1
 ...
 S HSTATS=U_HOLDSTTS_U          ;"^HOLD^" ;changed by MIR for 106931
 ...
 .S KEEPMED=(TYPE'="") Q:'KEEPMED
 .I $O(^TMP("PS",$J,INDEX,"A",0))>0!($O(^TMP("PS",$J,INDEX,"B",0))>0) S TYPE="IV"
 ...
 .S DRUGCLAS=" "
 .S MED=$P(NODE,U,2)
 .I (CLASSORT!('SUPPLIES)) D
 ..S DRUGIDX=$$IENNAME^TIULMED2(MED)
 ..D GETCLASS Q:'KEEPMED
 ..I +DRUGIDX=0 D  ;Find orderable item
 ...
 .I $P(NODE,U,9)="PENDING" S IDATE=$$DT^XLFDT   ;!($P(NODE,U,9)="HOLD")
 .S OK='$D(@TARGET@("B",MED,IDATE,XSTR))
 .I 'OK,(IDATE>@TARGET@("B",MED,IDATE,XSTR)) S OK=1
 .I OK D
 ..S @TARGET@("B",MED,IDATE,XSTR)=IDATE_U_INDEX_U_MEDTYPE_U_STATIDX_U_TYPE_U_DRUGCLAS_U_CHRONIC_U_ERX_U_STATUS
 ..S EMPTY=0
 ...
 ...S NODE=@TARGET@("B",MED,IDATE,XSTR) S:$P(NODE,U,9)["HOLD" STHOLD=1   ;added STHOLD by MIR for 119124
 ...S DATA=MED_U_$P(NODE,U,3)_U_$S($P(NODE,U,9)["HOLD":"ACTIVE",1:$P(NODE,U,9)),CNT=CNT+1  ;changed by MIR for 106931
 ...
 ...S $P(NODE,U,18)=REASON,$P(NODE,U,9)=HOLDSTTS
 ..I DETAILED D
 ...S HIEN=$P(NODE,U),INDIC=""
 ...I CLININC>0 D
 ...
 D ADD^BTIUMED1(" ")
 D ADD^BTIUMED1("(X) behind the status of the medication indicates medication was sent to an external pharmacy")
 I STHOLD D
 .D ADD^BTIUMED1(" "),ADD^BTIUMED1("(*) behind the status of the medication indicates pharmacy may be contacted about available fills of this medication")
 K @TARGET@("C")
LISTX K ^TMP("PS",$J)
 Q "~@"_$NA(@TARGET)
 ;
