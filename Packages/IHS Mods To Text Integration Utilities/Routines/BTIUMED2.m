BTIUMED2 ; IHS/MSC/MGH - Active/Recent Med Objects Routine ;13-Feb-2025 16:03
 ;;1.0;TEXT INTEGRATION UTILITIES;**1006,1007,1009,1010,1011,1012,1013,1029,1030**;NOV 10, 2004;Build 40
 ;Patch 1011 changed to use new pharmacy APIS
 ; IHS/MSC/MIR 02/13/2025 Feature 119124 p1030 added STHOLD in LIST+19, LIST+181, LIST+240
 Q
LIST(DFN,TARGET,CLININC) ; EP
 ...
 N NVATYPE,NVAMED,NVASTR,TIUXSTAT,CLIN,HIEN,IEN,REASON,REFILLS,COUNTER,EVENT,HOLDSTTS
 N %,%H,STOP,LSTFD,STHOLD S STHOLD=0  ;Clean up after external calls...
 ...
 .I $P($P(NODE,U),";")["N",STATUS'="HOLD",STATUS'["TRANSFER" S STATUS="ACTIVE"
 .I TYPE="" S KEEPMED=0
 .Q:'KEEPMED
 ...
 ...S NODE=@TARGET@("B",MED,IDATE,XSTR) S:$P(NODE,U,4)["HOLD" STHOLD=1   ;added STHOLD by MIR for 119124
 ...S DATA=MED_U_$P(NODE,U,3)_U_$P(NODE,U,5),CNT=CNT+1
 ...S STATUS=$P(NODE,U,4),TYPE=$P(NODE,U,3) S:STATUS["HOLD" STATUS="ACTIVE"
 ...
 .....S NODE=NODE_U_REASON,$P(NODE,U,9)=HOLDSTTS
 ....I CLININC=1 D
 .....S HIEN=+($P(NODE,U))
