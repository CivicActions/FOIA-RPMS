...
OBR3 ; Build OBR-3 sequence - filler's specimen id
 ...
 S $P(LA7Y,$E(LA7ECH),3)="2.16.840.1.113883.3.72.5.24"  ;maw 2015 chit 09102019
 S $P(LA7Y,$E(LA7ECH),4)="ISO"  ;maw 2015 chit 09102019
 ;I $G(LA7INPT),$G(LA7ADDON) S $P(LA7Y,$E(LA7ECH),3)=""  ;maw 2015 chit 01132020 commented out
 ;I $G(LA7INPT),$G(LA7ADDON) S $P(LA7Y,$E(LA7ECH),4)=""  ;maw 2015 chit 01132020 commented out
 Q
 ;
 ;
OBR4 ; Build OBR-4 sequence - Universal service ID
 ...
 I $P(LA7Y,$E(LA7ECH),4)="" D  ;maw 2015 chit 09102019
 . S $P(LA7Y,$E(LA7ECH),4)=$P(LA7Y,$E(LA7ECH))
 . S $P(LA7Y,$E(LA7ECH),5)=$P(LA7Y,$E(LA7ECH),2)
 . S $P(LA7Y,$E(LA7ECH),6)="99USI"
 . S $P(LA7Y,$E(LA7ECH),9)=$E($P(LA7Y,$E(LA7ECH),2),1,20)
