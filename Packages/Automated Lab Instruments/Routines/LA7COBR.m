...
OBR31(OD,OI,OII,LA7FS,LA7ECH) ;-- MU2 build reason for study field 408 BLR MASTER CONTROL file
 ;ihs/cmi/maw - 08152019 updated for MU3 2015 CHIT Certification ICD10
 ...
 I $G(DXI) D
 . N DXDATA
 . S DXDATA=$$ICDDX^ICDEX(DXI,DT,30,"I",0)
 . S DX=$P(DXDATA,U,2)
 . S DXE=$P(DXDATA,U,4)
 ...
 S LA7Y=$S($G(DXI):DX_CS_$E(DXE,1,20)_CS_"I10"_CS_$E(DXE,1,20)_CS_$E(DXE,1,20)_CS_"L"_CS_29_CS_"1.0",1:"")
 Q LA7Y
 ;
