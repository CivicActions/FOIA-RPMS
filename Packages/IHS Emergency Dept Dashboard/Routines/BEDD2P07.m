BEDD2P07 ;GDIT/HS/BEE-BEDD VERSION 2.0 Patch 7 ENV/PST ROUTINE ; 08 Nov 2011  12:00 PM
 ;;2.0;IHS EMERGENCY DEPT DASHBOARD;**7**;Jun 04, 2014;Build 21
 ;
 NEW VERSION,X
 ;
 ...
 I '$$INSTALLD("BEDD*2.0*6") D FIX(2)
 ;
 ;Check for the XML build
 I $T(XML^BEDD2X07)="" D IMES("BEDD v2.0 Patch 7 XML Build",0,""),FIX(2)
 ;
 ;Check for AMER*3.0*13 build
 I '$$INSTALLD("AMER*3.0*13") D FIX(2)
 ;
 Q
 ;
...
INSTALLD(BEDDSTAL,PATCH) ;EP - Determine if patch BEDDSTAL was installed, where
 ; BEDDSTAL is the name of the INSTALL.  E.g "AMER*3.0*12"
 ;
 S PATCH=$G(PATCH)
 ;
 NEW BEDDY,INST
