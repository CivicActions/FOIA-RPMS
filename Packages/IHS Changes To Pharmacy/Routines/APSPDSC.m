APSPDSC ; IHS/DSD/ENM - PRINT DISCHARGE SHEET ;  [ 08/29/2003  3:10 PM ]
...
ASK ;
 K X,DIR
 ;IHS/DSD/ENM 01/16/96
 ;S DIR("A")="CHOOSE FROM ",DIR("?")="SELECT A NUMBER",DIR(0)="L^1:"_PSOSD D ^DIR K DIR
 S DIR("A")="CHOOSE FROM ",DIR("?")="^D QUES^APSPDSC",DIR(0)="L^1:"_PSOSD D ^DIR K DIR
