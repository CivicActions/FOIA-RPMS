APSPPCCV ;IHS/CIA/DKM/PLS - PCC Data Management ;21-Apr-2021 09:43;DU
 ;;7.0;IHS PHARMACY MODIFICATIONS;**1003,1004,1005,1006,1007,1009,1018,1020,1028**;Sep 23, 2004;Build 50
...
STORE(FN,CF,CRT) ;EP
 ...
 S:$D(CIAERR) DATA=-$G(CIAERR("DIERR",1))_U_$G(CIAERR("DIERR",1,"TEXT",1))
...
RX ; Prescriptions
 ...
 .D UPDATE^DIE("","CIAFLD","CIAIEN","CIAERR")
 .;S:$G(DIERR) DATA=-CIAERR("DIERR",1)_U_CIAERR("DIERR",1,"TEXT",1)
 .S:$D(CIAERR) DATA=-$G(CIAERR("DIERR",1))_U_$G(CIAERR("DIERR",1,"TEXT",1)) ;P1028
 Q
RXV ; Non-VA Meds
 N SIG,IEN,VMED,CRT
 D LOOK("SIG",.SIG)
