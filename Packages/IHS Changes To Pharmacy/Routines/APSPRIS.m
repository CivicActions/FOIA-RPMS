APSPRIS ;IHS/MSC/PLS- Support for speed REISSUE ;02-Mar-2022 20:49;DU
 ;;7.0;OUTPATIENT PHARMACY;**1015,1016,1021,1022,1030**;DEC 1997;Build 7
...
ASKNEWV(DATAARY) ;EP - 03/28/2016
 ...
 .S DATAARY("NDC")=$P(^PSDRUG(+$P(^PSRX(RXIEN,0),U,6),2),U,4)
