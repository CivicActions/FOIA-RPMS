APSPEC29 ;IHS/CIA/PLS - APSP ENVIRONMENT CHECK ROUTINE ;03-Dec-2021 13:57;DU
 ;;7.0;IHS PHARMACY MODIFICATIONS;**1029**;Sep 23, 2004;Build 50
 ;
ENV ;EP
 ;
...
REMXPAR(PAR) ;Remove values stored for a given parameter
 ...
 Q
POST ;EP
 D RXCUIX  ;Build ^PSDRUG("RXCUI" xref
