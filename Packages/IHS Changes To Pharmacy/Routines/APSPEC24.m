APSPEC24 ;IHS/CIA/PLS - APSP ENVIRONMENT CHECK ROUTINE ;31-Jan-2020 09:40;DU
...
PAR ;Set system level for new parameters
 ;Enable RxNew service level
 D ADD^XPAR("SYS","APSP NCPDP SITE SERVICE LEVEL","`1","1")
 Q
...
SPECREDO ;Repoint the Pharmacy specialty types from Set of Codes to Pointer
 ...
 ...D FILE^DIE("","FDA","ERR")
 Q
SSLVL ;Set the SS level to New for all providers with an active SPI
 ;
 N PRV,SPI,ACTSPI,ENT
 S PRV=0 F  S PRV=$O(^VA(200,PRV)) Q:'+PRV  D
 .S SPI=$$SPI^APSPES1(PRV)
 .S ACTSPI=$$EFF^APSPES2A(PRV)
 .I +ACTSPI&(SPI'="") D
 ..S ENT="USR.`"_+PRV
 ..D ADD^XPAR(ENT,"APSP NCPDP USER SERVICE LEVEL","New","Y",.ERR)
 Q
 ;
IENS ;;147
 ;;150
