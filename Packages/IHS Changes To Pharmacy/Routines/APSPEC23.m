APSPEC23 ;IHS/CIA/PLS - APSP ENVIRONMENT CHECK ROUTINE ;14-Aug-2018 11:20;PLS
...
ENV ;EP
 ...
 W !!,$$CJ^XLFSTR("Checking Environment for "_$P($T(+2),";",4)_" V "_$P($T(+2),";",3)_", Patch 1023.",IOM)
...
REMXPAR(PAR) ;Remove values stored for a given parameter
 ...
 Q
POST ;EP
 D REGPROT^CIAURPC("OR EVSEND PS","IHS CS AUDIT LOG",90)
 D REGPROT^CIAURPC("PS EVSEND OR","IHS CS AUDIT LOG",90)
 D UNLOCK
 D ADDMENU
 ;D RESCH^XUTMOPT("APSP PHARMACY AUD SUM RPT","T+1@02:00","","24H","L")
 D REPOINT
 Q
