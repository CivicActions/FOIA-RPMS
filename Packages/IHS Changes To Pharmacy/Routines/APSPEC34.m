APSPEC34 ;IHS/CIA/PLS - APSP ENVIRONMENT CHECK ROUTINE ;22-Jun-2023 13:38;DU
...
REMXPAR(PAR) ;Remove values stored for a given parameter
 ...
 Q
POST ;EP
 ;D REGPROT("PSO HIDDEN ACTIONS","APSP PICKUP",77,"PK")
 ;D REGPROT("PSO HIDDEN ACTIONS #2","APSP SPEED PICKUP",29,"PK")
 D POPXPAR
 D REGMENU^BEHUTIL("APSP EARLIEST FILL DATE REPORT",,"EFDT","APSP MAIN MENU")
