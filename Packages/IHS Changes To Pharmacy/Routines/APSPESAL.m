APSPESAL ;IHS/MSC/MGH - Adverse reaction support;11-Sep-2019 16:30;DU;DU
 ;;7.0;IHS PHARMACY MODIFICATIONS;**1016,1024**;Sep 23, 2004;Build 68
 ;================================================================
...
GETADR(RESULT,DFN,ALL,AL1) ;get adverse reaction
 K RESULT N B,I,EIE,HASAL,CNT,INAC,C,J,K,PCNT,TIDDT,TATYPE,TI,TT,ZERO,IHS
 S HASAL=0,EIE=0
...
ADR S CNT=CNT+1
 ...
 ; 12th,13th
 S SOURCE=$$GET1^DIQ(120.8,I,9999999.11)
 S SNOMED=$$GET1^DIQ(120.8,I,9999999.13,"I")
 S RESULT(CNT)=RESULT(CNT)_U_SOURCE_U_SNOMED
 Q
