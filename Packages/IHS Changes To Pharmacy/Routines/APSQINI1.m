APSQINI1 ; ; 23-OCT-1998 [ 10/23/98  1:05 PM ]
 ;;1;APSQ;;OCT 23, 1998
...
ASK I %=1,$D(DIFQ(0)) W !,"SHALL I WRITE OVER FILE SECURITY CODES" S %=2 D YN^DICN S DSEC=%=1 I %<1 K DIFQ Q
 F X="BUL","DIB","DIE","DIP","DIS","KEY","OPT" D W Q:'$D(DIFQ)
 Q:'$D(DIFQ)  S %=2 W !!,"ARE YOU SURE EVERYTHING'S OK" D YN^DICN I %-1 K DIFQ S APSQUIT=1 Q  ;IHS/OKCAO/POC 10/23/98
 ...
 S DN="^APSQI" F R=1:1:23 D @(DN_$$B36(R)) W "."
