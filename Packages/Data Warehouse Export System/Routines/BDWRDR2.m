BDWRDR2 ; IHS/CMI/LAB - DW PROCESS VISIT ; 05 Dec 2022  5:31 PM
 ;;1.0;IHS DATA WAREHOUSE;**2,4,8**;JAN 24, 2006;Build 84
 ;
 K BDWE
 D VISIT
...
VISIT ;EP
 ...
 S X=$O(^DIBT("B","RPMS DEMO PATIENT NAMES",0)) I X,$D(^DIBT(X,1,BDWV("PATIENT DFN"))) S BDW("DEMO")=BDW("DEMO")+1,BDWE("ERROR")=101 Q
 S X=$$SSN^AUPNPAT(BDWV("PATIENT DFN")) I $E(X,1,5)="00000" S BDW("DEMO")=BDW("DEMO")+1,BDWE("ERROR")=101 Q
 Q
 ;
