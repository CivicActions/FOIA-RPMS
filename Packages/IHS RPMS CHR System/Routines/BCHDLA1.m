...
START ;
 ...
 ;
PP ;
 S BCHDT=BCHDLDT F  S BCHDT=$O(^AGPATCH(BCHDT)) Q:BCHDT=""  D
 .S BCHLOC=0 F  S BCHLOC=$O(^AGPATCH(BCHDT,BCHLOC)) Q:BCHLOC'=+BCHLOC  D
 ..S DFN=0 F  S DFN=$O(^AGPATCH(BCHDT,BCHLOC,DFN)) Q:DFN'=+DFN  D
 ...Q:'$D(^AUPNPAT(DFN,0))
 ...Q:'$D(^DPT(DFN,0))
 ...Q:$P(^DPT(DFN,0),U,19)
 ...Q:$D(^XTMP("BCHDL",BCHJOB,BCHBTH,"PATIENTS",DFN))  ;already processed this patient
 ...D PROC
 Q
 ;
 ;
