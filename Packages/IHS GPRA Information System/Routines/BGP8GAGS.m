BGP8GAGS ; IHS/CMI/LAB - AREA NATIONAL GPRA REPORT ;
...
TESTNTL ;
 ...
 S BGPSUL(3)=""
 S BGPSUL(2)=""
 D EP(.ERR,1,2522,"BGP 18 AREA GPRA","A",.BGPSUL,"B",1,$$NOW^XLFDT,1)
 W !,ERR
 Q
...
TSKMN ;
 S ZTIO=""
 K ZTSAVE S ZTSAVE("*")=""
 S ZTCPU=$G(IOCPU),ZTRTN="AOAGP^BGP8GAGS",ZTDTH=$S(BGPRTIME]"":BGPRTIME,1:$$NOW^XLFDT),ZTDESC="GUI AREA GPRA REPORT 15" D ^%ZTLOAD
...
AOAGP ;
 ...
 I BGPRPTT="A",'$G(BGPSUMON) D GNT1^BGP8UTL
 D ENDLOG
 D XIT
 Q
 ;
