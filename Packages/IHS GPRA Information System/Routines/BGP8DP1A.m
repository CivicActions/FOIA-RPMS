BGP8DP1A ; IHS/CMI/LAB - print ind 19 AGE DIST 02 Feb 2018 1:14 PM ;
...
I1AGE ;EP  special age tallies
 Q:$G(BGPSUMON)
 Q:BGPINDG="I"
 S BGPHD1="USER POP TOBACCO USERS/IN CESSATION",BGPHD2="UP Tob Users/in Cess"
 ...
 D I1AGEP
 Q:BGPQUIT
 S BGPHD1="MALE USER POP TOBACCO USERS/IN CESSATION",BGPHD2="Male UP Tob Users/in Cess"
 D:'$G(BGPSUMON) HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0)  D H4^BGP8DPH
 K BGPDAC,BGPDAP,BGPDAB S (D,C,E,F,G)=0 F BGPX="114.5.1","114.5.2","114.5.3" D I1AGE1,I1AGE2,I1AGE4
 D I1AGEP
 Q:BGPQUIT
FEM ;
 S BGPHD1="FEMALE USER POP TOBACCO USERS/IN CESSATION",BGPHD2="Female UP Tob Users/in Cess"
 D:'$G(BGPSUMON) HEADER^BGP8DPH Q:BGPQUIT  W !,^BGPINDR(BGPIC,53,1,0) W:$D(^BGPINDR(BGPIC,53,2,0)) !,^BGPINDR(BGPIC,53,2,0)  D H4^BGP8DPH
