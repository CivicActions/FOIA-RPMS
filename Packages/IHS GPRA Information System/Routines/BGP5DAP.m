BGP5DAP ; IHS/CMI/LAB - IHS GPRA 04 SELECTED REPORT DRIVER ALL PATIENTS ;  
 ;;5.0;IHS CLINICAL REPORTING;**1**;OCT 15, 2004
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2005 Clinical Performance Indicator Report (Selected Indicators)",80)
...
SETIND ;
 D XIT
 S BGPINDT=""
 S DIR(0)="S^DM:Diabetes-Related Indicators;CVD:Cardiovascular Disease Prevention for At-Risk Patients;WH:Women's Health-Related Indicators;ELD:Elder Care-Related Indicators;SEL:Selected Indicators (User Defined)"
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP5DL",ZTDTH="",ZTDESC="GPRA 05 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
