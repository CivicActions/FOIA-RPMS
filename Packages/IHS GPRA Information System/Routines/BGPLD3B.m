BGPLD3B ; IHS/CMI/LAB - PNEUMO REMINDER 27 Feb 2015 7:52 AM ; 11 Jul 2019  3:20 PM
 ;;19.1;IHS CLINICAL REPORTING;**1**;MAY 30, 2019;Build 7
 ;
I13 ;EP - PN
 NEW BGPTDAP,BGPTD,BGPFLU,BGPZOST,BGPPNEU,BGPPNEUD,BGPDTAPP,BGPPPSEV,BGPPCVEV,BGPPP65,BGPPC65,BGPPP5Y,BGPPC5Y,BGPPC1Y,BGPPC19,BGPPP1Y,BGPZVAX,BGPSHIN,BGPZOST
 S (BGPPNCON,BGPPPSEV,BGPPCVEV,BGPPP65,BGPPC65,BGPPP5Y,BGPPC5Y,BGPPC1Y,BGPPC19,BGPPP1Y,BGPPPCON,BGPPCCON)=""
 F X=1:1:20 S Y="BGPD"_X S @Y=""
 F X=1:1:61 S Y="BGPN"_X S @Y=""
 I BGPAGEB>64,BGPACTUP S BGPD3=1  ;UP 65+
 I BGPDMD8 S BGPD2=1  ;USER POP DM
 I BGPAGEB>64,BGPACTCL S BGPD1=1  ;AC 65+
 I BGPAGEB>17,BGPAGEB<65,BGPACTCL,$$HIGHRP^BGPLD3A(DFN,BGPEDATE) S BGPD4=1  ;18-64 AC HIGH RISK
 I BGPAGEB>17,BGPAGEB<65,BGPACTUP,$$HIGHRP^BGPLD3A(DFN,BGPEDATE) S BGPD5=1  ;18-64 UP HIGH RISK
 ...
 I BGPACTUP,BGPAGEB>18 S BGPD17=1  ;V18 USER POP 19+
 I BGPACTUP,BGPAGEB>18,BGPAGEB<50 S BGPD18=1  ;V19 GPRA DEV
 I BGPACTUP,BGPAGEB>49,BGPAGEB<65 S BGPD19=1  ;V19 GPRA DEV
 I '(BGPD1+BGPD2+BGPD3+BGPD4+BGPD5+BGPD6+BGPD7+BGPD8+BGPD9+BGPD10+BGPD11+BGPD12+BGPD13+BGPD14+BGPD15+BGPD16+BGPD17+BGPD18+BGPD19) S BGPSTOP=1 Q
 S BGPVALUE="",BGPVALUD="",BGPPLPNU="",BGPDTAPP="",BGPTDAP=""
PN ;EP - called from elder
 ;NEW PNEUMO AGE 65+ ONLY
 ;I BGPAGEB<65 G N1
 S BGPPPCON=$$PPCONT(DFN,BGPEDATE)
 S BGPPCCON=$$PCCONT(DFN,BGPEDATE)
 ;I BGPPCON S (BGPN1,BGPN8,BGPN37,BGPN46,BGPN47,BGPN48,BGPN49,BGPN50,BGPN51,BGPN52)=1 G N1
 S BGPPPSEV=$$PPSV23^BGPLD3C(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)  ;PPSV23 EVER
 S BGPPCVEV=$$PCV13^BGPLD3C(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)   ;PCV13 EVER
 S BGPPP5Y=$$PPSV23^BGPLD3C(DFN,$$FMADD^XLFDT(BGPEDATE,-(5*365)),BGPEDATE)  ;PPSV23 LAST 5 YEARS
 S BGPPC5Y=$$PCV13^BGPLD3C(DFN,$$FMADD^XLFDT(BGPEDATE,-(5*365)),BGPEDATE)  ;PCV13 LAST 5 YEARS
 S BGPPC1Y=$$PCV13^BGPLD3C(DFN,BGPBDATE,BGPEDATE)  ;PCV13 PAST YEAR
 S BGPPP1Y=$$PPSV23^BGPLD3C(DFN,BGPBDATE,BGPEDATE)  ;PPSV23 PAST YEAR
 S B=$$DOB^AUPNPAT(DFN)
 S BGPA65BD=$E(B,1,3)+65_$E(B,4,7)
 I BGPAGEB>64 S BGPPP65=$$PPSV23^BGPLD3C(DFN,BGPA65BD,BGPEDATE),BGPPC65=$$PCV13^BGPLD3C(DFN,BGPA65BD,BGPEDATE)
 S BGPA19BD=$E(B,1,3)+19_$E(B,4,7)
 S BGPPC19=$$PCV13^BGPLD3C(DFN,BGPA19BD,BGPEDATE)
...
TD ;new tdap and td stuff for v11.1
 I BGPRTYPE=5 G P1
 S BGPTDAP=$$DTAP^BGPLD3A(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)
 I BGPTDAP S BGPN9=1                                                        ;026.N.3 TDAP/TD EVER    BGPN9
 S BGPTD=$$DTAPTD^BGPLD3A(DFN,$$FMADD^XLFDT(BGPEDATE,-(10*365)),BGPEDATE)
 ...
 ;FLU
 S BGPFLU=$$FLU^BGPLD3(DFN,BGPBDATE,BGPEDATE)
 ...
 S BGPZOST=$$IZOSTER^BGPLD3C(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)
 I $P(BGPZOST,U,3)=1!($P(BGPZOST,U,3)=3) S BGPN17=1  ;026.O.7
 ;ZOSTAVAX IN 5 YRS
 S BGPZVAX=$$IZOSTVAC^BGPLD3C(DFN,($E(BGPEDATE,1,3)-4)_$E(BGPBDATE,4,7),BGPEDATE)
 I $P(BGPZVAX,U,3)=1!($P(BGPZVAX,U,3)=3) S BGPN55=1  ;ZOSTAVAX IN 5 YRS
 ;SHINGRIX IN 5 YRS
 S BGPSHIN=$$SHINGRIX^BGPLD3C(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)
 I $P(BGPSHIN,U,3)=1!($P(BGPSHIN,U,3)=3) S BGPN56=1  ;2 SHINGRIX EVER
 ;
 I BGPN55!(BGPN56) S BGPN57=1
 I BGPN30,BGPN57 S BGPN58=1  ;026.W.1  1:1:1*
 I BGPN30,BGPN56 S BGPN59=1  ;026.W.2  1:1:2
 I BGPN30,BGPN57,BGPN46 S BGPN60=1
 ...
 I BGPD14 D
 .;S BGPVALUD="AC PREG|||"
 .S BGPFPRDX=$$FIRSTPDX^BGPLD3C(DFN,$$FMADD^XLFDT(BGPEDATE,-608),BGPEDATE) I BGPFPRDX="" S BGPFPRDX=$P($G(^AUPNREP(DFN,11)),U,2)
 .;GET EDD
 .S BGPEDD=$$EDD^BGPLUTL2(DFN,BGPBDATE,BGPEDATE)
 .K BGPTDAPP
 .S D=BGPEDATE
 ...
 ..S TE=BGPEDD
 ..S BGPD16=$$LASTVD^BGPLD3C(DFN,TB,TE)
...
UNK ..I G="" S BGPN44=1,BGPTRIM="unk Trimester"
 ...
 ..S G=""
 ..S BGPD16=$$LASTDX^BGPLUTL1(DFN,"BGP PREGNANCY TRI 3 DXS",BGPBDATE,BGPEDATE)
 ..S X=$P(BGPTDAPP,U,2) ;DATE OF TDAP
 ..I X="" Q
 ..I $E(BGPTDAPP)=2 G UNK1
 ..S Y=$$LASTDX^BGPLUTL1(DFN,"BGP PREGNANCY TRI 3 DXS",$$FMADD^XLFDT(X,-7),$$FMADD^XLFDT(X,7))
 ..I Y S G=G_3,BGPD16=1
 ..S Y=$$LASTDX^BGPLUTL1(DFN,"BGP PREGNANCY TRI 2 DXS",$$FMADD^XLFDT(X,-7),$$FMADD^XLFDT(X,7))
 ..I Y S G=G_2
 ..S Y=$$LASTDX^BGPLUTL1(DFN,"BGP PREGNANCY TRI 1 DXS",$$FMADD^XLFDT(X,-7),$$FMADD^XLFDT(X,7))
 ..I Y S G=G_1
 ..I G[3 S BGPN43=1,BGPTRIM="3rd Trimester" Q
 ..I G[2 S BGPN42=1,BGPTRIM="2nd Trimester" Q
 ..I G[1 S BGPN41=1,BGPTRIM="1st Trimester" Q
...
N ;
 ...
 S (BGPDDV,BGPDV)=""
 D
 .I BGPD9 S BGPDDV=BGPDDV_$S(BGPDDV]"":",UP",1:"UP")
 .I BGPD2 S BGPDDV=BGPDDV_$S(BGPDDV]"":",UPDM",1:"UPDM")
 .I BGPD4!(BGPD5) S BGPDDV=BGPDDV_$S(BGPDDV]"":",HR",1:"HR")
 .I BGPD14 S BGPDDV=BGPDDV_$S(BGPDDV]"":",AC PREG",1:"AC PREG")
 .I BGPD16 S BGPDDV=BGPDDV_$S(BGPDDV]"":",PREGVTTM",1:"PREGVTTM")
 S BGPVALUD=BGPDDV_"|||"
 D
 ...
 .I BGPN55 S BGPVALUD=BGPVALUD_$S($P(BGPVALUD,"|||",2)]"":"; ",1:""),BGPVALUD=BGPVALUD_"ZOST/SHIN: "_$P(BGPZVAX,U,2)_" (past 5 yr)"
 .I BGPN56 S BGPVALUD=BGPVALUD_$S($P(BGPVALUD,"|||",2)]"":"; ",1:""),BGPVALUD=BGPVALUD_"ZOST/SHIN: "_$P(BGPSHIN,U,2)_" (ever)"
 .I BGPPPCON S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_"PPSV23: "_$$DATE^BGPLUTL($P(BGPPPCON,U,1))_" "_$P(BGPPPCON,U,2)
 .I BGPPCCON S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_"PCV13: "_$$DATE^BGPLUTL($P(BGPPCCON,U,1))_" "_$P(BGPPCCON,U,2)
 .;PPSV23
 .I BGPPPSEV D
 ..S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_"PPSV23: "_$$DATE^BGPLUTL($P(BGPPPSEV,U,1))_" "_$P(BGPPPSEV,U,2)_" (ever)"
 ..S:BGPPP5Y BGPVALUD=BGPVALUD_" (past 5 yrs)" S:BGPPP1Y BGPVALUD=BGPVALUD_" (past 1 yr)" S:BGPPP65 BGPVALUD=BGPVALUD_" (after 65)" I BGPN46 S BGPVALUD=BGPVALUD_" (up-to-date)"
 .I BGPPCVEV D
 ..S BGPVALUD=BGPVALUD_$S(BGPVALUD]"":"; ",1:"")_"PCV13: "_$$DATE^BGPLUTL($P(BGPPCVEV,U,1))_" "_$P(BGPPCVEV,U,2)_" (ever)"
 ..S:BGPPC5Y BGPVALUD=BGPVALUD_" (past 5 yrs)" S:BGPPC1Y BGPVALUD=BGPVALUD_" (past 1 yr)" S:BGPPC65 BGPVALUD=BGPVALUD_" (after 65)" S:BGPPC19 BGPVALUD=BGPVALUD_" (after 19)" I BGPN46 S BGPVALUD=BGPVALUD_" (up-to-date)"
 S BGPDV=""
 ;SELECTED DENOMINATOR LIST VALUE
 I BGPRTYPE=4 D
 .S BGPDV="UP"
 .I BGPD2 S BGPDV=BGPDV_$S(BGPDV]"":",UPDM",1:"UPDM")
 ...
 ;GRPA DEV  AGE APPROPRIATE
 I BGPD18,BGPN30 S BGPN61=1
 I BGPD19,BGPN58 S BGPN61=1
 I BGPD13,BGPN58 S BGPN61=1
 I BGPD3,BGPN60 S BGPN61=1
 ;MY GOD!
 S BGPVALUE=""
...
P1 I BGPPPCON S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_"PPSV23: "_$$DATE^BGPLUTL($P(BGPPPCON,U,1))_" "_$P(BGPPPCON,U,2)
 I BGPPCCON S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_"PCV13: "_$$DATE^BGPLUTL($P(BGPPCCON,U,1))_" "_$P(BGPPCCON,U,2)
 ;PPSV23
 I BGPPPSEV D
 .S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_"PPSV23: "_$$DATE^BGPLUTL($P(BGPPPSEV,U,1))_" "_$P(BGPPPSEV,U,2)_" (ever)"
 ...
 I BGPPCVEV D
 .S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_"PCV13: "_$$DATE^BGPLUTL($P(BGPPCVEV,U,1))_" "_$P(BGPPCVEV,U,2)_" (ever)"
...
TDE K BGPLPNU,BGPVAL,BGPA65,BGPVALH,BGPTD,BGPTDAP,BGPFLU,BGPTDAPP,BGPPNCON,BGPA65BD,BGPA19BD,BGPPNCON,BGPZVAX,BGPZSHIN,BGPDDV,BGPDV
 Q
OPTOM ;EP
 G OPTOM^BGPLD213
LASTTDAP(P,BDATE,EDATE) ;EP
 ...
 ..Q:ID<BDATE
 ..Q:ID>EDATE
 ..S BGPX=ID_U_$$DATE^BGPLUTL(ID)_" Imm 115"
 .Q
 ;now add in cpt
 S C=+$$CODEN^ICPTCOD(90715)
 S D=$$CPTI^BGPLDU(P,BDATE,EDATE,C)
 I $P(D,U,2)>$P(BGPX,U,1) S BGPX=$P(D,U,2)_U_$$DATE^BGPLUTL(D)_" CPT 90715"
 I BGPX Q 1_U_BGPX
 ;contra/nmi
 F BGPZ=115 S X=$$ANCONT^BGPLD31(P,BGPZ,EDATE)
 I X]"" S BGPX=2_U_$P(X,U,1)_U_$$DATE^BGPLUTL($P(X,U,1))_" "_$P(X,U,2) Q BGPX
 ;Refusals
 ...
 ..S R=D
 I R S BGPX=2_U_R_U_$$DATE^BGPLUTL(R)_" "_"NMI Dtap" Q BGPX
 S R="",B=+$$CODEN^ICPTCOD(90715)
 S G=$$NMIREF^BGPLUTL1(P,81,B,$$DOB^AUPNPAT(P),EDATE)
 I G S BGPX=2_U_$P(G,U,2)_U_$$DATE^BGPLUTL($P(G,U,2))_" "_"NMI Dtap 90715" Q G
 Q ""
PREG(P,BDATE,EDATE) ;
 I '$$PREG^BGPLD7(DFN,$$FMADD^XLFDT(EDATE,-608),EDATE,1,1,,BDATE,EDATE) Q ""    ;V17.1 CMI/LAB ADDED DATES FOR CURRENTLY PREGNANT
 Q 1
PPCONT(P,EDATE) ;contraindicated
 ...
 S BGPZ=0 F  S BGPZ=$O(^ATXAX(T1,21,"B",BGPZ)) Q:BGPZ'=+BGPZ!(X]"")  S X=$$ANCONT^BGPLD31(P,BGPZ,EDATE)
 I X]"" Q X_U_3
 ;NMI Refusal
 S BGPZ=0,G="" F  S BGPZ=$O(^ATXAX(T1,21,"B",BGPZ)) Q:BGPZ'=+BGPZ!(G)  D
 .S G=$$NMIREF^BGPLUTL1(P,9999999.14,$O(^AUTTIMM("C",BGPZ,0)),$$DOB^AUPNPAT(P),EDATE)
 .I $P(G,U)=1 S G=$P(G,U,2)_U_"NMI Refusal"_U_3
 I G]"" Q G
 S R=$$CPTREFT^BGPLUTL1(P,$$DOB^AUPNPAT(P),EDATE,$O(^ATXAX("B","BGP PPSV23 CPT CODES",0)),"N")
...
PCCONT(P,EDATE) ;
 ...
 .I $P(G,U)=1 S G=$P(G,U,2)_U_"NMI Refusal"_U_3
 I G]"" Q G
 S R=$$CPTREFT^BGPLUTL1(P,$$DOB^AUPNPAT(P),EDATE,$O(^ATXAX("B","BGP PNEUMO CONJUGATE CPTS",0)),"N")
 I R Q $P(R,U,2)_U_"NMI Refusal "_$P(R,U,4)_U_3
 Q ""
