...
EXCELGS ;EP
 ...
 S $P(BGPX,U,182)="Public Health Nursing"
...
REPORT ;EP
 ...
 L +^BGPGPDCV:30 I '$T W !!,"Unable to lock global, try later." G REPORTX
 L +^BGPGPDPV:30 I '$T W !!,"Unable to lock global, try later." G REPORTX
 L +^BGPGPDBV:30 I '$T W !!,"Unable to lock global, try later." G REPORTX
 D GETIEN
