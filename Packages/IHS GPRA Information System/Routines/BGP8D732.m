BGP8D732 ; IHS/CMI/LAB - measure AHR.A ;
...
ACECONT(P,BDATE,EDATE) ;EP does patient have an ACEI Contraidication
 ...
 I $D(BGPG(1)) Q 1_U_"ACEI Contra POV:  "_$$DATE^BGP8UTL($P(BGPG(1),U))_$P(BGPG(1),U,2)_" "_$$VAL^XBDIQ1(9000010.07,+$P(BGPG(1),U,4),.04)
 ;
 ...
 ...S BGPG=1_U_"NMI ACEI: "_$$VAL^XBDIQ1(9000022,N,.04)_"   "_$$DATE^BGP8UTL($P(^AUPNPREF(N,0),U,3))_"  "_$$VAL^XBDIQ1(9000022,X,1101)
 ..Q
 .Q
 I BGPG Q BGPG
 ;nmi in Refusal file for ACEI
 ...
 ..S N=0 F  S N=$O(^AUPNPREF("AA",P,50,X,D,N)) Q:N'=+N  D
 ...Q:$P($G(^AUPNPREF(N,0)),U,7)'="N"
 ...S BGPG=1_U_"NMI ARB: "_$$VAL^XBDIQ1(9000022,N,.04)_"   "_$$DATE^BGP8UTL($P(^AUPNPREF(N,0),U,3))_"  "_$$VAL^XBDIQ1(9000022,X,1101)
 ..Q
 .Q
 I BGPG Q BGPG
 S X=$$CPTI^BGP8DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8029"))
 I X Q 1_U_"arb Contra CPT code G8029: "_$$DATE^BGP8UTL($P(X,U,2))
 S X=$$TRANI^BGP8DU(P,BDATE,EDATE,+$$CODEN^ICPTCOD("G8029"))
 I X Q 1_U_"arb Contra Tran Code G8029: "_$$DATE^BGP8UTL($P(X,U,2))
 Q ""
...
STATALG(P,BDATE,EDATE) ;EP
 ...
 .I N["STATIN"!(N["STATINS"),N'["NYSTATIN" S BGPC="Alg Statin POV:  "_$$DATE^BGP8UTL($P(BGPG(X),U))_"  ["_$P(BGPG(X),U,2)_"]  "_N
 ...
 .I N["STATIN"!(N["STATINS"),N'["NYSTATIN" S BGPC=1_U_"alg statin POV:  "_$$DATE^BGP8UTL($P(BGPG(X),U))_$P(BGPG(X),U,2)_" "_N
 I BGPC Q BGPC
 ...
 .I $P(^AUPNPROB(X,0),U,13)="" Q:$P(^AUPNPROB(X,0),U,8)>EDATE  ;added after discharge date
