BGP8D723 ; IHS/CMI/LAB - measure AHR.A ;
...
ACECONT(P,BDATE,EDATE,NMIB,NMIE,RPBD) ;EP ACEI Contra
 ...
 I $D(BGPG(1)) Q 1_U_$$DATE^BGP8UTL($P(BGPG(1),U))_" ACEI/ARB Contra POV "_$P(BGPG(1),U,2)
 ;
 ;nmi
 S BGPG=""
 ...
 ...S BGPG=1_U_$$DATE^BGP8UTL($P(^AUPNPREF(N,0),U,3))_" ACEI NMI Refusal"
 ..Q
 .Q
 I BGPG Q BGPG
 ;nmi
 ...
 ..S N=0 F  S N=$O(^AUPNPREF("AA",P,50,X,D,N)) Q:N'=+N  D
 ...Q:$P($G(^AUPNPREF(N,0)),U,7)'="N"
 ...S BGPG=1_U_$$DATE^BGP8UTL($P(^AUPNPREF(N,0),U,3))_" ARB NMI Refusal"
 ..Q
 .Q
 I BGPG Q BGPG
 ;PREGNANCY
 S X=$$PREG^BGP8D715(P,$S($G(RPBD):RPBD,1:NMIB),NMIE,1,1,,RPBD,EDATE) I X Q 1_U_"ACEI/ARB Contra pregnant"   ;V17.1 CMI/LAB ADDED DATES FOR CURRENTLY PREGNANT
 ;breastfeeding
...
STATALG(P,BDATE,EDATE,RPB,RPE) ;EP
 ...
 .I N["STATIN"!(N["STATINS"),N'["NYSTATIN" S BGPC=1_U_"Alg Statin POV:  "_$$DATE^BGP8UTL($P(BGPG(X),U))_" "_$P(BGPG(X),U,2)_" "_N
 ...
 .I N["STATIN"!(N["STATINS"),N'["NYSTATIN" S BGPC=BGPC+1,BGPY(BGPC)=1_U_"Alg statin POV:  "_$$DATE^BGP8UTL($P(BGPG(X),U))_" "_$P(BGPG(X),U,2)_" "_N
 I BGPC Q BGPC
 ;PL
 S BGPC=0
