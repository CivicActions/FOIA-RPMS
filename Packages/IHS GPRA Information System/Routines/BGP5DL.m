BGP5DL ; IHS/CMI/LAB - IHS GPRA 05 SELECTED REPORT DRIVER ;  
 ;;5.0;IHS CLINICAL REPORTING;**1**;OCT 15, 2004
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2005 CRS - Clinical Performance Indicator Report (Selected Indicators)",80)
INTRO ;
 D XIT
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP5DL",ZTDTH="",ZTDESC="CRS 05 COM REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
