BGP8DPP ;IHS/CMI/LAB - PP REPORT;
 ;;18.0;IHS CLINICAL REPORTING;**1**;NOV 21, 2017;Build 62
 ;
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("2018 Clinical Performance Measure Report (Selected Measures)",80)
...
INTRO ;
 ...
 W !,"reporting period and 2) the baseline period to compare data."
...
SUM ;display summary of this report
 ...
 W !!,"These measures will be calculated: " S X=0 F  S X=$O(BGPIND(X)) Q:X'=+X  W $P(^BGPINDR(X,0),U,3)," ; "
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP8DPP",ZTDTH="",ZTDESC="GPRA 16 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP8DPP",XBRX="XIT^BGP8DPP",XBNS="BGP"
 D ^XBDBQUE
 ;D XIT
 Q
 ;
