BGP5LSTF ; IHS/CMI/LAB - List 'BG05' files in pub ; 
 ;;5.0;IHS CLINICAL REPORTING;**1**;OCT 15, 2004
 ;
 ;
 W:$D(IOF) @IOF
 W !,"This option is used to list all CRS 2005 files that are in a directory.",!,"These files begin with BG05.",!,"You must specify the directory in which the CRS 2005 data files reside.",!
FILE ;
 D HOME^%ZIS
DIR ;
 K DIR
 ...
 W !!,"The following CRS 2005 files reside in the ",BGPDIR," directory."
