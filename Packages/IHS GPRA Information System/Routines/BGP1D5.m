...
DV ;EP
 ...
 I $P(BGPDVEX,U)=1 S BGPVALUE=BGPVALUE_$P(BGPDVEX,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVEX,U,2))
 I $P(BGPDVDX,U)=1 S BGPVALUE=BGPVALUE_$S($P(BGPVALUE,"|||",2)]"":";",1:"")_$P(BGPDVDX,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVDX,U,2))
 I $P(BGPDVPED,U)=1 S BGPVALUE=BGPVALUE_$S($P(BGPVALUE,"|||",2)]"":";",1:"")_$P(BGPDVPED,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVPED,U,2))
 I $P(BGPDVCOU,U)=1 S BGPVALUE=BGPVALUE_$S($P(BGPVALUE,"|||",2)]"":";",1:"")_$P(BGPDVCOU,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVCOU,U,2))
 I $P(BGPDVREF,U)=1 S BGPVALUE=BGPVALUE_$S($P(BGPVALUE,"|||",2)]"":";",1:"")_$P(BGPDVREF,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVREF,U,2))
 S BGPVALUD="" I BGPD2 S BGPVALUD="AC15-40"_"|||" D
 .I $P(BGPDVEX,U)=1 S BGPVALUD=BGPVALUD_$P(BGPDVEX,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVEX,U,2))
 .I $P(BGPDVDX,U)=1 S BGPVALUD=BGPVALUD_$S($P(BGPVALUD,"|||",2)]"":";",1:"")_$P(BGPDVDX,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVDX,U,2))
 .I $P(BGPDVPED,U)=1 S BGPVALUD=BGPVALUD_$S($P(BGPVALUD,"|||",2)]"":";",1:"")_$P(BGPDVPED,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVPED,U,2))
 .I $P(BGPDVCOU,U)=1 S BGPVALUD=BGPVALUD_$S($P(BGPVALUD,"|||",2)]"":";",1:"")_$P(BGPDVCOU,U,3)_" "_$$DATE^BGP1UTL($P(BGPDVCOU,U,2))
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F,T
 Q
 ;
...
DVPED(P,BDATE,EDATE) ;EP
 ...
 .;I $P(T,"-",1)="99408"!($P(T,"-")="99409")!($P(T,"-")="G0396")!($P(T,"-")="G0397")!($P(T,"-")="H0049")!($P(T,"-")="H0050") S BGPLDV=1_"^"_$P(BGPG(X),U)_"^PED "_T_U_"PED "_T_U_$$DATE^BGP1UTL($P(BGPG(X),U)) Q
BHPED ;
...
ALHF(P,BDATE,EDATE) ;EP - alcohol hf or screening pov
 ...
 ..I T="AUDT"!(T="AUDC")!(T="CRFT") S BGPC=1_U_"BH MSR: "_T_U_$$DATE^BGP1UTL((9999999-D))_U_(9999999-D)
 I $P(BGPLAL,U,4)<$P(BGPC,U,4) S BGPLAL=BGPC
 K BGPG S %=P_"^LAST DX V11.3;DURING "_BDATE_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 I $D(BGPG(1)),$P(BGPLAL,U,4)<$P(BGPG(1),U,1) S BGPLAL=1_U_"DX: V11.3"_U_$$DATE^BGP1UTL($P(BGPG(1),U))_U_$P(BGPG(1),U,1)
 K BGPG
 S %=P_"^LAST DX V79.1;DURING "_BDATE_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 I $D(BGPG(1)),$P(BGPLAL,U,4)<$P(BGPG(1),U,1) S BGPLAL=1_U_"DX: V79.1"_U_$$DATE^BGP1UTL($P(BGPG(1),U))_U_$P(BGPG(1),U,1)
 ...
 ..I BGPP=29.1 S BGPC=1_U_"BH dx: 29.1"_U_$$DATE^BGP1UTL((9999999-$P(D,".")))_U_(9999999-$P(D,".")) Q
 ..Q
...
ALPRC(P,BDATE,EDATE) ;EP
 ...
 I BGPG Q 1_U_"PROC "_$P(BGPG,U,2)_U_$$DATE^BGP1UTL($P(BGPG,U,3))
 Q ""
ALPED(P,BDATE,EDATE) ;EP
 ...
 .Q:'$D(^AUTTEDT(T,0))
 .S T=$P(^AUTTEDT(T,0),U,2)
 .I $P(T,"-",1)="CD"!($P(T,"-",2)="CD")!($P(T,"-",1)="AOD")!($P(T,"-",2)="AOD"),$P(BGPLPED,U,4)<$P(BGPG(X),U) S BGPLPED=1_U_"EDUC: "_T_U_$$DATE^BGP1UTL($P(BGPG(X),U))_U_$P(BGPG(X),U)
 .I $P(T,"-",1)="V11.3"!($P(T,"-",1)="V79.1")!($P(T,"-",1)["303.")!($P(T,"-",1)["305.0")!($P(T,"-")["291.")!($P(T,"-")["357.5"),$P(BGPLPED,U,4)<$P(BGPG(X),U) D
 ..S BGPLPED=1_U_"EDUC: "_T_U_$$DATE^BGP1UTL($P(BGPG(X),U))_U_$P(BGPG(X),U)
 .I $P(T,"-",1)="99408"!($P(T,"-",1)="99409")!($P(T,"-",1)["G0396")!($P(T,"-",1)["G0397")!($P(T,"-")["H0049")!($P(T,"-")["H0050"),$P(BGPLPED,U,4)<$P(BGPG(X),U) D
 ..S BGPLPED=1_U_"EDUC: "_T_U_$$DATE^BGP1UTL($P(BGPG(X),U))_U_$P(BGPG(X),U)
ALMH ;
 ...
 ..Q:'$D(^AUTTEDT(T,0))
 ..S T=$P(^AUTTEDT(T,0),U,2)
 ..I $P(T,"-",1)="CD"!($P(T,"-",2)="CD")!($P(T,"-",1)="AOD")!($P(T,"-",2)="AOD"),$P(BGPLPED,U,4)<(9999999-D) S BGPLPED=1_U_"EDUC: "_T_U_$$DATE^BGP1UTL((9999999-D))_U_(9999999-D)
 ..I $P(T,"-",1)="V11.3"!($P(T,"-",1)="V79.1")!($P(T,"-",1)["303.")!($P(T,"-",1)["305.0")!($P(T,"-")["291.")!($P(T,"-")["357.5"),$P(BGPLPED,U,4)<(9999999-D) D
 ...S BGPLPED=1_U_"EDUC: "_T_U_$$DATE^BGP1UTL((9999999-D))_U_(9999999-D)
...
ALREF(P,BDATE,EDATE) ;EP
 ...
 I $P(G,U)=1 Q 1_"^ref exam 35^"_$$DATE^BGP1UTL($P(G,U,2))_U_$P(G,U,2)
 Q ""
LOINC(A,B) ;
 NEW %
