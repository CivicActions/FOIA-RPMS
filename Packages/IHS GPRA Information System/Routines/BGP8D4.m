BGP8D4 ; IHS/CMI/LAB - measure 3 11 Dec 2007 5:58 PM ; 12 Sep 2008  10:17 AM
...
I16 ;EP
 ...
 I BGPRTYPE'=3 S BGPVALUE=$S(BGPI8DA!(BGPI8DE):"UP",1:"")_$S(BGPI8DB!(BGPI8DD):";AC",1:"")_" - "_$S(BGPI82:">41",1:"")_$S(BGPI8:", 52-64",1:"")_"|||"_$$DATE^BGP8UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
 I BGPRTYPE=3 S BGPVALUE="AC|||"_$$DATE^BGP8UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
...
MP ;
 ...
 ;I T D  I $P(BGPLMAM,U,2)<X S BGPLMAM="1^"_X_"^WH"
 ;.S X=$$WH^BGP8DU(P,$$FMADD^XLFDT(EDATE,-(2*365)),EDATE,T,3)
 I BGPLMAM]"" Q BGPLMAM
 ;
...
MAS(P,EDATE) ;EP mastectomy before end of time frame
 ...
 S (X,Y,Z,G)=0 K BGPX
 S T=$O(^ATXAX("B","BGP BILATERAL MASTECTOMY CPTS",0))
 I T S %="" D  I %]"" Q 1
