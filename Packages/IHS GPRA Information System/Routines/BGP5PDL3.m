...
I36 ;EP
 D H1^BGP5PDL1
 F BGPPC1="36.1" D PI^BGP5PDL1
 ;D H1
 F BGPPC1="36.2.1","36.2.2","36.2.3","36.2.4","36.2.5" D PI
 F BGPPC1="36.3.1","36.3.2","36.3.3","36.3.4","36.3.5" D PI
 Q
PI ;EP
 K BGPEXCT,BGPSDP
 ...
 .S X=$P(^BGPINDVC(BGPPC,0),U,15) D
 ..I BGPINDT="E",X["65+",$P(^BGPINDVC(BGPPC,0),U,4)="023.E.3" S X="Any Setting" D S(X,1,1) S X="Ages 65+" D S(X,1,1) Q
 ..I BGPINDT="E",X["65+",$P(^BGPINDVC(BGPPC,0),U,4)="023.E.4" S X="Home Setting" D S(X,1,1) S X="Ages 65+" D S(X,1,1) Q
 ..D S(X,1,1)
 .I $P(^BGPINDVC(BGPPC,0),U,16)]"" S X=$P(^BGPINDVC(BGPPC,0),U,16) D S(X,1,1)
 .I BGPRTYPE=4,$P(^BGPINDVC(BGPPC,0),U,19)]"" S Y=$P(^BGPINDVC(BGPPC,0),U,19) D S(Y,1,1)
 .D H2
 Q
H2 ;
