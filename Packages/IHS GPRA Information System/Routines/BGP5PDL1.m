...
I11 ;EP
 D H1
 F BGPPC1="11.1","11.2","11.3" D PI
 F BGPPC1="11.4","11.5" D PI
 F BGPPC1="11.6","11.7" D PI
 Q
I12 ;EP
 D H1
...
I16 ;
 D H1
 F BGPPC1="16.1","16.2","16.3","16.4","16.5","16.6" D PI
 Q
I17 ;EP
 D H1
...
I20 ;EP
 D H1
 F BGPPC1="20.1","20.2","20.3" D PI
 Q
I21 ;EP
 D H1
 F BGPPC1="21.1","21.2","21.3","21.4","21.5","21.6" D PI
 Q
I23 ;EP
 D H1
 F BGPPC1="23.1","23.2","23.3","23.4","23.5","23.6" D PI
 Q
I25 ;EP
 D H1
...
I32 ;EP
 D H1
 F BGPPC1="32.1","32.2" D PI S X=" " D S(X,1,1)
 Q
I34 ;EP
 D H1
 F BGPPC1="34.1","34.2" D PI
 Q
I35 ;EP
 D H1
 F BGPPC1="35.1","35.2" D PI
 Q
PI ;EP
 S BGPDENP=0
...
PI1 ;EP
 ...
 I $P(^BGPINDVC(BGPPC,0),U,4)["031"!($P(^BGPINDVC(BGPPC,0),U,4)["C-")!($P(^BGPINDVC(BGPPC,0),U,4)["I.") D
 .S BGPDF=$P(^BGPINDVC(BGPPC,0),U,8)
 .;get denominator value of indicator
 .S BGPNP=$P(^DD(90371.03,BGPDF,0),U,4),N=$P(BGPNP,";"),P=$P(BGPNP,";",2)
 .S BGPCYD=$$V(1,BGPRPT,N,P,1) I $G(BGPAREAA) D SETEXA^BGP5DP1(1,N,P)
 ...
 S Y=" " D S(Y,1,1) S Y=$P(^BGPINDVC(BGPPC,0),U,15) D S(Y,1,1) I BGPRTYPE=4,$P($G(^BGPINDVC(BGPPC,12)),U,5) S X=Y_" (GPRA)" D S(X,0,1)
