BGP5D4 ; IHS/CMI/LAB - indicator 3 ; 
...
I15 ;EP
 ...
 I BGPRTYPE'=3 S BGPVALUE=$S(BGPI8DA:"UP",1:"")_$S(BGPI8DB:";AC",1:"")_"|||"_$$DATE^BGP5UTL($P(BGPMAM,U,2))_" "_$P(BGPMAM,U,3)
...
MAM(P,EDATE,YEARS) ;
 ...
 I T D  I X]"" Q "1^"_X_"^WH"
 .S X=$$WH^BGPDU(P,$$FMADD^XLFDT(EDATE,-(2*365)),EDATE,T,3)
 S T="" F BGPT=76091,76092,76090 D  Q:T]""
 .S C=$O(^ICPT("B",BGPT,0)) Q:C=""
 .S T=""
 .S T=$$REFUSAL^BGP5UTL1(P,71,$O(^RAMIS(71,"D",C,0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 .I T S T="1^"_$P(T,U,2)_"^ref"
 I BGPRTYPE=3 Q T
 S T="" F BGPT="G0202","G0204","G0206" D  Q:T]""
 .S C=$O(^ICPT("B",BGPT,0)) Q:C=""
 .S T=""
 .S T=$$REFUSAL^BGP5UTL1(P,71,$O(^RAMIS(71,"D",C,0)),$$FMADD^XLFDT(EDATE,-365),EDATE)
 .I T S T="1^"_$P(T,U,2)_"^ref"
...
MAS(P,EDATE) ;mastectomy before end of time frame
 ...
 K BGPX
 ;S %=P_"^ALL PROCEDURE [BGP MASTECTOMY PROCEDURES;DURING "_$$FMTE^XLFDT($$DOB^AUPNPAT(P))_"-"_$$FMTE^XLFDT(EDATE),E=$$START1^APCLDF(%,"BGP(")
 S T=$O(^ATXAX("B","BGP MASTECTOMY PROCEDURES",0))
