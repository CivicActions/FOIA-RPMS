BGP5DGPU ; IHS/CMI/LAB - IHS AREA CLIN 05 REPORT DRIVER ; 
...
DRIVER ;
 ...
 ;
NODEV ;
 S XBRP="",XBRC="NODEV1^BGP5DGPU",XBRX="XIT^BGP5DGPU",XBNS="BGP"
 D ^XBDBQUE
 Q
 ;
NODEV1 ;
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP5DGPU",ZTDTH="",ZTDESC="NATIONAL GPRA REPORT 05" D ^%ZTLOAD D XIT Q
 Q
 ;
XIT ;
 D ^%ZISC
