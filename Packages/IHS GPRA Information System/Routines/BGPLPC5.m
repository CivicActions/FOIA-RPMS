BGPLPC5 ; IHS/CMI/LAB - measure I2 ; 02 Feb 2019  11:25 AM
...
AIZ ;EP
 ...
 ;AGE 65+
 ;I BGPAGEB<65 G N1
 S BGPPPCON=$$PPCONT^BGPLD3B(DFN,BGPEDATE) ;I BGPPPCON S (BGPPPSEV,BGPPP5Y,BGPPP1Y,BGPPP65)=BGPPPCON G N1  ;did they have a contraindication
 S BGPPCCON=$$PCCONT^BGPLD3B(DFN,BGPEDATE) ;I BGPPCCON S (BGPPCVEV,BGPPC5Y,BGPPC1Y,BGPPC19)=BGPPCCON G N1  ;did they have a contraindication
...
SV ;
 ...
 I BGPPPCON S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":"; ",1:"")_"PPSV23: "_$$DATE^BGPLUTL($P(BGPPPCON,U,1))_" "_$P(BGPPPCON,U,2)
