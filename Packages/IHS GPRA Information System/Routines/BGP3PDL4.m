BGP3PDL4 ; IHS/CMI/LAB - print ind 1 ;  [ 07/14/2003   1:46 PM ]
 ;;2.0;IHS GPRA REPORTING;**2**;MAY 22, 2003
 ;
 ;
I31 ;EP
 D H1^BGP3PDL1
 F BGPPC1="031.AA","031.AB","031.AC" D PI^BGP3PDL1
 D I1AGE
 F BGPPC1="031.CA","031.CB","031.CC" D PI^BGP3PDL1
 D I1AGE^BGP3PDL5
 Q
I1AGE ;
 Q:BGPRTYPE'=4
 ...
 K BGPDAC,BGPDAP,BGPDAB S (C,D)=0 F BGPX="AD","AG","AJ","AM","AP","AS","AV","AY" D I1AGE1,I1AGE2
 D I1AGEP
 S BGPHD1="MALE GPRA USER POPULATION",BGPHD2="Total # MALE User Pop"
 S X=^BGPIND(BGPIC,53,1,0) D S(X,1,1) D H3
 K BGPDAC,BGPDAP,BGPDAB S (D,C)=0 F BGPX="AE","AH","AK","AN","AQ","AT","AW","AZ" D I1AGE1,I1AGE2
 D I1AGEP
 S BGPHD1="FEMALE GPRA USER POPULATION",BGPHD2="Total # FEMALE User Pop"
 S X=^BGPIND(BGPIC,53,1,0) D S(X,1,1) D H3
 K BGPDAC,BGPDAP,BGPDAB S (C,D)=0 F BGPX="AF","AI","AL","AO","AR","AU","AX","BA" D I1AGE1,I1AGE2
 D I1AGEP
 Q
I1AGE1 ;
 S C=C+1
