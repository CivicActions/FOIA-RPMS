...
I16 ;EP
 ...
 I BGPOTH]"" S BGPN1=1
 S BGPREF="" I 'BGPN1 S BGPREF=$$REF(DFN,$$FMADD^XLFDT(BGPEDATE,-365),BGPEDATE) I BGPREF S BGPN1=1,BGPN4=1
 S BGPVALUE=""
...
RECT(P,EDATE) ;EP
 ...
 .I D<BDATE Q
 .S S=1
 I S=1 Q "RECT VPRC"_"^"_$$DATE^BGP5UTL(D)_" "_$P(^ICD0(C,0),U)
 Q ""
SIG(P,EDATE) ;
...
FOB(P,EDATE) ;EP
 ...
 ...Q
 I BGPC]"" Q BGPC
 S E=$O(^ICPT("B",82270,0)) I E S %=$$CPTI^BGPDU(P,BDATE,EDATE,E) I $P(%,U)=1 Q "FOB CPT 82270"_"^"_$$DATE^BGP5UTL($P(%,U,2))
 S E=$O(^ICPT("B",82274,0)) I E S %=$$CPTI^BGPDU(P,BDATE,EDATE,E) I $P(%,U)=1 Q "FOB CPT 82274"_"^"_$$DATE^BGP5UTL($P(%,U,2))
 S E=$O(^ICPT("B",89205,0)) I E S %=$$CPTI^BGPDU(P,BDATE,EDATE,E) I $P(%,U)=1 Q "FOB CPT 89205"_"^"_$$DATE^BGP5UTL($P(%,U,2))
 S E=$O(^ICPT("B","G0107",0)) I E S %=$$CPTI^BGPDU(P,BDATE,EDATE,E) I $P(%,U)=1 Q "FOB CPT G0107"_"^"_$$DATE^BGP5UTL($P(%,U,2))
 Q ""
BE(P,EDATE) ;EP
 S BDATE=$$FMADD^XLFDT(EDATE,5*(-365))
...
REF(P,BDATE,EDATE) ;EP
 ...
 I $P(G,U)=1 Q 1_U_$P(G,U,2)_U_"REF RECT"
