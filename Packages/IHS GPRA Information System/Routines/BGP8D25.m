BGP8D25 ;IHS/CMI/LAB - MEASURE;
 ;;18.0;IHS CLINICAL REPORTING;**1**;NOV 21, 2017;Build 62
 ;
IA ;EP
 S (BGPN1,BGPN2,BGPN3,BGPN4,BGPN5,BGPN6,BGPN7,BGPN8,BGPN9,BGPN10,BGPN11,BGPD1,BGPD2,BGPD3,BGPD4,BGPD5,BGPD6,BGPD7,BGPD8,BGPD9,BGPD10,BGPD11)=0
 ;I BGPACTCL,BGPAGEB>7,BGPAGEB<18 S BGPD1=1  ;8-17
 I BGPACTCL,BGPAGEB>17 S BGPD2=1  ;AC 18+ A.B
 I BGPACTCL,BGPAGEB>64 S BGPD3=1  ;AC 65 AND OLDER
 I BGPACTUP,BGPAGEB>11,BGPAGEB<18 S BGPD4=1
 I BGPACTUP,BGPAGEB>17 S BGPD5=1  ;>17 UP
 I BGPACTUP,BGPAGEB>64 S BGPD6=1  ;65 UP
 I BGPACTCL,BGPAGEB>11,BGPAGEB<18 S BGPD9=1  ;A.L.1
 I BGPDMD2 S BGPD7=1
 I $$CHD^BGP8D729(DFN,BGPBDATE,BGPEDATE),BGPACTCL S BGPIHD=1,BGPD8=1
 ;I BGPACTCB,BGPAGEB>17 S BGPD10=1  ;>17
 ;I BGPACTCB,BGPAGEB>11,BGPAGEB<18 S BGPD11=1  ;19 TO 18 V17.0 A.L
 ;I BGPRTYPE=4,BGPAGEB<18,'BGPIHD,'BGPDMD2 S BGPSTOP=1 Q  ;IF THEY ARE UNDER 18 AND NOT IHD AND NOT DM Q
 I '(BGPD2+BGPD3+BGPD4+BGPD5+BGPD6+BGPD7+BGPD8+BGPD9) S BGPSTOP=1 Q
DEPEP ;EP - called from elder
 ...
 S BGPN11=0 S BGPSBHC=$$DEPSCRBH^BGP8D27(DFN,BGPBDATE,BGPEDATE) I $P(BGPSBHC,U)=1 S BGPN11=1
 I BGPN2 S BGPN1=1
 I BGPN3 S BGPN1=1
 S BGPREF=""
 ...
 I (BGPD1+BGPD2+BGPD3+BGPD9) S BGPVALUE=BGPVALUE_$S(BGPVALUE]"":",",1:"")_"AC"
 ...
 I BGPSBHC]"" S BGPVALUE=BGPVALUE_$S($P(BGPVALUE,"|||",2)]"":";BH Clinic: ",1:"BH Clinic: ") S BGPVALUE=BGPVALUE_$P(BGPSBHC,U,3)_" "_$P(BGPSBHC,U,2)
...
DEP(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(2)) S BGPDEP((9999999-$P(BGPG(1),U)))="",BGPDEP((9999999-$P(BGPG(2),U)))="" Q 1_U_$$DATE^BGP8UTL($P(BGPG(2),U))_" POV "_$P(BGPG(2),U,2)_" + "_$$DATE^BGP8UTL($P(BGPG(1),U))_" POV "_$P(BGPG(1),U,2)_U_U_$P(BGPG(1),U,1)
...
DEPSUIC(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(1)) Q 1_U_"POV "_$P(BGPG(1),U,2)_U_$$DATE^BGP8UTL($P(BGPG(1),U))
 ;
 S BGPC=""
 ...
 ..Q:'BGPP
 ..S BGPP=$P($G(^AMHPROB(BGPP,0)),U)
 ..I BGPP=39 S BGPC=1_U_"BH POV 39"_U_$$DATE^BGP8UTL((9999999-$P(D,".")))
 ..Q
 Q BGPC
DEPSCR(P,BDATE,EDATE) ;EP
 ...
 I $D(BGPG(1)) S BGPDEPS=1_"^DEP SCRN^"_$$DATE^BGP8UTL($P(BGPG(1),U))_U_$P(BGPG(1),U)_U_"Ex 36"
 K BGPG
 S Y="BGPG("
 S X=P_"^LAST DX [BGP DEPRESSION SCRN DXS;DURING "_$$FMTE^XLFDT(BDATE)_"-"_$$FMTE^XLFDT(EDATE) S E=$$START1^APCLDF(X,Y)
 I $D(BGPG(1)),$P(BGPDEPS,U,4)<$P(BGPG(1),U) S BGPDEPS=1_U_"POV "_$P(BGPG(1),U,2)_" DEP"_U_$$DATE^BGP8UTL($P(BGPG(1),U))_U_$P(BGPG(1),U)_U_"POV "_$P(BGPG(1),U,2)
 ;CPT CODE ADDED IN 11.1
 S Y=$$CPT^BGP8DU(DFN,BDATE,EDATE,$O(^ATXAX("B","BGP DEPRESSION SCREEN CPTS",0)),5)
 I Y,$P(BGPDEPS,U,4)<$P(Y,U,1) S BGPDEPS=1_U_"CPT "_$P(Y,U,2)_U_$$DATE^BGP8UTL($P(Y,U,1))_U_$P(Y,U,1)_U_"CPT "_$P(Y,U,2)
 ;now add in v measurements
 S BGPC=$$LASTITEM^BGP8DU(P,BDATE,EDATE,"MEASUREMENT","PHQ2")
 I $P(BGPDEPS,U,4)<$P(BGPC,U,2) S BGPDEPS=1_U_"Meas "_$P(BGPC,U,3)_U_$$DATE^BGP8UTL($P(BGPC,U,2))_U_$P(BGPC,U,2)_U_"Meas "_$P(BGPC,U,3)
...
BHSCR ;
 ...
 .Q:Y<BDATE
 .Q:Y>EDATE
 .S BGPC=1_U_"PRIME MD SCORE HEALTH FACTOR"_U_$$DATE^BGP8UTL(9999999-D)_U_(9999999-D)_U_"PRIME MD SCORE"
 .Q
...
DEPREF(P,BDATE,EDATE) ;EP
 ...
 I $P(G,U)=1 Q 1_"^Refused Ex 36^"_$$DATE^BGP8UTL($P(G,U,2))_U_$P(G,U,2)
 Q ""
DEPEDU(P,BDATE,EDATE) ;EP
 NEW BGPG,Y,X,E,D,T,BGPDEPE,V,BGPC,G,I,Z,S,SN
 S SN=$O(^BGPSNOMR("B","DEPRESSION SCREEN PATIENT ED",0))
 K BGPG
 S Y="BGPG(",BGPDEPE=""
 ...
 .I $P(T,"-",1)="DEP"!($P(T,"-",1)="BH")!($P(T,"-",1)="SB")!($P(T,"-",1)="PDEP"),$P(BGPDEPE,U,4)<$P(BGPG(X),U,1) S BGPDEPE=1_U_""_T_U_$$DATE^BGP8UTL($P(BGPG(X),U))_U_$P(BGPG(X),U)
 .S S=$P(T,"-",1)
 .S S=$$ICDDX^BGP8UTL2(S)
 .I $P(S,U,1)'="-1",$$ICD^BGP8UTL2($P(S,U,1),$O(^ATXAX("B","BGP DEP SCREEN EDUC DXS",0)),9),$P(BGPDEPE,U,4)<$P(BGPG(X),U,1) S BGPDEPE=1_U_""_T_U_$$DATE^BGP8UTL($P(BGPG(X),U))_U_$P(BGPG(X),U)
 .I $P(T,"-",1)]"",$D(^BGPSNOMR(SN,11,"B",$P(T,"-",1))),$P(BGPDEPE,U,4)<$P(BGPG(X),U,1) S BGPDEPE=1_U_""_T_U_$$DATE^BGP8UTL($P(BGPG(X),U))_U_$P(BGPG(X),U)
DEPMH ;
 ...
 ..Q:'$D(^AUTTEDT(T,0))
 ..S T=$P(^AUTTEDT(T,0),U,2)
 ..I $P(T,"-",1)="DEP"!($P(T,"-",1)="BH")!($P(T,"-",1)="SB")!($P(T,"-",1)="PDEP") S BGPC=1_U_""_T_U_$$DATE^BGP8UTL((9999999-D))_U_(9999999-D)
 ..S S=$P(T,"-",1)
 ..S S=$$ICDDX^BGP8UTL2(S)
 ..I $P(S,U,1)'="-1",$$ICD^BGP8UTL2($P(S,U,1),$O(^ATXAX("B","BGP DEP SCREEN EDUC DXS",0)),9) D
 ...S BGPC=1_U_T_U_$$DATE^BGP8UTL((9999999-D))_U_(9999999-D)
 ..I $P(T,"-")]"",$D(^BGPSNOMR(SN,11,"B",$P(T,"-"))) S BGPC=1_U_T_U_$$DATE^BGP8UTL((9999999-D))_U_(9999999-D)
