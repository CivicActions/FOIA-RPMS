BGP5DPH ; IHS/CMI/LAB - AREA REPORT HEADER ; 20 Jan 2005  7:56 PM
...
HEADER1 ;
 ...
 I BGPRTYPE=1,'$G(BGP5GPU) W $$CTR("*** IHS 2005 National GPRA Clinical Performance Indicator Report ***",80),!
 I BGPRTYPE=1,$G(BGP5GPU) W $$CTR("*** IHS GPRA Performance Report ***",80),!
 W:BGPRTYPE=3 $$CTR("*** IHS 2005 HEDIS Clinical Performance ***",80),!
