BGP8DAP ;IHS/CMI/LAB - GPRA AREA DRIVER;
 ...
 ;
 W:$D(IOF) @IOF
 W !!,$$CTR("IHS 2018 Clinical Performance Measure Report (Selected Measures)",80)
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BGP8DL",ZTDTH="",ZTDESC="GPRA 16 REPORT" D ^%ZTLOAD D XIT Q
 Q
 ;
NODEV ;
