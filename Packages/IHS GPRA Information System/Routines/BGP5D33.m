BGP5D33 ; IHS/CMI/LAB - indicator C ; 
...
OPV(P,EDATE) ;EP
 ...
 ...S Y=$P(^AUPNVCPT(X,0),U),Y=$P(^ICPT(Y,0),U) I Y=90712!(Y=90698)!(Y=90711)!(Y=90713)!(Y=90723) S BGPOPV(9999999-ED)="",BGPAPOV(9999999-ED)=""
 ...
 I $D(BGPG(1)) S X=0 F  S X=$O(BGPG(X)) Q:X'=+X  S BGPOPV($P(BGPG(1),U))=""
 ...
 I $$PLTAX^BGPDU(P,"BGP OPV EVID DISEASE") Q 4_U_"evid opv"
 ...
 I $$PLTAX^BGPDU(P,"BGP OPV CONTRAINDICATONS") Q 4_U_"contra opv"
 ;now go to refusals
 ...
 F BGPIMM=2,89,10,110 S R=$$IMMREF^BGP5D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q 3_U_"ref OPV"
 Q ""
MMR(P,EDATE) ;EP
 K BGPC,BGPG,BGPX
...
REF ;
 ...
 ;now check refusals in imm pkg
 S R="" F BGPIMM=3,94 S R=$$IMMREF^BGP5D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE)+R
 I R Q 3_U_"ref mmr"
MMRC K BGPG S %=P_"^LAST DX [BGP MMR CONTRAINDICATIONS;DURING "_$$DOB^AUPNPAT(P)_"-"_EDATE,E=$$START1^APCLDF(%,"BGPG(")
 ...
 I $$PLTAX^BGPDU(P,"BGP MMR CONTRAINDICATIONS") Q 4_U_"contra MMR"
REFMR ;
 I BGPMR=0 D
 ...
 ;now check refusals in imm pkg
 F BGPIMM=4 I $$IMMREF^BGP5D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE) S BGPMR=3
REFRM I BGPRM=0 D
...
MEX ;
 ...
 I $$PLTAX^BGPDU(P,"BGP MEASLES EVIDENCE") S BGPME=1
 I BGPME=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=5 D
 .S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
...
MUX ;
 ...
 I $$PLTAX^BGPDU(P,"BGP MUMPS EVIDENCE") S BGPMU=1
 I BGPMU=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=7 D
 .S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
...
RUBX ;
 ...
 I $$PLTAX^BGPDU(P,"BGP RUBELLA EVIDENCE") S BGPRUB=1
 I BGPRUB=0 D
 .S B=$$DOB^AUPNPAT(P),E=EDATE
 .F BGPIMM=6 D
 .S I=$O(^AUTTIMM("C",BGPIMM,0)) Q:'I
 ...
 F BGPIMM=6 I $$IMMREF^BGP5D32(P,BGPIMM,$$DOB^AUPNPAT(P),EDATE) S BGPMU=3
