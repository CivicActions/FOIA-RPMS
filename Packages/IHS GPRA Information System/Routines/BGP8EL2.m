BGP8EL2 ; IHS/CMI/LAB - measure 1,2,3,4 17 Jan 2010 6:49 AM 13 Jun 2016 3:54 PM ; 25 Jan 2018  3:19 PM
...
I1 ;EP - measure 1 general processing
 ...
 S BGPVALUE="UP|||"_$$DATE^BGP8UTL($P(BGPG(1),U))_" "_$P(BGPG(1),U,2)
 Q
 ;
I2 ;EP
...
STAT ;EP
 ...
 NEW BGPCVDL
 S BGPCVDL=""
 F X=1:1:6 S Y="BGPD"_X S @Y=""  ;7 denominators
 S BGPN1=""  ;1 numerators
 ;now exclude people
 S (BGPEXL1,BGPEXL2,BGPEXL3,BGPEXL4,BGPEXL5,BGPEXL6,BGPEXL7)=""
 S BGPEXL1=$$STATALG^BGP8D213(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE,BGPBDATE,BGPEDATE) I BGPEXL1 S BGPSTOP=1 Q  ;excl 1
 ;ALCOHOL HEP
 S BGPEXL1=$$ALCHEP^BGP8D212(DFN,BGPBDATE,BGPEDATE) I BGPEXL1 S BGPSTOP=1 Q
 ;NMI
 S BGPEXL1=$$STATNMI^BGP8D212(DFN,BGPBDATE,BGPEDATE) I BGPEXL1 S BGPSTOP=1 Q
 ;PREGNANCY
 S BGPEXL2=$$PREG^BGP8D715(DFN,BGPBDATE,BGPEDATE,1,1,,BGPBDATE,BGPEDATE,1) I BGPEXL2 S BGPSTOP=1 Q  ;V17.1 CMI/LAB ADDED DATES FOR CURRENTLY PREGNANT
 ;BREASTFEEDING
 S BGPEXL2=$$BF^BGP8D21(DFN,BGPBDATE,BGPEDATE) I BGPEXL2 S BGPSTOP=1 Q
 ;cirrhosis of liver
 S BGPEXL6=$$CLIVER^BGP8D213(DFN,BGPPBD,BGPEDATE) I BGPEXL6 S BGPSTOP=1 Q
 ;PALLIATIVE
 S BGPEXL3=$$LASTDX^BGP8UTL1(DFN,"BGP PALLIATIVE CARE DXS",BGPBDATE,BGPEDATE) I BGPEXL3 S BGPSTOP=1 Q
 ;ESRD
 S BGPEXL4=$$ESRD^BGP8D211(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) I BGPEXL4 S BGPSTOP=1 Q  ;excl 4 ESRD
 ;excl new 18 patch 1
 S BGPEXL7=$$HEPA^BGP8D21A(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) I BGPEXL7 S BGPSTOP=1 Q
 S BGPEXL7=$$HEPB^BGP8D21A(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) I BGPEXL7 S BGPSTOP=1 Q
 ;EXCL 5
 NEW BGPSTAT
 S BGPSTAT=$$STATIN^BGP8D214(DFN,BGPBDATE,BGPEDATE,0)
 S BGPEXL5=$$LASTLDLV^BGP8D212(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE) I BGPEXL5,'$P(BGPCVDL,U,3),'BGPSTAT S BGPSTOP=1 Q   ;excl 5
 I BGPAGEB>75 S BGPCVDL=$$CHDLDL^BGP8D212(DFN,$$DOB^AUPNPAT(DFN),BGPEDATE)  ;CHD OR LDL^CHD^LDL
 I BGPAGEB>54,BGPAGEB<76 S BGPD1=1  ;AD 55-75
 I BGPAGEB>75,BGPCVDL S BGPD2=1  ;AD 76+ W/CVD OR LDL
 I BGPAGEB>54,BGPAGEB<65 S BGPD3=1  ;AD 55-64
 I BGPAGEB>64,BGPAGEB<76 S BGPD4=1  ;AD 65-75
 I BGPAGEB>75,BGPAGEB<85,BGPCVDL S BGPD5=1  ;ad 76-84 with CVD or LDL
 I BGPAGEB>84,BGPCVDL S BGPD6=1  ;AD >84 WITH CVD
 ;
 ;numerator
 S BGPN1=BGPSTAT
SETL ;
 S BGPVALUE="AD"_$S($P(BGPCVDL,U,2):" (CHD)",$P(BGPCVDL,U,3):" (LDL)",$P(BGPCVDL,U,4):" (HYPER CHOL)",1:"")_"|||"
...
I7 ;EP
 ...
 I BGPAGEB>74,BGPAGEB<85 S BGPD4=1
 I BGPAGEB>84 S BGPD5=1
 S BGPVALUE=$$DENTSRV^BGP8D21(DFN,BGPBDATE,BGPEDATE)
 S BGPN1=0 I $P(BGPVALUE,U)=1 S BGPN1=1
 S BGPN2=0 I $P(BGPVALUE,U)=2 S BGPN2=1
 S BGPVALUE="AD|||"_$$DATE^BGP8UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 K ^TMP($J,"A")
 K BGPUP,BGPGFR,BGPX,BGPY,BGPC,BGPG
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F
 Q
I8 ;EP
 ...
 S BGPN1=0 I $P(BGPVALUE,U)=1 S BGPN1=1
 S BGPN2=0 I $P(BGPVALUE,U)=2 S BGPN2=1
 S BGPVALUE="UP|||"_$$DATE^BGP8UTL($P(BGPVALUE,U,2))_" "_$P(BGPVALUE,U,3)
 K ^TMP($J,"A")
 K BGPUP,BGPGFR,BGPX,BGPY,BGPC,BGPG
 K X,Y,Z,%,A,B,C,D,E,H,BDATE,EDATE,P,V,S,F
 Q
...
LIPID(P,BDATE,EDATE) ;EP
 K BGPC
 S BGPC=0
 S %="",E=+$$CODEN^ICPTCOD(80061),%=$$CPTI^BGP8DU(P,BDATE,EDATE,E)
 I %]"" Q 1_U_$P(%,U,2)_U_"80061"
 S %="",E=+$$CODEN^ICPTCOD(80061),%=$$TRANI^BGP8DU(P,BDATE,EDATE,E)
...
TRIG(P,BDATE,EDATE) ;EP
 K BGPC
 S BGPC=0
 S %="",E=+$$CODEN^ICPTCOD(84478),%=$$CPTI^BGP8DU(P,BDATE,EDATE,E)
 I %]"" Q 1_U_$P(%,U,2)
 S %="",E=+$$CODEN^ICPTCOD(84478),%=$$TRANI^BGP8DU(P,BDATE,EDATE,E)
 I %]"" Q 1_U_$P(%,U,2)
 ;now get all loinc/taxonomy tests
...
HDL(P,BDATE,EDATE) ;EP
 K BGPC
 S BGPC=0
 S %="",E=+$$CODEN^ICPTCOD(83718),%=$$CPTI^BGP8DU(P,BDATE,EDATE,E)
 I %]"" Q 1_U_$P(%,U,2)
 S %="",E=+$$CODEN^ICPTCOD(83718),%=$$TRANI^BGP8DU(P,BDATE,EDATE,E)
 I %]"" Q 1_U_$P(%,U,2)
 ;now get all loinc/taxonomy tests
...
LDL(P,BDATE,EDATE) ;EP
 K BGPG,BGPT,BGPC
 S BGPC=0
 S %="",E=+$$CODEN^ICPTCOD(83721),%=$$CPTI^BGP8DU(P,BDATE,EDATE,E)
 I %]"" S BGPC=BGPC+1,BGPT(9999999-$P(%,U,2),BGPC)=""
 S %="",E=+$$CODEN^ICPTCOD(83721),%=$$TRANI^BGP8DU(P,BDATE,EDATE,E)
 I %]"" S BGPC=BGPC+1,BGPT(9999999-$P(%,U,2),BGPC)=""
 ;now get all loinc/taxonomy tests
