...
H1 ;
 ...
 I $G(BGPAREAA) S X="",$P(X,U,2)=" Area",$P(X,U,3)=" Area",$P(X,U,4)=" Area",$P(X,U,5)="National",$P(X,U,6)="2010" D S(X,1,1)
 I '$G(BGPAREAA) S X="",$P(X,U,2)=" Site",$P(X,U,3)=" Site",$P(X,U,4)=" Site",$P(X,U,5)="National",$P(X,U,6)="2010" D S(X,1,1)
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="2004",$P(X,U,6)="Goal" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
H2 ;
 ...
 S X="",$P(X,U,2)="Current",$P(X,U,3)="Previous",$P(X,U,4)="Baseline",$P(X,U,5)="Current",$P(X,U,6)="2004",$P(X,U,7)="Goal" D S(X,1,1)
 S X=$TR($J("",80)," ","-") D S(X,1,1)
 Q
SDP ;
 I BGPRTYPE'=1 Q  ;national gpra only
 ...
 ..S X=" " D S(X,1,1)
 ..S XX=$P(^BGPINDVC(BGPPC,14),U,4),$P(XX,U,6)=$P(^BGPINDVC(BGPPC,14),U,2),$P(XX,U,7)=$P(^BGPINDVC(BGPPC,14),U,3) ;D S(X,1,1)
 ...
 ....S $P(XX,U,5)=$P(^TMP($J,"SUMMARYDEL DETAIL PAGE",BGPC,BGPO,BGPPC,BGPSN),U,4)
 ....;S $P(X,U,5)=$P(^BGPINDVC(BGPPC,14),U,2),$P(X,U,6)=$P(^BGPINDVC(BGPPC,14),U,3)
 ...E  D
 ...
 ....S $P(XX,U,5)=$P(^TMP($J,"SUMMARYDEL DETAIL PAGE",BGPC,BGPO,BGPPC,BGPSN),U,4)_"%"
 ....;S $P(X,U,5)=$P(^BGPINDVC(BGPPC,14),U,2),$P(X,U,6)=$P(^BGPINDVC(BGPPC,14),U,3)
 ...I BGPCNT=1 D S(XX,1,1)
 ...D S(X,1,1)
 S X=" " D S(X,1,1)
 S X="(* = Not GPRA indicator for FY 2005)" D S(X,1,1)
 Q
