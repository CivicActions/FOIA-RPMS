...
I36 ;EP
 D H1 S BGPNODEN=1
 F BGPPC1="36.1" D PI^BGP5DP1 Q:BGPQUIT
 Q:BGPQUIT
 F BGPPC1="36.2.1","36.2.2","36.2.3","36.2.4","36.2.5" Q:BGPQUIT  D PI
 Q:BGPQUIT
 W ! F BGPPC1="36.3.1","36.3.2","36.3.3","36.3.4","36.3.5" Q:BGPQUIT  D PI
 Q
PI ;EP
 ...
 .I $Y>(IOSL-6) D HEADER^BGP5DPH Q:BGPQUIT  W !!,^BGPINDV(BGPIC,53,1,0) D H1
 ...
 .I BGPRTYPE=4,$P(^BGPINDVC(BGPPC,0),U,19)]"" W !?1,$P(^BGPINDVC(BGPPC,0),U,19)
