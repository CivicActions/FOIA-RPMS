...
I0302 ;EP
 ...
 I BGPACTCL,$$CHD^BGPLD729(DFN,BGP365,BGPEDATE) S BGPIHD=1,BGPD3=1
...
BPCV ;EP - called from elder care routine
 ...
 I BGPVALUE["unknown" S BGPVALUE=$$BPCPT^BGPLD22(DFN,BGPBDATE,BGPEDATE) I BGPVALUE]"" S BGPN1=1,BGPVALUE=$P(BGPVALUE,U,2) G V  ;CPTS COUNT IN NUMERATOR 1 ONLY
...
DEP(P,BDATE,EDATE) ;EP
 S X=$$DEP^BGPLD25(P,BDATE,EDATE) I $P(X,U) Q X
 S X=$$DEPSCR^BGPLD25(P,BDATE,EDATE) I $P(X,U) Q X
 Q ""
DEPCHD(P,BDATE,EDATE) ;EP
 S X=$$DEP^BGPLD25(P,BDATE,EDATE) I $P(X,U) Q X
 S X=$$DEPSCR^BGPLD25(P,BDATE,EDATE) I $P(X,U) Q X
 S X=$$DEPSUIC^BGPLD25(P,BDATE,EDATE) I $P(X,U) Q X
 Q ""
LIFE(P,BDATE,EDATE) ;EP
 S X=$$MEDNUTR^BGPLD711(P,BDATE,EDATE) I X]"" Q 1_U_X
 S X=$$SPECNUTR^BGPLD711(P,BDATE,EDATE) I X]"" Q 1_U_X
 S X=$$SPECEX^BGPLD711(P,BDATE,EDATE) I X]"" Q 1_U_X
 S X=$$OTHREL^BGPLD711(P,BDATE,EDATE) I X]"" Q 1_U_X
 Q ""
...
TOBDX(P,BDATE,EDATE) ;EP
 ...
 .I $E($P($$ICDDX^BGPLUTL2(Y),U,2),1,5)'="305.1",$P($$ICDDX^BGPLUTL2(Y),U,2)'="V15.82" Q
 .S G=$P($$ICDDX^BGPLUTL2(Y),U,2)_" PL"
 .Q
 Q G
