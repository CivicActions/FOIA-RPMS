...
IRAA ;EP
 ...
 S BGPCREAT=$$CREAT^BGP8D22(DFN,BGPBDATE,BGPEDATE)
 S BGPN1=0
...
OSTEOAR(P,BDATE,EDATE) ;EP
 ...
 S H="" I $D(BGPG(1)) S H=$$DATE^BGP8UTL($P(BGPG(1),U))_" "_$P(BGPG(1),U,2)
 I H]"" G RPDXS
...
RPDXS ;check for 2 dxs in time period
 ...
 I $D(BGPG(2)) S C="2 dxs: "_$$DATE^BGP8UTL($P(BGPG(2),U))_" "_$$DATE^BGP8UTL($P(BGPG(1),U))
 I H=""!(C="") Q ""
