...
PID3 ;-- this will generate the IHS PID-3 field
 ...
 S INA("PID3",1)=BHLASU_BHLRN  ;_CS_CS_CS_CS_BHLLOC_".IHS.GOV"_CS_"DNS" 
...
PID4 ;-- this will generate the IHS PID-4 field
 ...
 . S BHLCNT=BHLCNT+1
 . S $P(INA("PID4",1),RS,BHLCNT)=BHLASU_BHLRN  ;_CS_CS_CS_CS_BHLLOC_".IHS.GOV"_CS_"DNS"  ;left in for backward compatability version 2.3.1 or earlier
