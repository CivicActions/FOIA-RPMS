BLRSLTL1 ; IHS/DIR/MJL - SET IHS LAB TRANSACTION LOG ; 18-Apr-2022 09:45 ; MKK
 ;;5.2;LR;**1001,1009,1018,1051**;NOV 01, 1997;Build 19
 ;
 ; MSC/MKK - LR*5.2*1051 - 18-Apr-2022 - Item 75766 - Inpatient/Outpatient Category Field to display correctly
 ;
SET ;
 ...
 S BLRCAT="A" S X=$$GET1^DIQ(2,BLRDFN,.103) I X]"",X'["OBSERVATION" S BLRCAT="I"    ; MSC/MKK - LR*5.2*1051 - Item 75766 - 18-Apr-2022
