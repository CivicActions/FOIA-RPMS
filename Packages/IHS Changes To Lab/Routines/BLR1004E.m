BLR1004E ;IHS/DIR/FJE- LR*5.2*1008 PATCH ENVIRNMENT CHECK ROUTINE [ 06/02/1999  12:45 PM ]
...
KERP W !!,"Checking for Kernel Patch 1005..."
 ...
 .  W ! S XPDQUIT=1
 W !!,"Checking for LA 5.2 Patch 1003..."
 F RN="LASET","LABERR" X "ZL @RN S LN2=$T(+2)" I LN2'["1003" D
 .  W !,$$CJ^XLFSTR(RN_"--Patch 'LA*5.2*1003' has not been installed.",80)
 .  W ! S XPDQUIT=1
