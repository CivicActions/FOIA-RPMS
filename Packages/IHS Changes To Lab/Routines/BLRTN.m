BLRTN ; IHS/HQT/MJL - CREATE/EDIT TRANSACTIONS ; 19-Apr-2022 09:45 ; MKK
 ;;5.2;IHS LABORATORY;**1011,1012,1013,1014,1015,1018,1026,1028,1033,1038,1051**;NOV 01, 1997;Build 19
 ;
 ; MSC/MKK - LR*5.2*1051 - 19-Apr-2022 - Item 76117 - Fix call to COMPDATE subroutine.
 ;
...
LOINC ; EP
 ...
 ;
 S:$G(BLRDTC)="" BLRDTC=$P($G(^LRO(68,BLRAA,1,BLRAD,1,BLRAN,3)),U)  ; IHS/MSC/MKK - BLRDTC should be from the Accession file.
 ;
 ...
 ;
 I $G(BLR("COMPLETE DATE"))="" S BLR("COMPLETE DATE")=$$COMPDATE(BLRLRDFN,BLRSS,9999999-BLRDTC,BLRACCN)  ; IHS/MSC/MKK - LR*5.2*1051
