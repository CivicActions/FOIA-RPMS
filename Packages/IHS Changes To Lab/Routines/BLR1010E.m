BLR1010E ; IHS/HQT/MJL - LR*5.2*1010 PATCH ENVIRONMENT CHECK ROUTINE ;  [ 02/27/2001  11:12 AM ]
...
EN ;Prevents loading of the transport global.
 ...
 W !!,"Checking for LR 5.2 Patch 1009..."
 F RN="LRORD1,LRORDST" X "ZL @RN S LN2=$T(+2)" I LN2'["1009",LN2'["1010" D
 .  W !,$$CJ^XLFSTR(RN_"--Patch 'LR*5.2*1009' has not been installed.",80)
 .  W ! S XPDQUIT=1
