BLRPRE44 ; IHS/MSC/MKK - RPMS COVID-19 LOINC Lab Patch LR*5.2*1044 Pre/Install/Post Routine ; 11-Mar-2020 14:45 ; MKK
...
ENVICHEK ; EP - Environment Checker
 ...
 ;
 D NEEDIT^BLRKIDS2(CP,"LR","5.2",1033,.ERRARRAY),BLANK  ; Lab Pre-Requisite - LR*5.2*1033 - Last LOINC update
 ;
