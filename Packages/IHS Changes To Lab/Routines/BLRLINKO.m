BLRLINKO ; IHS/MSC/MKK - VALIDATION OF VARIOUS V FILE FIELDS ; 03-Jan-2023 @ 1055 ; MKK
 ;;5.2;BLR;**1001,1003,1052**;NOV 01, 1997;Build 17
 ;
 ; IHS/MSC/MKK - LR*5.2*1052 - 03-Jan-2023 - Item 91401 - Dictionaries 3, 6, & 16 - Remove Remaining References
 ;
 ; Original Line 1: IHS/DIR/FJE - VALIDATION OF VARIOUS V FILE FIELDS ; [ 12/14/1998  10:28 AM ]
 ;
 ;ZL BLRLINKO     ZS BLRLINKP   IF STILL ON 1.6 AUPN
...
VPROV ;
 ...
 I '$D(^VA(200,BLRVPRV)) S BLRBUL=2,BLRPCC=BLRPMSG K X     ; IHS/MSC/MKK - LR*5.2*1052
 Q
FLDSCHK ;
