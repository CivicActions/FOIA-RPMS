BLRPRE47 ; IHS/MSC/MKK - RPMS Lab Patch LR*5.2*1047 Pre/Install/Post Routine ; 11-Feb-2020 14:45 ; MKK
 ;;5.2;IHS LABORATORY;**1047**;NOV 01, 1997;Build 21
 ;
ENVICHEK ; EP - Environment Checker
 ...
 D NEEDIT^BLRKIDS2(CP,"AUPN","99",26,.ERRARRAY),BLANK  ;  aupn Pre-Requisite
 D NEEDIT^BLRKIDS2(CP,"AG","7.1",13,.ERRARRAY),BLANK  ; ag Pre-Requisite
 ;
