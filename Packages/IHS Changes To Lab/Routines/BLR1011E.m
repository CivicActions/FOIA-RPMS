BLR1011E ; IHS/HQT/MJL - LR*5.2*1011 PATCH ENVIRONMENT CHECK ROUTINE ;  [ 05/02/2001  2:40 PM ]
 ;;5.2;LR;**1011**;MAR 01, 2001
EN ;Prevents loading of the transport global.
 ...
 W !!,"Checking for LR 5.2 Patch 1010..."
 F RN="LRORD1,LRORDST" X "ZL @RN S LN2=$T(+2)" I LN2'["1010" D
 .  W !,$$CJ^XLFSTR(RN_"--Patch 'LR*5.2*1010' has not been installed.",80)
 .  W ! S XPDQUIT=1
