BLRPRE45 ; IHS/MSC/MKK - RPMS COVID-19 Lab Patch LR*5.2*1045 Pre/Install/Post Routine ; 11-Mar-2020 14:45 ; MKK
 ;;5.2;IHS LABORATORY;**1045**;NOV 01, 1997;Build 21
 ;
ENVICHEK ; EP - Environment Checker
 ...
 ;
 D NEEDIT^BLRKIDS2(CP,"LR","5.2",1044,.ERRARRAY),BLANK  ; Lab Pre-Requisite - LR*5.2*1044 - LOINC COVID-19 update
 D NEEDIT^BLRKIDS2(CP,"ACPT","2.20",1,.ERRARRAY),BLANK  ; Lab Pre-Requisite - APCT*2.20*1 - CPT update
 ;
...
POST ; EP - Post-Install
 ...
 D MAIN^BLRCVDC("ABBOTT")  ;this can be changed based on the lab used and test setup
 ;
 D BLANK
