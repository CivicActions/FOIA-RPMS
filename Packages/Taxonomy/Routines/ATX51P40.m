ATX51P40 ; IHS/CMI/LAB - PCC Suite v5.1 patch 40 environment check ;
 ...
 ;I '$$INSTALLD("AUM*21.0*5") D SORRY(2)
 I '$$INSTALLD("ACPT*2.21*10") D SORRY(2)
 I '$$INSTALLD("XU*8.0*1018") D SORRY(2)
 I '$$INSTALLD("DI*22.0*1018") D SORRY(2)
 I +$$VERSION^XPDUTL("AUM")<22 D MES^XPDUTL($$CJ^XLFSTR("Version 22.0 of AUM is required.  Not installed",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Requires AUM V22.0....Present.",80))
 ;
 Q
 ;
PRE ;
 S DA=$O(^ATXAX("B","BQI PARATHYROID DXS",0))
 I DA S DIE="^ATXAX(",ATXFLG=1,DR=".01///BQI PARATYPHOID DXS" D ^DIE K DIE,DA,ATXFLG
 Q
POST ;
 D ^ATXFS
 D ^ATXFT
