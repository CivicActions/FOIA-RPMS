ATX51P35 ; IHS/CMI/LAB - PCC Suite v5.1 patch 35 environment check ;
 ...
 I '$$INSTALLD("ATX*5.1*34") D SORRY(2)
 I '$$INSTALLD("AUM*20.0*2") D SORRY(2)
 I '$$INSTALLD("XU*8.0*1018") D SORRY(2)
 I '$$INSTALLD("DI*22.0*1018") D SORRY(2)
 I +$$VERSION^XPDUTL("AUM")<20 D MES^XPDUTL($$CJ^XLFSTR("Version 20.0 of AUM is required.  Not installed",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Requires AUM V20.0....Present.",80))
 ;
 Q
 ;
PRE ;
 NEW DIE,DA,DR,ATXFLG
 S ATXFLG=1
 S DA=$O(^ATXAX("B","BGP ECQM CT COLONOGRAPHY LOINC",0))
 I DA S DIE="^ATXAX(",DR=".01///BGP ECQM COLONOGRAPHY LOINC" D ^DIE K DIE,DA
 Q
POST ;
 D ^ATXFN
 D BUILDAC
