ATX51P51 ; IHS/CMI/LAB - PCC Suite v5.1 patch 51 environment check ;
 ;;5.1;TAXONOMY;**51**;FEB 04, 1997;Build 114
 ;
 ;
 ...
 I '$$INSTALLD("ATX*5.1*50") D SORRY(2)
 ...
 ;
PRE ;
 S ATXX=0 F  S ATXX=$O(^ATXRXCUI(ATXX)) Q:ATXX'=+ATXX  S DA=ATXX,DIK="^ATXRXCUI(" D ^DIK
 Q
POST ;
 Q
 ;
