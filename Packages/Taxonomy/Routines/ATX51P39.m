ATX51P39 ; IHS/CMI/LAB - PCC Suite v5.1 patch 39 environment check ;
 ...
 I '$$INSTALLD("ATX*5.1*38") D SORRY(2)
 I '$$INSTALLD("AUM*21.0*4") D SORRY(2)
 I '$$INSTALLD("XU*8.0*1018") D SORRY(2)
 I '$$INSTALLD("DI*22.0*1018") D SORRY(2)
 ;I +$$VERSION^XPDUTL("AUM")<21 D MES^XPDUTL($$CJ^XLFSTR("Version 21.0 of AUM is required.  Not installed",80)) D SORRY(2) I 1
 ;E  D MES^XPDUTL($$CJ^XLFSTR("Requires AUM V21.0....Present.",80))
 ;
 Q
 ;
PRE ;
...
RXNORM ;
 ...
 S ATXFLG=1
 S BGPX="ATX IMMUNOSUPPRESS DRUGS",BGPRXN="ATX IMMUNOSUPPRESS RXNORM" D RXNORM1
 Q
RXNORM1 ;
 W !,BGPRXN
