ATXBULL ; IHS/OHPRD/TMJ - THE ROUTINE TO TRIGGER PT TAXONOMY BULLETIN ; 13 Oct 2016  3:44 PM
 ;;5.1;TAXONOMY;**25,42**;FEB 04, 1997;Build 93
 ;
 ;IHS/CMI/LAB - PATCH 42, REMOVED THE SETTING OF SSN
 ;
EN ; ENTRY POINT
...
DIQ1 ;
 ...
 ;S X=$P($G(^DPT(ATXPDFN,0)),U,9) S XMB(23)=$S(X:"XXX-XX-"_$E(X,6,9),1:"Not on file")   ;IHS/CMI/GRL **4** SSN  ;IHS/CMI/LAB - P42 COMMENTED OUT
 ;
