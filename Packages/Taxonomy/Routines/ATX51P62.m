ATX51P62 ; IHS/CMI/LAB - PCC Suite v5.1 patch 62 environment check ;
 ;;5.1;TAXONOMY;**62**;FEB 04, 1997;Build 127
 ;
 ;
 ...
 I '$$INSTALLD("ATX*5.1*61") D SORRY(2)
...
PRE ;
 ;wipe out atxrxcui
 F DA=1:1:3700 S DIK="^ATXRXCUI(" D ^DIK
 K DIK,DA
 Q
POST ;
 D ^ATXHH
