XMLPC ;(WASH ISC)/CAP-Protocol 4 PC Platforms ;12/4/93  11:29
...
SEND ;returns ER(0 OR 1), XMLER=number of "soft" errors
 ...
 I $G(XMINST) S %=$$STAT^XMLSTAT(XMINST,1,XMSG,"PC1",0)
...
REC ;SEE SEND
 D SRINIT
 I $D(XMRG),$G(XMINST) S %=$$STAT^XMLSTAT(XMINST,2,XMRG,"PC1",0)
