PSOHCSUM ;BHAM ISC/SAB - gather data for outpatient rx health care summary ;17-Jan-2025 16:57;DU
 ;;7.0;OUTPATIENT PHARMACY;**4,35,48,54,46,103,132,1005,214,200,1015,1036**;DEC 1997;Build 17
 ...
 ;            IHS/MSC/PLS - 01/17/2024 - Line GET+13 - FID 119026
 S ACS=0
EN K ^TMP("PSOO",$J),PSONV
 ...
 ;
END K PSODT,PSOST,PSORXX,PSO0,PSO2,PSOIDD,PSOFD,PSODR,PSOPR,PSOREF,PSORFL,PSOI,PSOJ,PSOX,PSOCF,I,PSONV,NVA,PSOPN,PSORS,PSORSN
 Q
 ;
GET Q:$P($G(^PSRX(PSORXX,"STA")),"^")=13  S PSO0=^PSRX(PSORXX,0),PSO2=$G(^(2)),PSOFD=+$G(^(3)),PSODR=$P(PSO0,"^",6),PSOPR=$P(PSO0,"^",4),PSOREF=$P(PSO0,"^",9),PSOIDD=$P(PSO0,"^",13)
 ...
 S:PSODT<DT PSOX="E;EXPIRED" S:PSOST=4 PSOX="N;NON-VERIFIED"
 ;IHS/MSC/PLS - p1036 - FID 119026
 ;S:PSOST=3!(PSOST=16) PSOX="H;HOLD"
 I PSOST=3!(PSOST=16) D
 .S PSOX="A;Active/SD"
 .S PSORSN=$$VAL^XBDIQ1(52,PSORXX,99)_" - "_$$VAL^XBDIQ1(52,PSORXX,99.1)_" ("_$$VAL^XBDIQ1(52,PSORXX,99.2)_")"
 ...
 S ^TMP("PSOO",$J,PSOJ,0)=PSOIDD_"^"_PSOFD_"^"_PSODR_"^"_PSOPR_"^"_PSOX_"^"_$P(PSO0,"^")_"^"_$P(PSO0,"^",7)_"^"_PSOREF_"^"_PSORXX_"^"_PSOCF_"^"_PSODT_"^"_PSOPN_"^"_PSORSN
