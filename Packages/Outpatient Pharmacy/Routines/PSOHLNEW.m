PSOHLNEW ;BIR/RTR - CPRS orders ;28-Nov-2017 12:30;DU
 ;;7.0;OUTPATIENT PHARMACY;**1,7,15,46,71,98,111,124,117,131,146,132,1006,1009,143,223,235,148,239,249,225,1015,1023**;DEC 1997;Build 121
 ...
 ; Modified - IHS/MSC/PLS - 05/16/17 - NFILE+4,NFILE+19,NFILE+55 Changes for EPCS
EN(MSG) ;
...
NFILE ;
 ...
 S DIC("DR")=DIC("DR")_";22////"_$G(PSORSO)_";22.1////"_$G(PREV)_";19////"_$G(ROUTING)_";17////"_$$UNESC^ORHLESC($G(SERV))_";7////"_$G(NATURE)_";13////"_$G(PSOREFIL)_";1.1////"_$G(LOCATION)
 S DIC("DR")=DIC("DR")_";117////"_$G(DSIG)_$S($G(DSIG):";118////"_$G(DDR),1:"")
 ...
 ;IHS/MSC/MGH - changes added for EPCS
 I $G(DSIG) D
 ...
 D CSET^PSODIAG
 I +DSIG D EN1^BEHOEPS(PENDING)  ;IHS/MSC/PLS - EPCS Hash
 Q
