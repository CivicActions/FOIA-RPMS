PSORDAY2 ;IHS/ASDS/ENM/POC - PROGRAM TO CALCULATE DEFAULT DAYS SUP [ 02/20/2001  3:45 PM ]
 ;;6.0;OUTPATIENT PHARMACY;**3**;01/02/01
 ;THIS IS REALLY PSORDAY
 ;W !,"ENTER THE STRING  "
 ;R X:30
 ;I (X="")!(X["^") QUIT
...
CHANGEH ;CHANGE TIME TO NUMBERS 
 ...
 S (FIRST,SECOND,FIND)=0,PSOSIGS=PSOEXSIG
 ...
 I $L(PSOEXSIG,"UNIT")>1 S DELIMIT="UNIT",MANY=$L(PSOEXSIG,"UNIT"),MULT=.01 F LOOP=1:1:MANY D A Q:$G(QUT)
 D KILLH
 Q
 ;
A S (PIECE(1),PIECE(2))=""
