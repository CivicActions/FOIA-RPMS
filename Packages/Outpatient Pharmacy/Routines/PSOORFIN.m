PSOORFIN ;BIR/SAB-finish cprs orders ;12-Mar-2019 14:20;DU
 ;;7.0;OUTPATIENT PHARMACY;**7,15,27,32,44,46,84,106,111,117,131,146,139,1004,1012,1013,195,225,315,266,1015,1023**;DEC 1997;Build 121
 ...
 ;            IHS/MSC/MGH - 12/14/17 - +6,ORD+9,ORD+14 changed for EPCS
 ...
 S DIR(0)="SMB^PA:PATIENT;RT:ROUTE;PR:PRIORITY;CL:CLINIC;FL:FLAGGED;DS:DIGITALLY SIGNED CS;E:EXIT"
 D ^DIR I $D(DIRUT)!(Y="E") G EX
 ;G:Y="PA" PAT G:Y="PR" PRI^PSOORFI5 G:Y="CL" ^PSOORFI3 G:Y="FL" FLG^PSOORFI5
 G:Y="PA" PAT G:Y="PR" PRI^PSOORFI5 G:Y="CL" ^PSOORFI3 G:Y="FL" FLG^PSOORFI5 G:Y="DS" CS^PSOORFI5
...
ORD I $G(PSOBCK) N LST,ORN
 ...
 K DRET,SIG,PSOPRC,PHI,PRC,PSOSIGFL,OBX,PSOMSG,DEA,PORD
 S PSOFDR=1,OR0=^PS(52.41,ORD,0),OI=$P(OR0,"^",8),PSORX("SC")=$P(OR0,"^",16)
 ;IHS/MSC/MGH EPCS and check for missing drug
 S PORD=$P(OR0,"^",9)
 I +PORD S DEA=+$P($G(^PSDRUG(PORD,0)),"^",3)   ;MGH EPCS
 E  D DEAOICLS^APSPFNC6(.DEA,OI,"2345")
 ...
 I ($P(OR0,"^",24)="")&($P(OR0,"^",17)'="C") D
 .I (DEA>0&(DEA<6)) S PKI=10 S VALMSG="Hardcopy Printed Prescription",PKIE="Processing "_VALMSG
 .E  S PKIE=""
 I $P(OR0,"^",24),($P(OR0,"^",3)="RNW"!($P(OR0,"^",3)="NW")) N PKI,PKI1,PKIR S PKI=0 D CER^PSOPKIV1 Q:PKI<1
...
SUCC ;
 ...
 S:$G(POERR("DFLG")) POERR("QFLG")=1 K POERR("DFLG"),PSONEW,ACP,OR0,DRET,SIG,OID,OI,PSORX("SC"),PSORX("CLINIC"),PSODRUG,PKI
 Q
