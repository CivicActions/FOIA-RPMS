PSONEWG ;BIR/RTR - Copay copy and edit questions ;27-Apr-2022 15:04
 ;;7.0;OUTPATIENT PHARMACY;**71,157,143,219,226,239,225,1031**;DEC 1997;Build 15
 ;External reference ^PSDRUG( supported by DBIA 221
 ;External reference VADPT supported by DBIA 10061
 ;Modified - IHS/MSC/MIR - 04/27/2022 - Line START+13
START ;
 N PSOPENIB,PSOMESOI
 ...
 I PSOSCA&(PSOSCP>49)!((PSOSCA!($G(PSOBILL)=2))&($P($G(^PS(53,+$G(PSONEW("PATIENT STATUS")),0)),"^",7)=1))!(PSOSCP>49&($G(PSOBILL)=2)) D SC^PSOMLLD2 I $G(PSOCPZ("DFLG")) K PSOANSQ,PSONEW("NEWCOPAY"),PSONEWFF,PSOMESOI Q
