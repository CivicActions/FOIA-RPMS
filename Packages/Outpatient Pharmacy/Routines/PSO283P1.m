PSO283P1 ;BIR/MFR-EXPIRATION DATE PROBLEM TALLY (Cont.) ;01-Dec-2021 16:28;DU
 ;;7.0;OUTPATIENT PHARMACY;**283,1029**;DEC 1997;Build 50
 ;External reference to ^PS(59.7 is supported by DBIA 694
 ;
 ;Modified - IHS/MSC/PLS - 12/01/2021 call to EXPDATE^PSOUTL2A
MAIL ;
...
CALCEXP ; CALCULATE THE EXPIRATION DATE
 ...
 S X2=$S(DAYSSUP=X2:X2,1:$$EXPDATE^PSOUTLA2($G(PSOCS),ISSUEDT))
