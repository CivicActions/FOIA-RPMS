PSOVER ;BIR/SAB-verify rx's by clerk ;30-Nov-2017 15:28;MGH
 ;;7.0;OUTPATIENT PHARMACY;**16,21,27,117,131,146,1004,1007,1023**;DEC 1997;Build 121
 ...
 ;            IHS/MSC/MGH -,05/18/17 - OERR+6 Changes for EPCS
...
DSPL ;
 ...
 S DA=PSONV
 D SAVE
 ;I $P($G(^PSRX(DA,"PKI")),"^") N PKI,PKI1,PKIR,PKIE D CER^PSOPKIV1
...
DONE ;
 I $P(^PSRX(PSONV,"STA"),"^")'=1,$P(^("STA"),"^")'=4 K ^PSRX(PSONV,"DRI")
...
SAVE ;
 K PSOOVNOD,PSOOVSTA
 S (PSOOVNOD,PSOOVSTA)="",PSOOVNOD=^PS(52.4,PSONV,0),PSOOVSTA=$P(^PSRX(PSONV,"STA"),"^")
 Q
