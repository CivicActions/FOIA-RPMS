PSORX1 ;BIR/SAB-medication processing driver ;14-Apr-2023 16:12;DU
 ;;7.0;OUTPATIENT PHARMACY;**7,22,23,57,62,46,74,71,90,95,115,117,146,139,135,1004,182,195,233,268,300,170,320,326,1015,1034**;DEC 1997;Build 37
...
OERR ;N:$G(MEDP) PAT,POERR K PSOXFLG S (DFN,PSODFN)=+Y,PSORX("NAME")=$P(Y,"^",2)
 ;IHS/MSC/PLS - PPN - P1034
 N:$G(MEDP) PAT,POERR K PSOXFLG S (DFN,PSODFN)=+Y,PSORX("NAME")=$$GETPREF^AUPNSOGI(+Y,"E",1)
