PSOORFI5 ;BIR/SJA-finish cprs orders ;24-May-2019 10:37;MGH
 ;;7.0;OUTPATIENT PHARMACY;**225,315,266,1015,1023**;DEC 1997;Build 121
 ;External references UL^PSSLOCK supported by DBIA 2789
 ;External reference to ^DPT supported by DBIA 10035
 ;
 ;Modified - IHS/MSC/PLS - 5/10/2010 - Lines FLG+8 and PRI+14
 ;           IHS/MSC/MGH - 11/28/17 New entry points for EPCS
 ;
...
PDEA ;
 ...
 ;IHS/MSC/MGH added for EPCS
PRV(PROV,DRG,ORN) ;
 N DETN,DEA,I,LBL,VADD,SPC,SUP,SUPDEA,SUPNME
 I PROV="" Q
 S DEA=$$DEA^XUSER(0,PROV)
 S LBL=$S(DEA["-":" VA#: ",1:"DEA#: ") I $G(ADDS) S LBL=" "_LBL
 ;IHS/MSC/MGH - ihs not using detox numbers
 ;I DRG,$$DETOX^PSSOPKI(DRG) S DETN=$$DETOX^XUSER(PROV)
 ;I +$$DETOXDR^APSPFNC6(DRG) S DETN=$$DETOX^XUSER(PROV)
 I DRG,+$$DETOXORD^APSPFNC6(DRG,ORN) S DETN=$$DETOX^XUSER(PROV)
 S $P(SPC," ",($S($G(ADDS):30,1:33)-$L(DEA)))=" "
 I (DEA'="")!($G(DETN)'="") S IEN=IEN+1,$E(^TMP("PSOPO",$J,IEN,0),16)=LBL_DEA_$S($G(DETN)]"":SPC_"DEA X#: "_$G(DETN),1:"")
