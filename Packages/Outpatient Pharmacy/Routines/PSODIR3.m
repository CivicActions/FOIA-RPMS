PSODIR3 ;ISC-BIRM/SAB - rx order entry contd ;01-Feb-2024 11:25;DU
 ;;7.0;OUTPATIENT PHARMACY;**3,46,1008,184,222,206,1015,1035**;DEC 1997;Build 39
 ;Modified - IHS/MSC/PLS - 12/30/2008 - Line FILLDT+3
 ;                         06/01/2010 - Line REFOR+6
 ;                         01/31/2024 - Line REFOR+11  FID 99321
 ;
EXP(PSODIR) ;
 K DIC,DIR
...
REFOR ;
 ...
 .S PSDY=PSODIR("DAYS SUPPLY"),PSDY1=$S(PSDY<60:15,PSDY'<60&(PSDY'>89):5,PSDY=90:3,PSDY=91:3,1:0) S PSOX=$S(PSOX'>PSDY1:PSOX,1:PSDY1)  ;Added 91:3 p1035
