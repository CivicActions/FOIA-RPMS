DGPMX5 ; GENERATED FROM 'DGPM LODGER CHECK-OUT' INPUT TEMPLATE(#2129), FILE 405;02/09/12
...
BEGIN S DNM="DGPMX5",DQ=1
 ...
 M DIEZAR=^DIE(2129,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2129,U="^"
...
19 D:$D(DG)>9 F^DIE17,DE S DQ=19,DW="USR;4",DV="RD",DU="",DLB="LAST EDITED ON",DIFLD=103
