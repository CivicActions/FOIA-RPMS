DGPMXA ; GENERATED FROM 'DGPM ASIH ADMIT' INPUT TEMPLATE(#2131), FILE 405;02/09/12
...
BEGIN S DNM="DGPMXA",DQ=1
 ...
 M DIEZAR=^DIE(2131,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2131,U="^"
...
13 S DW="ODS;1",DV="S",DU="",DLB="ODS AT ADMISSION",DIFLD=11500.01
 ...
 G RD:X="@",Z
X13 Q
14 S DW="USR;3",DV="RP200'a",DU="",DLB="LAST EDITED BY",DIFLD=102
 S DE(DW)="C14^DGPMXA"
 S DU="VA(200,"
 S X=DUZ
 S Y=X
...
16 D:$D(DG)>9 F^DIE17,DE S DQ=16,DW="USR;4",DV="RD",DU="",DLB="LAST EDITED ON",DIFLD=103
