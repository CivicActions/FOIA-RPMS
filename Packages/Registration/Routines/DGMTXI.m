DGMTXI ; GENERATED FROM 'DGMT ENTER/EDIT ANNUAL INCOME' INPUT TEMPLATE(#2467), FILE 408.21;02/09/12
...
BEGIN S DNM="DGMTXI",DQ=1
 ...
 M DIEZAR=^DIE(2467,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2467,U="^"
