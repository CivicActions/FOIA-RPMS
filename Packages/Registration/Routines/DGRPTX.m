DGRPTX ; GENERATED FROM 'DGRPT 10-10T REGISTRATION' INPUT TEMPLATE(#2488), FILE 2;02/09/12
...
BEGIN S DNM="DGRPTX",DQ=1
 ...
 M DIEZAR=^DIE(2488,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2488,U="^"
...
C4F1 N X,X1,X2 S DIXR=318 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DPT("APTYPE",X,DA)
...
C7F1 N X,X1,X2 S DIXR=22 D C7X1(U) K X2 M X2=X D C7X1("O") K X1 M X1=X
 D
...
C9F1 N X,X1,X2 S DIXR=24 D C9X1(U) K X2 M X2=X D C9X1("O") K X1 M X1=X
 D
...
C11F1 N X,X1,X2 S DIXR=25 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
C14S S X="" G:DG(DQ)=X C14F1 K DB
 D ^DGRPTX2
C14F1 N X,X1,X2 S DIXR=23 D C14X1(U) K X2 M X2=X D C14X1("O") K X1 M X1=X
 D
...
C14X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C14F2 S DIXR=51 D C14X2(U) K X2 M X2=X D C14X2("O") K X1 M X1=X
 D
...
C15S S X="" G:DG(DQ)=X C15F1 K DB
 D ^DGRPTX4
C15F1 N X,X1,X2 S DIXR=26 D C15X1(U) K X2 M X2=X D C15X1("O") K X1 M X1=X
 D
