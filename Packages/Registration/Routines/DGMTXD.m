DGMTXD ; GENERATED FROM 'DGMT ENTER/EDIT DEPENDENTS' INPUT TEMPLATE(#2466), FILE 408.22;02/09/12
...
BEGIN S DNM="DGMTXD",DQ=1
 ...
 M DIEZAR=^DIE(2466,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2466,U="^"
...
X22 S:'X Y="@10"
 Q
23 D:$D(DG)>9 F^DIE17,DE S DQ=23,DW="0;19",DV="NJ8,2",DU="",DLB="IF YOU DID NOT LIVE WITH CHILD, AMOUNT CONTRIBUTED TO CHILD LAST YEAR",DIFLD=.19
 G RE
