DGMTXM ; GENERATED FROM 'DGMT ENTER/EDIT MARITAL STATUS' INPUT TEMPLATE(#2465), FILE 408.22;02/09/12
 D DE G BEGIN;;;;;;Build 21
DE S DIE="^DGMT(408.22,",DIC=DIE,DP=408.22,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGMT(408.22,DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,5) S:%]"" DE(5)=% S %=$P(%Z,U,6) S:%]"" DE(7)=% S %=$P(%Z,U,7) S:%]"" DE(9)=% S %=$P(%Z,U,8) S:%]"" DE(12)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="DGMTXM",DQ=1
 ...
 M DIEZAR=^DIE(2465,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2465,U="^"
...
X8 S:X Y="@102"
 Q
9 D:$D(DG)>9 F^DIE17,DE S DQ=9,DW="0;7",DV="NJ8,2XR",DU="",DLB="IF YOU DID NOT LIVE WITH SPOUSE, AMOUNT CONTRIBUTED TO SPOUSE LAST YEAR",DIFLD=.07
 S DE(DW)="C9^DGMTXM"
 G RE
...
C9S S X="" G:DG(DQ)=X C9F1 K DB
 ...
 D E40822^DGRTRIG(DA)
C9F1 Q
X9 S:X["$" X=$P(X,"$",2) K:X'?.N.1".".2N!(X>99999)!(X<0) X D AMT^DGMTDD2:$D(X)
 Q
 ;
10 S DQ=11 ;@102
11 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=11 D X11 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X11 S:DGDR'["102" Y="@998"
 Q
12 D:$D(DG)>9 F^DIE17,DE S DQ=12,DW="0;8",DV="SXR",DU="",DLB="DID YOU HAVE ANY DEPENDENT CHILDREN",DIFLD=.08
 S DE(DW)="C12^DGMTXM"
 S DU="1:YES;0:NO;"
