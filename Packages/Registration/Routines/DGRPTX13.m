...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 ...
 I $D(^(.3)) S %Z=^(.3) S %=$P(%Z,U,1) S:%]"" DE(40)=%
 I $D(^(.32)) S %Z=^(.32) S %=$P(%Z,U,5) S:%]"" DE(20)=% S %=$P(%Z,U,8) S:%]"" DE(21)=%
 I $D(^(.321)) S %Z=^(.321) S %=$P(%Z,U,2) S:%]"" DE(36)=% S %=$P(%Z,U,3) S:%]"" DE(37)=%
 I $D(^(.322)) S %Z=^(.322) S %=$P(%Z,U,13) S:%]"" DE(38)=%
 ...
 I  S %=$P(%Z,U,9) S:%]"" DE(17)=% S %=$P(%Z,U,10) S:%]"" DE(1)=% S %=$P(%Z,U,11) S:%]"" DE(18)=%
 I $D(^(.36)) S %Z=^(.36) S %=$P(%Z,U,2) S:%]"" DE(39)=%
 I $D(^(.52)) S %Z=^(.52) S %=$P(%Z,U,5) S:%]"" DE(22)=%
 I $D(^(.53)) S %Z=^(.53) S %=$P(%Z,U,1) S:%]"" DE(24)=% S %=$P(%Z,U,2) S:%]"" DE(29)=% S %=$P(%Z,U,3) S:%]"" DE(33)=% S %=$P(%Z,U,4) S:%]"" DE(30)=%,DE(34)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
X5 S Y=.33011
 Q
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW=".33;1",DV="FX",DU="",DLB="E-NAME",DIFLD=.331
 S DE(DW)="C6^DGRPTX13",DE(DW,"INDEX")=1
 G RE
...
C6S S X="" G:DG(DQ)=X C6F1 K DB
 S X=DG(DQ),DIC=DIE
 ;
C6F1 N X,X1,X2 S DIXR=302 D C6X1(U) K X2 M X2=X D C6X1("O") K X1 M X1=X
 I $G(X(1))]"" D
...
8 D:$D(DG)>9 F^DIE17,DE S DQ=8,DW=".33;2",DV="FX",DU="",DLB="E-RELATIONSHIP TO PATIENT",DIFLD=.332
 S DE(DW)="C8^DGRPTX13",DE(DW,"INDEX")=1
 G RE
...
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,DW=".33;5",DV="FX",DU="",DLB="E-STREET ADDRESS [LINE 3]",DIFLD=.335
 S DE(DW)="C13^DGRPTX13",DE(DW,"INDEX")=1
 G RE
...
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW=".33;6",DV="FX",DU="",DLB="E-CITY",DIFLD=.336
 S DE(DW)="C14^DGRPTX13",DE(DW,"INDEX")=1
 G RE
...
15 D:$D(DG)>9 F^DIE17,DE S DQ=15,DW=".33;7",DV="P5'X",DU="",DLB="E-STATE",DIFLD=.337
 S DE(DW)="C15^DGRPTX13",DE(DW,"INDEX")=1
 S DU="DIC(5,"
 G RE
...
16 D:$D(DG)>9 F^DIE17,DE S DQ=16,DW=".22;1",DV="FOX",DU="",DLB="E-ZIP+4",DIFLD=.2201
 ...
 S DE(DW)="C16^DGRPTX13",DE(DW,"INDEX")=1
 G RE
...
X16 K:X[""""!($A(X)=45) X I $D(X) S DFN=DA D E1^DGLOCK2 I $D(X) K:$L(X)>15!($L(X)<5) X I $D(X) D ZIPIN^VAFADDR
 ...
 Q
 ;
17 D:$D(DG)>9 F^DIE17,DE S DQ=17,DW=".33;9",DV="FX",DU="",DLB="E-PHONE NUMBER",DIFLD=.339
 G RE
X17 K:$L(X)>20!($L(X)<3) X I $D(X) S DFN=DA D E1^DGLOCK2
 I $D(X),X'?.ANP K X
 Q
 ;
18 S DW=".33;11",DV="F",DU="",DLB="E-WORK PHONE NUMBER",DIFLD=.33011
 G RE
X18 K:$L(X)>20!($L(X)<4) X
 I $D(X),X'?.ANP K X
 Q
 ;
19 S DQ=20 ;@40
20 S DW=".32;5",DV="P23'X",DU="",DLB="SERVICE BRANCH [LAST]",DIFLD=.325
 S DE(DW)="C20^DGRPTX13",DE(DW,"INDEX")=1
 S DU="DIC(23,"
 G RE
...
C20S S X="" G:DG(DQ)=X C20F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 ;
C20F1 N X,X1,X2 S DIXR=251 D C20X1(U) K X2 M X2=X D C20X1("O") K X1 M X1=X
 D
...
C20X1(DION) K X
 ...
 Q
C20F2 Q
X20 S DFN=DA K:X=$O(^DIC(23,"B","B.E.C.","")) X I $D(X) D SV^DGLOCK S DGCOMBR=$G(Y) Q
 Q
 ;
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW=".32;8",DV="FX",DU="",DLB="SERVICE NUMBER [LAST]",DIFLD=.328
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 D EVENT^IVMPLOG(DA)
C21F1 Q
X21 S DFN=DA D SV^DGLOCK I $D(X) S:X?1"SS".E L=$S($D(^DPT(DA,0)):$P(^(0),U,9),1:X) W:X?1"SS".E "  ",L S:X?1"SS".E X=L K:$L(X)>15!($L(X)<1)!'(X?.N) X
 I $D(X),X'?.ANP K X
 Q
 ;
22 D:$D(DG)>9 F^DIE17,DE S DQ=22,DW=".52;5",DV="RSX",DU="",DLB="POW STATUS INDICATED?",DIFLD=.525
 S DE(DW)="C22^DGRPTX13",DE(DW,"INDEX")=1
...
C22S S X="" G:DG(DQ)=X C22F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D EVENT^IVMPLOG(DA)
C22F1 N X,X1,X2 S DIXR=257 D C22X1(U) K X2 M X2=X D C22X1("O") K X1 M X1=X
 D
...
C22X1(DION) K X
 ...
 Q
C22F2 Q
X22 S DFN=DA D POWV^DGLOCK I $D(X) D SV^DGLOCK
 Q
 ;
23 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=23 D X23 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X23 I $P($G(^DPT(DFN,.53)),U)]"" S Y="@53"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW=".53;1",DV="SX",DU="",DLB="CURRENT PH INDICATOR",DIFLD=.531
...
C29F1 Q
X29 Q
30 D:$D(DG)>9 F^DIE17,DE S DQ=30,DW=".53;4",DV="P4'",DU="",DLB="PH DIVISION",DIFLD=.535
 S DU="DIC(4,"
 S X=$$DIV^DGRPLE()
 S Y=X
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
...
X31 S Y="@53"
 Q
32 S DQ=33 ;@533
33 S DW=".53;3",DV="S",DU="",DLB="CURRENT PURPLE HEART REMARKS",DIFLD=.533
 S DE(DW)="C33^DGRPTX13"
...
C33F1 Q
X33 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW=".53;4",DV="P4'",DU="",DLB="PH DIVISION",DIFLD=.535
 S DU="DIC(4,"
 S X=$$DIV^DGRPLE()
 S Y=X
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
...
X34 Q
35 S DQ=36 ;@53
36 S DW=".321;2",DV="RSX",DU="",DLB="AGENT ORANGE EXPOS. INDICATED?",DIFLD=.32102
 S DE(DW)="C36^DGRPTX13"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
C36S S X="" G:DG(DQ)=X C36F1 K DB
 D ^DGRPTX17
C36F1 Q
X36 S DFN=DA D SV^DGLOCK
 Q
 ;
37 D:$D(DG)>9 F^DIE17,DE S DQ=37,DW=".321;3",DV="RSX",DU="",DLB="RADIATION EXPOSURE INDICATED?",DIFLD=.32103
 S DE(DW)="C37^DGRPTX13"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
C37S S X="" G:DG(DQ)=X C37F1 K DB
 D ^DGRPTX19
C37F1 Q
X37 S DFN=DA D SV^DGLOCK
 Q
 ;
38 D:$D(DG)>9 F^DIE17,DE S DQ=38,DW=".322;13",DV="RSX",DU="",DLB="ENVIRONMENTAL CONTAMINANTS?",DIFLD=.322013
 S DE(DW)="C38^DGRPTX13"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
C38S S X="" G:DG(DQ)=X C38F1 K DB
 D ^DGRPTX21
C38F1 Q
X38 S DFN=DA D SV^DGLOCK
 Q
 ;
39 D:$D(DG)>9 F^DIE17,DE S DQ=39,DW=".36;2",DV="RSX",DU="",DLB="DISABILITY RET. FROM MILITARY?",DIFLD=.362
 S DE(DW)="C39^DGRPTX13"
...
C39S S X="" G:DG(DQ)=X C39F1 K DB
 D ^DGRPTX23
C39F1 Q
X39 S DFN=DA D SV^DGLOCK
 Q
 ;
40 D:$D(DG)>9 F^DIE17,DE S DQ=40,DW=".3;1",DV="RSXa",DU="",DLB="SERVICE CONNECTED?",DIFLD=.301
 S DE(DW)="C40^DGRPTX13"
 S DU="Y:YES;N:NO;"
 G RE
