DGPTXC ; GENERATED FROM 'DG PTF CREATE PTF ENTRY' INPUT TEMPLATE(#2449), FILE 45;02/09/12
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=268,269,270,271,272,273,274,275,276,277,278,279,280,281,282 S DIEZRXR(45,DIXR)=""
 Q
X1 Q
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,D=0 K DE(1) ;50
 S DIFLD=50,DGO="^DGPTXC1",DC="35^45.02AI^M^",DV="45.02MNJ6,1X",DW="0;1",DOW="MOVEMENT RECORD",DLB=$P($$EZBLD^DIALOG(8042,DOW),":") S:D DC=DC_D
