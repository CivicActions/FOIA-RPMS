DGPTXM ; GENERATED FROM 'DG PTF ADD MESSAGE' INPUT TEMPLATE(#2453), FILE 45.5;02/09/12
...
BEGIN S DNM="DGPTXM",DQ=1
 ...
 M DIEZAR=^DIE(2453,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2453,U="^"
