DGPTX1 ; GENERATED FROM 'DG101' INPUT TEMPLATE(#2434), FILE 45;02/09/12
...
BEGIN S DNM="DGPTX1",DQ=1
 ...
 M DIEZAR=^DIE(2434,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2434,U="^"
