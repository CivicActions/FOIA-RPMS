DGRPXR ; GENERATED FROM 'DGRP COLLATERAL REGISTER' INPUT TEMPLATE(#2433), FILE 2;02/09/12
...
BEGIN S DNM="DGRPXR",DQ=1
 ...
 M DIEZAR=^DIE(2433,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2433,U="^"
