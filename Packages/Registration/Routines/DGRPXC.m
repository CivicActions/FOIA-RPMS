DGRPXC ; GENERATED FROM 'DG CONSISTENCY CHECKER' INPUT TEMPLATE(#2432), FILE 2;02/09/12
...
BEGIN S DNM="DGRPXC",DQ=1
 ...
 M DIEZAR=^DIE(2432,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2432,U="^"
