...
C5F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=258,259,260,261,262 S DIEZRXR(45.01,DIXR)=""
 Q
...
C15F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=258 S DIEZRXR(45.01,DIXR)=""
 Q
...
C20F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=259 S DIEZRXR(45.01,DIXR)=""
 Q
...
C25F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=260 S DIEZRXR(45.01,DIXR)=""
 Q
...
X29 I DGADD,$P(DGHOLD,U,11)]"" S Y="@60"
 Q
30 D:$D(DG)>9 F^DIE17,DE S DQ=30,DW="0;11",DV="*P80.1'",DU="",DLB="OPERATION CODE 4",DIFLD=11
...
C30F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=261 S DIEZRXR(45.01,DIXR)=""
 Q
X30 S DIC("S")="S DGI=11,DGCR=""AO"",DGSB=""S"" D EN1^DGPTFJC K DGI,DGCR,DGSB,K I 'DGER" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
...
X34 I DGADD,$P(DGHOLD,U,12)]"" S Y="@70"
 Q
35 D:$D(DG)>9 F^DIE17,DE S DQ=35,DW="0;12",DV="*P80.1'",DU="",DLB="OPERATION CODE 5",DIFLD=12
...
C35F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=262 S DIEZRXR(45.01,DIXR)=""
 Q
X35 S DIC("S")="S DGI=12,DGCR=""AO"",DGSB=""S"" D EN1^DGPTFJC K DGI,DGCR,DGSB,K I 'DGER" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
