DGPMXX1 ; COMPILED XREF FOR FILE #405 ; 02/07/12
 ; ;;;;;Build 21
 S DIKZK=2
 ...
 S X=$P($G(DIKZ(0)),U,9)
 I X'="" D:($T(ADGRU^DGRUDD01)'="") ADGRU^DGRUDD01(DFN)
 S X=$P($G(DIKZ(0)),U,9)
 ...
 I X'="" S DH=405,DV=102,DU=1 S DIIX=2 D:$G(DIK(0))'["A" AUDIT^DIK1
 ...
 S X=$P($G(DIKZ(0)),U,1)
 I X'="" S DH=405,DV=.01,DU=1 S DIIX=2 D:$G(DIK(0))'["A" AUDIT^DIK1
END Q
