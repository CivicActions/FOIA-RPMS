...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,26) S:%]"" DE(24)=%,DE(27)=% S %=$P(%Z,U,27) S:%]"" DE(30)=%,DE(33)=% S %=$P(%Z,U,28) S:%]"" DE(36)=%,DE(39)=% S %=$P(%Z,U,29) S:%]"" DE(46)=%,DE(49)=% S %=$P(%Z,U,30) S:%]"" DE(52)=%,DE(56)=%
...
X4 I '$D(DGBPC(5))!(DGDUP(5)) S Y="@840"
 Q
...
X8 I '$D(DGBPC(6))!(DGDUP(6)) S Y="@850"
 Q
...
X23 I '$D(DGEXQ(1)) S Y="@910"
 Q
24 S DW="0;26",DV="SX",DU="",DLB="WAS TREATMENT RELATED TO AGENT ORANGE EXPOSURE?",DIFLD=26
 S DU="Y:YES;N:NO;"
 G RE
X24 S DGFLAG=1 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
...
X25 S Y="@915"
 Q
26 S DQ=27 ;@910
27 S DW="0;26",DV="SX",DU="",DLB="TREATED FOR AO CONDITION",DIFLD=26
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X27 S DGFLAG=1 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
28 S DQ=29 ;@915
29 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=29 D X29 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X29 I '$D(DGEXQ(2)) S Y="@920"
 Q
30 S DW="0;27",DV="SX",DU="",DLB="WAS TREATMENT RELATED TO IONIZING RADIATION EXPOSURE?",DIFLD=27
 S DU="Y:YES;N:NO;"
 G RE
X30 S DGFLAG=2 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
...
X31 S Y="@925"
 Q
32 S DQ=33 ;@920
33 S DW="0;27",DV="SX",DU="",DLB="TREATED FOR IR CONDITION",DIFLD=27
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X33 S DGFLAG=2 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
34 S DQ=35 ;@925
35 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=35 D X35 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X35 I '$D(DGEXQ(3)) S Y="@930"
 Q
36 S DW="0;28",DV="SX",DU="",DLB="WAS TREATMENT RELATED TO SERVICE IN SW ASIA?",DIFLD=28
 S DU="Y:YES;N:NO;"
 G RE
X36 S DGFLAG=3 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
...
X37 S Y="@935"
 Q
38 S DQ=39 ;@930
39 S DW="0;28",DV="SX",DU="",DLB="EXPOSED TO ENVIR CONTAMINANTS",DIFLD=28
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X39 S DGFLAG=3 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
40 S DQ=41 ;@935
41 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=41 D X41 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X41 I '$D(DGEXQ(7)) S Y="@940"
 Q
...
X45 I '$D(DGEXQ(4)) S Y="@950"
 Q
46 S DW="0;29",DV="S",DU="",DLB="WAS TREATMENT RELATED TO MILITARY SEXUAL TRAUMA?",DIFLD=29
 S DU="Y:YES;N:NO;"
 G RE
X46 Q
...
X47 S Y="@955"
 Q
48 S DQ=49 ;@950
49 S DW="0;29",DV="S",DU="",DLB="TREATMENT FOR MST",DIFLD=29
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X51 I '$D(DGEXQ(5)) S Y="@960"
 Q
52 S DW="0;30",DV="S",DU="",DLB="WAS TREATMENT RELATED TO HEAD AND/OR NECK CANCER?",DIFLD=30
 S DU="Y:YES;N:NO;"
 G RE
X52 Q
...
X54 S Y="@965"
 Q
55 S DQ=56 ;@960
56 S DW="0;30",DV="S",DU="",DLB="TREATMENT FOR HEAD/NECK CA",DIFLD=30
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
