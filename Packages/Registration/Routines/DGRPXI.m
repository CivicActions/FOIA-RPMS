DGRPXI ; GENERATED FROM 'DGRP ENTER/EDIT ANNUAL INCOME' INPUT TEMPLATE(#2473), FILE 408.21;02/09/12
...
BEGIN S DNM="DGRPXI",DQ=1
 ...
 M DIEZAR=^DIE(2473,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2473,U="^"
