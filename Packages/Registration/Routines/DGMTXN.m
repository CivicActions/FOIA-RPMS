DGMTXN ; GENERATED FROM 'DGMT ENTER/EDIT NET WORTH' INPUT TEMPLATE(#2474), FILE 408.21;02/09/12
...
BEGIN S DNM="DGMTXN",DQ=1
 ...
 M DIEZAR=^DIE(2474,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2474,U="^"
...
X7 S:DGDR'["102" Y="@103"
 Q
8 D:$D(DG)>9 F^DIE17,DE S DQ=8,DW="2;2",DV="NJ9,2X",DU="",DLB="STOCKS AND BONDS",DIFLD=2.02
 S DE(DW)="C8^DGMTXN"
 G RE
...
X10 S:DGDR'["103" Y="@104"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="2;3",DV="NJ9,2X",DU="",DLB="REAL PROPERTY",DIFLD=2.03
 S DE(DW)="C11^DGMTXN"
 G RE
...
X13 S:DGDR'["104" Y="@105"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="2;4",DV="NJ9,2X",DU="",DLB="OTHER PROPERTY OR ASSETS",DIFLD=2.04
 S DE(DW)="C14^DGMTXN"
 G RE
