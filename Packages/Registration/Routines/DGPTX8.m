DGPTX8 ; GENERATED FROM 'DG801' INPUT TEMPLATE(#2945), FILE 46.1;02/09/12
...
BEGIN S DNM="DGPTX8",DQ=1
 ...
 M DIEZAR=^DIE(2945,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2945,U="^"
