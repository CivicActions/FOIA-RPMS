DGX5F3 ; ;02/09/12
 ;;;;;;Build 21
1 N X,X1,X2 S DIXR=283 D X1(U) K X2 M X2=X D X1("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X1(DION) K X
 ...
 S X=$G(X(1))
 Q
2 N X,X1,X2 S DIXR=284 D X2(U) K X2 M X2=X D X2("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=285 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=286 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=287 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X5(DION) K X
 ...
 S X=$G(X(1))
 Q
6 N X,X1,X2 S DIXR=288 D X6(U) K X2 M X2=X D X6("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X6(DION) K X
 ...
 S X=$G(X(1))
 Q
7 N X,X1,X2 S DIXR=289 D X7(U) K X2 M X2=X D X7("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X7(DION) K X
 ...
 S X=$G(X(1))
 Q
8 N X,X1,X2 S DIXR=290 D X8(U) K X2 M X2=X D X8("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X8(DION) K X
 ...
 S X=$G(X(1))
 Q
9 N X,X1,X2 S DIXR=291 D X9(U) K X2 M X2=X D X9("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
...
X9(DION) K X
 ...
 S X=$G(X(1))
 Q
10 N X,X1,X2 S DIXR=292 D X10(U) K X2 M X2=X D X10("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"" D
