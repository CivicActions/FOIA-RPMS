BSTS2P04 ;GDIT/HS/BEE-Version 2.0 Patch 4 Pre and Post Installs ; 19 Nov 2012  9:41 AM
...
ENV ;EP - Environmental Checking Routine
 ...
 ;
 ;Check for BSTS v2.0 Patch 3
 I '$$INSTALLD("BSTS*2.0*3") D BMES^XPDUTL("Version 2.0 Patch 2 of BSTS is required!") S XPDQUIT=2 Q
 ;
...
EN ;EP
 ;
 ;Make a log entry
 D LOG^BSTSAPIL("INST","","PATCH","BSTS*2.0*4")
 ;
...
FIX(X)   ;
 ...
 I X=3 S XPDQUIT=2 Q
 S XPDQUIT=X
 W *7,!,$$CJ^XLFSTR("This patch must be installed prior to the installation of BEDD*2.0*4",IOM)
 Q
