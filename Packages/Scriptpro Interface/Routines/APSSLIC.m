APSSLIC ;IHS/MSC/MDM - ScriptPro Interface;02-Feb-2023 12:15;DU
...
PADDR(PAT) ; Patient Address
 ...
 Q ADDR
PTMPADD(PAT) ;Patient Temporary Address
 N ADDR,ADDR1,ADDR2,ADDR3,CITY,STATE,ZIP,PTMPADD
 S IENS=PAT_","
 D GETS^DIQ(2,IENS,".1211;.1212;.1213;.1214;.1215;.12112","E","PTMPADD")
 S ADDR=$G(PTMPADD(2,IENS,.1211,"E"))_U_$G(PTMPADD(2,IENS,.1212,"E"))_U_$G(PTMPADD(2,IENS,.1213,"E"))_U_$G(PTMPADD(2,IENS,.1214,"E"))_U_$G(PTMPADD(2,IENS,.1215,"E"))_U_$G(PTMPADD(2,IENS,.12112,"E"))
 Q ADDR
