ACPT216 ;IHS/OIT/NKD - ACPT V2.16 CPT ENVIRONMENT CHECKER 2/22/16 ;
 ;;2.16;CPT FILES;**2**;DEC 19, 2015;Build 1
 ; 12/19/15 - Code cleanup
 ;          - Modified processing for a combined CPT/HCPCS annual update
 ;
