PSBOMH ;BIRMINGHAM/EFC-MAH ;31-Mar-2023 08:24;DU
 ;;3.0;BAR CODE MED ADMIN;**5,9,38,1033**;Mar 2004;Build 34
 ...
 ; ^DIWP/10011
 ;
 ; Modified - IHS/MSC/PLS - 03/31/2023 - Line EN1+38
 ;
...
EN1 ; Expects DFN,STRT,STOP
 ...
 .F I=1:1 Q:$P($TR(PSBSCH,",","-"),"-",I)=""  I $P($TR(PSBSCH,",","-"),"-",I)?2N!($P($TR(PSBSCH,",","-"),"-",I)?4N) S PSBYES=1,PSBYTFN=1
