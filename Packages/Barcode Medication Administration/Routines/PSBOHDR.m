PSBOHDR ;BIRMINGHAM/EFC - REPORT HEADERS ;01-Mar-2023 14:51
 ;;3.0;BAR CODE MED ADMIN;**5,13,42,1033**;Mar 2004;Build 34
 ;
 ; Reference/IA
 ; EN6^GMRVUTL/1120
 ; WARD^NURSUT5/3052
 ; IN5^VADPT/10061
 ; DEM^VADPT/10061
 ; Modified - IHS/MSC/MIR - 03/01/23 - WARD+15:+25
 ;
PT(DFN,PSBHDR,PSBCONT,PSBDT) ;
 ...
 .S PSBHDR("WARD")=$P(VAIP(5),U,2) S:PSBHDR("WARD")="" PSBHDR("WARD")=$G(BZONAME) ; CLINIC LOCATION
...
WARD(PSBWP,PSBHDR,PSBCONT,PSBDT) ; 
 ...
 F X=3:1 Q:'$D(PSBHDR(X))  W !,PSBHDR(X)  ; More Lines If Needed
 I $G(PSBCONT) W !?(IOM-35\2),"*** CONTINUED FROM PREVIOUS PAGE ***"
 ; - IHS/OCA/JTC - 2022.05.10 - HOSPITAL LOCATIONS
 ; LOOKUP HOSPITAL LOCATION THEN QUIT
 ;I $G(PSBWP)["SC(" D  Q
 I $G(PSBWP)>9000000 D  Q
 .S BZOI=(PSBWP-9000000)
 .S BZONAME=$P($G(^SC(BZOI,0)),U,1)
 .S BZODIV=$$GET1^DIQ(44,BZOI,3)  ; DIVISION
 .W !!,"Clinic Location: "_BZONAME
 .S X="Division: "_BZODIV
