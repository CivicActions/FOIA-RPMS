PSBMLLKU ;BIRMINGHAM/TEJ - BCMA RPC LOOKUP UTLILITIES ;22-Mar-2023 09:05;DU
 ;;3.0;BAR CODE MED ADMIN;**3,9,11,20,13,38,32,56,42,1033**;Mar 2004;Build 34
 ...
 ; File 211.4/1409
 ;
 ;Modified - IHS/MSC/PLS - 03/22/2023
...
PTLKUP(RESULTS,PSBREC) ; Patient lookup handled separately for security
 ...
 ..S $P(RESULTS(PSBXX),U,2)=$$GETPREF^AUPNSOGI(+RESULTS(PSBXX),"E",1)
