ALPBPALL ;OIFO-DALLAS MW,SED,KC-PRINT 3-DAY MAR BCMA BACLUP REPORT FOR ALL WARDS ;02-Apr-2019 15:58;DU
 ;;3.0;BAR CODE MED ADMIN;**8,29,1023**;Mar 2004;Build 121
 ;
...
DQ ; output entry point...
 ...
 ....;KCF VA IOT 1-9-19  IHS/MSC/PLS - 4/2/2019 - Patch 1023
 ....I '$D(^TMP($J,ALPBWARD,ALPBPTN_ALPBIEN)) S ^TMP($J,ALPBWARD,ALPBPTN_ALPBIEN)=ALPBIEN
 ....S ^TMP($J,ALPBWARD,ALPBPTN_ALPBIEN,ALPBOCT,ALPBOST,ALPBORDN)=ALPBOIEN
