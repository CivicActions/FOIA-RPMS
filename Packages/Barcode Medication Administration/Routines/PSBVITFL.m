PSBVITFL ;BIRMINGHAM/TEJ - BCMA VITAL MEASUREMENT FILER ;01-Mar-2023 11:03
 ;;3.0;BAR CODE MED ADMIN;**31,42,1033**;Mar 2004;Build 34
 ...
 ; 44/908
 ; 42/10039
 ; Modified - IHS/MSC/MIR - 03/01/23 - Lines RPC+9:+38
 ; 
 ;
 ; Description:
...
RPC(RESULTS,PSBDFN,PSBRATE,PSBVTYPE,PSBDTTKN) ;
 ...
 ; - IHS/OCA/JTC - 2022.05.16 - HOSPITAL LOCATION FIX - CHANGED ABOVE LINE TO LINE BELOW
 I 'VAIP(13)&('VADM(6)) D  Q
 .; find visit
 .S BZOV=0,BZOQ=0,BZOI=""
 .F  S BZOI=$O(^AUPNVSIT("AC",DFN,BZOI),-1) Q:('BZOI)!(BZOV)  D
 ..S BZO44=$$GET1^DIQ(9000010,BZOI,.22,"I") ; HOSPITAL LOCATION
 ..Q:'BZO44
 ..S BZO5346=$O(^PS(53.46,"B",BZO44,""))
 ..Q:'BZO5346
 ..Q:$P($G(^PS(53.46,BZO5346,0)),U,4)'=1    ; SEND TO BCMA IS NOT YES
 ..S BZOV=BZOI                              ; THIS IS THE VISIT WE WANT
 .; add measurement
 .Q:'$G(DUZ("AG"))="I"
 .Q:'$$GET^XPAR("ALL","BEHOVM USE VMSR")
 ...
 .Q:'VTYP
 .S VSIT=BZOV     ; S VSIT=$P($G(^DGPM(+$G(VAIP(13)),0)),U,27)
 ...
 .K BZOV,BZOQ,BZO44,BZO5346,BZOI
 ; - END -
