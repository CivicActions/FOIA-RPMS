PSBCSUTX ;BIRMINGHAM/TEJ- BCMA-HSC COVER SHEET UTILITIES 2 ;27-Apr-2023 13:12;DU
 ;;3.0;BAR CODE MED ADMIN;**16,13,38,32,1023,1033**;Mar 2004;Build 34
 ;Per VHA Directive 2004-038 (or future revisions regarding same), this routine should not be modified.
 ; Reference/IA
 ; $$GET1^DIQ/2056
 ; $$SCH^XLFDT/10103
 ; $$FMADD^XLFDT/10103
 ; Modified - IHS/MSC/PLS - 06/04/2018 - Added changes from PSB*3.0*107
 ;                          04/05/2023 - Added $TR at Line NEXTADM+39
...
NEXTADM(XX,YY) ;
 ...
 .....S X=PSBOST F  S X=$$FMADD^XLFDT(X,,,PSBXSCH*60) S Y="" S Y=$O(^PSB(53.79,"AORD",PSBPATX,PSBORXX,Y),-1) I X>Y S NEXTADM=X Q  ;PSB*3.0*107
 ....I PSBGSCH]"" D  Q
 ...
 ....S $P(X,".",2)=$P(PSBGSCH,"-"),NEXTADM=$$FMADD^XLFDT(X,,,PSBXSCH*60) Q  ;PSB*3.0*107
 ...
 ...S PSBNXTDT=X D DW^%DTC S PSBYS=0 F PSBIX2=1:1 S PSBDY=$P($P($TR(PSBSCH,",","-"),"@"),"-",PSBIX2) Q:PSBDY=""  I $F(X,PSBDY)>1 S PSBYS=1
