PSBVAR ;BIRMINGHAM/EFC-BCMA VARIANCE LOG FUNCTIONS ;01-Mar-2023 14:14
 ;;3.0;BAR CODE MED ADMIN;*31,1033*;Mar 2004;Build 34
 ;Per VHA Directive 2004-038, this routine should not be modified.
 ;
 ; Reference/IA
 ; ^DPT/10035
 ; ^DIC(42/10039
 ; Modified - IHS/MSC/MIR - 03/01/23 - WARD+11:+28
 ;
EN ;
 Q
 ;
...
WARD ;Extract the ward and room/bed information.
 ...
 ; - IHS/OCA/JTC - 2022.05.11 - HOSPITAL LOCATION
 I $G(PSBLOG) I PSBWRD="***" D
 .S BZON=$$GET1^DIQ(53.79,PSBLOG,.11)
 .Q:BZON=""
 .N BZO44,BZO100
 .I BZON["U" D
 ..S BZO100=+$P($G(^PS(55,DFN,5,(+BZON),0)),U,21)
 ..S BZO44=$$GET1^DIQ(100,BZO100,6,"I")  ; HOSPITAL LOCATION
 ..;S BZO44E=$$GET1^DIQ(100,BZO100,6)    ; HOSPITAL LOCATION
 ..I BZO44'="" S PSBWRD=(BZO44+9000000)  ;S PSBRB=BZO44E
 .I BZON["V" D
 ..;S BZO100=$P($G(^PS(53.79,DFN,"IV",(+BZON),0)),U,21)
 ..S BZO100=+$P($G(^PS(55,DFN,"IV",(+BZON),0)),U,21)
 ..S BZO44=$$GET1^DIQ(100,BZO100,6,"I")  ; HOSPITAL LOCATION
 ..;S BZO44E=$$GET1^DIQ(100,BZO100,6)    ; HOSPITAL LOCATION
 ..I BZO44'="" S PSBWRD=(BZO44+9000000)  ;S PSBRB=BZO44E
 .K BZO44,BZO100,BZON,BZO44E
 ; - END
 ; Set Variance Entry
