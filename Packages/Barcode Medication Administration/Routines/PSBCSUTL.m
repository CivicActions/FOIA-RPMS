PSBCSUTL ;BIRMINGHAM/TEJ- BCMA-HSC COVER SHEET UTILITIES ;27-Apr-2023 09:28
 ;;3.0;BAR CODE MED ADMIN;**16,13,38,32,50,1033**;Mar 2004;Build 34
 ...
 ; EN1^GMVDCEXT/4251
 ;
 ; Modified - IHS/MSC/PLS - 03/31/2023 - Line RPC+89
 ;          - IHS/MSC/MIR - 04/27/2023 - Lines RPC+79, RPC+95
 ;
RPC(RESULTS,DFN,EXPWIN) ;
 ...
 .I PSBLVIV D XFERBAGS^PSBCSUTY,LVIV^PSBCSUTY I $G(PSBEXPRD) S X1=$O(^TMP("PSB",$J,PSBTAB,""),-1) I X1>1 S:^TMP("PSB",$J,PSBTAB,X1)'="END" ^TMP("PSB",$J,PSBTAB,X1+1)="END" Q
 .D GETADMX^PSBCSUTY
 ...
 ..S PSBGLBX=$O(^TMP("PSB",$J,PSBTAB,""),-1) I PSBGLBX>1 S:^TMP("PSB",$J,PSBTAB,PSBGLBX)'="END" ^TMP("PSB",$J,PSBTAB,PSBGLBX+1)="END"
 .;cont - proces AdmnTm
