PSBML ;BIRMINGHAM/EFC-BCMA MED LOG FUNCTIONS ;29-Jun-2023 18:18;DU
 ;;3.0;BAR CODE MED ADMIN;**6,3,4,9,11,13,25,45,33,1034**;Mar 2004;Build 37
 ...
 ; ^XUSEC(/10076
 ;
 ; Modified - IHS/MSC/PLS - 06/29/2023 - Support for RXCUI
 ;
RPC(RESULTS,PSBHDR,PSBREC) ;BCMA MedLog Filing
 ...
 ...;Patch 1034
 ...D VAL(PSBDD,PSBIENS,9999999.01,$$GETRXCUI(PSBDD,+$P(PSBREC(PSBCNT),U,2)))
 ...
 Q
 ;Patch 1034
GETRXCUI(PSBDD,VAL) ;- Return RXCUI for related DRUG
 N RES
 S RES=""
 I PSBDD=53.795 D
 .S RES=$$GET1^DIQ(50,VAL,9999999.27)
 E  I PSBDD=53.796 D
 .S RES=$$GET1^DIQ(52.6,VAL,"1:9999999.27")
 E  I PSBDD=53.797 D
 .S RES=$$GET1^DIQ(52.7,VAL,"1:9999999.27")
 Q RES
BCBU ;HL7,NatContng
 Q:+$G(RESULTS(0))'>0
