PSBVDLTB ;BIRMINGHAM/EFC-BCMA VIRTUAL DUE LIST FUNCTIONS (CONT) ;03-Jan-2023 14:15;DU
 ;;3.0;BAR CODE MED ADMIN;**3,4,16,1033**;Mar 2004;Build 34
 ;
 ; Reference/IA
 ; EN^PSJBCMA/2828
 ; IN5^VADPT/10061
 ...
 ; $$GET^XPAR/2263
 ;
 ; Modified - IHS/MSC/PLS - 01/03/23 - Check for DISCHARGE
 ;
...
DISCHRGD(DFN) ; Patient Discharged OR Deceased?
 ...
 Q DISCHRGD  ;2019.6.3 JTC ? QUIT HERE TO REMOVE CHECK FOR DISCHARGED, ONLY RETAIN DEATH
