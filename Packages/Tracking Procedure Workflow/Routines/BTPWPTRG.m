BTPWPTRG ;VNGT/HS/ALA-Event Worksheet Trigger ; 24 Nov 2009  11:13 AM
 ;;1.2;CARE MANAGEMENT EVENT TRACKING;**4,6**;Jul 07, 2017;Build 14
 ;
 ;
...
QLNK(QRIEN,FLD) ; EP - Get links for a queued event
 ...
 . F I=1:1 Q:@DATA@(I)=$C(30)!(@DATA@(I)=$C(31))  S FULLR=FULLR_$$STRIP^XLFSTR(@DATA@(I),"^")
 ...
 I RCTP="V EXAM" D
 . S LINK=PRCDT_$C(28)_RCTP_$C(28)_"V:"_VISIT_$C(28)_$$GET1^DIQ(9000010.13,RIEN_",",.04,"E")
 . ;$P(LINK,$C(28),4)=$$GET1^DIQ(9000010.13,RIEN_",",.04,"E")
 Q LINK
 ;
