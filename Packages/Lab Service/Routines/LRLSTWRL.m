LRLSTWRL ;SLC/CJS/DALISC/DRH - BRIEF ACCESSION LIST PART 2 ;2/6/91  07:41 ; [ 04/14/2003  9:35 AM ]
...
INIT ;
 S CNT=0
 S LR("TIME")="$$DTF^LRAFUNC1($$NOW^LRAFUNC1)"
 Q
LOOP1 ;
...
L26 ;
 ...
 W $P(LRACC," ",1)," ",$P(LRACC," ",3),?11," ",$E(LRLLOC,1,4),?18," ",HRCN,?23," ",$E(PNM,1,15)  ;IHS/ANMC/CLS 08/18/96
...
END ;from LRLSTWRK
 ...
 ;----- BEGIN IHS MODIFICATIONS LR*5.2*1018
 K AGE,A,DFN,DIC,DOB,I,J,K,LRLAN,LRDFN,LRDPF,PNM,S2,S3,S4,SEX,SSN,HRCN,T5,X,Y,Z  ;IHS/ANMC/CLS 08/18/96
