LRLLP5 ;SLC/RWA/MILW - EXPANDED TRAY LIST PRINT ; 03/30/2022 ; MKK
 ;;5.2;LR;**116,1004,153,1018,1019,1051**;NOV 01, 1997;Build 19
 ;
 ; MSC/MKK - LR*5.2*1051 - 30-Mar-2022 - Item 83953 - SSN print issue
 ;
...
LP4 S LRACC=^LRO(68,LRAA,1,LRAD,1,LRAN,.2) W:$X=0 LRACC
 ...
 W ?20 W:LRDPF=2 $E(PNM,1,30),?50,HRCN W:LRDPF'=2 $E(PNM_" "_SSN(1),1,60) W ?64,LRACC W:LRV ?76,"Ver" W ?86,$E(LRDOC,1,20) S Y=LRCDT D ADD^LRX W ?110,Y D LEDI  ; MSC/MKK - LR*5.2*1051 - 30-Mar-2022 - Item 83953
...
SH Q:$G(LREXIT)
 ...
 W ?20 W:LRDPF=2 $E(PNM,1,30),?50,SSN(1) W:LRDPF'=2 $E(PNM_" "_SSN(1),1,60) W ?64,LRACC W:LRV ?76,"Ver" W ?86,$E(LRDOC,1,20) S Y=LRCDT D ADD^LRX W ?110,Y,!  ; MSC/MKK - LR*5.2*1051 - 30-Mar-2022 - Item 83953
 W:LRSHORT !,?18
 Q
