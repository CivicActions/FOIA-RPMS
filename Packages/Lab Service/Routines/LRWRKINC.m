LRWRKINC ;SLC/DCM/CJS-INCOMPLETE STATUS REPORT ; 26-Apr-2023 13:30 ; MKK
 ;;5.2;LAB SERVICE;**1004,1006,153,201,221,1018,1022,1054**;NOV 01, 1997;Build 20
 ;
...
EN ; EP
 ...
 . . S DIC("S")="I +$G(^(.3))=0"  ; IHS/MSC/MKK - LR*5.2*1054 - Do not select tests with INACTIVATION DATE set
 . . F  D  Q:+Y<1
 . . . N LRTEST,LRTSTS
 . . . D ^DIC Q:+Y<1
 . . . S ^TMP("LR",$J,"T",+Y)=Y(0)
...
TESTS Q:'$D(^LRO(68,LRAA,1,LRAD,1,LRAN,4,0))
 N LRI
 NEW LRDFN    ; IHS/MSC/MKK - LR*5.2*1054
 S LRI=0
