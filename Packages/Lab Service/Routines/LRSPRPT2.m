LRSPRPT2 ;AVAMC/REG/WTY - SURG PATH PRINT SNOMED ; 03/30/2022 ; MKK
 ;;5.2;LAB SERVICE;**72,1002,259,1030,1051**;NOV 01, 1997;Build 19
 ;;5.2;LAB SERVICE;**72,259**;Sep 27, 1994
 ;
 ; MSC/MKK - LR*5.2*1051 - 30-Mar-2022 - Item 83954 - SSN print issue
 ;
...
ACC ;
 ...
 S LRAN=X,X=^LR(LRDFN,0) D ^LRUP W !,LRP,"  ID: ",SSN(1)  ; IHS/MSC/MKK - LR*5.2*1051 - 30-Mar-2022 - Item 83954
