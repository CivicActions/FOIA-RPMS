LRVR ;DALOI/CJS/DALOI/FHS - LAB ROUTINE DATA VERIFICATION ; 06-Apr-2022 06:15 ; MKK
 ;;5.2;LAB SERVICE;**42,153,263,286,1027,1051**;NOV 01, 1997;Build 19
 ;
...
WLN ;
 ...
 . I '$G(LRNOP),LRIDT<1 W !,"NOTICE: NO POINTER TO FILE #63. ",LRASTR,! S LRNOP=1
 . I '$G(LRNOP),'$D(^LR(LRDFN,LRSS,LRIDT,0)) W !,"NOTICE: NO POINTER TO FILE #63. ",LRASTR,! S LRNOP=1
