LRORDST ;SLC/CJS/WTY - SET THE ORDER AND ACCESSION ; 29-Mar-2022 13:35 ;  MKK
 ;;5.2;LAB SERVICE;**1002,1003,1004,1009,100,107,121,1010,1011,1013,1015,153,202,1018,1019,290,291,359,362,1031,1032,1035,1041,1051**;NOV 1, 1997;Build 19
 ;
 ; MSC/MKK - LR*5.2*1051 - 29-Mar-2022 - Item 75423 - Fix ZSN+33^LBORDST Error
 ;
...
ZSN ; EP
 ...
 I +$G(BLRLOG),$L($G(BLROPT)),+$G(LRODT),+$G(LRSN) D ^BLREVTQ("C","O",$G(BLROPT),,LRODT_","_LRSN)     ; MSC/MKK - LR*5.2*1051 - Item 75423 - 29-Mar-2022
 ;
