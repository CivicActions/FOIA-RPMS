LR280 ;DALOI/JMC - LR*5.2*280 PATCH ENVIRONMENT CHECK ROUTINE ;11/27/2001
 ;;5.2;LAB SERVICE;**280**;Sep 27, 1994
...
EXIT ;
 ...
 ;
 ;
PRE ; KIDS Pre install for LR*5.2*280
 ;
 ...
 ;
 ;
POST ; KIDS Post install for LR*5.2*280
 N XQA,XQAMSG
 ;
