LR556 ;SLC/PBB - LR*5.2*556 PATCH ENVIRONMENT CHECK ROUTINE ;01/21/06
 ;;5.2;LAB SERVICE;**556**;NOV 01, 1997;Build 19
 ;;
...
POST ; KIDS Post install for LR*5.2*556
 ...
 D BMES^XPDUTL($$CJ^XLFSTR("*** Begin Adding MONKEYPOX LOINCS ***",80))
 D MONKYPOX^BLRPRE52
 D BMES^XPDUTL($$CJ^XLFSTR("*** End Adding MONKEYPOX LOINCS ***",80))
 ;
