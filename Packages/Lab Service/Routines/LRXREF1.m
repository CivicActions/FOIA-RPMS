LRXREF1 ; IHS/DIR/FJE - CONTINUE BUILD X-REF FOR RE-INDEX 12:41 ; [ 5/15/90 ]
 ;;5.2;LR;**1051**;NOV 01, 1997;Build 19
 ;
 ; MSC/MKK - LR*5.2*1051 - 05-Apr-2022 - Item 75895 - No Lab Data Error Fix
 ;
...
KILL ; I $D(^LAB(60,LRGTN,.2)) I $D(^LRO(68,"AC",+^LRO(68,DA(2),1,DA(1),1,DA,0),$P(^LRO(68,DA(2),1,DA(1),1,DA,3),U,5),+^LAB(60,LRGTN,.2))) K ^LRO(68,"AC",+^LRO(68,DA(2),1,DA(1),1,DA,0),$P(^LRO(68,DA(2),1,DA(1),1,DA,3),U,5),+^LAB(60,LRGTN,.2))
 I $D(^LAB(60,LRGTN,.2)) I $D(^LRO(68,"AC",+$G(^LRO(68,DA(2),1,DA(1),1,DA,0)),$P($G(^LRO(68,DA(2),1,DA(1),1,DA,3)),U,5),+^LAB(60,LRGTN,.2))) K ^LRO(68,"AC",+^LRO(68,DA(2),1,DA(1),1,DA,0),$P(^LRO(68,DA(2),1,DA(1),1,DA,3),U,5),+^LAB(60,LRGTN,.2))
 Q
