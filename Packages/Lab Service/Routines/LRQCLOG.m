LRQCLOG ; IHS/DIR/FJE - QUALITY CONTROL LOGGING ; 26-Apr-2023 12:30 ; MKK
 ;;5.2;LAB SERVICE;**9,89,1013,1054**;NOV 01, 1997;Build 20
 ;
...
TEST ; S DIC="^LAB(60,",DIC(0)="AEMOQ" D ^DIC G ASK:Y<1 S LRTEST=+Y
 S DIC="^LAB(60,",DIC(0)="AEMOQ",DIC("S")="I +$G(^(.3))=0" D ^DIC G ASK:Y<1 S LRTEST=+Y  ; IHS/MSC/MKK - LR*5.2*1054 - Do not select tests with INACTIVATION DATE set
