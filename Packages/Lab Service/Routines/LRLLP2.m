LRLLP2 ;IHS/OIT/MKK - TRAY LIST PRINT ; 03/29/2022 ; MKK
 ;;5.2;LR;**116,1004,153,1018,1019,1051**;NOV 01, 1997;Build 19
 ;
 ; MSC/MKK - LR*5.2*1051 - 29-Mar-2022 - Item 83952 - SSN print issue
 ;
...
LP4 S LRACC=^LRO(68,LRAA,1,LRAD,1,LRAN,.2) W:$X=0 LRACC
 ...
 W ?18,$E(PNM,1,17) W:LRDPF=2 ?36,HRCN W:LRDPF'=2 ?36,SSN(1),! W ?42,LRACC W:LRV ?52,"Ver" W ?63,$P($G(^LRO(68,LRAA,1,LRAD,1,LRAN,.3)),"^")  ; IHS/MSC/MKK - LR*5.2*1051 - 29-Mar-2022 - Item 83952
...
SH Q:$G(LREXIT)
 ...
 W ?18,$E(PNM,1,17),?36,SSN(1),! W ?42,LRACC W:LRV ?52,"Ver" W ?60," #:",LRODNUM S Y=9999999-LRIDT D ADD^LRX W !,?18,Y,?42,LRDOC D INF^LRX  ; IHS/MSC/MKK - LR*5.2*1051 - 29-Mar-2022 - Item 83952
 Q
