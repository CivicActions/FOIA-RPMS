LRLL ;SLC/RWF - LOAD LIST CONTROL ;2/19/91  10:41 ; [ 04/14/2003  9:10 AM ]
...
AS ;W !,"(C)ondensed or (E)xpanded list ? (req. 132 column format):C//" R LRFRMT:DTIME Q:'$T!(LRFRMT[U)  S LRFRMT=$E(LRFRMT) S:LRFRMT']"" LRFRMT="C" I LRFRMT'="C"&(LRFRMT'="E") W !,"Answer C or E" G AS
 ...
 W !,"(C)ondensed or (E)xpanded list ? (req. 132 column format):E//" R LRFRMT:DTIME Q:'$T!(LRFRMT[U)  S LRFRMT=$E(LRFRMT) S:LRFRMT']"" LRFRMT="E" I LRFRMT'="C"&(LRFRMT'="E") W !,"Answer C or E" G AS  ;IHS/ANMC/CLS 08/18/96
...
KILL K %,%DT,%H,%ZIS,A,AGE,AN,B,C,D,DA,DFN,DIB,DIC,DOB,E,G,G1,G2,G4,I,I1,J,J1,K,L,L1,L2,L3,LAST,LRAA,LRAAN,LRACC,LRAD,LRADD,LRALL,LRALTH,LRAN,LRCDT,LRCNT
 ...
 ;----- BEGIN IHS MODIFICATIONS LR*5.2*1018
 K LRWDTL,LRWPROF,LRWRD,LRXPD,PNM,POP,S,S1,S2,SEX,SSN,HRCN,T,T1,W,X,X9,Z  ;IHS/ANMC/CLS 08/18/96
 ;----- END IHS MODIFICATIONS
 Q
LOAD ;
