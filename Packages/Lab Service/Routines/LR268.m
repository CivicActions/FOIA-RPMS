LR268 ;DALOI/JMC - LR*5.2*268 PATCH ENVIRONMENT CHECK ROUTINE ;11/22/2000
 ;;5.2;LAB SERVICE;**268**;Sep 27, 1994
...
EXIT ;
 ...
 ;
 ;
PRE ; KIDS Pre install for LR*5.2*268
 ;
 ...
 ;
 ;
POST ; KIDS Post install for LR*5.2*268
 N XQA,XQAMSG
 ;
