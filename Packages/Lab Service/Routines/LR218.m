LR218 ;DALOI/JMC - LR*5.2*218 PATCH ENVIRONMENT CHECK ROUTINE ;8/21/98
...
EXIT ;
 ...
 Q
 ;
PRE ; KIDS Pre install for LR*5.2*218
 N XQA,XQAMSG
 ...
 Q
 ;
POST ; KIDS Post install for LR*5.2*218
 N XQA,XQAMSG
 ;
 ...
 D SETUP^XQALERT
 ;
 S XQAMSG="Lab LIM - perform patch LR*5.2*218 post-installation instructions"
 S XQA("G.LMI")=""
 D SETUP^XQALERT
 ;
 Q
