LRSORA ;VA/DRH/DALISC - HIGH/LOW VALUE REPORT ; 26-Apr-2023 12:50 ; MKK
 ;;5.2;LAB SERVICE;**344,357,369,1030,1054**;NOV 01, 1997;Build 20
 ;
...
TST ;
 ...
 S DIC("S")="I $P(^(0),U,5)[""CH"",""BO""[$P(^(0),U,3),+$G(^(.3))=0"  D ^DIC
 S LRA=$S(Y>0:2,1:0)
 S:X["^" LREND=1
