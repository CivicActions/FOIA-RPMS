...
REPORT ; dequeued
 ...
 D ONE^LRTT5P1
 S LRPNOW=$$NOW^LRAFUNC1,LRPTBF=$$DTF^LRAFUNC1(LRPSDT),LRPTEF=$$DTF^LRAFUNC1(LRPEDT)
...
DHDR ; from LRTT5R*
 ...
 Q
HDR Q:$G(LREND)
 F LRPLN=$G(LRPVAMC),"LEDI Management Report - "_LRPTITLE,"From "_LRPTBF_" To "_LRPTEF,"Date Printed: "_$$DTF^LRAFUNC1($$NOW^LRAFUNC1) W !?(IOM-$L(LRPLN)\2),LRPLN
