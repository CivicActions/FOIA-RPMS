LR408 ;hoifo/rlm-Disable VistA Blood Bank options ;Nov 21, 2002
 ;;5.2;LAB SERVICE;**408**;Sep 27, 1994;Build 11
 ;
 ;Medical Device #:
...
MSG ;Send a message showing success.
 D POSTPOST   ; IHS Post Install Code
 ;
 K ^TMP("VBEC",$J)
...
ZEOR ;LR408
 Q
 ;
POSTPOST ; EP - IHS POST INSTALL Code
 D DELBBMNU
 D DELOOBBO
 D ADDOPTS
 Q
...
DELBBMNU ; EP - DELete Blood Bank MeNU option from main LRMENU
 NEW CHEKIT
 ;
 S CHEKIT=$$DELETE^XPDMENU("LRMENU","LRBL")   ; Remove Blood Bank option from main LRMENU
 Q
 ;
...
ADDOPTS ; EP - Add Blood Bank option to BLRMENU
 NEW CHEKIT
 ;
 S CHEKIT=$$ADD^XPDMENU("BLRMENU","LRBL","BB")
 Q
 ;
