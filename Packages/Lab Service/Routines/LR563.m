LR563 ;VA/SLC/PBB - LR*5.2*563 PATCH ENVIRONMENT CHECK ROUTINE ;01/21/06
 ;;5.2;LAB SERVICE;**563**;Nov 01, 1997;Build 10
 ;;5.2;LAB SERVICE;**563**;Sep 27, 1994;Build 3
 ;;
EN ; Does not prevent loading of the transport global.
 ...
 Q
 ;
PRE ; KIDS Pre install for LR*5.2*563
 ;
 N XQA,XQAMSG
 ;K ^XTEMP($J,"LR563") ;Keep field 80 identifier
 ...
 Q
 ;
POST ; KIDS Post install for LR*5.2*563
 ;
 N XQA,XQAMSG
...
NLT1 ;
 ...
 S ^DD(95.3099,.01,9)="^"
 S ^DD(95.3,0,"VRRV")=2.74 ;LAB LOINC
 S ^DD(95.31,0,"VRRV")=2.74 ;LAB LOINC COMPONENT
 S ^DD(64,0,"VRRV")=2.74 ;WKLD CODE
 S ^DD(64.061,0,"VRRV")=2.74 ;LAB ELECTRONIC CODES 
 S ^DD(64.2,0,"VRRV")=2.74 ;WKLD SUFFIX CODES
 S ^DD(64.21,0,"VRRV")=2.74 ;WKLD CODE LAB SECT
 ;S ^DD(64.22,0,"VRRV")=2.74
 ;S ^DD(64.3,0,"VRRV")=2.74
 ;S Y=$$NOW^XLFDT\1 D DD^%DT S Y="2.52 ;;5.2;LAB SERVICE;**563**;"_Y_";Build 01"
 ;S Y="5.2;LAB SERVICE;**563**;MAY 05, 2016;Build 1"
 S Y="2.74;;5.2;LAB SERVICE;**563**;Sep 27, 1994"
 S ^LAB(95.3,"VR")=Y
 S ^LAB(95.31,"VR")=Y
 S ^LAM("VR")=Y
 S ^LAB(64.061,"VR")=Y
...
REINDEX ;Reindex LAM to fire new x-refs
 ...
 . S $P(^LAM(0),U,3)=99999
 K ^XTMP("LRNLTERR","LR563") S ^XTMP("LRNLTERR",0)=$$HTFM^XLFDT($H+90,1)_"^"_DT_"^LR52 563 Error Messages"
 K ^XTMP("LRNLT","LR563")
 S ^XTMP("LRNLT",0)=$$HTFM^XLFDT($H+90,1)_"^"_DT_"^LR52 563 Messages"
...
POST1 ;TRANSPORT FILE 64.81 INTO FILE 64 IF REQUIRED
 N LRREC,LRREC9
 K ^XTMP("LRNLT","LR563 ") D
 . S ^XTMP("LRNLT",0)=$$HTFM^XLFDT($H+90,1)_U_DT_U_"LR563  Added NLT Codes List"
 . S ^XTMP("LRNLT","LR563 ",0)=""
 ;D DSS W !
P1 F  L +^LAM:10 Q:$T  D BMES^XPDUTL("Attempting to Lock ^LAM Global.")
 ...
 S $P(^LAM(0),U,3)=99999
 D:'$G(LRDBUG)
 .S $ZE="LR563 : Application Error! please disregard " D ^%ZTER ;MAIL^LR563POA
...
SCR(LRMSG) ;Store message in ^XTMP("LRNLT" Global
 S LRSCR=$G(^XTMP("LRNLT","LR563 ",1,0))+1,^(0)=LRSCR
 S ^XTMP("LRNLT","LR563 ",1,LRSCR)=LRSCR_"|"_LRMSG
 Q
