...
MED ; Check the medication taxonomies
 ...
 K ^TMP("BKMARRAY",$J)
 D BLDTAX^BKMIXX5("BKMV FI MED NDCS","^TMP(""BKMARRAY"",$J)")
 S MED="" F  S MED=$O(^TMP("BKMARRAY",$J,MED)) Q:MED=""  D FMED("BKMV FI MED NDCS")
 K ^TMP("BKMARRAY",$J)
 D BLDTAX^BKMIXX5("BKMV FI MEDS","^TMP(""BKMARRAY"",$J)")
 S MED="" F  S MED=$O(^TMP("BKMARRAY",$J,MED)) Q:MED=""  D FMED("BKMV FI MEDS")
 K ^TMP("BKMARRAY",$J)
 ;
