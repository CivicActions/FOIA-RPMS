BKMVF33 ;PRXM/HC/ALA-HMS Reminders ; 05 Mar 2007  4:07 PM
 ;;1.0;HIV MANAGEMENT SYSTEM;**2**;Sep 29, 2006
 ;
ED01 ;EP - REM.ED.01
...
EX01 ;EP - REM.P.01
 ...
 . D LABTAX^BKMIXX(DFN,"BKM CD4 ABS TESTS TAX","",SINCE,GLOBAL)
...
TST01 ;EP - REM.T.01
 ...
 D LABCODES^BKMVF32(DFN,"BKM CD4 ABS TESTS TAX","BKMV CD4 ABS LOINC CODES","BKMV CD4 ABS CPTS","","",.LAST1)
 S LAST=$S(LAST>LAST1:LAST,1:LAST1)
