AMER ; IHS/ANMC/GIS - PRIMARY ROUTINE FOR ER ADMISSION ;
 ;;3.0;ER VISIT SYSTEM;**4,5,6,13,15,16**;MAR 03, 2009;Build 14
 ;
...
VAR D EXIT1 S AMERSTRT=1,AMERFIN=39  ;,AMERFIN=19
...
RUN F AMERRUN=AMERSTRT:1 Q:AMERRUN>AMERFIN  Q:$D(AMERQUIT)  D
 ...
 . D @("QA"_AMERRUN_"^AMER"_$S(AMERRUN<6:"1",AMERRUN<10:"1B",AMERRUN<30:"1",AMERRUN<40:"1B",1:"1"))
 . D SET
 . ;
 ...
 .. I $G(AMERDFN)]"" D LOG^AMERBUSA("P","E","AMER","AMER: Viewed/Updated Patient ER visit information - "_AFIELD_" ("_AMERDFN_")",AMERDFN)
 . Q
 ;
 ...
 ;
 ;GDIT/HS/BEE;FEATURE#110347;AMER*3.0*16;Save trauma provider to V PROVIDER
 D TRAUMA(AMERDFN)
 ;
 ;AMER*3.0*4
...
MAND ; ENTRY POINT FROM AMERD ; MANDATORY ANSWER
 W *7,!,"This answer is mandatory. If you need help, type '??'." H 2
...
TRG ; ENTRY POINT FOR EDITING TRIAGE NURSE'S FIELDS
 ...
 ;GDIT/HS/BEE;FEATURE#110347;AMER*3.0*16;TRAUMA REGISTRY
 ;S AMERSTRT=1,AMERFIN=27,AMERQSEQ=""
 S AMERSTRT=1,AMERFIN=39,AMERQSEQ=""
 S AMERTRG=1
 D EDIT^AMERD
 K AMERTRG,AMERLINE
 Q
...
R1 ;
 ...
 ;
 ;GDIT/HS/BEE;FEATURE#110347;AMER*3.0*16;Save trauma provider to V PROVIDER
TRAUMA(AMERDFN) ;Save trauma provider to V PROVIDER
 ;
 I +$G(AMERDFN)=0 Q
 ;
 NEW TRAUMABY,TRAUMADT,AMERPCC,D
 ;
 S AMERPCC=$$GET1^DIQ(9009081,AMERDFN_",",1.1,"I") Q:AMERPCC=""
 ;
 ;Get trauma provider - quit if none
 S TRAUMABY=$$GET1^DIQ(9009081,AMERDFN_",",2.6,"I") Q:'TRAUMABY
 ;
 ;Get the trauma provider time
 S TRAUMADT=$$GET1^DIQ(9009081,AMERDFN_",",2.7,"I")
 ;
 ;Save to V PROVIDER
 D TRAUMA^AMERPRV(AMERPCC,AMERDFN,TRAUMABY,TRAUMADT)
 ;
 Q
 ;
IVAR NEW AMERSVER,AMERTFLG,AMERVER,APCHSPAT,APCHSTYP,IOP
 Q
