AMER3P11 ;GDIT/HS/BEE - AMER v3.0 Patch 11 ENV Check/PST Check ; 07 Oct 2013  11:33 AM
 ;;3.0;ER VISIT SYSTEM;**11**;MAR 03, 2009;Build 27
 ;
 ;Check for AMER*3.0*10
 I '$$INSTALLD("AMER*3.0*10") D FIX(2)
 ;
 Q
 ;
INSTALLD(AMERSTAL) ;EP - Determine if patch AMERSTAL was installed, where
 ; AMERSTAL is the name of the INSTALL.  E.g "AMER*3.0*10"
 ;
 NEW AMERY,INST
 ;
