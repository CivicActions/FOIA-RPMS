AMER2 ; IHS/ANMC/GIS - ER DISCHARGE DATA COLLECTION ;   
 ;;3.0;ER VISIT SYSTEM;**1,2,6,12,13**;MAR 03, 2009;Build 36
 ;
QD1 ; NAME
...
QD2 ; INJURY
 ...
 ;GDIT/HS/BEE 07/08/2021;Do not delete 51:53 - now in use
 ;F I=32:1:35,41:1:46,51:1:57,61:1:64,70 K ^TMP("AMER",$J,2,I) ; KILL OFF ALL DESCENDENTS
 F I=32:1:35,41:1:46,54:1:57,61:1:64,70 K ^TMP("AMER",$J,2,I) ; KILL OFF ALL DESCENDENTS
 S AMERRUN=4
 Q
 ;
QD5 ; WORK RELATED
