AMER3P15 ;GDIT/HS/BEE - AMER v3.0 Patch 15 ENV Check/PRE/POST ; 07 Oct 2013  11:33 AM
 ;;3.0;ER VISIT SYSTEM;**15**;MAR 03, 2009;Build 5
 ;
...
INSTALLD(AMERSTAL) ;EP - Determine if patch AMERSTAL was installed, where
 ; AMERSTAL is the name of the INSTALL.  E.g "AMER*3.0*14"
 ;
 NEW AMERY,INST
 ;
...
FIX(X) ;
 ...
 I X=3 S XPDQUIT=2 Q
 S XPDQUIT=X
 W *7,!,$$CJ^XLFSTR("This patch must be installed prior to the installation of AMER*3.0*15",IOM)
 Q
