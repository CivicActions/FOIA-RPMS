AMER3P16 ;GDIT/HS/BEE - AMER v3.0 Patch 16 ENV Check ; 07 Oct 2013  11:33 AM
 ;;3.0;ER VISIT SYSTEM;**15,16**;MAR 03, 2009;Build 14
 ;
 ...
 ; 
 ;Check for AMER*3.0*14
 I '$$INSTALLD("AMER*3.0*15") D FIX(2)
 ;
 Q
 ;
INSTALLD(AMERSTAL) ;EP - Determine if patch AMERSTAL was installed, where
 ; AMERSTAL is the name of the INSTALL.  E.g "AMER*3.0*15"
 ;
 NEW AMERY,INST
 ;
...
FIX(X) ;
 ...
 I X=3 S XPDQUIT=2 Q
 S XPDQUIT=X
 W *7,!,$$CJ^XLFSTR("This patch must be installed prior to the installation of AMER*3.0*16",IOM)
 Q
