AMER4 ; IHS/ANMC/GIS - ER VISIT SUMMARY ; 
 ;;3.0;ER VISIT SYSTEM;**6,7,14,16**;MAR 03, 2009;Build 14
 ;
EDIT ; NEED TO REEDIT??
 I $D(IOF) W @IOF
 K AMEREFLG
...
OT(V,T) ;ENTRY POINT FROM AMER5
 ...
 I T=4 S Y=$$PPN^AMERUTIL(+V,0) Q Y
...
ADM1 ;S AMERFIN=14 D EDIT^AMER
 S AMERFIN=39 D EDIT^AMER
 I AMERQSEQ'[2 Q
 S AMERXSEQ=AMERQSEQ
 S AMERSTRT=20,AMERFIN=26 K AMERTFLG D EDIT^AMERD
 I '$D(AMERTFLG) Q
 S AMERQSEQ=AMERXSEQ
...
DX(AMERDFN) ;Set up DX information for display
 ...
 Q VAL
 ;
VAR NEW %Y,AMERDEST,AMERFIN,AMERQSEQ,AMERQUIT,AMERSTRT,AMERTRG,DFN,I1
 Q
