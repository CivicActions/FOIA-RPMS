AMER3P14 ;GDIT/HS/BEE - AMER v3.0 Patch 14 ENV Check/PRE/POST ; 07 Oct 2013  11:33 AM
 ;;3.0;ER VISIT SYSTEM;**14**;MAR 03, 2009;Build 4
 ;
...
FIX(X) ;
 ...
 I X=3 S XPDQUIT=2 Q
 S XPDQUIT=X
 W *7,!,$$CJ^XLFSTR("This patch must be installed prior to the installation of AMER*3.0*14",IOM)
 Q
