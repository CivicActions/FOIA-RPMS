ACHSACO1 ; IHS/ITSC/TPF/PMF - AREA CONSOLIDATION (2/3) ;
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**13,23,30**;JUN 11,2001;Build 39
 ;ACHS*3.1*13 6.14.2007 IHS/OIT/FCJ ADDED UFMS REC TO REC SUB, REC COUNTER AND TOT
 ;ACHS*3.1*30 4.29.22 IHS.OIT.FCJ ADDED NEW RECORD LENGTH FOR UEI
 ;ACHS*3.1*32 12.13.24 IHS.OIT.FCJ CHANGED STAT RECORD VERSION
 ;
...
T7 ; Statistical records.
 ...
 ;I ACHSSTV="CRV003" D
 ;ACHS*3.1*32 ADDED TEST FOR NEW STAT RECORD.
 I ACHSSTV="CRV004" D
...
TU ; UFMS Record ;ACHS*3.1*13 IHS/OIT/FCJ ADDED FOR PROCESSING UFMS RECORD
 ...
 ;S ^ACHSUFMS(ACHSCTUF)=$E(ACHSX2,2,161)     ;ACHS*3.1*30 UEI CHANGE
 S ^ACHSUFMS(ACHSCTUF)=$E(ACHSX2,2,177)      ;ACHS*3.1*30 UEI CHANGE
