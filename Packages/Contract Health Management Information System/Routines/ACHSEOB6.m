ACHSEOB6 ; IHS/ITSC/PMF - PROCESS EOBRS (7/7) SUMMARY/ERROR REPORT ;
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**13,18,22,23,28**;JUN 11,2001;Build 39
 ;ACHS*3.1*13 JVK/SET/ITSC 8/22/05 FIX CLOSING SLAVE DEV
 ;ACHS*3.1*28 03.18.2020 IHS.OIT.FCJ FIXED FIRST LINE NOT PRINTING ERROR CODE ON EOBR
 ;
...
P0 ;
 S ACHS="",ACHSER1=0
 I ACHSCTR(1)=1 S ACHSCTR(1)="",ACHSCTR(1)=$O(^ACHSEOBR("P",$E(ACHSEOBR("A",12),2,12),ACHSCTR(1)))  ;ACHS*3.1*28 ERROR NOT PRINTING IF ON FIRST PO
...
COST ;
 ...
 ;ACHS*3.1*32 ADD INTEREST TO PRINT
 I $G(ACHSEOBR("I",12))!$G(ACHSEOBR("I",13)) D
 .S ACHSIPA=0
 .S ACHSIPA=ACHSEOBR("I",12)+ACHSEOBR("I",13)
 .S ACHSCOST=$E(ACHSIPA,1,$L(ACHSIPA)-2)_"."_$E(ACHSIPA,$L(ACHSIPA)-1,$L(ACHSIPA))
 .W !,?70,$J(ACHSCOST,8)
 .S ACHSSUM=ACHSSUM+ACHSCOST
