ACHSGAO ; IHS/OIT/FCJ -version 2-GAO REPORT-DENIAL AND DEF LIST BY ISSUE DATE ; 30 Jul 2010  10:39 AM
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**18,19,23,32**;JUNE 11, 2001;Build 39
 ; ACHS*3.1*23 9.19.13 IHS.OIT.FCJ
...
LP1 ; DENIALS
 ...
 ..;S ACHSPRI=$P($G(^ACHSMPRI($P($G(^ACHSDEN(ACHSFAC,"D",DA,400)),U,2),0)),U)    ;ACHS*3.1*32
 ..S ACHSPRI=$P($G(^ACHSMPR($P($G(^ACHSDEN(ACHSFAC,"D",DA,400)),U,2),0)),U)      ;ACHS*3.1*32
 ...
 ..;DECISION-TEST $P(ACHS(0),U,8)="R" DEFAULT DENIED IF SET THEN REVERSED  ;ACHS*3.1*32 MIS-SPELL
 ..S ACHSDEC=$S($P(ACHS(0),U,8):"REVERSED",1:"DENIED")  ;ACHS*3.1*32 MIS-SPELL
