ACHSDNL1 ; IHS/ITSC/PMF - DENIAL LTR/FS (DRIVER) (2/6) ;  [ 10/31/2003  11:44 AM ]
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**4,6,30**;JUNE 11, 2001;Build 39
...
START ;ENTRY POINT - TaskMan.  PRINT LETTERS AND FACT SHEETS.
 ...
 I ACHDLTYP=3 S ACHSA=0 G ESIG  ;ACHS*3.1*30        
 G:'ACHDBDT S3
S1 ;
...
S2 ;
 ...
 G S2:$$DN^ACHS(0,8)="Y"
 G S2:$E($$DN^ACHS(0,1))="#"
 I ACHDLTYP=2 G S2:$$DN^ACHS(0,11)?1N.N    ;TEST FOR SIGNED DOC ;ACHS*3.1*30
 I ACHDLTYP=4 G S2:$$DN^ACHS(0,11)'?1N.N   ;TEST FOR SIGNED DOC ;ACHS*3.1*30
 ;
S3 ;
 S ACHDONE=""
...
PRNTFACT ;
 ...
 I ACHDLTYP=3 S ACHDCPAT=ACHD("CPAT") G ESIG  ;ACHS*3.1*30
...
END ;
 ...
 Q
 ;
ESIG ;PRINT DENIALS FROM QUE INDX ;ACHS*3.1*30
 I '$D(^ACHSDEN("AP",DUZ(2),"QP")) G END
 S ACHSA=$O(^ACHSDEN("AP",DUZ(2),"QP",ACHSA)) G END:'ACHSA!($G(ACHSQUIT))
 G ESIG:'$$DN^ACHS(0,11)
 G ESIG:$$DN^ACHS(0,8)="Y"
 G ESIG:$$DN^ACHS(0,8)="R"
 G ESIG:$E($$DN^ACHS(0,1))="#"
 G S3
 Q
 ;
