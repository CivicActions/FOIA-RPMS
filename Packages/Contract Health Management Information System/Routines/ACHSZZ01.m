ACHSZZ01 ; IHS/DIR/DJM -- RETRANSMIT BY TRANS CODE AND DATE ; [ 10/22/1999  2:00 PM ]
 ;;3.0;CONTRACT HEALTH MGMT SYSTEM;**12**;OCT 22, 1999
 ;;ACHS*3*12 NEW ROUTINE THIS PATCH
 ;
 D INIT
 S IEN=0
 F  S IEN=$O(^ACHS(2,IEN)) Q:'IEN  D  ; LOOP THROUGH CANS
 . S D=^ACHS(2,IEN,0) ; THE WHOLE THING
