ACHSCHF1 ; IHS/ITSC/TPF/PMF - PRINT C H E F REIMBURSEMENT REQUEST ;   
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**15,16,23,32**;JUN 11, 2001;Build 39
...
START ;EP - From TaskMan.
 ...
 . S CT=CT+1   ;ACHS*3.1*32
 . S ACHSDIEN=$O(^ACHSF(DUZ(2),"D","B",1_$E(ACHSPO)_$P(ACHSPO,"-",3),0))
 . S:CT=1 ACHSMPRI=$$DOC^ACHS(3,6),ACHSMPRI=$$VAL^XBDIQ1(9002073.4,ACHSMPRI,.01)  ;ACHS*3.1*32
 .;S ACHSMPRI=ACHSMPRI_","_$$DOC^ACHS(3,6)   ;ACHS*3.1*32  
...
HDR ; Write header of CHEF sheet.
 ...
 ;W !,"|",$E(ACHSDRG,2,23),?25,"|",?39,"|",?54,"|",?64,$P(ACHSMPRI,",",2),?78,"|"  ;ACHS*3.1*32
 W !,"|",$E(ACHSDRG,2,23),?25,"|",?39,"|",?54,"|",?64,ACHSMPRI,?78,"|"  ;ACHS*3.1*32
 D LN
 ;
 D RTRN^ACHS
 Q:$G(ACHSQUIT)
