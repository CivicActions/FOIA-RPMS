ACHSSIG0 ;ITSC/JVK/SET - ADD EDIT CHS AUTHORIZED E-SIG USERS  [ 11/26/2003  11:16 AM ]
 ;;3.1;CONTRACT HEALTH MANAGEMENT SYSTEM;**7,30**;JUNE 11,2001;Build 39
 ;ACHS*3.1*7- NEW ROUTINE TO ADD EDIT E-SIG USERS
 ;ACHS*3.1*30 5.6.2022 IHS.OIT.FCJ ADD E-SIG DENIAL PARAMETER
 ;
USRS ;EP
 D LOC
