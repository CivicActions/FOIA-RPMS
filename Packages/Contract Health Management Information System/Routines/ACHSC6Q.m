ACHSC6Q ; IHS/ADC/GTH - QUE CHS EXPENDITURE REPORT ; [ 05/19/1999  4:17 PM ]
 ;;3.0;CONTRACT HEALTH MGMT SYSTEM;**9**;SEP 17, 1997
 ;
 ;;ACHS*3*9;CS;MODIFIED TO HAVE CONSISTANT DISPLAY OF DATES
 ;
...
DEV ; Select device.
 ...
 ;S ZTRTN=$S(ACHSRPT=3:"^ACHSC6D",1:"^ACHSC6C"),ZTIO="",ZTDESC="CHS EXPENDITURE REPORT #"_ACHSRPT_", "_$$FMTE^XLFDT(ACHSBDT)_" to "_$E(ACHSEDT,2,7),ACHSQIO=ION_";"_IOST_";"_IOM_";"_IOSL
 S ZTRTN=$S(ACHSRPT=3:"^ACHSC6D",1:"^ACHSC6C"),ZTIO="",ZTDESC="CHS EXPENDITURE REPORT #"_ACHSRPT_", "_$$FMTE^XLFDT(ACHSBDT)_" to "_$$FMTE^XLFDT(ACHSEDT),ACHSQIO=ION_";"_IOST_";"_IOM_";"_IOSL ;ACHS*3*9
