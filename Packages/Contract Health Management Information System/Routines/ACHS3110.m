ACHS3110 ;IHS/ITSC/FCJ - ACHS 3.1 PATCH 11 ;  [ 09/20/2004  11:18 AM ]
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**11**;JUNE 11, 2001
 ; 3.1*10 7/1/2004;IHS/ITSC/FCJ;ORIGINAL RTN FR P10 
 ;
 I '$G(IOM) D HOME^%ZIS
 ...
 ;
 D HELP^XBHELP("INTROE","ACHS3110")
 I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2) Q
 ;
 I $G(XPDENV)=1 S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0 D HELP^XBHELP("INTROI","ACHS3110") I '$$DIR^XBDIR("E","","","","","",1) D SORRY(2)
 ;
 Q
 ;
SORRY(X) ;
...
INTROE ; Intro text during KIDS Environment check.
 ...
 ;;(1) Routines: ACHSDN, ACHSDN1, ACHSDN2 and ACHSBMC
 ;;    modified to allow selection of referrals when entering a denial,
 ;;    default fields for denials and PO's if data already exists in
 ;;    referral. Closes referral once denial has been completed.
 ;;(2) Data Dictionary:
 ;;    modified to fix allowing selection of inactive Denial reasons.
 ;;###
 ;
