...
INTRM ;EP - Sets interim payment nodes.
 ...
 ;S ACHSTIP=$P($G(^ACHSF(DUZ(2),"D",ACHSDIEN,"IP")),U)+ACHSPAMT  ;ACHS*3.1*32
 S ACHSTIP=$P($G(^ACHSF(DUZ(2),"D",ACHSDIEN,"IP")),U)+ACHSPAMT+$G(ACHSIPI)   ;ACHS*3.1*32 ADD INTEREST AMOUNT
 ...
 ;S $P(ACHSTOT(ACHSY,"INTERIM PAYMENTS"),U)=$P(ACHSTOT(ACHSY,"INTERIM PAYMENTS"),U)+ACHSPAMT              ;ACHS*3.1*32
 S $P(ACHSTOT(ACHSY,"INTERIM PAYMENTS"),U)=$P(ACHSTOT(ACHSY,"INTERIM PAYMENTS"),U)+ACHSPAMT+$G(ACHS(26))  ;ACHS*3.1*32 ADD INTEREST AMOUNT
