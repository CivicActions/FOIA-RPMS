ACHSODP1 ; IHS/ITSC/PMF - PRINT DCR REPORT (2/3) ;  [ 10/16/2001   8:16 AM ]
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**31**;JUN 11, 2001;Build 39
 ;ACHS*3.1*31 6.22.23 IHS.OIT.FCJ DOC SUM REPORT ADDS INTERIUM PAYMENT TO TOTALS
 ;
...
A1 ;
 ...
 ;S X=$P($G(^ACHSF(DUZ(2),"D",ACHSDIEN,0)),U,17),$P(L(2),U,4)=$S(X="I":"IHS",1:"FI") I T="IP" S $P(L(2),U,4)=$P(L(2),U,4)_"  NOT IN TOTALS"    ;ACHS*3.1*31
 S X=$P($G(^ACHSF(DUZ(2),"D",ACHSDIEN,0)),U,17),$P(L(2),U,4)=$S(X="I":"IHS",1:"FI") I T="IP",'$G(ACHSPSR) S $P(L(2),U,4)=$P(L(2),U,4)_"  NOT IN TOTALS"   ;ACHS*3.1*31
