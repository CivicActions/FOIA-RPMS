ACHSPAM ; IHS/ITSC/PMF - DOCUMENT PAYMENT - ENTER/EDIT MEDICAL DATA ; JUL 10, 2008
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**5,7,14,17,23,29,32**;JUN 11,2001;Build 39
 ...
 ;ACHS*3.1*29 7/1/2021 IHS.OIT.FCJ ADDED DA(1) VAR ON LOOKUP
...
REF ;EP - From option. Enter/Edit Referral medical data.
 ...
 ;ACHS*3.1*29 7/1/2021 IHS.OIT.FCJ ADDED DA(1) TO NXT LINE
 S DIE="^ACHSF("_DUZ(2)_",""D"",",DA(1)=DUZ(2),DA=ACHSDIEN,DR="80:83;84:87"
 D ^DIE
 W !
