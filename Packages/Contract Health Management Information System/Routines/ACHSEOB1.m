ACHSEOB1 ; IHS/ITSC/TPF/PMF - PROCESS EOBRS (2/6) - READ IN, PROCESS ; 15 Feb 2016  5:00 PM
 ...
 ;ACHS*3.1*32 10.9.24 IHS.OIT.FCJ MOD RESPONSE OF INVALID FILE
 ;
 K ^TMP("ACHSEOB",$J)
 D NOW^ACHS
...
MAIN ;
 ...
 U IO(0)
 ;I ACHSEOBR="" S ACHSTERR=1 W !,"Unexpected End Of File!  This file is incomplete." G TERR  ;ACHS*3.1*32
 I ACHSEOBR="" S ACHSTERR=1 W !,"EOBR file not processed; please follow up with local IT support." G TERR  ;ACHS*3.1*32
