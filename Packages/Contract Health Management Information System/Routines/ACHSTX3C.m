ACHSTX3C ; IHS/ITSC/PMF - EXPORT DATA (4A/9) - RECORD 3(PATIENT FOR AO/FI) ;
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**13,18,22,27,28**;JUN 11, 2001;Build 86
 ;ACHS*3.1*13 11/27/06 IHS/OIT/FCJ PRT POL & COV TYPE FR CORRECT FILE
 ;ACHS*3.1*22 9/9/13 IHS.OIT.FCJ FIXED CENTURY DATE
 ;ACHS*3.1*28 12.2.19 IHS.OIT.FCJ ADDED BCBS GLOBAL AND CHECKED FOR "/" IN INS NAME
 ;
MCR ;
...
MCR1 ;
 ...
 S:'$D(ACHS3CFL) ACHSRCT=ACHSRCT+1,(^ACHSBCBS(ACHSRCT),^ACHSDATA(ACHSRCT))=ACHS3C,ACHSRTYP(3)=ACHSRTYP(3)+1    ;ACHS*3.1*28 ADDED ACHSBCBS
 ;
...
INIT3C ;
 ...
 S ACHS3C=$TR(ACHS3C,"/\","  ")    ;ACHS*3.1*28
 Q
 ;
SET3C(B,E,V) ;
