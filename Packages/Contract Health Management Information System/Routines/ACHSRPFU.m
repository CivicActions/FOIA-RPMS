ACHSRPFU ; IHS/OIT/FCJ - PRINT CHS FORM AND DATA 3 OF 3;JUL 10, 2008 ; 30 Jun 2011  10:10 AM
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**18,19,20,28**;JUN 11,2001;Build 86
 ;ACHS*3.1*18 4.29.2010 IHS.OIT.FCJ NEW ROUTINE
 ;SET VARIABLES IN TMP("ACHSPO",$J,ACHSDIEN,ACHSTIEN
 ;CALLED BY ACHSRPF1
 ;ACHS*3.1*28 03/09/2020 IHS.OIT.FCJ PRT REF#
 ;
INS ;
...
DIAG ;
 ...
 ;S ^TMP("ACHSPO",$J,ACHSDIEN,ACHSTIEN,2)=$G(R("D",1))_U_$G(R("D",2))_U_$G(R("D",3))  ;ACHS*3.1*28
 S ^TMP("ACHSPO",$J,ACHSDIEN,ACHSTIEN,2)=$G(R("D",1))_U_$G(R("D",2))_U_$G(R("N",1))   ;ACHS*3.1*28 CHANGE TO PRINT REF#
PROC ;
