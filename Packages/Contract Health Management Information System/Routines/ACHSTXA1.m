ACHSTXA1 ; IHS/ITSC/PMF - EXPORT DATA - RECORD 2(DHR), SPECIFIC RE-EXPORTS ;  [ 11/26/2003  8:04 AM ]
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**7,14,16,32**;JUNE 11,2001;Build 39
 ...
 ;ACHS*3.1*32 11.14.2024 TEST FOR TRIBAL FI EXPORT
 ;
 D LINES^ACHSFU
...
S5 ;
 ...
 ;I ACHSF638="Y",$$PARM^ACHS(2,9)="Y" G S7  ;ACHS*3.1*32
 I ACHSF638="Y",$$PARM^ACHS(2,9)="Y",$$PARM^ACHS(2,11)'="Y" G S7   ;ACHS*3.1*32 TEST FOR TRIBAL FI EXPORT
...
S7 ;
 ...
 ;ACHS*3.1*32 COMMENTED OUT NXT 4 LINES AND ADDED 1 TEST FOR TRIBAL FI SITES
 ;I $$PARM^ACHS(2,9)'="Y" G S7A   ;ACHS*3.1*32 
 ;S ^ACHSTXPG(ACHSTOS,ACHSDIEN,ACHSTIEN)=""  ;ACHS*3.1*32
S7A ;
 ;I ACHSF638'="Y" G S8  ;ACHS*3.1*32
 ;S:'$P(ACHSDOCR,U,3) ^ACHSTXPG(ACHSTOS,ACHSDIEN,ACHSTIEN)=""   ;ACHS*3.1*32
 I ACHSF638="Y",$$PARM^ACHS(2,9)="Y",$$PARM^ACHS(2,11)'="Y",'$P(ACHSDOCR,U,3) S ^ACHSTXPG(ACHSTOS,ACHSDIEN,ACHSTIEN)=""   ;ACHS*3.1*32
...
S8 ;
 ...
 ;I ACHSF638="Y",$$PARM^ACHS(2,9)="Y" G S5  ;ACHS*3.1*32
 I ACHSF638="Y",$$PARM^ACHS(2,11)'="Y" G S5  ;ACHS*3.1*32 TEST FOR SENDING TRIBAL FI DATA
 ...
 ;ACHS*3.1*32 ADD TEST FOR TRIBAL FI EXPORT
 S TST=0
 I ACHSF638'="Y" D
 ...
 .I $L(^ACHSDATA(ACHSRCT))'=80 W !!,*7,*7,"A DHR RECORD WAS PRODUCED THAT WAS NOT 80 CHARACTERS IN LENGTH:",!!,^(ACHSRCT),!,*7,*7 S TST=1
 .I ACHSRCT=1 S ACHSFDT=ACHSBDT W !!,"NUMBER OF RECORDS PROCESSED = ",!!
 .W $J(ACHSRCT,8)
 .D BC^ACHSTX2
 G:TST=1 ERROR^ACHSTX
