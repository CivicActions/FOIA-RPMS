ACHSCHF ; IHS/ITSC/TPF/PMF - C H E F REIMBURSEMENT SEARCHES ;   
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**15,16,31**;JUN 11, 2001;Build 39
 ...
 ;ACHS*3.1*31 6.23.23 IHS.OIT.FCJ REMOVED PRINTING OF SSN
 ;
...
HDR ;
 ...
 ;W !!,$P($G(^DPT(DFN,0)),U),!,$S(SEX="F":"Female",SEX="M":"Male",1:"<sex missing>"),", born ",$$FMTE^XLFDT(DOB),", SSN: ",SSN,", HRN: ",$$HRN^ACHS(DFN,DUZ(2))  ;ACHS*3.1*31
 W !!,$P($G(^DPT(DFN,0)),U),!,$S(SEX="F":"Female",SEX="M":"Male",1:"<sex missing>"),", born ",$$FMTE^XLFDT(DOB),", HRN: ",$$HRN^ACHS(DFN,DUZ(2))     ;ACHS*3.1*31
 D EN^ACHSRP31
H ;EP
