ACHSDNS ; IHS/ITSC/PMF - DENIAL STATISTICS REPORT (1/2) ;7/27/10  16:15
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**6,7,18,28,32**;JUN 11, 2001;Build 39
 ...
 ;ACHS*3.1*28 12.20.19 OIT.IHS.FCJ FX FOR NON REG PAT REP BY COM
...
B ; --- Loop thru Denial IENs
 ...
 ;I ACHSMPRI S ACHSMPRI=$P($G(^ACHSMPRI(ACHSMPRI,0)),U)  ; ACHS*3.1*32
 I ACHSMPRI S ACHSMPRI=$P($G(^ACHSMPR(ACHSMPRI,0)),U)    ; ACHS*3.1*32
