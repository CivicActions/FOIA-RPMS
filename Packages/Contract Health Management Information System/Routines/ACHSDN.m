ACHSDN ; IHS/ITSC/PMF - DENIAL DATA ENTRY (1/2) ;
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**10,11,12,13,18,21,30,32**;JUN 11,2001;Build 39
 ...
 ;ACHS*3.1*30 5.19.22 IHS.OIT.FCJ add print que and test for esig
 ;ACHS*3.1*32 8.20.24 IHS.OIT.FCJ Added Vars to kill when leaving routine
 ;
SITE ;
...
END ;
 ...
 K ACHDDOS,ACHDENO,ACHDENR,ACHDENS,ACHDOPTR,ACHDOREO,ACHDROPT,ACHSDREA   ;ACHS*3.1*32
 Q
 ;
...
SEQ ;
 ...
 I '$$LOCK^ACHS("^ACHSDENR(DUZ(2),4)","-") Q
 ;
 I ACHSDESG I '$$DIE(".12////QP")        ;ACHS*3.1*30;add print que
 I '$$DIE(".01///"_ACHDNUM_";2////"_DT_";3////"_DUZ) Q
 W @IOF,!!,"This denial has been posted.  The DENIAL NUMBER is: ",ACHDNUM,!!!!
 I ACHSDESG S T=$P(^ACHSDENR(DUZ(2),0),U,14)+1 S DIE="^ACHSDENR(",DA=DUZ(2),DR=".14////"_T D ^DIE    ;ACHS*3.1*30
