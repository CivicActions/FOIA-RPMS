ACHSDADP ; IHS/ITSC/JVK - DENIAL APPEAL DISPLAY/EDIT;   [ 09/21/2006  3:05 PM ]
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**6,13,32**;JUNE 11, 2001;Build 39
...
P1 ; --- Display Page 1
 ...
 ;W !,"3. MEDICAL PRIORITY: ",$S(ACHSMPRI'="":$P($G(^ACHSMPRI($$DN^ACHS(400,2),0)),U),ACHSMPRI="":"NONE SET") ;ACHS*3.1*32
 W !,"3. MEDICAL PRIORITY: ",$S(ACHSMPRI'="":$P($G(^ACHSMPR($$DN^ACHS(400,2),0)),U),ACHSMPRI="":"NONE SET")   ;ACHS*3.1*32
 S %=$$DN^ACHS(100,10)
 ;
