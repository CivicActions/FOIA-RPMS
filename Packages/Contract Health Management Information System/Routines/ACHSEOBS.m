ACHSEOBS ; IHS/ITSC/TPF/PMF - SELECT EOBR FILE FOR PROCESSING ; 
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**22**;JUN 11, 2001;Build 39
 ;
...
D0 ;
 ...
 W !,"------   ---------------             ---------------  ------   ------"
D1 ;
 ;ACHS*3.1*32 ST OF CHANGE TO DISPLAY IN REV ORDER
D2 ;
 F  S ACHSI=$O(ACHSUFLS(ACHSI)) G:ACHSI'?1N.N DEND D
 .Q:$P(ACHSUFLS(ACHSI),U,2)'="OK"
 ...
 .W ?39,$$FMTE^XLFDT(X),?54,$J($FN($P(ACHSUFLS(ACHSI),U,4),",",0),6),?64,$J($P(ACHSUFLS(ACHSI),U,5),3)
 .S ACHSSEL(ACHSISEQ)=ACHSI
 ;ACHS*3.1*32 END OF CHANGE TO DISPLAY IN REV ORDER
 ;
DEND ;
 W !
