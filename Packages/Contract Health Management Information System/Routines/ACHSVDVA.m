ACHSVDVA ; IHS/ITSC/PMF - 2/2 EDIT VENDOR INFORMATION - CALLED FROM ACHSVDV ;
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**6,11,13,19,23,29**;JUN 11, 2001;Build 86
 ...
 ;ACHS*3.1*19 3.30.11 IHS/OIT/FCJ ADDED E-MAIL OPTION
 ;ACHS*3.1*23 IHS.OIT.FCJ ADDED DIRECT PARTICIPANT AND DIRECT EMAIL ADDRESS
 ;ACHS*3.1*29 07.01.2021 IHS/OIT/FCJ ADDED UEI AND EFT
 ;
EDIT ;EP
...
13 ;DIRECT PARTICIPANT
 ...
 Q
 ;ACHS*3.1*29 IHS.OIT.FCJ ADDED UEI AND EFT FOR REPLACEMENT OF DUNS AND RENUMBERED
14 ;UNIQUE ENTITY IDENTIFIER (UEI)
 D EDITVNDR(ACHSPROV,".1")
 Q
15 ;DIRECT EMAIL ADDRESS ;ACHS*3.1*23
 D EDITVNDR(ACHSPROV,"2105")
 Q
16 ;EFT NUMBER FOR GSA ;ACHS*3.1*29
 D EDITVNDR(ACHSPROV,".09")
 Q
17 ;
