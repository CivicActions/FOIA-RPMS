ACHSPA0 ; IHS/ITSC/PMF - DOCUMENT PAYMENT ;
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**11,12,13,32**;JUN 11,2001;Build 39
...
EOBRCX ;
 ...
 ;S $P(^ACHSF(DUZ(2),"D",ACHSDIEN,"T",ACHSTDA,0),U,13)=ACHSPDAT,$P(^(0),U,14)=ACHSPSQN,$P(^(0),U,15)=ACHSPIND ;ALREADY SET AT A
...
C1 S Y="ACHSDRG^ACHSADDT^ACHSDIDT^ACHSDITY"
 ...
 S ACHSDAP=ACHSIPA
 I ACHSPIND="I" S ACHSDAP=ACHSDAP+$G(ACHS(26)) ;ACHS*3.1*32 ADD INTEREST AMOUNT IF "IP"
 ;
