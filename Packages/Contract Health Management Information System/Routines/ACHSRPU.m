ACHSRPU ; IHS/ITSC/PMF - PRINT UNIVERSAL 843 FORMS ;JUL 10, 2008
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**6,7,11,12,13,14,15,16,18,19,20,22,23,27,28,30**;JUN 11,2001;Build 39
 ...
 ;ACHS*3.1*28 03/09/2020 IHS.OIT.FCJ PRNT REF#
 ;ACHS*3.1*30 4.29.22 IHS.OIT.FCJ COMMENT CHANGE PRINTING UEI INSTEAD OF DUNS
 ;
...
PONUM ; -- Field 1 : DCR #, Document type, PDO number.
 ...
 E  W ?ACHSTAB+61,"0",ACHSORDN,ACHSSF     ;ORD NUM EITHER CANCEL OR SUPPLEMENT
 ;
...
ORDFAC ;
 ...
 ;
INSOTH1 ;
 S N=$O(I("B",N))               ;OTHER INS STUFF
 S:N=ACHSIPRM N=$O(I("B",N))
 W:(N'="") ?ACHSTAB+38,$P(I("B",N),U)   ;INS TYPE
 ;
ORDADRS1 ;
...
INSOTH5 ;
 ...
 ..W ?ACHSTAB+38,$P(I("B",N),U)
 ..W !?ACHSTAB+39,$P(I("B",N),U,2),!
 ..S ACHSBZD=ACHSBZD+1                ;MORE OTHER INS 3h
 ;
OPT ;
...
REF ;
 ...
 ;W:$D(R("D",3)) ?ACHSTAB+39,R("D",3)      ;ACHS*3.1*28
 W:$D(R("N",1)) ?ACHSTAB+41,R("N",1)       ;REF# ACHS*3.1*28
 W !
...
UPIN ;ACHS*3.1*16 CHNG UPIN TO DUNS;ACHS*3.1*30- CHG TO UEI
