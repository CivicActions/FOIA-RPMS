ACHSACO2 ; IHS/ITSC/TPF/PMF - AREA CONSOLIDATION (3/3) PLACE ENTRY INTO THE CHS AO PROCESSING LOG ;JUL 10, 2008
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**13,14,19,23,32**;JUN 11,2001;Build 39
 ...
 ;ACHS*3.1*32 8.13.2024 IHS.OIT.FCJ ADDED TOTALS FOR PO
 ;
END ;EP.
 U IO(0)
 ...
 W !!?20,"TOTAL FI Purchase Orders:  " W ?50,$S(ACHSTOTL(5)>0:$J((ACHSTOTL(5)/3),6),1:$J(ACHSTOTL(5),6))  ;ACHS*3.1*32
 W !?20,"Total UFMS Purchase Orders:  " W ?50,$J(ACHSTOTL("U"),6)     ;ACHS*3.1*32
