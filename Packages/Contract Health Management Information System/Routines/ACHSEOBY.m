ACHSEOBY ; IHS/ITSC/TPF/PMF - CHECK STATUS OF BCBS EOBR REPORTS ; 
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**21,22,32**;JUN 11, 2001;Build 39
 ;ACHS*3.1*32 6/26/24 IHS.OIT.FCJ DISPLAY FILES IN REVERSE ORDER;DISPLAY ONLY FILES THAT HAVE NOT BEEN PROCESSED
 ;
...
FILDELC2 ;
 ...
 G FILDELC1:+ACHSRR=0
 S ACHSCNT=ACHSCNT+1
 ;I ACHSCNT=6 S ACHSDELD=9999999-ACHSR ;ACHS*3.1*32 NO LONGER CHECK TO DELETE
 G FILDELC2
 ;
FILDELF ;
 ...
 U IO(0)
 ;ACHS*3.1*32 No longer ask, check to see if processed and delete file from list
 ;S Y=$$DIR^XBDIR("Y","Delete ALL FI EOBR FILES With Process Date BEFORE "_Y,"Y","","","",2)   ;ACHS*3.1*32
 ;I Y=1 G FILDELK   ;ACHS*3.1*32
 ;G FILDEND   ;ACHS*3.1*32
 ;
FILDELK ;
