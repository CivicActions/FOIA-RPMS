ACHSDNU2 ; IHS/ITSC/PMF - DENIAL UNMET NEED LIST (3/3) ; [ 10/16/2001   8:16 AM ]
 ...
 ;
 ;S MEDPRI=0 F  S MEDPRI=$O(^ACHSMPRI(MEDPRI)) Q:+MEDPRI=0  D    ;ACHS*3.1*32
 S MEDPRI=0 F  S MEDPRI=$O(^ACHSMPR(MEDPRI)) Q:+MEDPRI=0  D      ;ACHS*3.1*32
 .;S MEDPRI0=$G(^ACHSMPRI(MEDPRI,0))                             ;ACHS*3.1*32
 .S MEDPRI0=$G(^ACHSMPR(MEDPRI,0))                               ;ACHS*3.1*32
