ACHSDNDP ; IHS/ITSC/TPF/PMF - DENIAL DISPLAY/EDIT ; 
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**23,32**;JUN 11, 2001;Build 39
 ;ACHS*3.1*32 9/12/24 IHS.OIT.FCJ Display New Priorities
 ;
TOF ;
 Q:'$D(ACHSA)
...
P1 ; --- Display Page 1
 ...
 ;W !!,"3. MEDICAL PRIORITY: ",IORVON,$P($G(^ACHSMPRI($$DN^ACHS(400,2),0)),U),IORVOFF    ;ACHS*3.1*32
 W !!,"3. MEDICAL PRIORITY: ",IORVON,$P($G(^ACHSMPR($$DN^ACHS(400,2),0)),U),IORVOFF     ;ACHS*3.1*32
 S %=$$DN^ACHS(100,10)
 ;
