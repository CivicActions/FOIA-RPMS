ACHSACT ; IHS/ITSC/PMF - DOCUMENT ACTIONS ;  [ 10/16/2001   8:16 AM ]
 ...
 ;ACHS*3.1*28 03.05.2020 IHS.OIT.FCJ ADDED STORING COMMENTS IN ACTION NODE
 ;
...
ENTER ;EP - Enter actions on a document.
 ...
 Q
 ;
 ;ACHS*3.1*28;ADDING COMMENT TO FOR PO CANCELLATION
ACT(ACHSDIEN,ACHSTIME,ACHSACT,ACHSCOM) ;EP - Non-Interactive entry of an action on a document.
 N ACHS,DA,DIC,DIE,DR
 I '$D(^ACHSF(DUZ(2),"D",ACHSDIEN,"A",0)) S ^ACHSF(DUZ(2),"D",ACHSDIEN,"A",0)=$$ZEROTH^ACHS(9002080.01,101)
 S DIC(0)="",DIC="^ACHSF(DUZ(2),""D"",ACHSDIEN,""A"",",X=ACHSTIME
 S DA(2)=DUZ(2),DA(1)=ACHSDIEN,DIC("DR")=".02////"_DUZ_";1///"_$G(ACHSACT)_";2///"_$G(ACHSCOM)
 K DO,DD D FILE^DICN
 Q
 ;
