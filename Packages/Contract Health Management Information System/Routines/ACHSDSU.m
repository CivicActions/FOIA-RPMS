ACHSDSU ; IHS/ITSC/PMF - DOCUMENT SUMMARY REPORT ;    [ 10/16/2001   8:16 AM ]
 ...
 ;ACHS*3.1*31 6.22.23 IHS.OIT.FCJ FIXED TOTAL ISSUE AND PRINTING INTER PAY AND ADJ
 ;
...
A4 ;
 ...
 ;I 'O G A6  ;ACHS*3.1*31 Do not skip printing POs with pay=obl
A5 ;
...
A6 ;
 ...
 ;S ACHSTY=$S(ACHSTY="I":"INITIAL",ACHSTY="P":"PAYMENT",ACHSTY="S":"SUPPLEMENTAL",ACHSTY="IP":"INTERIM PAYMENT",1:"CANCEL")      ;ACHS*3.1*31
 S ACHSTY=$S(ACHSTY="I":"INITIAL",ACHSTY="P":"PAYMENT",ACHSTY="S":"SUPPLEMENTAL",ACHSTY="IP":"INTERIM PAYMENT",ACHSTY="ZA":"ADJUSTMENT",1:"CANCEL")     ;ACHS*3.1*31
 ;
 ...
 S ^FCJ(ACHSDEST,ACHSTY,ACHSDIEN)=""
 G A4
 ;
...
SUM ;
 ...
 ;F ACHSTYPE="INITIAL","SUPPLEMENTAL","CANCEL","PAYMENT","INTERIM PAYMENT" D          ;ACHS*3.1*31
 F ACHSTYPE="INITIAL","SUPPLEMENTAL","CANCEL","PAYMENT","INTERIM PAYMENT","ADJUSTMENT" D     ;ACHS*3.1*31
