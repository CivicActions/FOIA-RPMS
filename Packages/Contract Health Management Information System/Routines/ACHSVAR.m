ACHSVAR ; IHS/ITSC/TPF/PMF - VARIABLES, OPTIONS ;     [ 06/15/2001  8:10 AM ]
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**18,22,23,26,30**;JUN 11, 2001;Build 39
 ;ACHS*3.1*18 7/16/2010;IHS/OIT/ABK;Change every occurrance of Deferred to Unmet Need
 ;ACHS*3.1*30 5.18.2022 IHS.OIT.FCJ ADD E-SIG PARM
 ;
 ...
 K ACHSY,ACHSCHSS
 D ^ACHSUF
 ;ACHS*3.1*30 ST OF CHG
 S ACHSDESG="" I '$G(ACHSISAO),$D(^ACHSESIG(DUZ(2),0)) D
 .Q:'$P(^ACHSESIG(DUZ(2),0),U,4)
 .S:DT>($P(^ACHSESIG(DUZ(2),0),U,4)-1) ACHSDESG=1    ;E-SIG PARM
