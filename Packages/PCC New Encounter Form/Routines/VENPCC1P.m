VENPCC1P ; IHS/ITSC/GIS - NEW ICD PREFERENCES MANAGER - ;   [ 06/19/06  10:57 AM ]
 ;;2.5;PCC+;**1,5**;JUN 15, 2006
 ;
 ; 
 ;
 ;
...
UID F  S UID=$O(^VEN(7.34,"AC",UID)) Q:$P(UID,"_",1,2)'=IX  D  ; SORT THE RESULTS
...
PL ; EP - GLOBAL LIST OF ICD PREFERENCES (NEW))
 ...
 Q
 ; 
ITEST ; TEST AUTO SUBMISSION OF ICD CRITERIA
 S IN="1/1/1989|54|1|1|54"
 D ICD(.OUT,IN)
 Q
 ; 
ICD(OUT,IN) ; EP - RPC (VEN PCC+ SUBMIT ICD CRITERIA)
 ...
 S OUT="",QUIET=1
 S P200=(^DD(9000010.06,.01,0)["DIC(6,")
...
CIDC(CODE) ; EP-CONVERT ICD CODE TO BRIEF ICD TEXT
 N TXT,IIEN
 S IIEN=$O(^ICD9("AB",$G(CODE),0)) I 'IIEN Q ""
