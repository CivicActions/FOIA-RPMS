VEN26P07 ;GDIT/HS/BEE-PCC+ (Well Child) Version 2.6 Patch 7 Post Install - Register Components ; 05 Apr 2023  12:00 PM
 ;;2.6;PCC+;**7**;NOV 16, 2007;Build 26
 ;
ENV ;EP - Environmental Checking Routine
 ...
 ;        ;
 ;Check for PCC+*2.6*6
 I '$$INSTALLD("PCC+*2.6*6") D BMES^XPDUTL("Version 2.6 Patch 6 of PCC+ is required!") S XPDQUIT=2 Q
 ;
 Q
 ;
EN ;EP - Register the Well Child objects into the VUECENTRIC OBJECT REGISTRY
 ...
 . I WP10(1)["IHS.WCM.EHR.ASQ.chm" S WP10(1)="IHS.WCM.EHR.ASQ.chm;2018.5.10.145252;75DEE77C6F5648155F3B9B2DD6EF13B9"
 . I WP10(1)["IHS.WCM.EHR.GrowthCharts.chm" S WP10(1)="IHS.WCM.EHR.GrowthCharts.chm;2018.5.10.145252;7C2CF3A1CDF47AC44C846344CB3C34B8"
 ...
 . ;MD5 CHECKSUM
 . S CHKSM=""
 . I $P(TEXT,";")["IHS.WCM.EHR.ASQ.ASQCOMPONENT" S CHKSM="0AB3E34393331CAEA4F295DD2B7BC740"
 . I $P(TEXT,";")["IHS.WCM.EHR.GROWTHCHARTS.CHARTCOMPONENT" S CHKSM="5D8B493A23FCE558E7B08AF849122FA7"
 . I $P(TEXT,";")["IHS.WCM.EHR.PATIENTED.PATIENTEDCOMPONENT" S CHKSM="1AB2E44C0505E51B7E62EC9B15F01A5D"
 . I $P(TEXT,";")["IHS.WCM.EHR.REMINDERS.REMINDERSCOMPONENT" S CHKSM="8510DE1032918EAC2D1ED06B1E5E9F13"
...
OBJ ;;
 ...
 ;;IHS.WCM.EHR.ASQ.ASQCOMPONENT;Well Child ASQ;1.5.0.5;IHS.WCM.EHR.ASQ.dll;;;IHS.WCM.EHR.ASQ.chm;0;1;0;0;0;0;0;0;;1;;;;{E75D9C45-8BFD-4FE0-A322-941DF2CAC1D9};300;600;
 ;;IHS.WCM.EHR.GROWTHCHARTS.CHARTCOMPONENT;Well Child Pediatric Growth Charts;1.5.0.5;IHS.WCM.EHR.GrowthCharts.dll;PrintHRN=BOOL;;IHS.WCM.EHR.GrowthCharts.chm;0;1;0;0;0;0;0;0;;1;;;;{916E390F-CBE4-4FD0-95E0-5C26AA191906};640;480;
 ;;IHS.WCM.EHR.PATIENTED.PATIENTEDCOMPONENT;Well Child Patient Education;1.5.0.5;IHS.WCM.EHR.PATIENTED.dll;;;IHS.WCM.EHR.PatientEd.chm;0;1;0;0;0;0;0;0;;1;;;;{4F37CE40-077C-4F5B-94BC-180952737BF4};100;400;
 ;;IHS.WCM.EHR.REMINDERS.REMINDERSCOMPONENT;Well Child Reminders List;1.5.0.5;IHS.WCM.EHR.REMINDERS.dll;;;IHS.WCM.EHR.Reminders.chm;0;1;0;0;0;0;0;0;;1;;;;{8D15368C-CE3D-49FE-AFAD-BEF6C3E8D83B};480;640;
 ;;END;
 ;;
ASQUSE ;;
...
INSTALLD(VENSTAL) ;EP - Determine if patch VENSTAL was installed, where
 ;VENSTAL is the name of the INSTALL.  E.g "VEN*2.6*6".
 ;
