VENPCCIC ; IHS/ITSC/GIS - INSTALLATION TOOLS: ADD A NEW TEMPLATE FOR VER 2.5 ; ENTER/EDIT PCC+ CLINICS
...
LKUP() ; LOOK UP A PCC+ CLINIC
 ...
 Q CIEN
 ; 
DC(CIEN)  ; DELETE AN EXISTING TEMPLATE
 N DA,CLNAME,%
