VENPCC1H ; IHS/ITSC/GIS - MORE ENCOUNTER FORM DATA MINING ; [ 06/19/06  10:53 AM ]
 ;;2.5;PCC+;**1,4,5**;JUN 16, 2006
...
POV ; ADD POVS TO THE LIST
 ...
 S @TMP@(1,("p"_TOT))=$E(%,1,40),^("p"_TOT_"c")=$E(%,1,8) ; INSERT THE POV DIVIDER LINE
...
MLOOP F  S IDT=$O(^AUPNVMED("AA",DFN,IDT)) Q:'IDT  S MIEN=0 F  S MIEN=$O(^AUPNVMED("AA",DFN,IDT,MIEN)) Q:'MIEN  D  I $G(STOP) Q
