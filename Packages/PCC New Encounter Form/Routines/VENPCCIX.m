VENPCCIX ; IHS/ITSC/GIS - INSTALLATION TOOLS: ADD A NEW TEMPLATE FOR VER 2.5 ; EXTENSION OF VENPCCIT
...
GRAPH ; GRAPHS ASSOCIATED WITH THE FORM
 W !!,SEP,"  GRAPHS  ",SEP
...
KB ; KNOWLEDGEBASE ASSOCIATED WITH THE FORM
...
GG ; GROWTH GRIDS FOR WELL CHILD FORM
...
GG1 ; UPDATE THE OCX COMPONENTS FILE
 S DA(1)=GGIEN
...
GRDEL S DIK="^VEN(7.63," S DA=GRIEN ; REMOVE GRAPH DEFINITION
 ...
 Q
 ; 
OK(TXT) ; CONFRIM REMOVAL OF ITEMS
