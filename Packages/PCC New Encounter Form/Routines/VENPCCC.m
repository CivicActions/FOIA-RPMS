VENPCCC ; IHS/ITSC/GIS - CHECK LIST MANAGEMENT ;
...
COI ; CONVERT ORDERABLES TO ITEMS
 ...
 Q
 ;
NAME(NAME) ; CAPITALIZE THE 1ST LETTER OF EVERY WORD
 N L,I,F,X,Y,A
 I '$L($G(NAME)) Q ""
 I NAME?1.U Q NAME
 ...
 Q A
 ; 
CSUB(X,Y) ; MAKE ENTRY IN CHECKIN GROUP SUBFILE
 N DIC,DIE,DA,DR
 I '$D(^VEN(7.9,+$G(X),0)) Q
 I '$G(Y) Q
 S DA(1)=Y
 ...
 Q
 ; 
DR(DA,GRP,C1,C2,CKIEN,PRE,POST) ; MAKE DR STG
 N DR,STG
 S %=$G(GRP) I '% Q
 S DR=".0"_(%+2)_"////1"
