TIULMED1 ; SLC/JM - Active/Recent Med Objects Routine ;21-Feb-2024 11:48
 ;;1.0;TEXT INTEGRATION UTILITIES;**38,73,92,94,1006,202,1010,226,1011,1029**;Jun 20, 1997;Build 34
 ;;IHS/MSC/MGH added items to display for objects
 ; IHS/MSC/JSM updated ADDP to update HOLD status to BEHORX LABEL HOLD STATUS XPAR when PNUM is 9 (Feature 106931)
...
ADDMED(XMODE) ; if XMODE creates XSTR, if not add med to TARGET
 N DATA,FIRST,XSUM,XCOUNT,TOPLINE,WSTATUS,TSTAT,HOLDSTTS
 S FIRST=1
...
ADDP(PNUM) ; Adds or XSUMs a piece of NODE
 ...
 .;IHS/MSC/JSM Changed below line to update status for p1029
 .;I PNUM=9,VALUE="ACTIVE/SUSP" S VALUE="ACTIVE (S)"
 .I PNUM=9  D
 ..S:VALUE="ACTIVE/SUSP" VALUE="ACTIVE (S)"
 ..I VALUE="HOLD"  D
 ...S HOLDSTTS=$$UP^XLFSTR($$GET^XPAR("ALL","BEHORX LABEL HOLD STATUS",,"E"))_"*"
