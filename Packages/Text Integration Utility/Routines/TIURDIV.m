TIURDIV ; SLC/JAK - Review unsig/uncosig Documents by DIVISION ;04/10/23  13:14
 ;;1.0;TEXT INTEGRATION UTILITIES;**113,259,1027**;Jun 20, 1997;Build 11
 ; Multidivisional Enhancements - from BUF/DCN - modified by SLC/JAK
 ; IHS/MSC/MIR changed to use HRN - PRTELMNT+16, +21 - Apr 10,2023 - Patch 1028
 ;
...
PRINT(TIUSTDT,TIUENDT) ; Display/print the output
 ...
 N TIUIFP,TIULST4,TIUOUT,TIUPG,TIUPT,TIUSVC,TIUTP,TIUHRN
 N TIUAUECS
...
PRTELMNT(TIUDA,TIUIFP,TIUSVC,TIUAUECS,TIUEDT,TIUSTDT,TIUENDT) ; Print each element
 ...
 I $Y>(IOSL-5) D ASK Q:TIUOUT  D HDR(TIUIFP,TIUSTDT,TIUENDT),FHDR(TIUSVC):TIURPT="F"
 I TIURPT="F" D
 . S TIUPT=+$P(TIUD0,U,2),TIUHRN=$$HRCN^TIUR2(TIUPT,+$G(DUZ(2)))   ;TIULST4=$E($$GET1^DIQ(2,TIUPT,.09),6,9)
 ...
 . W ?32,$S(TIUHRN:TIUHRN,1:"UNK")   ;TIULST4]"":$G(TIULST4),1:"UNK")
...
HDR(TIUIFP,TIUSTDT,TIUENDT) ; Page (Division) Header
 ...
 I TIURPT="F" D
 . W !,"AUTHOR/EXP COS",?17,"PATIENT",?25,"HRN",?39,"STATUS"
