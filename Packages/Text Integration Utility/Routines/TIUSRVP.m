TIUSRVP ; SLC/JER - RPCs for CREATE & UPDATE ;18-Nov-2021 17:50;DU
 ;;1.0;TEXT INTEGRATION UTILITIES;**1,7,19,28,47,89,104,100,115,109,167,1003,1007,113,112,175,157,1009,184,1010,239,1013,1019,1025**;Jun 20, 1997;Build 8
...
UPDATE(SUCCESS,TIUDA,TIUX,SUPPRESS) ; Update existing Document
 ...
 ;IHS/MSC/MGH Patch 1025 fix missing visit in quick note update
 I $G(CIA("UID")),$G(TIUX("VISIT"))="@" K TIUX("VISIT")
