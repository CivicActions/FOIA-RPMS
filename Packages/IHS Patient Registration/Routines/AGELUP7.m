AGELUP7 ;IHS/ASDS/EFG - UPDATE ELIGIBILITY FROM FILE  
 ...
 ;
FILE(AG) ;EP - file RAILROAD RETIREMENT
 ...
 S DA(1)=DA
 ;S DIK="^AUPNRRE(DA(1),11,"  ; IHS/SD/EFG  AG*7*2  #22
 S DIK="^AUPNRRE("_DA(1)_",11,"  ; IHS/SD/EFG  AG*7*2  #22
 S DA=0 F  S DA=$O(^AUPNRRE(DA(1),11,DA)) Q:'DA  D
 .D ^DIK
 ;S DIC="^AUPNRRE(DA(1),11,"  ; IHS/SD/EFG  AG*7*2  #22
 S DIC="^AUPNRRE("_DA(1)_",11,"  ; IHS/SD/EFG  AG*7*2  #22
 S DIC(0)="LX"
 S DIC("P")="9000003.11D"
 K DD,DO
 S AGI=0
