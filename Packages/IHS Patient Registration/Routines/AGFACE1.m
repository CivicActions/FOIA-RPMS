AGFACE1 ; IHS/ASDS/EFG - FACE SHEET (DEMOGRAPHIC DATA) ;  
 ;;7.1;PATIENT REGISTRATION;**11,15**;AUG 25,2005;Build 1
...
L2 S DIC=2 W !,AG("-"),!
 ...
 ;IHS/OIT/NKD AG*7.1*15 MU3 - DISPLAY ALL ETHNICITIES - START NEW CODE
 I $$GET1^DIQ(9009061,DUZ(2)_",",501,"I") D   ;CONDITIONAL DISPLAY OF ETHNICITY
 .N AGETHN,AGCNT S AGETHN=$$ETHN^AGUTL(DFN)
 .Q:+AGETHN<2   ;IF LESS THAN 2, DO NOT DISPLAY (0 NO DISPLAY, 1 WILL ALREADY DISPLAY ABOVE)
 .W "ETHNICITIES:"
 .F AGCNT=1:1:+AGETHN W !?5,$P(AGETHN,U,AGCNT+1)
 .W !,AG("-"),!
