AGED ; IHS/ASDS/EFG - EDITOR MAIN ROUTINE ; MAR 19, 2010   
 ;;7.1;PATIENT REGISTRATION;**2,4,7,9,15**;AUG 25, 2005;Build 1
 ;IHS/OIT/NKD AG*7.1*15 PAGE 11
 ;IHS/OIT/NKD AG*7.1*15 PREFERRED NAME
 ;IHS/OIT/NKD AG*7.1*15 BANNER DISPLAY
 ;
 I '$D(IOF) D HOME^%ZIS
 W $$S^AGVDF("IOF"),!
 ...
 S AGPAT=$S(AG("PG")?.N:$$GETPREF^AUPNSOGI(DFN,"E"),1:AGPAT)  ;IHS/OIT/NKD AG*7.1*15 PREFERRED NAME
 ...
 ;W ?27,$$DTEST^AGUTILS(DFN)  ;AG*7.1*4 ;IHS/OIT/NKD AG*7.1*15 BANNER DISPLAY
...
ZMFI ;
 ...
 Q
 ;
 ;11 ;;0;  ;IHS/OIT/NKD AG*7.1*15 - PAGE 11
1 ;;0;
...
11 ;;23;SEXUAL ORIENTATION/GENDER IDENTITY
