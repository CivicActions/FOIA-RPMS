AGCARD ; IHS/ASDS/EFG - EMBOSSED CARD ; JUL 11, 2023  
 ;;7.1;PATIENT REGISTRATION;**4,11,16,17**;AUG 25,2005;Build 9
...
START ;EP - TaskMan.
 ...
 ;S AGNAME=$E($P($G(^DPT(DFN,0)),U),1,28)  ;IHS/OIT/JS AG*7.1*17 PREFERRED NAME
 S AGNAME=$E($$GETPREF^AUPNSOGI(DFN,"E",1),1,38) ;IHS/OIT/JS AG*7.1*17 PREFERRED NAME
...
CARDP ;Print an ID Card.
 ;W !!,AGFAC,!!,"(",AGCHART,")       ",AGSSN,!!,AGNAME,!,AGDOB,"   "  ;IHS/OIT/NKD AG*7.1*16 SSN REMOVAL
 W !!,AGFAC,!!,"(",AGCHART,")       ",!!,AGNAME,!,AGDOB,"   "
