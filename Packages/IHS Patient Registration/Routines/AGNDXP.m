AGNDXP ; IHS/ASDS/EFG - PRINT AN INDEX CARD-DFN REQUIRED ; JUL 11, 2023
 ;;7.1;PATIENT REGISTRATION;**4,11,17**;AUG 25,2005;Build 9
...
NMCH S AGDPT=^DPT(DFN,0),AG41=^AUPNPAT(DFN,41,DUZ(2),0)
 ;W $P(AGDPT,U),?45-$L($P(AG41,U,2)),$P(AG41,U,2) D LINE ;Line 1  ;;IHS/OIT/JS AG*7.1*17 PREFERRED NAME
 W $$GETPREF^AUPNSOGI(DFN,"E",1),?45-$L($P(AG41,U,2)),$P(AG41,U,2) D LINE ;Line 1 ;;IHS/OIT/JS AG*7.1*17 PREFERRED NAME
