AG7P4 ;IHS/SD/EFG - Patient Registration 7.0 Patch 4 ENVIRONMENT CHECKER ;   [ 05/08/2003  1:14 PM ]
 ...
 S X=$$LAST^AG7P4("IHS DICTIONARIES (PATIENT)","99.1")
 ...
 S X=$$LAST^AG7P4("IHS DICTIONARIES (POINTERS)","98.1")
...
OPTSAV(AGM) ;
 ...
 I $D(^XTMP("AG7P4",7.2,"OPTSAV",AGM)) D BMES^XPDUTL("NOT SAVED.  Option '"_AGM_"' has previously been saved.") Q
 I '$D(^XTMP("AG7P4")) S ^XTMP("AG7P4",0)=$$FMADD^XLFDT(DT,30)_U_DT_U_"AG7P4 - SAVE OPTION CONFIGURATIONS."
 NEW I,A
 S I=$O(^DIC(19,"B",AGM,0))
 I 'I D BMES^XPDUTL("NOT SAVED.  Option '"_AGM_"' not found in OPTION file.") Q
 S A=0
 F  S A=$O(^DIC(19,I,10,A)) Q:'A  S ^XTMP("AG7P4",7.2,"OPTSAV",AGM,A)=$P(^DIC(19,+^DIC(19,I,10,A,0),0),U,1)_U_$P(^DIC(19,I,10,A,0),U,2,3)
 Q
 ;
