AGED10B ; VNGT/HS/BEE - EDIT PG 10 - ETHNICITY/RACE/LANGUAGE/MIGRANT/HOMELESS/INTERNET/HOUSEHOLD INFO (CONT) ; MAR 19, 2010 
 ...
 ;IHS/OIT/NKD AG*7.1*15 REPLACED CHKRACE WITH CHKRE^AGUTL2
 ;IHS/OIT/NKD AG*7.1*15 RACE/ETHNICITY CHECK MOVED TO AGUTL2
 ;
...
ETHNIC ;EP
EDETHNIC ;EP
 ;IHS/OIT/NKD AG*7.1*15 MULTIPLE ETHNICITY LOGIC - START OLD CODE
 ;
 ...
 S:$D(Y) DUOUT=""
 ;
 D CHKRE^AGUTL2(DFN,"E")
 ;
 I +$$ETHN^AGUTL(DFN)<1,$$RQETH^AGEDERR4(DUZ(2)) W "??  Required" K DA,DR,DIE,DUOUT,Y G EDETHNIC
...
EDRACE ;EP
 ...
 S:$D(Y) DUOUT=""
 ;
 ;D CHKRACE  ;IHS/OIT/NKD AG*7.1*15 REPLACED CHKRACE WITH CHKRE^AGUTL2
 ;END NEW CODE
 D CHKRE^AGUTL2(DFN,"R")  ;IHS/OIT/NKD AG*7.1*15
 ...
 ;
 Q
 ;IHS/OIT/NKD AG*7.1*15 REPLACED WITH AGUTL2 ROUTINE - START OLD CODE
