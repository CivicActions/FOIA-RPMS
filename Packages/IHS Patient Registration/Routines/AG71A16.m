AG71A16 ;IHS/OIT/NKD - PATIENT REGISTRATION 7.1 PATCH 16 CHECK/PRE/POST INSTALL ; 04/29/2022
 ;;7.1;PATIENT REGISTRATION;**16**;AUG 25, 2005;Build 1
 ;
 ...
 S:'$$PCHK("AG","7.1","15") XPDQUIT=2
 ;S:'$$VCHK("AUT","98.1","29") XPDQUIT=2
 ;S:'$$VCHK("AUPN","99.1","28") XPDQUIT=2
 ;S:'$$VCHK("AVA","93.2","26") XPDQUIT=2
 ;
 NEW DA,DIC
...
LAST(PKG,VER) ; EP - returns last patch applied for a Package, PATCH^DATE
 ...
 ;
PRE ; EP FR KIDS
 N AGI,AGV S AGI=$O(^DIC(9.4,"C","AG",0)) Q:'AGI
 S AGV=$G(^DIC(9.4,AGI,"VERSION"))
 W !,"AG VERSION: ",AGV,", ",$S(AGV="7.1":"OK",1:"SETTING TO 7.1")
 S:AGV'="7.1" ^DIC(9.4,AGI,"VERSION")="7.1"
 Q
 ;
POST ; EP FR KIDS
 ;
