AGEDERR4 ; VNGT/HS/BEE - EDIT CHECK CALLS ; MAR 19, 2010 
 ;;7.1;PATIENT REGISTRATION;**8,9,11,17**;AUG 25, 2005;Build 9
...
RQRACE(FAC) ;Determine whether Race is required - AG*7.1*9
 ...
 Q RQRACE
WADD(DFN)  ;Check advnace directive warning ;;IHS/OIT/JS AG*7.1*17
 ;
 Q:DFN="" 1
 I $$DECEASED^AGEDERR2(DFN) Q 0
 I '$$PTACTIVE^AGEDERR2(DFN) Q 0
 I '$D(^AUPNADVD(DFN,11,"B")) Q 1
 Q 0
WNPP(DFN)  ;check notice of privacy warning ;;IHS/OIT/JS AG*7.1*17
 ;
 Q:DFN="" 1
 I $$DECEASED^AGEDERR2(DFN) Q 0
 I '$$PTACTIVE^AGEDERR2(DFN) Q 0
 I '$O(^AUPNNPP("B",DFN,"")) Q 1
 Q 0
