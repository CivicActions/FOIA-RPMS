AG71A15 ;IHS/OIT/NKD - PATIENT REGISTRATION 7.1 PATCH 15 CHECK/PRE/POST INSTALL ; 04/06/2020
...
PRE ; EP FR KIDS
 ;
 D BMES^XPDUTL("Preparing AG Patient Registration Error Codes File for update...")
 N DIK,DA
 S DIK="^AGEDERRS(" F DA=9,54 D ^DIK
 Q
 ;
POST ; EP FR KIDS
 ;
