...
VAR2 S AG("PG")="4",ROUTID=$P($T(+1)," "),AGANS=""
 ...
 .S AG("ED")=$$CHKPG^AGUTL2(Y)
 .I '$L(AG("ED")) W *7,!!,AGANS," not found." K AG("ED") S AG("ERR")=""
...
DRAW2 ;EP
 ...
 ..;I ($P($G(^AUTNINS(AGINSPTR,2)),U)'="K") D EN^AGEDPRVB(PARDFN,PARREC,0,AGINSREC,AGINSPTR,POLHPTR,COVPTR)  ;IHS/OIT/NKD AG*7.1*15 INSURER TYPE FIX
 ..I $$INSTYP^AGUTL(AGINSPTR)'="K" D EN^AGEDPRVB(PARDFN,PARREC,0,AGINSREC,AGINSPTR,POLHPTR,COVPTR)
 .I AGTYPE="T" D
 ..S PARDFN=$P($P(AGINSREC,U,11),",")
 ..S PARDT=$P($P(AGINSREC,U,11),",",2)
 ..S NEWENTRY=0
...
ADDINS ;EP
 ...
 .;S INSTYP=$P($G(^AUTNINS(AGELP("INS"),2)),U)  ;IHS/OIT/NKD AG*7.1*15 INSURER TYPE FIX
 .S INSTYP=$$INSTYP^AGUTL(AGELP("INS"))
 ...
 ;END NEW CODE
 S AGNEWINS=""
 ;S AGTYPE=$P($G(^AUTNINS(AGELP("INS"),2)),U)  ;IHS/OIT/NKD AG*7.1*15 INSURER TYPE FIX
 S AGTYPE=$$INSTYP^AGUTL(AGELP("INS"))
 ;AG/SD/TPF 12/20/2005 AG*7.1*1 ITEM 2
