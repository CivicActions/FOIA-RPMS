AGED6 ; IHS/ASDS/EFG -EDIT PG 6 RAILROAD RETIREMENT;   
 ;;7.1;PATIENT REGISTRATION;**1,2,3,13,15**;AUG 25, 2005;Build 1
...
HDR ;
 ...
 S AGLINE("EQ")=$TR($J(" ",80)," ","=")
 W !,AGLINE("EQ")
 ;IHS/OIT/NKD AG*7.1*15 DISPLAY CLEANUP - START OLD CODE
 ;W !,$E(AGPAT,1,23)
 ...
 D EDBAN^AGUTL2(DFN)  ;IHS/OIT/NKD AG*7.1*15 DISPLAY CLEANUP
 W !,"======================= RAILROAD PART A AND B DATA ONLY ========================"  ;IHS/OIT/NKD AG*7.1*15 DISPLAY CLEANUP
 S DA=DFN
 K AG("EDIT")
 G DISP
NONE ;
