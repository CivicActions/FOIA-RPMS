AG3A ; IHS/ASDS/EFG - ENTER & EDIT NON-MANDATORY DATA ; JUL 11, 2023
 ;;7.1;PATIENT REGISTRATION;**4,12,17**;AUG 25,2005;Build 9
 ;
 ;AG*7.1 #  IHS/SD/TPF 
...
SSN ;EP - Social Security Number.
 N HIT  ;;IHS/OIT/JS AG*7.1*17 SSN edit check - Begin
 D EN^AGSECCHK("AGZVIEWSSN",.HIT)
 I $G(HIT)'="Y" D  G END2
 . W !,"  User is not authorized to edit SSN information."
 . K DIR
 . S DIR(0)="E"
 . D ^DIR
 ;;IHS/OIT/JS AG*7.1*17 SSN edit check - End
...
OPH ;EP - Office Phone #.
 ...
 D END
 Q
CPH ;EP - Cell Phone #.  ;;IHS/OIT/JS AG*7.1*4
 D S2
 S DR=.134
 D END
 Q
