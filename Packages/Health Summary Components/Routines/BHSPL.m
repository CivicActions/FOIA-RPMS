BHSPL ;IHS/MSC/MGH  - Health Summary for Problem list ;06-Mar-2025 09:44
 ;;1.0;HEALTH SUMMARY COMPONENTS;**1,2,6,8,22**;Mar 17,2006;Build 47
 ;===================================================================
 ...
 ;IHS/MSC/MIR 01/29/2025 Patch 22 (Feature 116663) PROBDSP+2:+3 PROBDSP+16:21
 ;
...
IPROB S BHSTAT="I"
 ; <SETUP>
COMMON ;
 N BHSPAT,BHSX,BHSFPP,BHSFAC,BHSQ,BHSDFN
 S BHSPAT=DFN
...
PROBSCH ;
 N BHSPRB,BHSIN
 S BHSPRB="" F  S BHSPRB=$O(^AUPNPROB("AA",BHSPAT,BHSFAC,BHSPRB)) Q:BHSPRB=""  D
 .S BHSIN=$O(^AUPNPROB("AA",BHSPAT,BHSFAC,BHSPRB,"")) Q:BHSIN=""  D
 ..S:BHSTAT[$P(^AUPNPROB(BHSIN,0),U,12) BHSNDF=BHSNDF+1,BHSDFT(BHSFAC_BHSPRB)=BHSIN
 Q
PROBDSP ;
 ; <SETUP PROBLEM>
 N BHSN,BHSSNO,BHSICD,BHSNRQ,BHSITE,BHSPNM,X,BHSDTM,BHSDTN,BHSDOO,BHSDIAG,BHSRESOL
 S (BHSDOO,BHSDIAG,BHSRESOL,BHSNTE)=""
 ...
 S X=$P(BHSN,U,24) S:'X BHSDIAG="Unknown" I X D REGDT4^GMTSU S BHSDIAG=X
 S BHSNTE=BHSNTE_" (Diagnosis "_BHSDIAG_")"
 S X=$P($G(^AUPNPROB(BHSDFN,1)),U,7)
 I X]"" D REGDT4^GMTSU S BHSRESOL=X,BHSNTE=BHSNTE_" (Resolution "_BHSRESOL_")"
 S BHSPLN=BHSPNM_$J("",12-$L(BHSPNM))_BHSDTN_" "_BHSDTM_" "
...
NOTEDSP ; DISPLAY NOTES UNDER BHSPRBLEM
 S BHSNFP=0 F  S BHSNFP=$O(^AUPNPROB(BHSDFN,11,BHSNFP)) Q:'BHSNFP  D DSPFACN
 Q
...
DSPN ; DISPLAY SINGLE NOTE
 ...
 Q
PLDETAIL ;DISPLAY PROBLEM DETAILS IN HEALTH SUMMARY
