BHSBDEM ;IHS/MSC/MGH - Health Summary Demographics  ;01-Dec-2021 11:39;DU
 ;;1.0;HEALTH SUMMARY COMPONENTS;**4,6,9,17**;March 17,2006;Build 11
 ;=================================================================
...
BDEMOG ; ******************** BRIEF DEMOGRAPHICS - W/ADV DIRECTIVES ********************
 ; <SETUP>
 N BHSPAT,BHSDN,BHDNAM,BHSDOB,BHSADR,BHSZ,BHSX,BHPLNG,Y
 S BHSPAT=DFN
 S BHSN=^DPT(BHSPAT,0)
 S BHSNAM=$P(BHSN,U,1)
 S Y=$P(BHSN,U,3)
...
BDEMDSP ; <DISPLAY>
 ...
 .E  W !!
 .;W !
 K ^UTILITY($J,"W"),BHSDSC,DIWL,DIWR,X,BHSX,BHSZ,DIW
 ;IHS/MSC/MGH Patch 17 changed to HRCN
 W !,BHSNAM,"  ",$$VAL^XBDIQ1(2,BHSPAT,.02)," DOB: ",BHSDOB," AGE: ",$$AGE^AUPNPAT(BHSPAT,DT),"  HRCN: ",$$HRCN(BHSPAT,$G(DUZ(2))),!
