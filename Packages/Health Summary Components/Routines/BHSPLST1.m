BHSPLST1 ;IHS/MSC/MGH  - Health Summary for Problem list;06-Mar-2025 14:48
 ;;1.0;HEALTH SUMMARY COMPONENTS;**13,22**;Mar 17,2006;Build 47
 ; IHS/CMI/LAB - PART 4 OF APCHS -- SUMMARY PRODUCTION COMPONENTS ;31-Mar-2014 16:53;DU
 ; IHS/MSC/MIR - p22 FID 118514 PROBDSP+2 PROBDSP+14:15 PROBDSP+20:21
 ;
...
PROBX K BHSDFT,BHSNDF,BHSFPP,BHSFAC,BHSPLN,BHSPBN,BHSDTM,BHSDTN,BHSPRB,BHSTAT,BHSNFP,BHSNRQ,BHSPNM,BHSDFN,BHSFCN,BHSICD,BHSDOO
 ...
 K BHSNFL,BHSNSH,BHSNAB,BHSVSC,BHSITE,Y,BHSVD,BHSX,BHSPAT,BHSPER,I,X,DIAGDT,RESDT
 Q
PROBSCH ;
...
PROBDSP ;
 ...
 S X=$P(BHSN,U,24) S:'X DIAGDT="Unknown" I X D REGDT4^GMTSU S DIAGDT=X
 S X=$P($G(^AUPNPROB(BHSDFN,1)),U,7) I X D REGDT4^GMTSU S RESDT=X
 ...
 S BHSNTE=BHSNTE_" (Diagnosis "_DIAGDT_")"
 S:RESDT BHSNTE=BHSNTE_" (Resolution "_RESDT_")"
