AVA4A7 ; IHS/ORDC/LJF - GIVE PROVIDER KEY,CALLED BY XREF ; 27-MAY-1993
 ...
 ;PATCH 27: REMOVED/COMMENTED OUT INTERACTIONS WITH DELETED FILES #3 (USER) AND #6(PROVIDER)
 ;
 ;
 Q
F6S ;EP;Give provider the key.
 ...
 ;
 ;S AVAX=$P(^DIC(3,AVAY,0),U,16) Q:'AVAX  ;AVA*93.2*27
 ;stuff new person fields into provider file entry
 ;I $D(^DIC(6,AVAX,0))#2 S DIK="^VA(200,",DA=AVAY D IX1^DIK  ;AVA*93.2*27
 Q
 ;
 ;
