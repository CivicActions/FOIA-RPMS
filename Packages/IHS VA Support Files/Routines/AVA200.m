AVA200 ; IHS/OIT/FBD - ADD/ EDIT PERSONS TO VA(200 ;30-Sep-2010 17:29;fbd
 ;;93.2;VA SUPPORT FILES;**1,4,7,8,13,19,21,22,24,27,29**;JUL 01, 1993;Build 1
 ...
 ;PATCH #27 Deactivated references to files 3/6/16 - IHS/OIT/FBD
 ;PATCH #29 Added Direct Address field edit to Add Provider - IHS/OIT/NKD
 ;
 Q
...
PROVIDER(AVADR,AVADR1) ;PEP;EXTR FUNC add/edit one provider
 ...
 S Y=".136;.151;.161;"_X_";9999999.05:9999999.08;53.1;43.99;53.6:53.9" ;IHS/OIT/NKD AVA*93.2*29 - DIRECT ADDRESS
 ...
 .;S DA=$P(^DIC(3,+AVADA,0),U,16) ;IHS/ORDC/LJF 9/13/93 PATCH #1  ;AVA*93.2*27 - COMMENTED OUT
 . S DA=+AVADA  ;AVA*93.2*27 - CONVERTED TO FILE 200 REFERENCE FOLLOWING REMOVAL OF FILES 3/6/16
 .;I DA S DIE=6,DR="9999999.21" D ^DIE ;IHS/ORDC/LJF 9/13/93 PATCH #1  ;AVA*93.2*27 - COMMENTED OUT
 . S DIE=200,DR="54.1" D ^DIE  ;AVA*93.2*27 - CONVERTED TO FILE 200 REFERENCE FOLLOWING REMOVAL OF FILES 3/6/16
