AUM2104 ;IHS/ASDST/GTH - SCB UPDATE 2001 DEC 14 ; [ 01/29/2002   4:01 PM ]
 ...
 D HELP^XBHELP("INTROE","AUM2104")
 ;
 I $G(XPDENV)=1 D
 . ; The following line prevents the "Disable Options..." and "Move
 . ; Routines..." questions from being asked during the install.
 . S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 . D HELP^XBHELP("INTROI","AUM2104")
 .Q
 ;
...
VCHK(AUMPRE,AUMVER,AUMQUIT) ; Check versions needed.
 ...
 Q 1
 ;
INSTALLD(AUM) ; Determine if patch AUM was installed, where AUM is
...
POST ;EP - From KIDS.
 ...
 KILL ^TMP("AUM2104",$J)
 D AUDS,START^AUM21041,START^AUM21042,AUDR
 S XMSUB=$P($P($T(+1),";",2)," ",4,99),XMDUZ=$G(DUZ,.5),XMTEXT="^TMP(""AUM2104"",$J,",XMY(1)="",XMY(DUZ)=""
 ...
 Q:'$L($T(+1^AUMDELR))
 S ZTRTN="DEL^AUMDELR(""AUM2104"")",ZTDESC="Delete routines in the 'AUM2104' namespace.",ZTDTH=$$HADD^XLFDT($H,0,0,30,0),ZTIO="",ZTPRI=1
 D ^%ZTLOAD
...
INTROE ; Intro text during KIDS Environment check.
 ...
 ;;(2) Adds ICD E-codes from "ICD-9-CM 2002", Volumes 1 and 2,
 ;;(3) Corrects two facility names incorrectly mod'd by the LOCATION
 ;;    file comprehensive update in the previous patch (AUM*2.1*3),
 ;;(4) Publishes two PEP's in routine AUMICDU for use by application
 ;;    programmers in determining currencies of ICD codes.
 ;;###
 ;
...
GREET ;;EP - To add to mail message.
 ...
 ;;"hqwhd@mail.ihs.gov".  Please refer to patch "AUM*2.1*4".
 ;;  
