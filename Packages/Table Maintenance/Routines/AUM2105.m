AUM2105 ;IHS/SET/GTH - SCB UPDATE 2002 FEB 07 ; [ 02/08/2002   4:14 PM ]
 ...
 D HELP^XBHELP("INTROE","AUM2105")
 ;
 I $G(XPDENV)=1 D
 . ; The following line prevents the "Disable Options..." and "Move
 . ; Routines..." questions from being asked during the install.
 . S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 . D HELP^XBHELP("INTROI","AUM2105")
 .Q
 ;
...
POST ;EP - From KIDS.
 ...
 KILL ^TMP("AUM2105",$J)
 D AUDS,START^AUM21051,AUDR
 S XMSUB=$P($P($T(+1),";",2)," ",4,99),XMDUZ=$G(DUZ,.5),XMTEXT="^TMP(""AUM2105"",$J,",XMY(1)="",XMY(DUZ)=""
 ...
 Q:'$L($T(+1^AUMDELR))
 S ZTRTN="DEL^AUMDELR(""AUM2105"")",ZTDESC="Delete routines in the 'AUM2105' namespace.",ZTDTH=$$HADD^XLFDT($H,0,0,30,0),ZTIO="",ZTPRI=1
 D ^%ZTLOAD
...
GREET ;;EP - To add to mail message.
 ...
 ;;"hqwhd@mail.ihs.gov".  Please refer to patch "AUM*2.1*5".
 ;;  
