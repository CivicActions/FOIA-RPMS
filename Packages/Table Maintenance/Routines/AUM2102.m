AUM2102 ; IHS/ASDST/GTH - STANDARD TABLE UPDATES, 2001 NOV 02 ; [ 11/15/2001  12:00 PM ]
 ...
 D HELP^XBHELP("INTROE","AUM2102")
 ;
 I $G(XPDENV)=1 D
 . ; The following line prevents the "Disable Options..." and "Move
 . ; Routines..." questions from being asked during the install.
 . S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 . D HELP^XBHELP("INTROI","AUM2102")
 .Q
 ;
...
POST ;EP - From KIDS.
 ...
 KILL ^TMP("AUM2102",$J)
 D AUDS,START^AUM21021,AUDR
 S XMSUB=$P($P($T(+1),";",2)," ",4,99),XMDUZ=$G(DUZ,.5),XMTEXT="^TMP(""AUM2102"",$J,",XMY(1)="",XMY(DUZ)=""
 ...
 Q:'$L($T(+1^AUMDELR))
 S ZTRTN="DEL^AUMDELR(""AUM2102"")",ZTDESC="Delete routines in the 'AUM2102' namespace.",ZTDTH=$$HADD^XLFDT($H,0,0,30,0),ZTIO="",ZTPRI=1
 D ^%ZTLOAD
...
INTROE ; Intro text during KIDS Environment check.
 ...
 ;;Herrera, date stamped November 02, 2001.
 ;;###
 ;
