BWYNOTP ; GENERATED FROM 'BW PRINT NOTIF PURPOSE&LETTER' PRINT TEMPLATE (#1662) ;15-Feb-2003 22:16;PLS
...
BEGIN ;
 ...
 I $D(DXS)<9 M DXS=^DIPT(1662,"DXS")
 S I(0)="^BWNOTP(",J(0)=9002086.404
 W ?0 S:$D(BWPAGE) BWPAGE=BWPAGE+1 K DIP K:DN Y
 ...
 D N:$X>69 Q:'DN  W ?69 W:$D(BWPAGE) "PAGE "_BWPAGE K DIP K:DN Y
 ...
 S X=$G(^BWNOTP(D0,0)) W ?1,$E($P(X,U,1),1,50)
 ...
 W ?0 W " LETTER:"
 D T Q:'DN  D N W ?0 W ""
 S:'$D(DIWF) DIWF="" S:DIWF'["N" DIWF=DIWF_"N" S X="" S I(1)=1,J(1)=9002086.414 F D1=0:0 Q:$O(^BWNOTP(D0,1,D1))'>0  S D1=$O(^(D1)) D:$X>2 T Q:'DN  D A1
 G A1R
A1 ;
 S X=$G(^BWNOTP(D0,1,D1,0)) S DIWL=3,DIWR=78 D ^DIWP
 Q
A1R ;
 D A^DIWW
 D T Q:'DN  W ?2 D:$E(IOST)="C" DIRZ^BWUTL3 K DIP K:DN Y
