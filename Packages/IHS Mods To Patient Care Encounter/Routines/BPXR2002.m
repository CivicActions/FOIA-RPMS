BPXR2002 ; IHS/MSC/MGH - Version 2.0 Patch 2002 environment check routine ;18-Jan-2022 16:48
 ;;2.0;CLINICAL REMINDERS;**2002**;Feb 04, 2005;Build 11
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*2001") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 2001.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.22*1") D MES^XPDUTL($$CJ^XLFSTR("Requires acpt V2.22 patch 1.  Not installed.",80)) D SORRY(2)
 Q
