BPXR2008 ; IHS/MSC/MGH - Version 2.0 Patch 2006 environment check routine ;7-Dec-2022 16:48
 ;;2.0;CLINICAL REMINDERS;**2008**;Feb 04, 2005;Build 19
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*2007") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 2007.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.22*12") D MES^XPDUTL($$CJ^XLFSTR("Requires acpt V2.22 patch 12.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("BI*8.5*1011") D MES^XPDUTL($$CJ^XLFSTR("Requires bi V8.5 patch 1011.  Not installed.",80)) D SORRY(2)
 Q
