BPXRM214 ; IHS/MSC/MGH - Version 2.0 Patch 1014 post routine. ;28-Dec-2021 10:14;du
 ;;2.0;CLINICAL REMINDERS;**1014**;Feb 04, 2005;Build 21
 ;
ENV ;EP environment check
 ...
 S IN="EHR*1.1*35",INSTDA=""
 I '$D(^XPD(9.7,"B",IN)) D  Q
 .W !,"You must first install the EHR patch 35 before installing patch PXRM 2014"
 S INSTDA=$O(^XPD(9.7,"B",IN,INSTDA),-1)
 S STAT=+$P($G(^XPD(9.7,INSTDA,0)),U,9)
 I STAT'=3 D  Q
 .W !,"EHR patch 35 must be completely installed before installing PXRM patch 2014"
 S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 D MES^XPDUTL($$CJ^XLFSTR("EHR Patch 35 is installed.",IOM))
 Q
