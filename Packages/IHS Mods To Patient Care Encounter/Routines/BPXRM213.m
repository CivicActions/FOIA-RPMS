BPXRM213 ; IHS/MSC/MGH - Version 2.0 Patch 1013 post routine. ;27-Oct-2021 15:26;DU
 ;;2.0;CLINICAL REMINDERS;**1013**;Feb 04, 2005;Build 9
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*1012") D MES^XPDUTL($$CJ^XLFSTR("Requires PXRM V2.0 patch 1012.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("TIU*1.0*1024") D MES^XPDUTL($$CJ^XLFSTR("Requires TIU V1.0 patch 1024.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.21*9") D MES^XPDUTL($$CJ^XLFSTR("Requires ACPT V2.21 patch 9.  Not installed.",80)) D SORRY(2)
 Q
