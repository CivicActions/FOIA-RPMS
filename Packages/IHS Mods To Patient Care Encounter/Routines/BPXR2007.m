BPXR2007 ; IHS/MSC/MGH - Version 2.0 Patch 2006 environment check routine ;19-Oct-2022 16:48
 ;;2.0;CLINICAL REMINDERS;**2007**;Feb 04, 2005;Build 12
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*2006") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 2006.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.22*10") D MES^XPDUTL($$CJ^XLFSTR("Requires acpt V2.22 patch 10.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("BI*8.5*1010") D MES^XPDUTL($$CJ^XLFSTR("Requires bi V8.5 patch 1010.  Not installed.",80)) D SORRY(2)
 Q
