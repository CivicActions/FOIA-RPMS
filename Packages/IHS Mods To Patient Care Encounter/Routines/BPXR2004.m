BPXR2004 ; IHS/MSC/MGH - Version 2.0 Patch 2003 environment check routine ;27-Jun-2022 16:48
 ;;2.0;CLINICAL REMINDERS;**2004**;Feb 04, 2005;Build 49
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*2003") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 2003.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.22*7") D MES^XPDUTL($$CJ^XLFSTR("Requires acpt V2.22 patch 7.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("BI*8.5*1007") D MES^XPDUTL($$CJ^XLFSTR("Requires bi V8.5 patch 1007.  Not installed.",80)) D SORRY(2)
 Q
