BPXR2006 ; IHS/MSC/MGH - Version 2.0 Patch 2006 environment check routine ;15-Sep-2022 16:48
 ;;2.0;CLINICAL REMINDERS;**2006**;Feb 04, 2005;Build 9
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*2005") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 2004.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.22*9") D MES^XPDUTL($$CJ^XLFSTR("Requires acpt V2.22 patch 8.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("BI*8.5*1008") D MES^XPDUTL($$CJ^XLFSTR("Requires bi V8.5 patch 1008.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("TIU*1.0*1026") D MES^XPDUTL($$CJ^XLFSTR("Requires tiu V1.0 patch 1026.  Not installed.",80)) D SORRY(2)
 Q
