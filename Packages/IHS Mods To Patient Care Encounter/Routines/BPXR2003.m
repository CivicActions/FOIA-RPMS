BPXR2003 ; IHS/MSC/MGH - Version 2.0 Patch 2003 environment check routine ;08-Apr-2022 16:48
 ;;2.0;CLINICAL REMINDERS;**2003**;Feb 04, 2005;Build 25
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*2002") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 2001.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.22*4") D MES^XPDUTL($$CJ^XLFSTR("Requires acpt V2.22 patch 4.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("BI*8.5*1005") D MES^XPDUTL($$CJ^XLFSTR("Requires bi V8.5 patch 1005.  Not installed.",80)) D SORRY(2)
 Q
