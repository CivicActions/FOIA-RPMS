BPXRM210 ; IHS/MSC/MGH - Version 2.0 Patch 1010 post routine. ;11-Feb-2021 15:29;DU
 ;;2.0;CLINICAL REMINDERS;**1010**;Feb 04, 2005;Build 17
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*1009") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 1008.  Not installed.",80)) D SORRY(2)
 ;Check for the installation of other patches
 I '$$INSTALLD("BI*8.5*1000") D MES^XPDUTL($$CJ^XLFSTR("Requires BI V8.5 patch 1000.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.20*9") D MES^XPDUTL($$CJ^XLFSTR("Requires ACPT V2.20 patch 9.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("TIU*1.0*1023") D MES^XPDUTL($$CJ^XLFSTR("Required TIU V1 patch 1023.  Not installed.",80)) D SORRY(2)
 Q
