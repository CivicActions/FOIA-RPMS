BPXR2005 ; IHS/MSC/MGH - Version 2.0 Patch 2003 environment check routine ;16-Aug-2022 16:48
 ;;2.0;CLINICAL REMINDERS;**2005**;Feb 04, 2005;Build 6
 ;
ENV ;EP environment check
 ...
 I '$$INSTALLD("PXRM*2.0*2004") D MES^XPDUTL($$CJ^XLFSTR("Requires pxrm V2.0 patch 2004.  Not installed.",80)) D SORRY(2)
 I '$$INSTALLD("ACPT*2.22*8") D MES^XPDUTL($$CJ^XLFSTR("Requires acpt V2.22 patch 8.  Not installed.",80)) D SORRY(2)
