ORIN1019 ;IHS/CIA/PLS - KIDS Inits for OR patch 1019 ;13-Feb-2020 08:39;DU
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**1019**;Dec 17, 1997;Build 3
 ;=================================================================
...
PRE ;EP - Preinit
 ...
 ;
POST ;EP - Postinit
 D CHKOR("PSJI OR PAT FLUID OE","OR GTX STRENGTH PSIV")
 D CHKOR("PSO OERR","OR GTX QUANTITY")
 Q
 ;
