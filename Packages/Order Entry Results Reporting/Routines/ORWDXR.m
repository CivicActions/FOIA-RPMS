ORWDXR ; SLC/KCM/JDL - Utilites for Order Actions;03-May-2006 15:44;DKM
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,125,131,134,141,149,187,190,1004**;Dec 17, 1997
 ;
...
RENEW(REC,ORIFN,ORVP,ORNP,ORL,FLDS,CPLX,ORAPPT) ; Renew an order
 ...
 . ; IHS/CIA/DKM - 10/26/05 - Added next 4 lines for chronic med support
 . I $L($T(^BEHORXFN)) D
 . . N CMF
 . . S CMF=$$GETCMF1^BEHORXFN(+ORIFN)
