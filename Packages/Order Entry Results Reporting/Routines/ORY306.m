ORY306 ;ISL/TC,JER - Pre- and Post-install for patch OR*3*306 ;26-Jan-2018 09:30;PLS
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**306,1017**;Dec 17, 1997;Build 47
 ;
 ;IHS/MSC/MGH  Only items needed for EPCS included from CPRS 29
...
POST ; Initiate post-init processes
 ;D SETMGS
 ;D REGRPCS
 D REGNMSP^CIAURPC("ORDEA","OR CPRS GUI CHART")
...
LOAD ; load data into ^TMP (expects ROOT to be defined)
 ...
 . S @(ROOT_REF)=VAL
 Q
UPMENU ;IHS/MSC/MGH remove and inactivate the option to manually set EPCS users
 S RESULT=$$DELETE^XPDMENU("OR EPCS MENU","OR EPCS USERS PARAMETER")
 D OUT^XPDMENU("OR EPCS USERS PARAMETER","This activity can only be done in the EHR.")
 Q
DATA ; parameter data
 ;;7000,"KEY")
