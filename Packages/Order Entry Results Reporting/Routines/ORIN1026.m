ORIN1026 ;IHS/CIA/PLS - KIDS Inits for OR patch 1026 ;16-Jan-2024 12:32;PLS
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**1026**;Dec 17, 1997;Build 3
 ;=================================================================
...
PRE ;EP - Preinit
 ...
 ;
POST ;EP - Postinit
 ;Set POLICY Nature of Order to require signature
 N PIEN
 S PIEN=$$FIND1^DIC(100.02,,"X","POLICY")
 S:PIEN $P(^ORD(100.02,PIEN,1),U,4)=2  ;Set to require signature
 Q
 ;
