BARFPST3 ; IHS/SD/LSL - A/R FLAT RATE POSTING #3 ; 05/18/2020
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,6,10,21,23,30,35**;OCT 26, 2005;Build 187
...
HIT(BARPASS)       ; EP
 ...
 .I $O(^BARTR(DUZ(2),"AM4",+BARBDA)) S BARBLO="m"_BARBLO
 .S BARSTOP=$$CHKLINE(0)
 .Q:BARSTOP
 .S BARCMSG="      "
 ...
 .W !,$J(BARLIN,3)
 .W ?5,$$SHDT^BARDUTL($P(BARREC,U))
 .W ?14,BARBLO
 .W ?36,$J($P(BARREC,U,3),8,2)
 .W ?46,$E($P(BARREC,U,4),1,23)
 .W ?70,$J($P(BARREC,U,5),8,2)
 .;BAR*1.8*30 CR9409 IHS/SD/CPC - 20200518 END
 Q
HD      ; header ;BAR*1.8*30 CR9409 IHS/SD/CPC - 20200518
 ...
 ;start old bar*1.8*35 IHS/SD/SDR ADO60910
 ;W " from "_$$SDT^BARDUTL($P(BARPASS,U,2))
 ;W " to "_$$SDT^BARDUTL($P(BARPASS,U,3))
 ;W ?(IOM-15),"Page: "_BARPG
 ;end old start new bar*1.8*35 IHS/SD/SDR ADO60910
...
CHKLINE(BARHD)     ;
 ...
 D EOP^BARUTL(0)
 I 'Y Q 1
 D HD  ;BAR*1.8*30 CR9409 IHS/SD/CPC - 20200518
 Q 0
 ;**********************************************
ASKLIN ; EP
