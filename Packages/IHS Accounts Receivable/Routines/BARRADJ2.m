BARRADJ2 ; IHS/SD/TPF - TRANSACTION/ADJUSTMENT REPORT ;08/20/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**6,7,19,20,21,23,24,31**;OCT 26, 2005;Build 90
 ; IHS/SD/POT 03/20/12 HEAT60464 FIX INITIAL VALUE OF DSRCTOT ;BAR*1.8*23
 ; IHS/SD/POT 03/19/13 HEAT107110 FIX TOTALS ;BAR*1.8*23
 ; IHS/SD/POT 01/15/14 HEAT124730 ADD DOS TO RPT ;BAR*1.8*24
 ; IHS/SD/POT 02/18/14 HEAT153046 FIX TOTALS (COLUMN TRANSACTIONS) ;BAR*1.8*24
 ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938 ADD PRIM PROV-DETAIL RPT;OPT FOR XML RPT
 ;            MVD PART OF RTN TO BARRADJ3
 Q
 ;
DETAIL ; EP
 ...
 ;TT = 40 FOR PAY TRANS TYPE
 ;AND 43 FOR AN ADJUST ACCOUNT
 ;AND 993 FOR 'STATUS CHANGE' TRANS TYPE  ;bar*1.8*19*ADD*TMM
 ...
 ;D:'BARTEXT HDB  ;Page-column header   ;BAR*1.8.*31
 D:BARTEXT="P" HDB^BARRADJ3  ;Page-column header ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ...
 S DSRCTOT=0  ;HEAT#60464 FIX INITIAL VALUE OF DSRCTOT
 ;
 K I,Y,X
 S BARDASH="                                          ----------     ----------"
 S BAREQUAL="                                         ==========     =========="
 ...
 S BAR="^"_BAR("Z")_")"
 ;I '$D(@BAR) D  Q  ;BAR*1.8.*31
 I BARTEXT'="X",'$D(@BAR) D  Q  ;No data ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 . W $$CJ^XLFSTR("*** NO DATA TO PRINT FOR "_$P($G(^DIC(4,DUZ(2),0)),U)_" ***",IOM)
 . D EOP^BARUTL(0)
 . I $D(DTOUT)!$D(DUOUT)!$D(DIROUT) S BAR("F1")=1 Q  ;IHS/SD/AR 1.8*19
 I BARTEXT="X",'$D(@BAR) D NODATA^BARRADJ4 Q  ;No data-xml;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 S BARBILLO=""  ;BAR*1.8*6
 F  S BAR=$Q(@BAR) Q:BAR[("BAR-TSRS")  D  Q:$G(BAR("F1"))
 . ;OLD CODE I $Y>(IOSL-5) D HD Q:$G(BAR("F1"))  D SUBHD  ;
 . ;I 'BARTEXT I $Y>(IOSL-5) D HD Q:$G(BAR("F1"))  D SUBHD  ;BAR*1.8*24;BAR*1.8.*31
 .I BARTEXT="P",$Y>(IOSL-5) D HD^BARRADJ3 Q:$G(BAR("F1"))  D SUBHD  ;BAR*1.8*24 (NO PAGING);BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ...
 .S BAR(14)=$P(BAR("NODE"),U,14)  ;Primary Provider  ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 .S BAR(15)=$S($P(BAR("NODE"),U,15)'="":$P(BAR("NODE"),U,15),1:99999)  ;Visit   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 .S BAR(16)=$S($P(BAR("NODE"),U,16)'="":$P(BAR("NODE"),U,16),1:99999)  ;Clinic  ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 .;I BARTEXT D      ;BAR*1.8.*31
 .I (BARTEXT="D")!(BARTEXT="X") D   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ..Q:$L(BAR("NODE"),U)<10
 ..N BARDLMTD
 ..S BARDLMTD("CLINICVISIT")="NONE"
 ..S BARDLMTD("VISIT")=$P(BAR("TXT"),U,2)
 ..I BARTEXT="X" D   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ...S BARDLMTD("CLINIC")=$S(BAR(16)=99999:"NO CLINIC",1:$P(^DIC(40.7,BAR(16),0),U))   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ...S BARDLMTD("VISITTYP")=$S(BAR(15)=99999:"NO VISIT TYPE",1:$P($G(^ABMDVTYP(BAR(15),0)),U))   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ..I BARY("SORT")="C" D
 ...
 ..S BARDLMTD("PV")=$S(BAR(14):$$GET1^DIQ(200,BAR(14),.01),1:"No Primary Provider") ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ..I BARTEXT="X" D DETAIL^BARRADJ4   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 ...
 ...;IHS/SD/POT BAR*1.8*24 ADDED DOS;BAR*1.8.*31 IHS.OIT.FCJ CR#8938 AND LINE WAS TOO LONG FOR SAC ADDED IF
 ...
 ...W:BARY("SORT")="N" !,BARDLMTD("VISIT")_U_BARDLMTD("ADJCAT")_U_BARDLMTD("BILLNUM")_U_BARDLMTD("DOS")_U_BARDLMTD("TRANSDATE")_U_BARDLMTD("INSURER")_U_BARDLMTD("BILLAMT")_U_BARDLMTD("TRXNAMT")_U_BARDLMTD("ADJTYPE")_U_BARDLMTD("PV")
 ...I BARY("SORT")'="N" D
 ....W !,BARDLMTD("VISIT")_U_BARDLMTD("CLINICVISIT")_U_BARDLMTD("ADJCAT")_U_BARDLMTD("BILLNUM")_U_BARDLMTD("DOS")_U_BARDLMTD("TRANSDATE")_U_BARDLMTD("INSURER")_U_BARDLMTD("BILLAMT")_U_BARDLMTD("TRXNAMT")_U_BARDLMTD("ADJTYPE")_U_BARDLMTD("PV")
 ..E  D
 ...;IHS/SD/POT BAR*1.8*24 ADDED DOS;BAR*1.8.*31 IHS.OIT.FCJ CR#8938 ADD PRIM PROV
 ...
 ...W:BARY("SORT")="N" !,BARDLMTD("VISIT")_U_BARDLMTD("BILLNUM")_U_BARDLMTD("DOS")_U_BARDLMTD("TRANSDATE")_U_BARDLMTD("INSURER")_U_BARDLMTD("BILLAMT")_U_BARDLMTD("TRXNAMT")_U_BARDLMTD("PV")
 ...W:BARY("SORT")'="N" !,BARDLMTD("VISIT")_U_BARDLMTD("CLINICVISIT")_U_BARDLMTD("BILLNUM")_U_BARDLMTD("DOS")_U_BARDLMTD("TRANSDATE")_U_BARDLMTD("INSURER")_U_BARDLMTD("BILLAMT")_U_BARDLMTD("TRXNAMT")_U_BARDLMTD("PV")
 .;Q:BARTEXT      ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 .Q:(BARTEXT="D")!(BARTEXT="X")  ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938
 .I BARPREV="BEGIN" D
 ..S BARPREV=BAR(12)
 .E  D
 ...
 .;ADD SUBTOT IF NEW BILL. DON'T ADD IF BILL HAS ALREADY BEEN COUNTED
 ...
 I BARTEXT="X" Q   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938         
 ;Q:$G(BAR("F1"))!BARTEXT        ;BAR*1.8.*31
 Q:$G(BAR("F1"))!(BARTEXT="D")   ;BAR*1.8.*31 IHS.OIT.FCJ CR#8938  
 I SUMMARY D GETCOUNT
 W !,BARDASH
 D SUBSORT ;2 LINES SWAPPED 107110 FIXING TOTALS ; Tot by Sort type
 D SUBDSRC ;Tot by Data Source
 W ! D SUBTRAN
 W ! D SUBLOC
 D TOT
 Q
SUBHD ;
 ...
 Q
SUBTRAN ;EP - TOTALS BY TRANS TYPE
