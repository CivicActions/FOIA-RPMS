BARCLU ; IHS/SD/LSL - USER ENTRY INTO COLLECTION BATCHES ;; 07/09/2010
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,6,16,18,19,23,24,30**;OCT 26,2005;Build 55
 ;;
 ...
 ; IHS/SD/CPC CR10550 20200705 - BAR*1.8*30
 ; ********************************************************************* ;
 ;
ENTRY ;
...
ENTER ; EP
 ...
 W ?57,"BATCH TOTAL: ",$$GET1^DIQ(90051.01,BARCLDA,15)  ;IHS/SD/CPC BAR*1.8*30 CR10550
