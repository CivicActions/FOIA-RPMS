BARCLU4 ; IHS/SD/LSL - COLLECTION BATCH PREPAYMENTS ;; 07/09/2010
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**19,35**;OCT 26, 2005;Build 187
 ;;
 ; 
 ...
 ;IHS/SD/SDR 1.8*35 ADO60910 Added Preferred Name PPN to display
 ; *********************************************************************
 ;
...
DISPPAY ;   Display all Prepayments not assigned to a collection batch
 ...
 ...I $$GETPREF^AUPNSOGI(BARPPAY(.08,"I"),"I",1)'="" S BARPTNM=BARPTNM_" - "_$$GETPREF^AUPNSOGI(BARPPAY(.08,"I"),"I",1)_"*"  ;bar*1.8*35 IHS/SD/SDR ADO60910
