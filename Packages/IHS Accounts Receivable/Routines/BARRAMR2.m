BARRAMR2 ; IHS/SD/LSL - Aging management report ;08/20/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**7,23,24,29**;OCT 26, 2005;Build 66
...
DETAIL ; EP
 ...
 . S BARTST=""""_""""
 .I $L(BAR,BARTST)>1 D  ;ADD TO CATCH "" IN BAR VARIABLE WHEN LITERAL IS CONTAINED IN STRING ;IHS/SD/CPC - 20191111 CR 10586
 ..N L F L=1:1:$L(BAR,BARTST)-1 S BARCNTTMP=BARCNTTMP_$P(BAR,BARTST,L)_"'"
 ..K L
 ..S BARCNTTMP=BARCNTTMP_$P(BAR,BARTST,$L(BAR,BARTST))
 ..S:$G(BARCNTTMP)]"" BAR=BARCNTTMP
 ..K BARCNTTMP,BARCNTX,BARTST
 ..Q
