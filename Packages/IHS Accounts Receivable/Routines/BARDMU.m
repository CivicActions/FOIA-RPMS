BARDMU ;IHS/OIT/FCJ - DEBT MANAGEMENT UTILITY ROUTINE ; 26 May 2011  8:33 AM
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**22,23,24,35**;OCT 26, 2005;Build 187
 ;New routine 5-12-2011 for Debt Letter Management
 ;IHS/SD/POT 1.8*23 JAN 2013 ADDED SORTING PARAMETER, PRT BILL DATE (TO SITE PARAMETERS)
 ;IHS/SD/POT 1.8*23 FEB 2013 CHANGED PTR TO INSURER TYPE
 ;IHS/SD/POT 1.8*24 HEAT118656 JUL 2013 BELCOURT: SKIP UNDEF ENTRY IN ^BARBL
 ;IHS/SD/POT 1.8*24 HEAT152452 2/10/2014 CHK IF PAR/SAT FILE CORECTLY SET UP
...
ACC ;ACCOUNT SELECTION
 ...
 S BARQ=0
 ;S (DIE,DIC)="^BARAC("_DUZ(2)_",",DIC(0)="AEQZ",DR=7  ;bar*1.8*35 IHS/SD/SDR ADO60910
 S (DIE,DIC)="^BARAC("_DUZ(2)_",",DIC(0)="AEQZMI",DR=7  ;bar*1.8*35 IHS/SD/SDR ADO60910
 F  D  Q:BARQ
