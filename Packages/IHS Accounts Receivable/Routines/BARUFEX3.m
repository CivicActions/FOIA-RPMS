BARUFEX3 ; IHS/SD/TPF - CONTINUATION OF EXPORT TO PROCESS PAYMENTS ;10/31/08
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**4,6,7,8,23,33**;OCT 26, 2005;Build 133
 ;NEW ROUTINE ;ITEM 1 OF SCR58 1/2/2008
 ;BAR*1.8*4 DD ITEM 4.1.1
 ;IHS/SD/SDR 1.8*33 ADO60817 Corrected output so it will be date/time and not TRDFN since the TRDFN is no longer
 ;   date/time, it is now date/time/counter; it looks like what I changed was for testing only, but changed anyway
 ;   just to be safe
 ;
...
FINDREV ;EP - FIND REVERSALS ON THE SYSTEM - THIS IS FOR TESTING ONLY
 ...
 ..S BARTRDT=$$GET1^DIQ(90050.03,TRDATE,".011","E")
 ..W !!!,"FACILITY: ",FACILITY
 ..W !,"BILL: ",ARBILL
 ..;W !,"TRDATE: ",TRDATE  ;bar*1.8*33 IHS/SD/SDR ADO60817
 ..W !,"TRDATE: ",BARTRDT  ;bar*1.8*33 IHS/SD/SDR ADO60817
 ..W !,"TRANTYPE: ",TRANTYPE
 ..W !,"REVDATE: ",REVDATE
 ..W !,"SCHEDNUM: ",SCHEDNUM
 ..W !,"ARCOL: ",ARCOL
