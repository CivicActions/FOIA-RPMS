BARCLU1 ; IHS/SD/LSL - UTILITY CALLS FROM BARCLU ; 07/09/2010
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,19,23,30**;OCT 26, 2005;Build 55
 ;;
...
DISPLAY ; EP
 ...
 W ?50,"BATCH TOTAL: ",$$GET1^DIQ(90051.01,BARCLDA,15)  ;;BAR*1.8*30 Move 2 to right no cr
 ...
 ..I $G(BARCLIT(BARFLD))]"" W !,?3,BARNM,?27,BARCLIT(BARFLD)  ;BAR*1.8*30 CR10550
 I $D(BARCLIT(301)) D
 .W !,"COMMENTS"
...
FLD2 ;;7;A/R ACCOUNT^201;PAYOR^8;LOCATION OF SERVICE^10;INPAT/OUTPAT^5;PATIENT^6;BILL^16;AUTO PRINT^20;TREASURY DEP/IPAC #
