BARUFSUP ; IHS/SD/TPF - SUPERVISORY FUNCTIONS FOR UFMS ; 04/09/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,17,21,22,23,30,37**;OCT 26, 2005;Build 210
 ;IHS/SD/POT HEAT#62222 MAR2012 ADDED CALL $$GETDAY0^BARUFUT1
 ;IHS/SD/POT HEAT#71924 JUN2012 in UUE replaced PRINT^TIMTEST with PRINT^BARUFSUP
 ;IHS/SD/POT NOHEAT AUG2013 CHOCKTAW REQUEST: LIMIT DISPLAY FOR NON-IHS
 ;IHS/SD/SDR 1.8*37 ADO60825 Made ERA/PST populate the ERA side correctly
 Q
 ;
...
LOOP(UDUZ,STAT,LINE,LIST,PRTSTAT) ;EP - GET DATA FROM SESSION LEVEL
 ...
 .;S ERASTAT=$E($$GET1^DIQ(90057.11,IENS,.04,"E"))  ;bar*1.8*37 IHS/SD/SDR ADO60825
 .S ERASTAT=$S($E($$GET1^DIQ(90057.11,IENS,.04,"E"))="Y":"Y",1:"N")  ;bar*1.8*37 IHS/SD/SDR ADO60825
 .S POSTING=$$STILPOST^BARUFUT1(UDUZ)
 ...
 .;W ?58,$S(PRTSTAT="ALL STATUSES":$E(STAT,1,14),1:""),?72,$S(+POSTING&(STAT="OPEN"):"*",1:""),?75,ERASTAT,?76,"\",?77,$S(+POSTING=1&(CURSTAT="OPEN"):"Y",1:"")  ;bar*1.8*37 IHS/SD/SDR ADO60825
 .W ?58,$S(PRTSTAT="ALL STATUSES":$E(STAT,1,14),1:""),?75,ERASTAT,?76,"\",?77,$S(+POSTING=1&(CURSTAT="OPEN"):"Y",1:"N")  ;bar*1.8*37 IHS/SD/SDR ADO60825
 Q
 ;
