BAR50P09 ; IHS/SD/LSL - FIND ERA CHECKS AND MATCH TO RPMS ;07/08/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,4,5,6,20,21,22,23,24,29,30**;OCT 26,2005;Build 55
 ...
 ;IHS/SD/POT            12/19/2013 FIXED UNDEF Y - BAR*1.8*.23
 ;IHS/SD/POT HEAT152930 2.12.2014 CONVERTED BATCHEIN AND BATCHDATE TO EXTERNALS - BAR*1.8*.24
 ;IHS/SD/CPC ;BAR*1.8*29 CR5993 - Prevent selection of batch > 180 days for IHS sites.
...
CHECK(IMPDA) ; EP
 ...
 Q:'+Y 0  ;P.OTT 12/19/2013 FIXED UNDEF Y - BAR*1.8*.23
 D STORE
 W $$EN^BARVDF("IOF")
 D DISPLAY
...
BATCHECK ;
 ...
 . S BARXCHK=$$BARXCHK^BAREDP09(BARCHKN) ;- BAR*1.8*.23
 ...
 . . S BARBATCH=0 F  S BARBATCH=$O(^BARCOL(DUZ(2),"D",BARXCHK,BARBATCH)) Q:'+BARBATCH  D
 . . . NEW X,BARCBDT ;P.OTT
...
MATCH ;
 ...
 .I $L($$GET1^DIQ(90056.02011,IENS,.01))<31 W ?40,"Matching...  "   ; IHS/SD/CPC CR10550 20200705 - BAR*1.8*30
 .E  W !,?4,"Matching..."         ; IHS/SD/CPC CR10550 20200705 - BAR*1.8*30
 .; chk if prev. matched
...
DISPLAY ;
 ...
 .W ?10,$J($FN($P(BARREC,U,3),",",2),12),?24
 .I $L($P(BARREC,U))<20 W $P(BARREC,U)    ;BAR*1.8*30 CR10550
 .I $L($P(BARREC,U))>19 W $$PRTFMT^BARCHKU1($P(BARREC,U),19)    ;BAR*1.8*30 CR10550
 .I $P(BARREC,U,7)="" W ?47,"NOT FOUND"
 .I $P(BARREC,U,7)'="" D
 ..S IENS=BARI_","_IMPDA_","
 ..W ?47,$$GET1^DIQ(90056.02011,IENS,.07)_"  "_$P(BARREC,U,8)
 .I $L($P(BARREC,U))>19 W !,?4,"FULL CHECK #: ",$P(BARREC,U,1)    ;BAR*1.8*30 CR10550
 ;BAR*1.8*30 CR10550
 Q
SETHDR ;
 ;Set up Rpt Hdr
