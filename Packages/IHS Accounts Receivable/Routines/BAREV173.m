BAREV173 ; IHS/SD/LSL - ENVIRONMENT CHECK V1.7 Patch 3;  [ 09/11/2003  10:51 AM ]
 ;;1.7;IHS ACCOUNTS RECEIVABLE;**3**;MAY 2, 2003
 ;
 I '$G(DUZ) D  Q
 ...
 D HELP^XBHELP("INTROE","BAREV173")
 ;
 I $G(XPDENV)=1 D
 . ; The following line prevents the "Disable Options..." and "Move
 . ; Routines..." questions from being asked during the install.
 . S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 . D HELP^XBHELP("INTROI","BAREV173")
 . Q
 ;
...
INTROE ; Intro text during KIDS Environment check.
 ;;This distribution updates Accounts Receivable V1.7 with Patch 3 modifications.
 ;;This patch will resolve the issue of duplicates bills in AR when printed from
 ;;3P.  Also, a mailman message is sent to AR managers listing existing
 ;;possible duplicate bills currently in the AR system.
 ;;###
 ;;
 ;
