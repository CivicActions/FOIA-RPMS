BARUFRP3 ; IHS/SD/TPF - UFMS REPORTS SECONDARY CALLS ;
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**6,13,20,22,23,30,35**;OCT 26, 2005;Build 187
 ;IHS/SD/POT FEB 2013 CHANGED PTR TO INSURER TYPE
 ;IHS/SD/SDR 1.8*35 ADO92427 Set insurer type based on 3P Bill and K BARALLC so it doesn't carry over from previous transaction
 Q
GRNTOT ;EP;
 K PAGE
...
GETDATA ;
 ...
 S TPBDUZ=$$GET1^DIQ(90050.01,BLLIEN_",",22,"I")  ;bar*1.8*35 IHS/SD/SDR ADO92427
 S TRANTYP=$$GET1^DIQ(90050.03,IENS,101,"E")
 S ADJCAT=$$GET1^DIQ(90050.03,IENS,102,"E")
 ;S BARIIEN=$$INSIEN^BARUTL("BILL",BLLIEN,DUZ(2))  ;bar*1.8*35 IHS/SD/SDR ADO92427
 ;start new bar*1.8*35 IHS/SD/SDR ADO92427
 S BARIIEN=$P($G(^ABMDBILL(TPBDUZ,TPBIEN,0)),U,8)  ;active insurer
 K BARALLC
 ;end new bar*1.8*35 IHS/SD/SDR ADO92427
 I BARIIEN'="" D
