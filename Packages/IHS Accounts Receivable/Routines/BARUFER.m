BARUFER ; IHS/SD/TPF - UFMS ERROR RESOLUTION ; 10/24/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,7,8,23,33**;OCT 26, 2005;Build 133
 ;
 ;IHS/SD/SDR 1.8*33 ADO60817 Changed transaction date to use .011 for date/time instead of IEN which is no longer date time
 ;
 Q
 ;
