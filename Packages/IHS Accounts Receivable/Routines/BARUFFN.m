BARUFFN ; IHS/SD/TPF - UFMS REPORT BY FILENAME ; 03/03/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,20,23,35**;OCT 26, 2005;Build 187
 ;IHS/SD/SDR 1.8*35 ADO76095 Changed where it writes 'PRE-UFMS COLLECTIONS'; if the IPAC is blank and before BOOKING
 ;   DATE IN UFMS, then it will print 'PRE-UFMS COLLECTIONS'; if blank and after that date it will print '<NONE>'
 Q
 ;
...
FNDATA(FILENAME) ;EP - PULL FILE DATE
 ...
 ..;S:IPAC="" IPAC="PRE-UFMS-COLLECTIONS"  ;bar*1.8*35 IHS/SD/SDR ADO76095
 ..;start new bar*1.8*35 IHS/SD/SDR ADO76095
 ..S BARBKDT=$$GET1^DIQ(90052.06,DUZ(2),1505,"I")  ;A/R Site Parameter, BOOKING DATE IN UFMS
 ..I ((IPAC="")&(TRDATE<BARBKDT)) S IPAC="PRE-UFMS-COLLECTIONS"
 ..I ((IPAC="")&(TRDATE>(BARBKDT-1))) S IPAC="<NONE>"
 ..;end new bar*1.8*35 IHS/SD/SDR ADO76095
 ..;
 ..S (TPBILL)=""
