BAREV175 ; IHS/SD/LSL - ENVIRONMENT CHECK V1.7 Patch 5;  [ 03/02/2003  03:39 PM ]
 ...
 D HELP^XBHELP("INTROE","BAREV175")
 ;
 I $G(XPDENV)=1 D
 . ; The following line prevents the "Disable Options..." and "Move
 . ; Routines..." questions from being asked during the install.
 . S (XPDDIQ("XPZ1"),XPDDIQ("XPZ2"))=0
 . D HELP^XBHELP("INTROI","BAREV175")
 . Q
 ;
...
INTROE ; Intro text during KIDS Environment check.
 ;;This distribution updates Accounts Receivable V1.7 with Patch 5 modifications.
 ;;This patch is cumulative of previous patches (1-4) and also accomodates
 ;;Remittance Advice Remark Codes and NCPDP Payment/Reject Codes whether
 ;;posted either manually (2 new menu options) or via ERA. Two additional menu
 ;;options have been added allowing inquiry to Standard Adjustment Reasons and
 ;;Remark Codes respectively.  This patch also resolves 7 support center calls
 ;;detailed in the notes file.
 ;;###
 ;;
 ;
