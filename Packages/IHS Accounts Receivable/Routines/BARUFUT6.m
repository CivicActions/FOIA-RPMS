BARUFUT6 ; IHS/SD/TPF - UTILITIES FOR UFMS - PRINT BATCHES WITH SCHEDULE NUMBER POPULATED ;04/10/08
 ...
 ;
 ;IHS/SD/SDR 1.8*6 DD item 4.1.2 added fields check# and check amt
 ;IHS/SD/SDR 1.8*33 ADO60817 Updated to use 'C' xref since DINUM was removed; also fixed so
 ;  report will write to path/filename instead of terminal
 ;
 Q
 ;
EN ;EP - PRINT OUT BATCH AND ITEM WITH SCHEDULE NUMBER POPULATED
 ...
 .S TRDATE=3070930.999999  ;PULL ONLY TRANSACTIONS FROM 10/1/2007 AND AFTER
 .F  S TRDATE=$O(^BARTR(DUZ(2),"C",TRDATE)) Q:'TRDATE  D
 ..S BARTRDFN=0
 ..F  S BARTRDFN=$O(^BARTR(DUZ(2),"C",TRDATE,BARTRDFN)) Q:'BARTRDFN  D
 ...Q:'$$IHS^BARUFUT(DUZ(2))  ;DO ONLY IHS SITES
 ...Q:$$GET1^DIQ(90050.03,BARTRDFN_",",101,"E")'="PAYMENT"  ;A/R TRANSACTIONS, TRANS TYPE'=PAYMENT
 ...S BARCOL=$$GET1^DIQ(90050.03,BARTRDFN_",",14,"I")  ;A/R TRANSACTIONS, A/R COLLECTION BATCH PTR
 ...Q:'BARCOL   ;NO COLLECTION BATCH
 ...S BARITEM=$$GET1^DIQ(90050.03,BARTRDFN_",",15,"I") ;A/R TRANSACTIONS, A/R COLLECTION ITEM NUMBER
 ...I BARITEM="" D  Q    ;NO ITEM NUMBER
 ....S ^XTMP("BARUFUT6",$J,DUZ(2),"NO ITEM#",BARCOL,"MISSING",BARTRDFN)=""
 ...S IPAC=$$GET1^DIQ(90051.1101,BARITEM_","_BARCOL_",",20,"E")
 ...S:'$$GOODIPAC^BARUFEX3(IPAC) IPAC="BAD TDN: "_IPAC
 ...S ^XTMP("BARUFUT6",$J,DUZ(2),IPAC,BARCOL,BARITEM)=BARTRDFN
...
PRINT ;EP - PRINT
 ...
 Q:$G(POP)
 U IO  ;bar*1.8*33 IHS/SD/SDR ADO60817
