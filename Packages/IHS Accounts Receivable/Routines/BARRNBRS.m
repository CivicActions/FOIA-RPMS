BARRNBRS ;  IHS/SD/POT - Non Ben Payment Report PART5
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**24,35**;OCT 26, 2005;Build 187
...
ASK1 F  D  Q:+BARDONE2!(+BARDONE)
 ...
 ;
MSG ; EP      
 ;N X S X=$G(BAR("OPT")) Q:(X="PAY"!(X="TDN"))&($I(BARMSGPT)>1)  ;bar*1.8*35 IHS/SD/SDR ADO60910 - XINDEX finding for $I
 N X S X=$G(BAR("OPT")) Q:(X="PAY"!(X="TDN"))  ;bar*1.8*35 IHS/SD/SDR ADO60910 - XINDEX finding for $I
