BARUFRPT ; IHS/SD/TPF - UFMS DS,NS, TRANSACTION REPORTS ;12/15/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,6,7,10,20,23,30,33**;OCT 26, 2005;Build 133
 Q
 ;THIS ROUTINE IS CALLED BY BAR UFMS 'NOT SENT' REPORT AND BAR UFMS DELAYED SEND REPORT
 ;
 ;IHS/SD/SDR ADO60817 Changed transaction date to use .011 for date/time instead of IEN which is no longer date time
 ;
...
PRINT ;EP - ENTRY POINT FOR REPORT
 ...
 .W !!,BILL
 .;S Y=TRDATE X ^DD("DD") S EXDATE=Y  ;bar*1.8*33 IHS/SD/SDR ADO60817
 .S Y=$$GET1^DIQ(90050.03,TRDATE_",",.011,"I") X ^DD("DD") S EXDATE=Y  ;bar*1.8*33 IHS/SD/SDR ADO60817
 .W ?18,EXDATE
 .W ?40,APPLYTO
