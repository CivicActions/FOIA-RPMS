BARDMRQN ;IHS/OIT/FCJ - DEBT MANAGEMENT-QUE LETTER REPORT
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**22,23,35**;OCT 26, 2005;Build 187
 ;New routine 5-12-2011 for Debt Letter Management
 ;
 ;This report shows recently printed letters by cycle, Insurer and detail
 ;
 ;IHS/SD/POT CODE CLONED FROM BARDMRQ, CALLS  CALC^BARDMRQC
 ;IHS/SD/POT MAY 2013 NOHEAT ADDED LOOP TO DISPLAY LIST AFTER RETURN FROM SELD
 ;IHS/SD/POT AUG 2013 NOHEAT ADDED SUMMARIES (# OF PRINTED BILLS - BARTOT1, TOT $$$ - BARTOT2)
...
SELA ;SELECT ACCOUNT
 ...
 ;S DIC(0)="AEQZ",DIC("A")="View by Account: "  ;bar*1.8*35 IHS/SD/SDR ADO60910
 S DIC(0)="AEQZMI",DIC("A")="View by Account: "  ;bar*1.8*35 IHS/SD/SDR ADO60910
 S DIC("S")="I $P(^(0),U,7)=""Y"""
