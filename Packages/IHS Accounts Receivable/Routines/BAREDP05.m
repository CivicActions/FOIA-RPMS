BAREDP05 ; IHS/SD/LSL - REVIEW CLAIM STATUS ; 01/30/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,4,5,6,20,23,24,26,28,29**;OCT 26,2005;Build 66
 ;
...
INIT ; EP
 ...
 I TRNAME["5010" D INIT^BAR50P05 Q  ;IHS/DIT/CPC - BAR*1.8*29 CR6982
 D GATHER(IMPDA)
 S VALMCNT=LN
 Q
 ;
...
GATHER(IMPDA) ;
 ...
 I TRNAME["5010" D GATHER^BAR50P05(IMPDA) Q   ;IHS/DIT/CPC - BAR*1.8*29 CR6982
...
CLAIM ;
 ...
 .S:REASON'="MM" ^TMP($J,"E",LINE,401,REASDA)=REASCODE_U_$$GET1^DIQ(90056.0205401,REASIENS,.01,"E")_U_$$GET1^DIQ(90056.21,REASCODE,.02,"E")
 S LINE=LINE+1
 Q
 ;
PAD(D,L) ;
...
BROWSE ; Called from Listman screen BAR ERA Claim Review
 I TRNAME["5010" D BROWSE^BAR50P05 Q   ;IHS/DIT/CPC BAR*1.8*29 CR 6982 & 10777
 K CLAIM
 D GETITEM
 Q
 ;
...
AUTOREV ;EP - AUTO REVIEW ;BAR*1.8*6 SCR120 ADD LIST MANAGER PROMPT FOR AUTO-REVIEW
 I TRNAME["5010" D AUTOREV^BAR50P05 Q   ;IHS/DIT/CPC BAR*1.8*29 CR 6982 & 10777
 N CLMDA
 D CLEAR^VALM1
 S CLMDA=0
 ...
 D NEGBAL^BAREDEB(IMPDA,"ERA")  ;note: IHS/TRIBAL CHK INSIDE BAR50EB CHK FOR NEG BAL IN RPMS BILLS HEAT147572 MOD: 2/5/2014 
 ...
 D:$$IHSNEGB^BARUFUT(DUZ(2)) NONPAYCH^BAREDEP1(IMPDA)  ;CHECK FOR PAYMENTS NOT MATCHED TO A REVERSAL TO SEE IF THEY ARE BEING POSTED TO A 'NONPAYMENT' BATCH ;HEAT147572; ;BAR*1.8*29 IHSNEGB returns false if neg posting is allowed
 D GATHER(IMPDA)
 Q
 ;start new code bar*1.8*20 REQ5
VIEW ;EP
