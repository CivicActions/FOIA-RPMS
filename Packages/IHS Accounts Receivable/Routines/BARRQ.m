BARRQ ; IHS/SD/TPF - Re-queue A/R Transactions for UFMS export ;
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**22,23,33**;OCT 26,2005;Build 133
 ;IHS/SD/TMM 1.8*14 10/01/09 Re-transmit indiv. A/R Trans; Re-transmit individual A/R Trans
 ;IHS/SD/TPF 7/14/2011 COPIED FROM BZHIXMP. CLEANED UP FOR READABILITY
 ;IHS/SD/POT OCT 24 2012 HEAT# 80306 (PARAMETER PASSING ADDED TO RESEND)
 ;IHS/SD/SDR 1.8*33 ADO60817 Commented out options that we don't believe work, leaving only 'I', 'SS', and 'RQ'
 ;  If the others are added back they should be reviewed to see if they actually work or not
 Q
