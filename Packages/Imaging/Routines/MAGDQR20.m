MAGDQR20 ;VA/WOIFO/EdM,NST,MLH,BT - RPCs for Query/Retrieve SetUp ; 19 Oct 2020 4:27 PM
 ;;3.0;IMAGING;**119,BMAG191**;Mar 19, 2002;Build 4396;Apr 19, 2013
...
SRTMAGTI(INUM,I0,REQDFN) ; Save IMAGE_IEN and GROUP_IEN lines
 ...
 ;
 S MAGTI=MAGTI+1,^TMP("MAG",$J,"TI",MAGTI)="IMAGE_SOP_CLASS_UID|"_$$GET1^DIQ(2005,I0,251)  ; ISI/NST 10/19/2020 Add SOP UID 
 ;
 Q
 ;
