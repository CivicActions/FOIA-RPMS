PSIVSUS1 ;BIR/RGY-REPRINT LABEL FROM SUSPENSE ;02-Feb-2024 15:22;DU
 ;;5.0; INPATIENT MEDICATIONS ;**58,1035**;16 DEC 97;Build 39
 ;
 ; Reference to ^PS(55 is supported by DBIA 2191.
 ;
 ; Modified - IHS/MSC/PLS - 02/02/2024 - Added call to SETP - FID 99318
 ;
...
LA Q:"PDH"[$P($G(^PS(55,DFN,"IV",ON,0)),"^",17)
 ...
 F PSJID=0:0 S PSJID=$O(^PS(55,"PSIVSUS",PSIVSN,PSIVDT,DFN,ON,SDT,PSJID)) Q:'PSJID  D SETP,REPRT^PSIVLBL1
 ;
