PSJHL6 ;BIR/LDT-ACTIONS ON HL7 MESSAGES FROM OE/RR (CONT) ;16 Jan 2023  9:26 AM
 ;;5.0; INPATIENT MEDICATIONS ;**1,11,27,34,40,42,51,59,88,98,1033**;16 DEC 97;Build 34
 ;
 ; Reference to EN^ORERR is supported by DBIA# 2187.
 ; Reference to ^PS(55 is supported by DBIA# 2191.
 ;
 ;Modified - IHS/MSC/MIR - 01/16/23 - Line CANCEL+22  Patch 1033
 ;
CANCEL ;Cancel or Discontinue orders thru OE/RR
 ...
 I PSOC="DC",$$PATCH^XPDUTL("BOP*1.0*4") S PSGP=PSJHLDFN,(PSGORD,PSJORD)=RXON D NEW1^BOPCAP:RXON["V",NEW^BOPCAP:RXON'["V"  ;IHS/MSC/MIR - 01/16/2023 Call Automated Dispensing System if present
