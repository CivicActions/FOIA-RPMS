PSIVRNL ;BIR/RGY-PRINT RENEWAL AND ACTIVE ORDER LIST ;05-Feb-2025 14:04;DU
 ;;5.0; INPATIENT MEDICATIONS ;**3,137,1035**;16 DEC 97;Build 39
 ;
...
UT ;IHS/MSC/PLS - 02/02/2024 - p1035
 ;S ^UTILITY("PSIV",$J,$S($P(VAIN(4),U,2)]"":$P(VAIN(4),U,2),1:"Outpatient IV"),DFN,ON)="" Q
 D SETP  ;p1035
 S ^UTILITY("PSIV",$J,$S($P(VAIN(4),U,2)]"":$P(VAIN(4),U,2),1:$$GETHLOC^PSIVWL(.P)),DFN,ON)="" Q
