PSGNE3 ;BIR/CML3,MLM-DETERMINE DEFAULT FOR START & STOP TIMES ;01-Feb-2024 17:39;DU
 ;;5.0; INPATIENT MEDICATIONS ;**4,26,47,50,63,69,105,80,111,183,193,1035**;16 DEC 97;Build 39
 ;
 ; Reference to ^PS(51.1 is supported by DBIA 2177
 ; Reference to ^PS(55 is supported by DBIA 2191
 ;
 ; Modified - IHS/MSC/PLS - 02/01/2024 - ENFD and ENSD - FID 105235,105236
 ;
 N X1,X2,Y
NOW ;
...
SF I '$O(^PS(55,PSGP,5,"AUS",PSGDT)),'$D(^PS(53.1,"AC",PSGP)),+$G(^PS(55,PSGP,5.1)) S $P(^PS(55,PSGP,5.1),U)=""
 ...
 .; Changed next line to match PSJ*5.0*179 - p1035  FID 105235
...
ENSD(SCH,AT,LI,OSD) ;Find start date/time for orders.
 ...
 ;IHS/MSC/PLS - 02/01/2024 - FID 105236
 ;I $G(APPT),$G(PSGORD)["P" S XD=$$DATE2^PSJUTL2(APPT) Q XD
 I $G(APPT),$G(PSGORD)["P" S XD=$$DATE2^PSJUTL2($$NOW^XLFDT()) Q XD
 N X,OSDLI D
 .I $L(LI)<13 S X=LI Q
