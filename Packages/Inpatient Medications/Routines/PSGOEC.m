PSGOEC ;BIR/CML3-CANCEL ORDERS ;16-Jan-2023 14:29
 ;;5.0; INPATIENT MEDICATIONS ;**23,58,1013,110,175,201,134,1015,1029,1033**;16 DEC 97;Build 34
 ;
 ; Reference to ^PS(55 is supported by DBIA# 2191.
 ; Reference to ^PSSLOCK is supported by DBIA 2789.
 ; Modified - IHS/MSC/PLS - 10/17/2011 - Line SOC+2
 ; Modified - IHS/MSC/MIR-01/16/2023 - Line SOC+7,+8,+17,+18 -  Patch 1033
ENA ; all orders
...
SOC ;
 ...
 I 'PSJCOM D
 .I PSGORD["U" D ASET:CF,AC D:$$PATCH^XPDUTL("BOP*1.0*4") CALLBOP^PSGOEV ;IHS/MSC/MIR - Call Automated Dispensing System if present
 .I PSGORD'["U" D NSET:CF,NC I PSGORD["V",$$PATCH^XPDUTL("BOP*1.0*4") S PSJORD=PSGORD D CALLBOP^PSIVORC2 ;IHS/MSC/MIR - Call Automated Dispensing System if present
 ...
 .. D:$$PATCH^XPDUTL("BOP*1.0*4") CALLBOP^PSIVORC2 ;IHS/MSC/MIR - Call Automated Dispensing System if present
 . I OO["U" N PSGORD,PSJORD S PSGORD=OO D ASET^PSGOEC,AC^PSGOEC D:$$PATCH^XPDUTL("BOP*1.0*4") CALLBOP^PSGOEV
 Q
