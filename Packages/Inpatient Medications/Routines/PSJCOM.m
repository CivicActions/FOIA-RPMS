PSJCOM ;BIR/CML3-FINISH COMPLEX UNIT DOSE ORDERS ENTERED THROUGH OE/RR ;12-Jan-2022  12:20 PM
 ;;5.0; INPATIENT MEDICATIONS ;**110,186,1029**;16 DEC 97;Build 50
 ;
 ...
 ;
 ; Modified - IHS/MSC/MIR-01/12/2022 - VFY+35 -  Patch 1029
 ;
UPD ;
 Q:'PSJCOM
...
VFY ; change status, move to 55, and change label record
 ...
 D:$$PATCH^XPDUTL("BOP*1.0*4") CALLBOP^PSGOEV  ;IHS/MSC/MIR - Call to Automated Dispensing System
