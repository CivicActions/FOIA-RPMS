PSJLIACT ;BIR/MV-IV ACTION ;04-October-2023 14:38
 ;;5.0; INPATIENT MEDICATIONS ;**15,47,62,58,82,97,80,1013,110,111,134,1015,1034**;16 DEC 97;Build 37
 ;
 ; Reference to ^PS(55 is supported by DBIA 2191.
 ; Reference to MAIN^TIUEDIT is supported by DBIA 2410.
 ;
 ; Modified - IHS/MSC/PLS - 10/17/2011 - Line DC+1
 ; Modified - IHS/MSC/MIR - 10/04/2023 - Line VF1+54 - Patch 1034
...
VF1(PSIVREA,PSIVAL,PSIVLOG) ;
 ...
 N PSJORD S PSJORD=+ON55 D CALLBOP^PSIVORC2 ;IHS/MSC/MIR - 10/04/23 - Call Automated Dispensing System if present
 Q
