PSIVUWL ;BIR/RGY,PR-UPDATE DAILY WARD LIST ;05-Feb-2025 14:29;DU
 ;;5.0; INPATIENT MEDICATIONS ;**1035**;16 DEC 97;Build 39
 ;
 ; Modified - IHS/MSC/PLS - 02/02/2024 - Added call to GETHLOC FID 99318
...
FIND ;
 ...
 D SETP  ;p1035
 S WRD=$S($P(VAIN(4),U,2)]"":$P(VAIN(4),U,2),1:$$GETHLOC^PSIVWL(.P))  ;p1035
