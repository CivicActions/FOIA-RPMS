PSIVOPT2 ;BIR/PR,MLM-OPTION DRIVER (CONT) ;16-Jan-2023 14:34
 ;;5.0; INPATIENT MEDICATIONS ;**23,29,58,1009,1013,110,127,133,135,157,1015,1033**;16 DEC 97;Build 34
 ;
 ...
 ;                         10/16/11 - Line D+1
 ;         - IHS/MSC/MIR - 01/16/23 - Line D1+11 p1033
D ; Discontinue order.
 N INCOM
...
D1 N %,DA,DIE,DIU,STP,NSTOP
 ...
 I $$PATCH^XPDUTL("BOP*1.0*4") S PSGP=DFN,PSJORD=ON55 D CALLBOP^PSIVORC2 ;IHS/MSC/MIR - 01/16/2023 Call Automated Dispensing System if present
