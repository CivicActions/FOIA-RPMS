PSGOEE ;BIR/CML3-EDIT ACTIVE OR NON-VERIFIED ORDERS ;23-Mar-2023 11:57;DU
 ;;5.0; INPATIENT MEDICATIONS ;**4,7,29,47,64,58,82,91,1004,110,111,112,142,1015,1029,1033**;16 DEC 97;Build 34
 ;
 ; Reference to ^PS(55 is supported by DBIA# 2191.
 ; Reference to ^PSSLOCK is supported by DBIA# 2789.
 ;
 ; Modified - IHS/CIA/PLS - 10/14/05 - Line UPD+10
 ; Modified - IHS/MSC/MIR - 01/12/2022 - NEW+5 - Patch 1029
 ; Modified - IHS/MSC/MIR - 01/20/2023 - NEW+6 - Patch 1033
 ;
...
NEW ;
 ...
 I PSGORD["U" D:$$PATCH^XPDUTL("BOP*1.0*4") CALLBOP^PSGOEV  ;IHS/CIA/MIR - 12/17/21 - Call to Automated Dispensing System
 I PSGORD["V",$$PATCH^XPDUTL("BOP*1.0*4") S PSJORD=PSGORD D CALLBOP^PSIVORC2 ;IHS/MSC/MIR - 01/20/23 - Call Automated Dispensing System if present
