PSIVHYPR ;BIR/PR-REPRINT LABELS ;05-Feb-2025 13:44;DU
 ;;5.0; INPATIENT MEDICATIONS ;**58,88,96,178,184,1015,1035**;16 DEC 97;Build 39
 ;
...
SSWARD ;Get patient SS# and ward location
 ...
 D SETP  ;p1035
 D ENIV^PSJAC S VADM(2)=$G(VA("BID")),PSIVWD=$S(+VAIN(4):$P(VAIN(4),U,2),1:$$GETHLOC^PSIVLABR(.P))  ;p1035
