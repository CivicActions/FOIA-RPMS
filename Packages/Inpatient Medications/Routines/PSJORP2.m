PSJORP2 ;BIR/JCH-CALCULATE FIRST DOSE FOR OE/RR 3.0 ;31-Mar-2023 07:57;DU
 ;;5.0; INPATIENT MEDICATIONS ;**80,110,111,133,189,1033**;16 DEC 97;Build 34
 ;
 ; Modified - IHS/MSC/PLS - 03/31/2023 - Line DTS+2
 ;
 Q
ENQ(PSGP,INFO) ; start
...
DTS(SCHEDULE) ;
 ...
 .;IHS/MSC/PLS - 03/31/2023 - p1033
 .; F Q=0:0 S Q=$O(PSGD(Q)) Q:'Q  F QQ=1:1:$L(WD,"-") I $P($P(PSGD(Q),U,2),$P(WD,"-",QQ))="" S S(Q)="",S=S+1 Q
 . F Q=0:0 S Q=$O(PSGD(Q)) Q:'Q  F QQ=1:1:$L($TR(WD,",","-"),"-") I $P($P(PSGD(Q),U,2),$P($TR(WD,",","-"),"-",QQ))="" S S(Q)="",S=S+1 Q
