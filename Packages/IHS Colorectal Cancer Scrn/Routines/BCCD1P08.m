BCCD1P08 ;GDIT/HS/GCD-Post-Install; 15 Mar 2018  4:05 PM
 ;;1.0;CCDA;**8**;Feb 21, 2014;Build 33
 Q
POST ;
 ...
 I STATUS S EXEC="S TSC=##class(BCCD.Install.PostInstallPatch8).RunTask()" X EXEC I 1
 E  D
 . D BMES^XPDUTL("  Could not run Ensemble post-install task. Please schedule the global cleanup task as described in the installation notes.")
 . D BMES^XPDUTL(" ")
 . K DIR
