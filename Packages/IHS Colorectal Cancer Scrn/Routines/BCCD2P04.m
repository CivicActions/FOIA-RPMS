BCCD2P04 ;GDIT/HS/GCD-Post-Install; 01 Nov 2023  2:13 PM
 ;;2.0;CCDA;**4**;Aug 12, 2020;Build 158
 Q
 ;
POST ;
 N DIC,DIE,DIK,DA,DR,DTOUT
 N PRUN,CRUN,I,ERR,TRNM,TRIEN,BCCD,CLASS,TIME,OPTIEN
 ;
 ...
 I $G(ERR) D ERRMSG("  Error occurred duing import. Error: "_ERR_".  Post-install aborted.") M ^BCCDS("IMPORT","ERR")=ERR G Q
 ;
 ; Change menu text if it has already been changed by a previous install
 S OPTIEN=$O(^DIC(19,"B","BCCD ERROR PURGE",""))
 I OPTIEN D
 . S DIE=19,DA=OPTIEN,DR=".01////BCCD ERROR PROCESSING;1////Purge or Resubmit Error Documents;25////ERROR^BCCDSTAT"
 . D ^DIE
 ;
