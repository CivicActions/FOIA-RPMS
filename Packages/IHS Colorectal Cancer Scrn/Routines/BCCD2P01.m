BCCD2P01 ;GDIT/HS/GCD-Post-Install; 26 Apr 2022  3:02 PM
 ;;2.0;CCDA;**1**;Aug 12, 2020;Build 106
 Q
 ;
POST ;
 N DIC,DIE,DIK,DA,DR,DTOUT
 N PRUN,CRUN,I,ERR,TRNM,TRIEN,BCCD
 ;
 D BMES^XPDUTL("Starting Post-Install Routine")
 I $G(DT)="" D DT^DICRW
 ;
 ;Update the USE VISIT INFO FOR AUTHOR DATA to "NO"
 S BCCD(90310.02,"1,","2.05")="0" D FILE^DIE("","BCCD","ERR")
 ;
