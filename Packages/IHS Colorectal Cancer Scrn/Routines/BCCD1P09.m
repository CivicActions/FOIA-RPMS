BCCD1P09 ;GDIT/HS/BEE - BCCD v1.0 Patch 9 Post-Install; 15 Aug 2019  3:03 PM
 ;;1.0;CCDA;**9**;Feb 21, 2014;Build 34
 Q
POST ;
 ...
 ;
 ;
 ;Remove LOCK from BCCD MENU option
 D
 . NEW DA,BCCDUPD,ERROR
 . S DA=$$FIND1^DIC(19,"","B","BCCD MENU","","","ERROR") I '+DA Q
 . S BCCDUPD(19,DA_",",3)="@"
 . D FILE^DIE("","BCCDUPD","ERROR")
 ;
