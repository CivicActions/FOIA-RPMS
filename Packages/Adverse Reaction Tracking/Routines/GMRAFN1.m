GMRAFN1 ;HIRMFO/WAA-FDA PART 1 MEDWATCH FORM ;07/19/22  15:18
 ;;4.0;Adverse Reaction Tracking;**1010**;Mar 29, 1996;Build 17
 ; Modified IHS/MSC/MIR 07/19/2022 Patch 1010 Changed SSN to HRN
 ;                                 Lines +8:+9
 Q:'GMRAPA1
 K ^TMP($J,"GMR")
 ...
 S GMRAID=$$HRCN^GMRCMP(DFN,+$G(DUZ(2))),GMRASEX=VADM(5),GMRADOB=$P(VADM(3),U) D KVAR^VADPT
