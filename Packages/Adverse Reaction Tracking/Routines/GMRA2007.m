GMRA2007 ;IHS/MSC/PLS - Patch support;27-Aug-2025 09:30
 ;;4.0;Adverse Reaction Tracking;**2007**;Mar 28, 1996;Build 12
 ;
ENV ;EP -
 N PATCH
...
SUBSIGN(DIEN) ;EP-
 ...
 Q
PRETRAN ;EP -
 D PRELOOP(120.82,"GMR ALLERGIES","")
 D PRELOOP(120.83,"SIGN/SYMPTOMS","")
 Q
