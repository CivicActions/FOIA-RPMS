BUD7XTCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ;
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**4**;DEC 29, 2004
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2007 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
...
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2007 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
...
TAXS ;
 ...
 ;;BUD CPT PAP 07;;Pap CPTs Taxonomy
 ;;BGP PAP LOINC CODES
 ;;BUD CPT PAP 03
 ;;BUD CPT PAP 04
 ;;BUD CPT PAP 05
