BUD7RPL2 ; IHS/CMI/LAB - UDS print lists ;
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**4**;DEC 29, 2004
 ;
T52 ;EP
 S BUDP=0,BUD7L=35
 I '$D(^XTMP("BUD7RPT1",BUDJ,BUDH,"T5",BUD7L)) D T52H W !!,"No Uncategorized Provider visits to report." Q
 D T52H
...
T5W ;
 ...
 ..I $Y>(IOSL-3) D T52H Q:BUDQUIT  W !!,"Line ",BUD7L,"   ",BUDY
...
T5H2 ;
 ...
 W $TR($J("",80)," ","-")
 I BUDP=0 W !,"List of all patients, for uncategorized provider visits.  Displays",!,"community, gender, age and visit data, including Provider codes."
