BUD6RPL2 ; IHS/CMI/LAB - UDS print lists ;
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**3**;DEC 29, 2004
 ;
T52 ;EP
 S BUDP=0
 D T52H
 S BUD6L=35,BUD6L2=0,BUDY=$O(^BUDSTFIV("B",BUD6L,0)),BUDY=$P(^BUDSTFIV(BUDY,0),U,2)
 W !!,"Line ",BUD6L,"   ",BUDY
...
T5W ;
 ...
 W ?51,$P(^DPT(DFN,0),U,2),?55,$$AGE^AUPNPAT(DFN,BUDCAD),?60,$P($$RACE^BUD6RPTC(DFN),U,2)
