BUD7RPT1 ; IHS/CMI/LAB - UDS REPORT DRIVER ;
...
EN1 ;
 ...
 ;S XBRP="PRINT^BUD7RPTP",XBRC="PROC^BUD7RPTC",XBRX="EOJ^BUD7RPT1",XBNS="BUD"
 ;D ^XBDBQUE
ZIS ;call to XBDBQUE
 K IOP,%ZIS
 W !! S %ZIS="PQM" D ^%ZIS
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD7RPT1",ZTDTH="",ZTDESC="UDS 07 REPORT" D ^%ZTLOAD D EOJ Q
 Q
M ;EP - called from option
 ...
 W !?5,"3   Table 3B: Patients by Race/Ethnicity & Linguistic Pref"
...
T6I ;intro for table 6
 ...
 W !,"This report will produce UDS Table 6 which itemizes encounters",!,"and patients by selected diagnoses and services provided.",!
 Q
QUARTER ;
 S BUDQTR=""
