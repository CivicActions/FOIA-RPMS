BUD5RPL2 ; IHS/CMI/LAB - UDS print lists ;
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**1**;DEC 29, 2004
 ;
T52 ;EP
 S BUDP=0
 D T52H
 S BUD5L=35,BUD5L2=0,BUDY=$O(^BUDVTFIV("B",BUD5L,0)),BUDY=$P(^BUDVTFIV(BUDY,0),U,2)
 W !!,"Line ",BUD5L,"   ",BUDY
...
T5W ;
 ...
 W ?51,$P(^DPT(DFN,0),U,2),?55,$$AGE^AUPNPAT(DFN,BUDCAD),?60,$P($$RACE^BUD5RPTC(DFN),U,2)
