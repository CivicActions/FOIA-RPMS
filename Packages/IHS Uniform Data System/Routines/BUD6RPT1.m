BUD6RPT1 ; IHS/CMI/LAB - UDS REPORT DRIVER ;
...
EN1 ;
 S BUDSITE=""
 S DIC="^BUDSSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 ;S XBRP="PRINT^BUD6RPTP",XBRC="PROC^BUD6RPTC",XBRX="EOJ^BUD6RPT1",XBNS="BUD"
 ;D ^XBDBQUE
ZIS ;call to XBDBQUE
 K IOP,%ZIS
 W !! S %ZIS="PQM" D ^%ZIS
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD6RPT1",ZTDTH="",ZTDESC="UDS 06 REPORT" D ^%ZTLOAD D EOJ Q
 Q
M ;EP - called from option
 ...
 W !?5,"2   Table 3A: Users by Age and Gender"
 W !?5,"3   Table 3B: Users by Race/Ethnicity & Linguistic Pref"
 W !?5,"4   Table 5 col b&c: Staffing and Utilization (columns b & c)"
 W !?5,"5   Table 6: Selected Diagnoses and Services Rendered"
 W !?5,"6   Staff List for Table 5 col a"
 W !?5,"7   ALL Tables"
