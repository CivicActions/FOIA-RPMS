BUD5TXCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ;
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**1**;DEC 29, 2004
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2005 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
...
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2005 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
