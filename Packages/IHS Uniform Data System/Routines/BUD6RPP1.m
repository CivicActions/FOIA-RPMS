BUD6RPP1 ; IHS/CMI/LAB - UDS PRINT TABLE 6 05 Dec 2006 6:26 AM ; [ 05 Dec 2006 6:26 AM ]
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**3**;DEC 29, 2004
T6 ;EP
 S BUDPG=0,BUDQUIT="",BUDTYPE="D"
 D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH
 W !,"SELECTED INFECTIOUS AND PARASITIC DISEASES"
 W !," 1.  Symptomatic HIV",?35,$$CTR("042.,042.xx",15),?56,$$C($P(BUDT6("V"),U,1)),?70,$$C($P(BUDT6("P"),U,1)),!,BUD80L
 ...
 I $Y>(IOSL-3) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-6) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-4) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-12) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH
 ...
 ;
SRV ;
 S BUDTYPE="S" D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-6) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH1
 W !,"22.  Mammogram",?33,"CPT-4: 76090-76092, G0202, G0204, G0206",!,?33,"ICD-9: V76.11, V76.12",!,?33,"VProc 87.36-.37",!?33,"WH Screening Mammogram",!?33,"WH Mammogram DX Bilat",!?33,"WH Mammogram DX Unilat"
 W ?56,$$C($P(BUDT6("V"),U,22)),?70,$$C($P(BUDT6("P"),U,22)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-13) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH1
 ...
 W !?33,"CVX: 83-84, 46-49, 15,",!?33,"111, 100, 20, 01, 28",!?33,"02-07, 09-10, 21, 94, 115",!?33,"22, 50, 110, 43",!?33,"08, 51"
...
DENT ;
 ...
 I $Y>(IOSL-3) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH1
 W !,"31.      Fluoride treatment",?34,"ADA: 1201, 1203, 1204",!?34,"1205, ICD-9 V07.31",?56,$$C($P(BUDT6("V"),U,31)),?70,$$C($P(BUDT6("P"),U,31)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD6RPTP Q:BUDQUIT  D T6SH1
