BUD6XTCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ;
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**3**;DEC 29, 2004
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2006 UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BUD5TXCH",XBNS="",XBRX="XIT^BUD5TXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the 2006 UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
...
TAXS ;
 ...
 ;;BUD CPT PAP 05;;Pap CPTs Taxonomy
 ;;BGP PAP LOINC CODES
 ;;
LAB ;
 ;;BGP PAP SMEAR TAX
