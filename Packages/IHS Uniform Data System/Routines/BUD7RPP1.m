BUD7RPP1 ; IHS/CMI/LAB - UDS PRINT TABLE 6 05 Dec 2007 6:26 AM ; 
 ;;2.0;IHS/RPMS UNIFORM DATA SYSTEM;**4**;DEC 29, 2004
T6 ;EP
 S BUDPG=0,BUDQUIT="",BUDTYPE="D"
 D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH
 W !,"SELECTED INFECTIOUS AND PARASITIC DISEASES"
 W !," 1.  Symptomatic HIV",?35,$$CTR("042.,042.xx,079.53",15),?56,$$C($P(BUDT6("V"),U,1)),?70,$$C($P(BUDT6("P"),U,1)),!,BUD80L
 ...
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH
 W !," 9.  Diabetes mellitus",?35,$$CTR("250.xx; 775.1x",15),?56,$$C($P(BUDT6("V"),U,9)),?70,$$C($P(BUDT6("P"),U,9)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-6) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH
 ...
 W !?6,"or mental development;",!?6,"Nutritional deficiences",?56,$$C($P(BUDT6("V"),U,17)),?70,$$C($P(BUDT6("P"),U,17)),!,BUD80L
 I $Y>(IOSL-4) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-12) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH
 ...
 ;
SRV ;
 S BUDTYPE="S" D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !!,"SELECTED DIAGNOSTIC TESTS/SCREENING/PREVENTIVE SERVICES",!,BUD80L
 W !,"21.  HIV Test",?33,"CPT-4: 86689; 86701-86703",!,?33,"87390-87391; 87534-87539",!,?33,"LOINC & site-",!,?33,"defined taxonomies",?56,$$C($P(BUDT6("V"),U,21)),?70,$$C($P(BUDT6("P"),U,21)),!,BUD80L
 I $Y>(IOSL-6) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"22.  Mammogram",?33,"CPT-4: 76090-76092, G0202, G0204, G0206",!?33,"77055-77057, 77058-77059",!,?33,"ICD-9: V76.11, V76.12",!,?33,"VProc 87.36-.37",!?33,"WH Screening Mammogram",!?33,"WH Mammogram DX Bilat",!?33,"WH Mammogram DX Unilat"
 W ?56,$$C($P(BUDT6("V"),U,22)),?70,$$C($P(BUDT6("P"),U,22)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"23.  Pap Smear",?33,"CPT-4: 88141-88155, 88164-88167",!?33,"88160-88162, 88174, 88175, Q0091",!?33,"ICD-9: V72.3, V72.31, V76.2, V72.32,",!?33,"V76.47, V76.49; 795.06; ",!?33,"VLab Pap Smear; WH Pap Smear; "
 W !?33,"VProc 91.46; LOINC & site",!,?33,"defined taxonomies",?56,$$C($P(BUDT6("V"),U,23)),?70,$$C($P(BUDT6("P"),U,23)),!,BUD80L
 I $Y>(IOSL-13) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"24.  Selected immunizations;",?33,"CPT-4: 90633-90634"
 W !?6,"Hepatitis A, Hemophilius ",?33,"90645-90648, 90657-90660"
 W !?6,"Influenza B (HIB), ",?33,"90669, 90700-90702"
 W !?6,"Influenza virus, ",?33,"90704-90716, 90718"
 W !?6,"Pneumococcal, Diphtheria, ",?33,"90720-90721, 90723"
 W !?6,"Tetanus, Pertussis (DTap)",?33,"90743-90744, 90748"
 W !?6,"(DTP)(DT), Mumps, Measles,",?33,"CVX: 83-84, 46-49, 15, 16"
 W !?6,"Rubella, Poliovirus, ",?33,"111, 100, 20, 01, 28"
 W !?6,"Varicella, ",?33,"02-07, 09-10, 21, 94, 113, 115"
 W !?6,"Hepatitis B Child",?33,"22, 50, 110, 43",!?33,"08, 51"
...
DENT ;
 ...
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"28.  II. Oral Exams",?34,"ADA: 0120, 0140, 0145, 0150",!?34,"0160, 0170, 0180",?56,$$C($P(BUDT6("V"),U,28)),?70,$$C($P(BUDT6("P"),U,28)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"29.      Prophylaxis - adult",?34,"ADA: 1110, 1120,",!?11,"or child",?56,$$C($P(BUDT6("V"),U,29)),?70,$$C($P(BUDT6("P"),U,29)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"30.      Sealants",?34,"ADA: 1351"
 W ?56,$$C($P(BUDT6("V"),U,30)),?70,$$C($P(BUDT6("P"),U,30)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"31.      Fluoride treatment - ",?34,"ADA: 1201, 1203, 1204, 1205",!?10,"adult or child",?34,"1206, ICD-9 V07.31",?56,$$C($P(BUDT6("V"),U,31)),?70,$$C($P(BUDT6("P"),U,31)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 ...
 W !?6,"(extractions and other",?34,"7230, 7240, 7241, 7250, 7260, 7261"
 W !?6,"surgical procedures)",?34,"7270, 7272, 7280"
 W ?56,$$C($P(BUDT6("V"),U,33)),?70,$$C($P(BUDT6("P"),U,33)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD7RPTP Q:BUDQUIT  D T6SH1
 W !,"34.  V. Rehabilitative services ",!?6,"(Endo, Perio, Prostho, Ortho)",?34,"ADA: 3xxx, 4xxx, 5xxx",!?34,"6xxx, 8xxx"
...
T6SH ;
 ...
 W !,$TR($J("",80)," ","-")
 W !,?35,"Applicable",?54,"Number of",?67,"# of Pts"
