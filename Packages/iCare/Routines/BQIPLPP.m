BQIPLPP ;PRXM/HC/ALA-Populate a panel based on definition ; 19 Oct 2005  12:26 PM
 ;;2.9;ICARE MANAGEMENT SYSTEM;**3,6,7**;Mar 01, 2021;Build 14
 ;
 Q
 ;
POP(DATA,OWNR,PLIEN,KEEP,OVER) ;EP - BQI POPULATE PANEL
 ...
 I $G(BQINIGHT)'=1,'$$CKSHR^BQIPLSH(OWNR,PLIEN) S BMXSEC="You do not have write access" Q
 ;
 NEW UID,II,TEMP
...
DONE ;
 ...
 ;
EXIT ;
 K AGE,AUPNDAYS,AUPNDOB,AUPNDOD,AUPNPAT,AUPNSEX,BQII,CDA,FNAME
 K DFN,DOB,SEX,SSN,X,Y,BQIUPD,GLREF,FGLOB,CTYP,ASN,ASSOC,ATYP
 K FPORDN,FPORDO,FVAL,PEXE,PMAP,PORD,Z
 I $G(DCRIT)'="" K @DCRIT,DCRIT
 Q
 ;
...
FLT ; Get filter parameters
 ...
 ... S DA(3)=OWNR,DA(2)=PLIEN,DA(1)=N,DA=NN,IENS=$$IENS^DILF(.DA)
 ... I PTYP="T" D
 .... S VALUE=$$GET1^DIQ(90505.1151,IENS,.02,"E")
 .... I VALUE="" S VALUE=$$GET1^DIQ(90505.1151,IENS,.01,"E")
