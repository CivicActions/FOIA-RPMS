BQIPLRT ;PRXM/HC/DLS - Panel List Displays ; 26 Oct 2005  9:24 AM
 ...
 ;
LISTS(DATA,FAKE) ; PEP -- BQI GET PANEL LIST
 ;Description
 ...
 I '$D(^BQICARE(DUZ,1,"B")),'$D(^BQICARE("C",DUZ)) G DONE
 ;
 ...
 . I $G(^BQICARE(DUZ,1,PLIEN,0))="" K ^BQICARE(DUZ,1,PLIEN) Q
 . S DA=PLIEN,IENS=$$IENS^DILF(.DA)
 . S PLID=$$PLID^BQIUG1(DUZ,PLIEN)
 . D GETDATA(DUZ,PLIEN)
 . S BQII=BQII+1,@DATA@(BQII)=DUZ_PLDATA
 . I $O(^BQICARE(DUZ,1,PLIEN,30,0))'="" D
 .. S @DATA@(BQII)=DUZ_$P(PLDATA,$C(30))_"Y"_$C(30)
 ;
 ...
 .. N DA
 .. S DA(2)=OWNRIEN,DA(1)=PLIEN,DA=DUZ
 .. S IENS=$$IENS^DILF(.DA)
