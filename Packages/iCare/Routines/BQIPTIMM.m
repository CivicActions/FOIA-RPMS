BQIPTIMM ;PRXM/HC/ALA - PATIENT IMMUNIZATIONS ; 27 Mar 2007  11:00 AM
 ;;2.9;ICARE MANAGEMENT SYSTEM;**1,2**;Mar 01, 2021;Build 13
 ;
 Q
 ;
...
DONE S II=II+1,@DATA@(II)=$C(31)
 Q
 ;
MAX(IZN) ;EP - Maximum Doses in a Series
 ;DD(9999999.14,.05,0)="MAXIMUM# DOSES IN SERIES
 NEW MAX,CVX
 S MAX=$P(^AUTTIMM(IZN,0),"^",5),CVX=$P(^AUTTIMM(IZN,0),"^",3)
 I MAX=""&(CVX=212) S MAX=1
 I MAX=""&(CVX>206) D
 . S MAX=2
 . I CVX<220 Q
 . S MAX=""
