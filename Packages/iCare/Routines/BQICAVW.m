...
EN(DATA,FAKE) ;EP -- BQI GET COMM ALERTS VIEW
 ...
 . I LIEN'="",$P(^BQI(90507.8,LIEN,0),U,5)=1 Q
 . I LIEN'="",$P($G(^BQI(90507.8,LIEN,2)),"^",7)=1 Q
 . I LIEN'="" D
...
VAL(NDUZ,NDCN) ;EP - Find the values of a community alert
 ...
 .. I $P(^BQICARE(NDUZ,11,BQUIEN,1,BQII,0),U,1)="TMFRAME" S DATE=$$DATE^BQIUL1("T-60")
