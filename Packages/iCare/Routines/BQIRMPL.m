...
PAT(DATA,OWNR,PLIEN,DFN) ;EP - Build record by patient
 NEW IEN,HDR,VALUE,HEADR,DORD,HDOB,Y,ORD,TQFL
 S VALUE="",CTYP="R"
...
RMVL ;  Reminder value
 ...
 . I $P(RDATA,U,3)="DUE NOW" D  S EQFL=1 Q
 .. I $P(RDATA,U,4)'="" S VAL=$$FMTMDY^BQIUL1($P(RDATA,U,4))
 .. I $P(RDATA,U,4)="" S VAL=$$FMTMDY^BQIUL1(DT)
 F I=2:1:4 S:$P(RDATA,U,I)'=""&($P(RDATA,U,I)'="N/A") CT=CT+1
 S HDR="T00030"_STVW
 I CT=0 S VAL="1/1/0001 12:01:00 AM" Q
 S DUE=$P(RDATA,U,4)
 I $P(RDATA,U,3)'="",DUE="" S DUE=DT
 ; if there was no due date determined, set to indeterminate
 I DUE="" S VAL="1/1/0001 12:02:00 AM" Q
