...
FND ; EP - Find Suicides
 ...
 ... I COMM="" S COMM=$$COMM()
 ... S @DATA@(COMM,DFN,$P(VCODE(VCIEN),U,2),DATE\1,$P(VCODE(VCIEN),U,1))=U_IEN_U_FILE
 ;
 ...
 .. S COMM=$$GET1^DIQ(9000001,DFN_",",1117,"I")
 .. I COMM="" S COMM=$$COMM()
 .. S @DATA@(COMM,DFN,STY,DTACT\1,ICD)=U_RIEN_U_FILE
 ;
 ...
 ... I '$D(@DATA@(COMM,DFN,DTY,VSDTM)) S @DATA@(COMM,DFN,DTY,VSDTM,DIAC)=VISIT_U_IEN_U_FILE Q
 ; Look for ECODES
 K @TREF
 ...
 ..... D NFILE(CM,DTY,DTC,DTE,VISIT,PT,FILE,@DATA@(CM,PT,DTY,DTE,DTC))
 ;
 NEW DIK
 ...
 Q
 ;
NFILE(COMM,DCAT,DXC,DATE,VISIT,PT,FILE,SDATA) ;
 ; Input
 ;   COMM  - Community
 ...
 I $D(BQIUPD) D FILE^DIE("","BQIUPD","ERROR5")
 NEW DIK
 S DIK=DIC,DIK(1)=.04
 D ENALL^DIK
 Q
...
STOR(TIEN,VSDTM) ;
 ...
 S DFN=$$GET1^DIQ(9000010.07,IEN_",",.02,"I") Q:DFN=""
 S COMM=$$GET1^DIQ(9000001,DFN_",",1117,"I")
 I COMM="" S COMM=$$COMM()
 S DIAG=$P(@TREF@(TIEN),U,1),FILE=9000010
 I '$D(@DATA@(COMM,DFN,"Not Categorized",VSDTM)) S @DATA@(COMM,DFN,"Not Categorized",VSDTM,DIAG)=VISIT_U_IEN_U_FILE Q
 Q
 ;
...
SNS(BQCID) ;EP - Look by concept ID
 ...
 . S COMM=$$GET1^DIQ(9000001,DFN_",",1117,"I")
 . I COMM="" S COMM=$$COMM()
 . I '$D(@DATA@(COMM,DFN,DTY,VSDTM)) S @DATA@(COMM,DFN,DTY,VSDTM,DIAC)=U_PIEN_U_"9000011" Q
 . S @DATA@(COMM,DFN,DTY,VSDTM,BQCID)=U_PIEN_U_"9000011"
 ;
 S IEN=""
...
COMM() ;EP - Get UNKNOWN community
 S COMM=$$FIND1^DIC(9999999.05,"","BX","UNKNOWN","","","ERROR6")
