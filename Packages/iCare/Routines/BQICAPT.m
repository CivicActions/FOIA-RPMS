...
ADXC ; Get all types
 ...
 NEW TIEN,NAM
 S TIEN=0
 F  S TIEN=$O(^BQI(90507.8,TIEN)) Q:'TIEN  D
 . I $P(^BQI(90507.8,TIEN,0),U,5)=1 Q
 . I $P($G(^BQI(90507.8,TIEN,2)),U,7)=1 Q
 . S DXCAT($P(^BQI(90507.8,TIEN,0),U,1))=""
 F NAM="Attempt","Ideation","Completion" S DXCAT(NAM)=""
 F NAM="Confirmed Opioid Exposure","Possible Opioid Exposure" S DXCAT(NAM)=""
 Q
 ;
COM(CIEN) ;EP
...
FND(CIEN,TYP) ;EP
 ...
 NEW DA,IENS,BQIH,BQI,SDATE,DIS,DIEN
 S BQIH=$$SPM^BQIGPUTL()
 ...
 S DIS=+$$GET1^DIQ(90508.015,IENS,.04,"I")
 I 'DIS Q
 ...
 ... S $P(@TEMP@(PATNAM,PAT,COMM,TYPE,DCAT,LOCDT),U,3,5)=RECORD_U_FILE_U_LOCDT
 ... S $P(@TEMP@(PATNAM,PAT,COMM,TYPE,DCAT,LOCDT),U,6)=VISIT
 .. I '$D(@TEMP@(PATNAM,PAT,COMM,TYPE,DCAT)) D
...
SOR ; Sort out the alerts
 ...
 ...... I DOCDT=""&(LOCDT'="")&(VISIT'="") S DOCDT=$P($G(^AUPNVSIT(VISIT,0)),"^",1)\1 S:DOCDT=0 DOCDT=""
 ...... D STAND(PAT)
 ...... S TCAT=$S(DCAT="Ideation":"Ideation",DCAT="Completion":"Completion",1:DCAT)
