...
MSR(DATA,DFN,DRANGE) ; EP -- BQI PATIENT MEASUREMENTS
 ...
 NEW BI,BMI,HDR,IENSMS,ORPHY,EVDTM
 ...
 S @DATA@(II)="I00010MEAS_IEN^I00010VISIT_IEN^D00030VISIT_DATETIME^T00030TYPE_DESC^T00100VALUE^D00030EVENT_DATETIME^N00005PERCENTILE"_$C(30)
 S IEN=""
 ...
 . S II=II+1,@DATA@(II)=IEN_U_VISIT_U_$$FMTE^BQIUL1(VSDTM)_U_TNAME_U_VALUE_U_$$FMTE^BQIUL1(EVDTM)_U_PERCNT_$C(30)
 ;
 ; Check for refusals
 D REF
 ;
...
LST(DATA,DFN) ;EP -- BQI PATIENT LAST MEASURES
 ...
 NEW $ESTACK,$ETRAP S $ETRAP="D ERR^BQIPTMSR D UNWIND^%ZTER" ; SAC 2006 2.2.3.3.2
 ;
 S HDR="I00010MEAS_IEN^I00010VISIT_IEN^D00030EVENT_VISIT_DATETIME^T00030TYPE_DESC^T00100VALUE^T00010BMI"
 S @DATA@(II)=HDR_$C(30)
 ;
 K BQISORT
 S IEN=""
 ...
 .. S VSDTM=$$GET1^DIQ(9000010,VISIT_",",.01,"I")\1 I VSDTM=0 Q
 .. S MEAS(TNAME)=VSDTM
 .. S II=II+1,@DATA@(II)=IEN_U_VISIT_U_$$FMTE^BQIUL1(VSDTM)_U_TNAME_U_VALUE_U_$J($P(BMI,"^",1),3,2)_$C(30)
 I BMI="" D
 ...
 . S MEAS("HEIGHT")=VSDTM
 . S II=II+1,@DATA@(II)=IEN_U_VISIT_U_$$FMTE^BQIUL1(VSDTM)_U_"HEIGHT"_U_VALUE_U_"NC"_$C(30)
 . S WT=$$MREC^BQIUTIL(DFN,9000010.01,"WT")
 . S VISIT=$P(WT,U,4),VALUE=$P(WT,U,3),IEN=$P(WT,U,5),VSDTM=$P(WT,U,2)
 . I VALUE="" S VALUE="None found"
 . S MEAS("WEIGHT")=VSDTM
 . S II=II+1,@DATA@(II)=IEN_U_VISIT_U_$$FMTE^BQIUL1(VSDTM)_U_"WEIGHT"_U_VALUE_U_"NC"_$C(30)
 ;
 ...
 . I $G(MEAS(TNAME))'="" Q
 . S VALUE=$$GET1^DIQ(9000010.01,IEN_",",.04,"E")
 . S BQIMEAS(TNAME)=IEN_U_VISIT_U_$$FMTE^BQIUL1(VSDTM)_U_TNAME_U_VALUE_U_BMI
 ;
 NEW MS
 S MS=""
