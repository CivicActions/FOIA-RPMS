...
EHR ;
 ...
 . S RCLIN=$$GET1^DIQ(811.9,EHIEN_",",100,"E") I RCLIN="NATIONAL" S DEF=1
...
EMR(APCHSPAT,CODE) ;EP
 NEW EHIEN,RNAME,BQCODE
 S EHIEN=$P(CODE,"_",2),BQCODE=CODE
 I $G(ERRCNT)="" S ERRCNT=0
 ;
 S (REMDUE,REMLAST,REMNEXT,RDATA)=""
 S BQRDFN=APCHSPAT
 D MAIN^PXRM(BQRDFN,EHIEN,1,1)
 S CODE=BQCODE
...
VAL(CODE) ;EP - Get the name of a reminder given the CODE
 ...
 I $P(CODE,"_",1)="EHR" S NAME=NAME_" (EHR)" Q NAME
 I $P(CODE,"_",1)="REG" S NAME=NAME_" (HMS)" Q NAME
 I $P(CODE,"_",1)="CMET" S NAME=NAME_" (CMET)" Q NAME
 I $P(CODE,"_",1)="IZ" S NAME=NAME_" (Forecaster)" Q NAME
 S NAME=NAME_" (HS)"
 Q NAME
