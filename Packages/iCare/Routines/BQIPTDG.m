...
GET(DATA,DFN) ; EP -- BQI GET PATIENT DEMOGRAPHICS
 ...
 ;
 NEW UID,STR,X,GDDATA,FLDS,IEN,BQI,RETURN,PTCSZ,PTTRIBE,CMGR
 NEW PTNAME,PTSEX,PTDOB,PTAGE,PTADD1,PTCITY,PTSTATE,PTZIP
 NEW PTADR,PTCOMM,HRN,ALRTFLG,HMPHONE,ALTPHONE,GPMET,PTDOD
 NEW DPCP,PTBEN,WKPHONE,PTSSN,NAFLG
 ...
 ;
 S IEN=DFN_","
 S FLDS=".01;4101;1107.2;1102.2;1108;1602.2;1603.2;1604.2;1605.2;1117;1606.2;1607.2;1801;1111"
 ...
 ;S PTAGE=$G(GDDATA(9000001,IEN,1102.99,"E"))
 ...
 S RETURN=ALRTFLG_U_PTNAME_U_HRN_U_PTSSN_U_PTDOB_U_PTSEX_U_PTAGE_U_PTADR_U_PTCSZ_U_PTCOMM_U_HMPHONE_U_WKPHONE_U_ALTPHONE_U_PTTRIBE_U_DPCP_U_CMGR_U_$$SENS^BQIULPT(DFN)_U_PTDOD_U_PTBEN
 ;S RETURN=ALRTFLG_U_PTNAME_U_HRN_U_PTSSN_U_PTDOB_U_PTSEX_U_PTAGE_U_PTADR_U_PTCSZ_U_PTCOMM_U_HMPHONE_U_ALTPHONE_U_GPMET_U_PTTRIBE_U_DPCP_U_CMGR_U_$$SENS^BQIULPT(DFN)
...
HDR ;
 ...
 ;S @DATA@(BQI)="T00001FLAG_INDICATOR^T00030PATIENT_NAME^T00030HRN^D00030DOB^T00001SEX^T00010AGE^T00050ADDRESS^T00070CITY_STATE_ZIP^"
 ...
 S @DATA@(BQI)=@DATA@(BQI)_"T00001SENSITIVE_INDICATOR^D00030DOD^T00030BENEFICIARY"_$C(30)
 Q
 ;
ERR ;
 D ^%ZTER
