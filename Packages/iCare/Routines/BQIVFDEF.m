...
EN(DATA,VFILE,TYPE) ;EP -- BQI GET VFILE DISPLAY
 ...
 NEW HELP,VDATA3,VFILN,VHELP,BN,BQIHELP,BQIHELPW,VFLD
 ...
 S HDR=HDR_"T00045INIT_TRIG_PARAM^T00030DELETE_RPC^T00045DELETE_RPC_PARAM^T00001FILTER^"
 ...
 S HDR=HDR_"T00250CLEAR_FIELDS^T01024HELP_TEXT"_$C(30)
 S @DATA@(II)=HDR
 ;
 I VFIEN="" D  G DONE
 . S VFIL=0
...
VF(VFIL) ;EP
 ...
 ;   
 NEW VFDATA,VFSDATA,MULTR,SFIL,VFSDATA2,FILTER
 ...
 S VALUE=$P(VFDATA,U,1)_U_VFILN_U_$P(VFDATA,U,4)_U_BQPARM(3)_U_$P(VFDATA,U,12)_U_BQPARM(4)_U_$P(VFDATA,U,13)_U_BQPARM(5)_U_$P(VFDATA2,U)_U_BQPARM(6)_U_FILTER
 S ORD=""
 ...
 . S VALUE=$P(VFSDATA,U,1)_U_VFILN_U_$P(VFSDATA,U,4)_U_BQPARM(3)_U_$P(VFSDATA,U,12)_U_BQPARM(4)_U_$P(VFSDATA,U,13)_U_BQPARM(5)_U_$P(VFSDATA2,U)_U_BQPARM(6)_U_FILTER
 . S ORD=""
...
RET(VFIL,IEN) ; Retrieve data
 ...
 S @DATA@(II)=@DATA@(II)_$P(VDATA3,U,5)_U_CLRFLD_U
 ;
 ;Check for HELP text
 K BQIHELPW,BQIHELP
