GMRYUT0 ;HIRMFO/YH - PATIENT I/O UTILITIES - PATIENT SEARCH AND IV DISPLAY ;30-Nov-2022 08:09;PLS
 ;;4.0;Intake/Output;**3,6,1002**;Apr 25, 1997
 ;Modified - IHS/MSC/PLS - 11/30/2022 - PT+1
...
PT D 1^VADPT S GMRWARD(1)=$S($D(GMRVWLO):GMRVWLO,1:$P(VAIN(4),"^",2)),GMRWARD=$P(VAIN(4),"^"),GMRVADM=$P(VAIN(7),"^",2),GMRAGE=$P(VADM(4),"^"),SSN=$P(VADM(2),"^",2),GMRDIAG=$P(VAIN(9),"^"),GMRBED=$P($P(VAIN(5),"^"),"-",1,2)
 S SSN="XXX-XX-XXXX"  ;IHS/MSC/PLS - P1002
