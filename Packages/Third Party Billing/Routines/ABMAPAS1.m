...
START ;START HERE
 ...
 N ABME D
 .;S ABMP("ITYPE")=$P($G(^AUTNINS(+ABMA("INS"),2)),"^",1) D ISET^ABMERUTL,CONV2 K ABMP("SET")  ;abm*2.6*10 HEAT73780
 .S ABMP("ITYPE")=$$GET1^DIQ(9999999.181,$$GET1^DIQ(9999999.18,+ABMA("INS"),".211","I"),1,"I") D ISET^ABMERUTL,CONV2 K ABMP("SET")  ;abm*2.6*10 HEAT73780
