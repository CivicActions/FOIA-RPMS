ABMDE8I ; IHS/ASDST/DMJ - Page 8 - DENTAL ;
 ...
 ;
 ;IHS/SD/SDR 2.6*30 CR8870 Stopped lines from wrapping if charge max amount
 ;
...
HD ;
 ...
 W !?4,"VISIT",?60,"OPER"
 W !?4,"DATE",?11,"        INPATIENT DENTAL SERVICE",?60,"SITE",?65,"SURF",?72,"CHARGE"
 W !?4,"=====",?11,"===============================================",?60,"====",?65,"=====",?72,"========"
...
EOP I $Y>(IOSL-5) D PAUSE^ABMDE1,HD
 ...
 ;end old start new abm*2.6*30 IHS/SD/SR CR8870
 W ?11,$P(^AUTTADA(+ABM("X0"),0),U)," ",$E($P(^(0),U,2),1,42)  ;ADA code, description
 W ?61 W $S($P(ABM("X0"),U,5)="":"",$D(^ADEOPS($P(ABM("X0"),U,5),88)):$P(^(88),U),1:"")  ;operative site
 W ?65,$J($P(ABM("X0"),U,6),4)  ;surface
 W ?72,$J($FN($P(ABM("X0"),U,8),",",2),8)  ;charge
 ;end new abm*2.6*30 IHS/SD/SDR CR8870
