ABME5L5 ; IHS/SD/SDR - Header 
 ;;2.6;IHS Third Party Billing;**6,8,9,14,21,28,40**;NOV 12, 2009;Build 785
 ;Header Segments
 ;IHS/SD/SDR 2.6*21 - HEAT135923 - Print DTP*435 if date and bill type is 181
 ;IHS/SD/AML 2.6*28 CR8341 Added code to print DTP*096 and DTP*435 when bill type is 121.
...
START ;START HERE
 ...
 D ^ABME5CLM
 D WR^ABMUTL8("CLM")
 ;I $P(ABMB6,U,4)'="",($E(ABMP("BTYP"),1,2)=11) D  ;abm*2.6*28 IHS/SD/AML CR8341
 I $P(ABMB6,U,4)'="",(($E(ABMP("BTYP"),1,2)=11)!($E(ABMP("BTYP"),1,2)=12)) D  ;abm*2.6*28 IHS/SD/AML CR8341
 ...
 ;I $P(ABMB6,U),(($E(ABMP("BTYP"),1,2)=11)!(ABMP("BTYP")=181)) D  ;abm*2.6*21 IHS/SD/SDR HEAT135923  ;abm*2.6*28 IHS/SD/AML CR8341
 I $P(ABMB6,U),(($E(ABMP("BTYP"),1,2)=11)!(ABMP("BTYP")=181)!($E(ABMP("BTYP"),1,2)=12)) D  ;abm*2.6*28 IHS/SD/AML CR8341
 ...
 ;I $D(^ABMDBILL(DUZ(2),ABMP("BDFN"),61)) D  ;abm*2.6*40 IHS/SD/SDR ADO111599
