...
40 ;DTP03 - Date Time Period
 ...
 I ABMFMT="RD8" D
 .;S ABMR("DTP",40)=$$Y2KD2^ABMDUTL(ABMFDT)_"-"_$$Y2KD2^ABMDUTL(ABMTDT)  ;abm*2.6*10 HEAT70933
 .S ABMR("DTP",40)=$$Y2KD2^ABMDUTL($P(ABMFDT,"."))_"-"_$$Y2KD2^ABMDUTL($P(ABMTDT,"."))  ;abm*2.6*10 HEAT70933
 I ABMFMT="DT" D
