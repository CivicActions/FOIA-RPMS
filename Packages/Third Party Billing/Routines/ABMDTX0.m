...
BILL Q:'$D(^ABMDBILL(DUZ(2),ABM("BDFN"),0))  S ABM(0)=^ABMDBILL(DUZ(2),ABM("BDFN"),0)
 ...
 ;I ABM("ITYPES")'[$P($G(^AUTNINS($P(ABM(0),U,8),2)),U) G RSET  ;abm*2.6*10 HEAT73780
 I ABM("ITYPES")'[$$GET1^DIQ(9999999.181,$$GET1^DIQ(9999999.18,$P(ABM(0),U,8),".211","I"),1,"I") G RSET  ;abm*2.6*10 HEAT73780
