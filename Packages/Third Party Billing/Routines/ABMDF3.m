ABMDF3 ; IHS/ASDST/DMJ - Set HCFA-1500 Print Array ;  [ 11/14/2003  8:09 AM ]
 ;;2.5;IHS 3P BILLING SYSTEM;**3,9,10,12,14**;APR 05, 2002
...
HCFA ;
 ...
 ;I ABMS("I")=47,+$O(ABMR(ABMS)) D ^ABMDF3X G HCFA
 ;I ABMS("I")=47,(+$O(ABMR(ABMS))'=0) D ^ABMDF3X G HCFA  ;abm*2.5*12 IM24880
 ;Next Line Changed - Having problems printing when claim more than 2 forms long - IHS/OCA/CPC - 9/10/07
 ;I ABMS("I")>47,(+$O(ABMR(ABMS))'=0) D ^ABMDF3X G HCFA ;abm*2.5*12 IM24880  ;abm*2.5*14 IM27599
 I (ABMS("I")>=47),(+$O(ABMR(ABMS))'=0)!(ABMS("I")>=47),($O(ABMR(ABMS))="MORE") D ^ABMDF3X G HCFA  ;abm*2.5*14 IM27599
