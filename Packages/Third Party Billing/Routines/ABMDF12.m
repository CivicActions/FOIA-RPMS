ABMDF12 ; IHS/ASDST/DMJ - ADA-94 Dental Export Routine ;  
 ;;2.5;IHS 3P BILLING SYSTEM;**8,10,11**;APR 05, 2002
...
BODY ;
 ...
 ...S ABM("I")=ABM("I")+1
 ...I ABM("I")=10 D
 ....;Q:($O(ABMRV(ABMRC,ABMED))=""&($O(ABMRV(ABMRCD))=""))  ;abm*2.5*11 IM22575
 ....Q:($O(ABMRV(ABMRCD,ABMED))=""&($O(ABMRV(ABMRCD))=""))  ;abm*2.5*11 IM22575
 ....S ABM("MORE")=1
 ....D ^ABMDF12X  ;print form
