ABMER41A ; IHS/ASDST/DMJ - UB92 EMC RECORD 41 (Claim Data Condition-Value) cont'd ; 
 ;;2.5;IHS 3P BILLING SYSTEM;**8,11**;APR 05, 2002
 ;Original;DMJ;
 ;
 ...
 ;
LOOP ;LOOP HERE
 ;F I=10:10:200 D  ;abm*2.5*11 NPI
 F I=10:10:210 D  ;abm*2.5*11 NPI
 .D @I
...
170 ;Value Amount - 1 (SOURCE: FILE=9002274.4055, FIELD=.02)
 ...
 ;S ABMR(41,170)=$$FMT^ABMERUTL(ABMR(41,170),"9RNJ2")  ;IM13324
 S ABMR(41,170)=$$FMT^ABMERUTL(ABMR(41,170),"9RN2")  ;IM13324
 Q
 ;
180 ;Value Code - 2 (SOURCE: FIlE=9002274.4055, FIELD=.01)
 ; form locator #40a
 D GET55
 S ABMR(41,180)=$P(ABM(55,2),"^",1)
...
190 ;Value Amount - 2 (SOURCE: FILE=9002274.4055, FIELD=.02)
 ...
 ;S ABMR(41,190)=$$FMT^ABMERUTL(ABMR(41,190),"9RNJ2")  ;IM13324
 S ABMR(41,190)=$$FMT^ABMERUTL(ABMR(41,190),"9RN2")  ;IM13324
 Q
 ;
200 ;Value Code - 3 (SOURCE: FILE=9002274.4055, FIELD=.01) D GET55
 ; form locator #40a
 D GET55
 S ABMR(41,200)=$P(ABM(55,3),"^",1)
...
GET53 ;GET CONDITION CODES
 ...
 .S ABM(53,CNT)=$P($G(^ABMDCODE(+ABM(53,CNT),0)),"^",1)
...
GET55 ;GET VALUE CODES
 ...
 .S $P(ABM(55,CNT),"^",1)=$P($G(^ABMDCODE(+ABM(55,CNT),0)),"^",1)
