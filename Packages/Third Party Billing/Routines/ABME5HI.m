ABME5HI ; IHS/SD/SDR - 837 HI Segment 
 ;;2.6;IHS Third Party Billing System;**6,8,9,10,11,14,16,18,33,34**;NOV 12, 2009;Build 645
 ...
 ;IHS/SD/SDR 2.6*33 ADO60187 Updated to send more than the first Condition Code, up to 12
 ;IHS/SD/SDR 2.6*34 ADO60694/CR7384 Added DR segment for DRG
 ;
EP(X) ;EP
 K ABMREC("HI"),ABMR("HI")
 S ABME("RTYPE")="HI"
...
20 ;HI01 - Health Care Code Information
 ...
 I ABMEIC="DR" S ABMR("HI",20)="DR"  ;abm*2.6*34 IHS/SD/SDR ADO60694
 Q
30 ;HI02 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",30)=$G(ABMCD(2))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 I ABMEIC="DR" S ABMR("HI",30)=$P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),5)),U,13)  ;abm*2.6*34 IHS/SD/SDR ADO60694
 Q
40 ;HI03 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",40)=$G(ABMCD(3))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
50 ;HI04 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",50)=$G(ABMCD(4))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
60 ;HI05 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",60)=$G(ABMCD(5))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
70 ;HI06 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",70)=$G(ABMCD(6))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
80 ;HI07 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",80)=$G(ABMCD(7))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
90 ;HI08 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",90)=$G(ABMCD(8))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
100 ;HI09 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",100)=$G(ABMCD(9))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
110 ;HI10 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",110)=$G(ABMCD(10))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
120 ;HI11 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",120)=$G(ABMCD(11))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
130 ;HI12 - Health Care Code Information
 ...
 I ABMEIC="BG" S ABMR("HI",130)=$G(ABMCD(12))  ;abm*2.6*33 IHS/SD/SDR ADO60187
 Q
