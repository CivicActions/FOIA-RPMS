ABME8PRV ; IHS/ASDST/DMJ - 837 PRV Segment [ 02/04/2003  11:07 AM ]
 ;;2.5;IHS 3P BILLING SYSTEM;**1,3,5,10**;APR 05, 2002
...
EP(X,Y) ;EP - START HERE
 ;x=type
 ;y=ien
 I $G(^ABMDPARM(DUZ(2),1,19,ABMP("INS"),0))'="" S ABMR("PRV")="",ABMREC("PRV")="" Q  ;abm*2.5*10 IM17482
 I +Y=0 S Y=$P(ABMP("PRV","F",Y),"^",2)  ;IHS/SD/SDR 5/17/04
