ABMDF3E ; IHS/ASDST/DMJ - Set HCFA1500 Print Array - Part 5 ;   
 ;;2.5;IHS 3P BILLING SYSTEM;**5,8,9,10,12**;APR 05, 2002
 ;;Y2K/OK - IHS/DSD/DMJ/LSL 7/21/97
...
PROC ;EP for setting the procedure portion of the ABMF array
 ...
 .;S $P(ABMF(ABMS("I")),U,5)=" "_$P(ABMS(ABMS),U,4)  ;abm*2.5*9 IM15591
 .;S $P(ABMF(ABMS("I")),U,5)=$P(ABMS(ABMS),U,4)  ;abm*2.5*9 IM15591  ;abm*2.5*10 IM20197
 .S $P(ABMR(ABMS,ABMLN),U,5)=$P(ABMS(ABMS),U,4)  ;abm*2.5*9 IM15591  ;abm*2.5*10 IM20197
 .; If CPT code, and modifier exists, add it
 .;S $P(ABMF(ABMS("I")),U,5)=" "_$P(ABMF(ABMS("I")),U,5)_$S($E($P(ABMS(ABMS),U,8))="#":" "_$P($P(ABMS(ABMS),U,8)," "),1:"")  ;abm*2.5*9 IM15591
 .;S $P(ABMF(ABMS("I")),U,5)=$P(ABMF(ABMS("I")),U,5)_$S($E($P(ABMS(ABMS),U,8))="#":" "_$P($P(ABMS(ABMS),U,8)," "),1:"")  ;abm*2.5*9 IM15591  ;abm*2.5*10 IM21097
 .S $P(ABMR(ABMS,ABMLN),U,5)=$P(ABMR(ABMS,ABMLN),U,5)_$S($E($P(ABMS(ABMS),U,8))="#":" "_$P($P(ABMS(ABMS),U,8)," "),1:"")  ;abm*2.5*10 IM21097
 .;S:$G(ABM("EPSDT")) $P(ABMF(ABMS("I")),U,9)="X"  ; Form locator 24H  abm*2.5*10 IM21097
 .S:$G(ABM("EPSDT")) $P(ABMR(ABMS,ABMLN),U,9)="X"  ; Form locator 24H  abm*2.5*10 IM21097
 .;S:$G(ABM("EMG")) $P(ABMF(ABMS("I")),U,10)="X"   ; Form locator 24I  ;abm*2.5*10 IM21097
 .S:$G(ABM("EMG")) $P(ABMR(ABMS,ABMLN),U,10)="X"   ; Form locator 24I  ;abm*2.5*10 IM21097
 E  D
 ...
 ..S ABMU=4
 ..D LNG^ABMDWRAP
 ..;start old code abm*2.5*10 IM21097
 ...
 ...S ABMLND=ABMLND+1
 ..;end new code IM20197
 ..;K ABMU(1),ABMU(2)  ;abm*2.5*10 IM21097
 ...
 .;end old code start new code IM20197
 .;start old code abm*2.5*12 IM24880
 ...
 .;end old code abm*2.5*12 IM24880
 .;end new code IM20197
 .K ABMLOCAL
