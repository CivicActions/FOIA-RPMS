ABMDF36B ; IHS/SD/SDR - ADA 2019 Dental Export -part 3 ;    
 ;;2.6;IHS Third Party Billing;**30,31,40**;NOV 12, 2009;Build 785
 ;abm*2.6*30 new routine
 ...
 ;IHS/SD/SDR 2.6*40 ADO111599 Print VA Contract# in box 35
 ;
INS ;Ins Info
...
BNODES ; Bill nodes
 ...
 .S ABMF(41)=$P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),9)),U,27)  ;VA Contract# (35)
...
PROTH ;Proth. Included?
 ...
 ;S $P(ABMF(22),U,5)=ABMBIL_"-"_ABMSFX_" "_ABMHRN  ;Pt ID(23)  ;abm*2.6*30 IHS/SD/SDR CR11171
 S $P(ABMF(22),U,6)=ABMBIL_"-"_ABMSFX_" "_ABMHRN  ;Pt ID(23)  ;abm*2.6*30 IHS/SD/SDR CR11171
...
PAT ;
 ...
 ;E  S $P(ABMF(22),U,4)="X"  ;sex-female(22)  ;abm*2.6*30 IHS/SD/SDR CR11171
 ;start new abm*2.6*30 IHS/SD/SDR CR11171
...
POL ;
 ...
 I ($P(ABMV("X2"),U,6)="M") S $P(ABMF(10),U,2)="X"  ;Sex-male (14)
 I ($P(ABMV("X2"),U,6)="F") S $P(ABMF(10),U,3)="X"  ;Sex-female (14)
 I (("^F^M^")'[("^"_$P(ABMV("X2"),U,6)_"^")) S $P(ABMF(10),U,4)="X"  ;Sex-unknown (14)
 S $P(ABMF(10),U,5)=$P(ABMV("X1"),U,4)  ;Emp. id(15)
 ;end new abm*2.6*30 IHS/SD/SDR CR11171
