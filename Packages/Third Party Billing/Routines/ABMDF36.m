ABMDF36 ; IHS/SD/SDR - ADA-2019 Dental Export Routine ;   
 ;;2.6;IHS 3P BILLING SYSTEM;**30,37**;NOV 12, 2009;Build 739
 ;IHS/SD/SDR 2.6*30 CR11171 New Routine
 ;IHS/SD/SDR 2.6*30 CR8870 Only print whole number
 ;IHS/SD/SDR 2.6*37 ADO76301 Changed box 27 to check parameter before putting leading zero
 ;
 ;********************************************************
 K ABM
 S U="^"
 S ABMP("EXP")=36                ; Export mode
