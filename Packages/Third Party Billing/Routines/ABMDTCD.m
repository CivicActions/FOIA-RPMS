ABMDTCD ; IHS/ASDST/DMJ - Table Maintenance of 3P CODES ;  
 ...
 ;
 ; IHS/ASDS/LSL - 05/31/00 - V2.4 Patch 1 - NOIS XAA-0500-200043
 ;     Modified routine to allow for addition of alpha codes.  Numeric
 ;     codes such as 01 will have two "AC" cross-references. One for 1 
 ;     and one for 01.
 ;
 ...
 S U="^"
 W !
SEL ;K DIR,ABM S DIR(0)="SO^1:CONDITION CODES;2:OCCURRENCE CODES;3:OCCURRENCE SPAN CODES;4:SPECIAL PROGRAM CODES;5:VALUE CODES;6:BILL TYPE",DIR("A")="Select Desired Code" D ^DIR  ;abm*2.5*9 IM18516
 K DIR,ABM  ;abm*2.5*9 IM18516
 S DIR(0)="SO^1:CONDITION CODES;2:OCCURRENCE CODES;3:OCCURRENCE SPAN CODES;4:SPECIAL PROGRAM CODES;5:VALUE CODES;6:BILL TYPE;7:DELAYED REASON CODES"  ;abm*2.5*9 IM18516
 S DIR("A")="Select Desired Code" D ^DIR  ;abm*2.5*9 IM18516
 G XIT:$D(DIROUT)!$D(DIRUT)
 ;S ABM=$S(Y=1:"C",Y=2:"O",Y=3:"S",Y=4:"I",Y=5:"V",1:"B")  ;abm*2.5*9 IM18516
 S ABM=$S(Y=1:"C",Y=2:"O",Y=3:"S",Y=4:"I",Y=5:"V",Y=6:"B",1:"U")  ;abm*2.5*9 IM18516
 ;
 ;S ABM("TITL")=$S(ABM="C":"CONDITION CODE",ABM="O":"OCCURRENCE CODE",ABM="S":"OCCURRENCE SPAN CODE",ABM="I":"SPECIAL PROGRAM CODE",ABM="B":"BILL TYPE",1:"VALUE CODE")  ;abm*2.5*9 IM18516
 S ABM("TITL")=$S(ABM="C":"CONDITION CODE",ABM="O":"OCCURRENCE CODE",ABM="S":"OCCURRENCE SPAN CODE",ABM="I":"SPECIAL PROGRAM CODE",ABM="B":"BILL TYPE",ABM="U":"DELAYED REASON CODES",1:"VALUE CODE")  ;abm*2.5*9 IM18516
 W !
