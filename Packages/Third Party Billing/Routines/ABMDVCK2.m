ABMDVCK2 ; IHS/ASDST/DMJ - PCC Visit Edits ;      
 ...
 ;
 ;IHS/DSD/MRS 9/13/1999 NOIS BXX-0999-150023 Patch 3 #14 Increased default lag time from 5 to 45 days
 ;IHS/ASDS/LSL 05/19/00 V2.4 Patch 1 NOIS NCA-0500-180018 Modified to do proper checking of POV and orphan lag time
 ;   for children visits where a parent claim already exists and has proper POV.
 ;IHS/ASDS/DMJ 03/20/01 V2.4 P5 NOIS NHA-0201-180052 Modified to correct "Visit location not found in 3P
 ;   site parameters" error
 ;IHS/ASDS/LSL 06/27/01 V2.4 Patch 9 NOIS HQW-0798-100082 Modified to expand No Eligibility Found. Routine created as
 ;   ABMDVCK0 became too large
 ;
 ;IHS/SD/SDR 2.6*35 ADO60700 Added API call for CG report
 ;
 ; *********************************************************************
 ;
 Q
...
INS ; EP ;Go thru insurers in eligibility array
 ...
 ..S DR=".04////28"
 ..D ^DIE
 ..D VISIT^ABMCGAPI(ABMVDFN,ABMCGIEN,28)  ;abm*2.6*35 IHS/SD/SDR ADO60700
...
PCFL(X) ; EP ; file .04 field in VISIT file 
 ...
 S DR=".04////"_X
 D ^DIE
 D VISIT^ABMCGAPI(ABMVDFN,ABMCGIEN,X)  ;abm*2.6*35 IHS/SD/SDR ADO60700
 Q
