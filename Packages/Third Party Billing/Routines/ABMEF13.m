ABMEF13 ; IHS/ASDST/DMJ - Medicare Electronic UB-92 Version 041 ;  
 ...
 ;     EMC file name.
 ;
 ; IHS/ASDS/LSL - 07/27/01 - V2.4 Patch 7 -NOIS NDA-0301-180017
 ;     Modified to resolve <UNDEF>PCN+1^ABMERUTL for all electronic
 ;     modes of export.
 ;
 ; IHS/ASDS/SDH - 05/24/01 - V2.4 Patch 9 - NOIS CXX-0501-110015
 ;     Allow ND Medicaid to transmit w/o a line feed.
 ;
 ; *********************************************************************
START ;
 ;START HERE
...
LOOP ;
 ...
 ;I $$RCID^ABMERUTL(ABMP("INS"))="04001" U 0 W !,"BATCH #",ABMR(1,170),!  ;abm*2.6*10 HEAT74059
...
WRITE ;
 ...
 I ABMP("FTYPE")="H" D
 .U IO
 . I $$RCID^ABMERUTL(ABMP("INS"))["01058" D
 . . W ABMEF("LINE")
 . E  W ABMEF("LINE"),$C(13,10)
 .U IO(0)
 I ABMP("FTYPE")="M" D
 .S ABMP("L#")=ABMP("L#")+1
