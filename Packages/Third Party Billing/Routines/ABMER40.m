ABMER40 ; IHS/ASDST/DMJ - UB92 EMC RECORD 40 (Claim Data) ; [ 02/07/2002  1:25 PM ]
 ;;2.5;IHS 3P BILLING SYSTEM;**11**;FEB 04, 2002
...
GET51 ;GET OCCURANCE CODES
 ...
 .S $P(ABM(51,CNT),"^",1)=$P($G(^ABMDCODE(+ABM(51,CNT),0)),"^",1)
...
GET57 ;GET OCCURRENCE SPAN CODES
 ...
 .S $P(ABM(57,CNT),"^",1)=$P($G(^ABMDCODE(+ABM(57,CNT),0)),"^",1)
