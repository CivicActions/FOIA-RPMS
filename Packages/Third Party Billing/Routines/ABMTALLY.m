...
COMPUTE ;
 ...
 ..;S:ABMACTI'="" ABMITYP=$P($G(^AUTNINS(ABMACTI,2)),U)  ;abm*2.6*10 HEAT73780
 ..S:ABMACTI'="" ABMITYP=$$GET1^DIQ(9999999.181,$$GET1^DIQ(9999999.18,ABMACTI,".211","I"),1,"I")  ;abm*2.6*10 HEAT73780
