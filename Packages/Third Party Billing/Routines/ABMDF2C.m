ABMDF2C ; IHS/SD/SDR - Set HCFA1500 Print Array ;
...
PAYOR S Y=ABM("INSCO") D SEL^ABMDE2X
 S ABM("I0")=+ABMV("X1")
 ;I ABM("INSCO")'=$P(ABMP("B0"),U,8),ABM("CNT")=0,$P($G(^AUTNINS(ABM("I0"),2)),U)'="N" S $P(ABMF(12),U)=$P(^AUTNINS(ABM("I0"),0),U),$P(ABMF(13),U)=$P($P(ABMV("X2"),U),";",2)  ;abm*2.6*10 HEAT73780
 I ABM("INSCO")'=$P(ABMP("B0"),U,8),ABM("CNT")=0,$$GET1^DIQ(9999999.181,$$GET1^DIQ(9999999.18,ABM("I0"),".211","I"),1,"I")'="N" S $P(ABMF(12),U)=$P(^AUTNINS(ABM("I0"),0),U),$P(ABMF(13),U)=$P($P(ABMV("X2"),U),";",2)  ;abm*2.6*10 HEAT73780
