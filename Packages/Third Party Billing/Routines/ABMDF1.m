ABMDF1 ; IHS/SD/SDR - Set UB82 Print Array ; 
...
INSNUM S ABM("INUM")=$P($G(^ABMNINS(DUZ(2),ABMP("INS"),1,ABMP("VTYP"),0)),U,8)
 ...
 ;S $P(ABMF(4),U,$S($P($G(^AUTNINS(ABMP("INS"),2)),U)="D":5,1:2))=ABM("INUM")  ;abm*2.6*10 HEAT73780
 S $P(ABMF(4),U,$S($$GET1^DIQ(9999999.181,$$GET1^DIQ(9999999.18,ABMP("INS"),".211","I"),1,"I")="D":5,1:2))=ABM("INUM")  ;abm*2.6*10 HEAT73780
