...
EN ; EP
 ...
 ;I Y>0 S X=$P($$MOD^ABMCVAPI(X,"",ABMP("VDT")),U,2)  ;CSV-c  ;abm*2.6*10 HEAT71969
 I Y>0 S X=$P($$MOD^ABMCVAPI(X,"",$S($G(ABMP("VDT")):ABMP("VDT"),1:DT)),U,2)  ;CSV-c  ;abm*2.6*10 HEAT71969
 ;K X
 Q
