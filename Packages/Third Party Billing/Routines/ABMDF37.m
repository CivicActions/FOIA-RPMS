ABMDF37 ; IHS/SD/SDR - ADA-2024 Dental Export Routine ;   
...
BODY ;
 ...
 ;
 S $P(ABMF(36),U)=$S($P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),0)),U,21)=10:"AB",1:"B")  ;(34)
 ;(34a)
 ...
 .S:ABMDENP]"" $P(ABMF(ABM("F")),U,6)=$S($L($P(ABMF(ABM("F")),U,6))=4:ABMDENP_$P(ABMF(ABM("F")),U,6),(ABMDENP'="D"):ABMDENP_$E($P(ABMF(ABM("F")),U,6),2,5),1:$P(ABMF(ABM("F")),U,6))
 .;
