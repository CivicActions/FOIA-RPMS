ABMDRST ; IHS/ASDST/DMJ - Statistical Report ;
 ;;2.5;IHS 3P BILLING SYSTEM;**15**;FEB 04, 2002
 ;Original;TMD;
...
DATA ;
 ...
 ;SET ABMREC=^ABMDBILL(DUZ(2),ABM,0)  ;MOVE BILL FILE TO ABMREC  ;abm*2.5*15 NO IM
 S ABMREC=$G(^ABMDBILL(DUZ(2),ABM,0))  ;MOVE BILL FILE TO ABMREC  ;abm*2.5*15 NO IM
 SET ABMSTAT=$P(ABMREC,U,4)  ;SET BILL STATUS FRM BILL FILE TO ABMSTAT
 SET ABMTYP=$P(ABMREC,U,7)  ;SET VISIT TYPE FROM BILL FILE TO ABMTYP
