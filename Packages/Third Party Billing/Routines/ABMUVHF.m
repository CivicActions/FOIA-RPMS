ABMUVHF ; IHS/SD/SDR - UFMS View Host File
 ;;2.6;IHS Third Party Billing;**1,34**;NOV 12, 2009;Build 645
 ;IHS/SD/SDR 2.6*1 Updated display for new fields.  Fixes:
 ;  3PMS10019
 ;  FIXPMS10001
 ;  FIXPMS10011
 ;  FIXPMS10026
 ;  FIXPMS10027
 ;IHS/SD/SDR 2.6*34 ADO60695 CR7380 Fixed alignment of headers on FILE LAYOUT and extraction of fields for CAPTIONED.
 ;   Both were off a little so things weren't lining up or were blank.
 Q
 ;
...
FNHDR80 ;EP - 80 column header
 ...
 W !!?7,"INVOICE#"
 ;start old abm*2.6*34 IHS/SD/SDR ADO60695
 ;W ?27,"DT/TM APP."
 ;W ?37,"TAX ID"
 ;W ?47,"DESCRIPTION"
 ;W !?67,"BILL AMT"
 ...
 ;end old start new abm*2.6*34 IHS/SD/SDR ADO60695
 W ?47,"DT/TM APP."
 W ?57,"TAX ID"
 W ?67,"DESCRIPTION"
 ;
 ...
 W ?65,"MASTERTIN"
 W ?75,"DOS"
 ;end new abm*2.6*34 IHS/SD/SDR ADO60695
...
CAPTIONS(ABMFNAME,ABMREC,ABMRNUM) ;EP - captioned records
 ...
 S ABMINV=$TR($E(ABMREC,2,41)," ")  ;invoice#
 S ABMDTTMA=$TR($E(ABMREC,42,51)," ")  ;date/time approved
 S ABMTAXID=$TR($E(ABMREC,52,61)," ")  ;tax ID
 S ABMDESC=$TR($E(ABMREC,62,161)," ")  ;description (ASUFAC-ASUFAC-BILL#)
 S ABMAMT=+$TR($E(ABMREC,162,181)," ")  ;bill amount
 S ABMAMT=$E(ABMAMT,1,$L(ABMAMT)-2)_"."_$E(ABMAMT,$L(ABMAMT)-1,$L(ABMAMT))
 ;start old abm*2.6*34 IHS/SD/SDR ADO60695
 ...
 ;end old start new abm*2.6*34 IHS/SD/SDR ADO60695
 S ABMCAN=$TR($E(ABMREC,182,191)," ")  ;CAN (blank)
 S ABMTCODE=$TR($E(ABMREC,192,201)," ")  ;HHS T-code
 S ABMOCL=$TR($E(ABMREC,202,206)," ")  ;object class
 S ABMBUDG=$TR($E(ABMREC,207,216)," ")  ;budget activity
 S ABMCC=$TR($E(ABMREC,217,219)," ")  ;cost center
 S ABMPTIN=$TR($E(ABMREC,220,229)," ")  ;master TIN
 S ABMDOS=$TR($E(ABMREC,230,239)," ")  ;DOS
 S ABMVTYP=$E(ABMREC,240,289)  ;visit type
 S ABMITYP=$TR($E(ABMREC,290,299)," ")  ;insurer type
 ;end new abm*2.6*34 IHS/SD/SDR ADO60695
 ;
 ...
 .;start old abm*2.6*34 IHS/SD/SDR ADO60695
 .;W !!,"RECORD #: ",?17,ABMRNUM
 .;W !,"RECORD TYPE: ",?17,ABMRECT
 .;W !,"INVOICE#: ",?17,ABMINV
 .;W !,"DT/TM APPROVED: ",?17,ABMDTTMA
 .;W !,"TAX ID: ",?17,ABMTAXID
 .;W !,"DESC: ",?17,ABMDESC
 .;W !,"BILL AMT: ",?17,ABMAMT
 .;W !,"CAN: ",ABMCAN
 ...
 .W !,"DT/TM APPROVED: ",?17,ABMDTTMA
 .W !,"TAX ID: ",?17,ABMTAXID
 .W !,"DESCRIPTION: ",?17,ABMDESC
 .W !,"BILL AMT: ",?17,ABMAMT
 .W !,"CAN: ",?17,ABMCAN
 .W !,"OBJECT CLASS: ",?17,ABMOCL
 .W !,"BUDGET ACTIVITY: ",?17,ABMBUDG
 .W !,"COST CENTER: ",?17,ABMCC
 .W !,"MASTER TIN: ",?17,ABMPTIN
 .W !,"HHS T-CODE: ",?17,ABMTCODE
 .W !,"DATE OF SERVICE: ",?17,ABMDOS
 .W !,"VISIT TYPE: ",?17,ABMVTYP
 .W !,"INSURER TYPE: ",?17,ABMITYP
 ;end new abm*2.6*34 IHS/SD/SDR ADO60695
