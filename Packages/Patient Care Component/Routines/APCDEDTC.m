...
HDR ; Write Header
 ...
 S APCDPAT="",APCDNOXV=""
 F  D GETPAT Q:APCDPAT=""  S APCDCAT="" F  D GETCAT Q:APCDCAT=""  D GETVISIT I APCDVSIT D MNEPROC
 D EOJ
 Q
 ;
GETCAT ;
 ...
 I $D(DIRUT) S Y="" Q
 S APCDCAT=Y
 I "AORSI"'[APCDCAT W $C(7),$C(7),!!,"That SERIVCE CATEGORY is not appropriate for this option!" G GETCAT
 Q
 ;
GETPAT ; GET PATIENT
 W !
...
MNEPROC ; PROCESS MNEMONICS UNTIL DONE
 W !
 S X="DTC",DIC="^APCDTKW(",DIC(0)="M" D ^DIC K DIC
...
FINDVSIT ; INTERACTIVE MODE
 ...
 I '$D(APCDALV) W !!,"No "_$$EXTSET^XBFUNC(9000010,.07,APCDCAT)_" Visits for ",$P(^DPT(APCDPAT,0),U),!,"on ",$$FMTE^XLFDT(APCDDATE)," at ",$P(^DIC(4,DUZ(2),0),U),".",! D  Q
 .;se if user wants to create a new visit
 .W ! S DIR(0)="Y",DIR("A")="Do you wish to create a new "_$S(APCDCAT="A":"AMBULATORY",APCDCAT="I":"IN-HOSPITAL",1:"A")_" Visit for this patient",DIR("B")="Y" KILL DA D ^DIR KILL DIR
 .Q:$D(DIRUT)
 .Q:'Y
 .D GENVISIT
...
TEXT ;
 ...
 ;;
 ;;************************************************
 ;;* ENTER TRANS CODES (DTC) FOR HOSPITALIZATION/AMBULATORY VISITS *
 ;;************************************************
 Q
