APCHS7R ; IHS/CMI/LAB - PART 7 OF APCHS -- SUMMARY PRODUCTION COMPONENTS ; 
 ;;2.0;IHS PCC SUITE;**2,5,23**;MAY 14, 2009;Build 17
 ;
SET ;
 ;S APCHCNT=APCHCNT+1
...
CONT ; <SETUP>
 ...
 .I $P($G(^AUPNVSIT(V,0)),U,7)="E" S C="OUTSIDE MEDICATIONS" D SET Q
...
DISP ;DISPLAY MEDS
 ...
 ..S APCHDT=0 S APCHDT=$O(APCHSTAT("ACTIVE MEDICATIONS",APCHN,APCHDI,APCHDT)) Q:APCHDT'=+APCHDT!($D(APCHSQIT))  D
