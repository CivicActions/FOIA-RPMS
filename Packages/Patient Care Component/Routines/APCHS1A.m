APCHS1A ; IHS/CMI/LAB - PART 1A OF APCHS -- SUMMARY PRODUCTION COMPONENTS ;
 ;;2.0;IHS PCC SUITE;**2,5,11,26,27,29**;MAY 14, 2009;Build 20
...
BDEMDSP ; <DISPLAY>
 ...
 Q:$D(APCHSQIT)
 W !,APCHSNAM,"    DOB: ",APCHSDOB W ! ;,"    SSN: ",$$SSN^APCHS1(APCHSPAT),!  ;$P(^DPT(APCHSPAT,0),U,9),! ;IHS/CMI/LAB - added SSN
 ...
 W "Cell Phone: ",$S($$VAL^XBDIQ1(2,APCHSPAT,.134)]"":$$VAL^XBDIQ1(2,APCHSPAT,.134),1:"None")_"     "_"Other Phone: ",$S($$VAL^XBDIQ1(9000001,APCHSPAT,1801)]"":$$VAL^XBDIQ1(9000001,APCHSPAT,1801),1:"None"),!
