APCHS1B ; IHS/CMI/LAB - PART 1 OF APCHS -- SUMMARY PRODUCTION COMPONENTS ;
 ;;2.0;IHS PCC SUITE;**5,10,11,26,27,29**;MAY 14, 2009;Build 20
 ;
DEMOG ; ******************** DEMOGRAPHICS ********************
 ; <SETUP>
...
DEMDSP ; <DISPLAY>
 ...
 W !
 S X=$$GETPREF^AUPNSOGI(DFN,"I",1)
 I X]"",X'=$P(^DPT(DFN,0),U,1) W "PREFERRED NAME: ",X,!
 I APCHSTR]""!(APCHSMNM]"") W:APCHSTR]"" $E(APCHSTR,1,33) W !
 W:APCHSMNM]"" ?34,"MOTHER'S MAIDEN NAME: ",APCHSMNM W !
 W APCHSHPH,APCHSOPH W:APCHSFNM]"" ?34,"FATHER'S NAME: ",APCHSFNM W !
 S C=$$VAL^XBDIQ1(2,APCHSPAT,.134) W:C]"" "CELL PHONE: "_C W $S($$VAL^XBDIQ1(9000001,APCHSPAT,1801)]"":"   OTHER PHONE: "_$$VAL^XBDIQ1(9000001,APCHSPAT,1801),1:""),!
 S APCHPLNG=$$PREFLANG^APCLAPI7(APCHSPAT,DT,"E")
 I APCHPLNG]"" W ?34,"PREFERRED LANGUAGE: ",APCHPLNG,!
 S %=$$VAL^XBDIQ1(9000001,APCHSPAT,1802) I %]"" W "EMAIL ADDRESS: ",%,!
 ...
 ;D DSPCMSRG
 ; <CLEANUP>
DEMOGX K APCHSNAM,APCHSTR,APCHSEX,APCHSDOB,APCHSMNM,APCHSCMR,APCHSEL,APCHSFP,APCHSFAC,APCHSHRN,APCHSBT,APCHSPP,APCHSADR,APCHSN,APCHSP,APCHSI,APCHSJ,APCHSHPH,APCHSOPH,APCHSVST,APCHSLUD,APCHSRE1,APCHSRE2,E,X,Y
 Q
