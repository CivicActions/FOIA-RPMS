APCHS2A3 ; IHS/CMI/LAB - BODY MASS INDEX & RELATIVE WEIGHT FOR MEASUREMENT TRANSFORMS ; 16 Apr 2025  10:14 AM
 ;;2.0;IHS PCC SUITE;**4,13,31**;MAY 14, 2009;Build 10
 ;
...
RW(APCHPAT,APCHWT,APCHDATE) ; ENTRY POINT - TO OBTAIN RELATIVE WEIGHT PERCENTAGE
 ...
 ;------------
 D COMMON G:$E(APCHCOMT)="!" ERROR
  I APCHSEX="U"!(APCHSEX="") S APCHCOMT="!UNABLE TO CALCULATE, SEX UNKNOWN." G ERROR
