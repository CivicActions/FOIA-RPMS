APCHS0 ; IHS/TUCSON/LAB - PCC HEALTH SUMMARY - MAIN DRIVER PART 2 ;  [ 09/24/04  2:06 PM ]
 ;;2.0;IHS RPMS/PCC Health Summary;**3,7,8,10,12**;JUN 24, 1997
 ;
...
START ;
 ...
 I $P(IOST,"-",1)="C" S APCHSCKP=APCHSCKP_"W *7,""<>"" R X:DTIME S:'$T X=U W *13 S:X[U APCHSQIT="""" I '$D(APCHSQIT) "
