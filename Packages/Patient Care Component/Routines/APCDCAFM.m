...
SUB ;
 ...
 S APCDVSTD=Y
ZIS ;call xbdbque
 S XBRC="DRIVER^APCDCAFM",XBRP="PRINT^APCDCAFM",XBRX="XIT^APCDCAFM",XBNS="APCD"
 D ^XBDBQUE
 D XIT
 Q
...
HDR1 ;
 ...
 W !,$$CTR("******************************************************",80)
 W !,$$CTR("*   COUNT OF VISITS REVIEWED/COMPLETED BY "_$$VAL^XBDIQ1(200,APCDDEO,.01)_"  *",80)
 W !,$$CTR("******************************************************",80)
...
INFORM ;inform user what this report is all about
 ...
 W !,"by you.  "
 W !,"PLEASE NOTE: this report will only look at visits that have been reviewed and"
 W !,"marked as either REVIEWED/COMPLETE or INCOMPLETE by you.  If a visit has"
 ...
 W !,"were reviewed.",!!
 W !,"Please keep in mind that you may not be the only operator who reviewed"
 W !,"a visit, but as long as you reviewed and marked the visit as either"
 W !,"complete or incomplete, that visit will be counted in this report."
 W !
 Q
OLOC ;one location
