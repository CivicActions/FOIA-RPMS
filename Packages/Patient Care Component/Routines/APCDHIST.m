APCDHIST ; IHS/CMI/LAB - DISPLAY HIST. DATA ;
 ;;2.0;IHS PCC SUITE;**7,11,29**;MAY 14, 2009;Build 20
 ;
...
REF ;EP - called from [APCD REF] template to 
 ...
 .W !?5,"Service Type:  ",$$VAL^XBDIQ1(9000022,APCDX,.07) I $$VAL^XBDIQ1(9000022,APCDX,.09)]"" W ?50,"VISIT: ",$$VAL^XBDIQ1(9000022,APCDX,.09)
 .Q
 W !
 Q
