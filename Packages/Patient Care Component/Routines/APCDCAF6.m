APCDCAF6 ;IHS/OIT/LJF - NEW INCOMPLETE CHART EDIT OPTION ; 23 Mar 2015  12:30 PM
 ;;2.0;IHS PCC SUITE;**11,26**;MAY 14, 2009;Build 48
 ;
 ;
...
ADDMORE(APCDVSIT,PRV) ; add new deficiencies for provider
 ...
 . I $$GET1^DIQ(9000095.12,IENS,.11,"I")'="R",$P(^APCDSITE(DUZ(2),0),U,39) D ALERT^APCDCAF4(PRV,APCDVSIT,IENS)   ;IHS/CMI/LAB - add alert to provider
 . K DIE,DA,DR
 Q
 ;
