APCHS3B ; IHS/TUCSON/LAB - PART 3A OF APCHS -- SUMMARY PRODUCTION COMPONENTS ;  [ 04/04/2008  9:43 AM ]
...
REORDER ;reorder by accession, parent and child
 ...
 ;K ^TMP($J,"APCHS")
 ;Q
LDATE S APCHSIVD=$O(^AUPNVLAB("AA",APCHSPAT,APCHSLRT,0)) S APCHSDFN=$O(^(APCHSIVD,0)) D:APCHSIVD&(APCHSIVD'>APCHSDLM) LSET
 Q
LSET ;
