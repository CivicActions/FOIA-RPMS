APCDAPOV ; IHS/CMI/LAB - POV LOOKUP ; 13 Feb 2014  2:26 PM
 ;;2.0;IHS PCC SUITE;**10,11,13,20,25**;MAY 14, 2009;Build 37
 ;
START ;
 S (APCDLOOK,APCDTNQP)=""
 D EN^XBNEW("START1^APCDAPOV","APCDEIN;APCDTSKI;APCDLOOK;APCDDATE;APCDTERR;APCDPAT;DFN;APCDTNQP;APCDTPCC;APCDTDIA;APCDVSIT;APCDINAD,APCDTIN9")
 Q
START1 ;EP
...
LEX ;EP - called from input template
 ...
 .S APCDVAL="" I $P(Y,U)'=-1 S APCDVAL=$$ICDDX^ICDEX(+Y,$P(APCDD,"."))
...
LEXN ;
 ...
 .I 'Y S Q=1 Q
 S Q=""
 I $G(DFN),$P(APCDVAL,U,15)]""!($P(APCDVAL,U,16))]"",$G(APCDVSIT) D  I Q W ! S APCDTERR=1,APCDLOOK="" G XITL
