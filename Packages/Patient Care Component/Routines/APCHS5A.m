APCHS5A ; IHS/CMI/LAB - PART 5A OF APCHS5 -- SUMMARY PRODUCTION COMPONENTS ; 19 Aug 2020  9:46 AM
 ;;2.0;IHS PCC SUITE;**2,5,21,25**;MAY 14, 2009;Build 37
 ;
MAID ;ENTRY POINT
 ; MEDICAID
 K APCHSITB
...
DMCARE ;
 ...
 I $P(APCHSNM,U,3)'="D" W APCHSINS,?32,$$GETMCR^AGUTL(APCHSPAT),?44,APCHSUFF   ;IHS/CMI/LAB NMCI
 I $P(APCHSNM,U,3)="D" W APCHSINS,?32,$S($P(APCHSNM,U,6)]"":$P(APCHSNM,U,6),1:$$GETMCR^AGUTL(APCHSPAT)),?44,APCHSUFF
 ...
 I $P(APCHSNM,U,4) S %=$P(APCHSNM,U,4) I %,$D(^AUTNINS(%,0)) W ?3,"Plan Name: ",$P(^AUTNINS(%,0),U,1)
 K APCHSXDT,APCHSNM
 Q
THIRD ;ENTRY POINT
 ; OTHER THIRD PARTY
