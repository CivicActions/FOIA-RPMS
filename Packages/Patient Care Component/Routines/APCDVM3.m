...
PROBLEM ;EP - called to change pointers in AUPNPROB from used as pov and used as inpatient afer merge
 ...
 .Q
 Q
DELPROB ;EP - called from visit delete
 NEW APCDP,APCDX
 I '$G(APCDVDLT) Q
 S APCDP=$P($G(^AUPNVSIT(APCDVDLT,0)),U,5)
 I 'APCDP Q  ;;NO PATIENT??
 S APCDX=0 F  S APCDX=$O(^AUPNPROB("AC",APCDP,APCDX)) Q:APCDX'=+APCDX  D
 .;USED AS POV
 .S APCDY=0 F  S APCDY=$O(^AUPNPROB(APCDX,14,"B",APCDVDLT,APCDY)) Q:APCDY'=+APCDY  D
 ..;call die to DELETE
 ..K DIE,DA,DR
 ..S DA(1)=APCDX,DA=APCDY,DIE="^AUPNPROB("_APCDX_",14,",DR=".01///@"
 ..D ^DIE
 ..K DIE,DA,DR
 .;USED AS INPATIENT
 .S APCDY=0 F  S APCDY=$O(^AUPNPROB(APCDX,15,"B",APCDVDLT,APCDY)) Q:APCDY'=+APCDY  D
 ..;call die to DELETE
 ..K DIE,DA,DR
 ..S DA(1)=APCDX,DA=APCDY,DIE="^AUPNPROB("_APCDX_",15,",DR=".01///@"
 ..D ^DIE
 ..K DIE,DA,DR
 .Q
 Q
