APCDVM2 ; IHS/CMI/LAB - VISIT MERGE ;
 ;;2.0;IHS PCC SUITE;**8,29**;MAY 14, 2009;Build 20
 ;
 ...
 ;ADD IN REFUSALS FILE
 S APCDVMFL=9000022 D
 .S APCDVMG=^DIC(APCDVMFL,0,"GL")
 .Q:'$D(@(APCDVMG_"""AV"","_APCDVMF_")"))
 .W:'$D(ZTQUEUED) !,APCDVMFL
 .S APCDVMN="" F APCDVML=0:0 S APCDVMN=$O(@(APCDVMG_"""AV"","_APCDVMF_",APCDVMN)")) Q:APCDVMN=""  D
 ..W:'$D(ZTQUEUED) "."
 ..S DIK=APCDVMG,DA=APCDVMN,X=2 D DD^DIK,1^DIK1 K DIK,DA
 ..S $P(@(APCDVMG_APCDVMN_",0)"),U,9)=APCDVMT
