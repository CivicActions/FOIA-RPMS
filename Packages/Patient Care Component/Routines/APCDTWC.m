APCDTWC ;  IHS/CMI/TUCSON - GENERATED FROM 'APCD WCE (ADD)' INPUT TEMPLATE(#XXX), FILE 9000010  ;09/23/05
...
POV ; PURPOSE OF VISIT
 ...
 S X=$O(^ICD9("AB","V20.2",0)) I 'X G POVX ; GET THE ICD9 IEN FOR A WELL CHILD EXAM
