APCDEWHA ; IHS/CMI/LAB - DISPLAY PATIENT & VISIT INFO ;
 ;;2.0;IHS PCC SUITE;**22,23,25,27,29**;MAY 14, 2009;Build 20
...
DSPLY ;
 ...
 S APCDVFLE=9000022 D   ;IHS/CMI/LAB PATCH 29 ADDED REFUSALS FILE IF IT HAS A VISIT POINTER
 .S APCDVNM=$P(^DIC(APCDVFLE,0),U),APCDVDG=^DIC(APCDVFLE,0,"GL"),APCDVIGR=APCDVDG_"""AV"",APCDVDSP,APCDVDFN)",APCDVDFN=""
 .S APCDVFC=0 F APCDVI=1:1 S APCDVDFN=$O(@APCDVIGR) Q:APCDVDFN=""  D DSPLY3
 D XIT
 Q
 ;
DSPLY2 ;
...
DSPLY3 ;
 ...
 I APCDVI<2 S APCDX=$L($S($E(APCDVNM)="V":$P(APCDVNM,"V ",2),1:APCDVNM)_"s"),APCDY=APCDX\2,APCDZ=APCDX-APCDY W !!,"============  ",$S($E(APCDVNM)="V":$P(APCDVNM,"V ",2),1:APCDVNM)_"'s","  ============"
 I APCDVI>1 W !
 K ^UTILITY("DIQ1",$J)
 ...
 ;I APCDVFLE=9000010.41 S DIC=APCDVDG,DR=".04:999999",(DA,D0)=APCDVDFN D EN^DIQ1  ;PATCH 27
 D DSPLY4
 Q
 ;
DSPLY4 ;
 ...
 Q
DSPLY41 ;
 I APCDVFLE=9000010.41,APCDY=.01 Q
...
WRITE ;
 ...
 S APCDX=APCDH_": "_APCDV W:$X>39 ! S APCDT=$S($X>1:41,1:1) W:(APCDT+$L(APCDX))>79 ! W ?APCDT,APCDH,": ",APCDV
 K APCDT,APCDX
 Q
