APCHSBAN ; IHS/TUCSON/LAB - Banner routine for Health Summary ;  [ 01/17/01  7:22 AM ]
 ;;2.0;IHS RPMS/PCC Health Summary;**8,14**;JUN 24, 1997
 ;
V ; GET VERSION
 S APCH("VERSION")="",APCH("VERSION")=$O(^DIC(9.4,"C","APCH",APCH("VERSION"))),APCH("VERSION")=^DIC(9.4,APCH("VERSION"),"VERSION")
...
PRINT W:$D(IOF) @IOF
 ...
 W !?80-(8+$L(APCH("VERSION")))/2,"Version ",APCH("VERSION")
