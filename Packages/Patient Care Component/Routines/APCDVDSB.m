APCDVDSB ; IHS/CMI/LAB -VISIT DISPLAY W/LIMITED LAB ELEMENTS ; 02 Nov 2015  11:45 AM
 ;;2.0;IHS PCC SUITE;**2,4,5,10,11,13,17,23,27,29**;MAY 14, 2009;Build 20
 ;
...
VFILES ;set up array of all v file entries
 ...
 .S APCDVNM=$P(^DIC(APCDVFLE,0),U),APCDVDG=^DIC(APCDVFLE,0,"GL"),APCDVIGR=APCDVDG_"""AV"",APCDVIEN,APCDVDFN)",APCDVDFN=""
...
VF3 ;
 ...
 S APCDVFC=APCDVFC+1
 I APCDVFC<2 S APCDSTR="" D SET S APCDSTR="=============== "_IOINHI_$S($E(APCDVNM)="V":$P(APCDVNM,"V ",2),1:APCDVNM)_"s"_IOINORM_" ===============",X=(80-$L(APCDSTR)\2) D SET ;$J("",X)_APCDSTR D SET
 ...
 .K APCDAR,APCDNARR
 .Q:F=".02"
 .I APCDVFLE'=9000022 Q:F=".03"
 .I APCDVFLE=9000010.41,F=".01" Q  ;PATCH 27 SUPPRESS V ASTHMA .01
