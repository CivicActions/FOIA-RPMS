AGMPCLAS ;GDIT/HS/BE-Post Install ; 18 Apr 2013  12:51 PM
...
EXPORT ;
 ...
 ; Create a new global-based character stream
EXPGO ;
 ; Create new record in 9002021.02 with IEN of REC
 ; Populate Name (not sure what it should be), Date/Time, and set status to I
 K DO,DA S DIC=9002021.02,DLAYGO=9002021.02,DIC(0)="L",X=$S($G(NAME)'="":NAME,1:"New Record for "_$H)
...
POPULATE(REC,XML) ;
 S DA(1)=REC
 K DIC S DIC="^AGMPCLS("_DA(1)_",10," ;XML Subfile
