BMCRR5 ; IHS/PHXAO/TMJ - list patients for which medical and/or cost data has not been received ;  [ 12/11/2003  3:32 PM ]
 ;;2.0;REFERRED CARE INFO SYSTEM;**2**;JAN 20, 2004
 ;2.0*2 11.13.03 IHS/ITSC/FCJ ADDED VAR
 ;2.0*2 12.11.03 IHS/ITSC/FCJ ADDED REQUEST TO SORT BY ALPHA
 ;
 ;
 ;
START ;
...
SORT ;sort by?
 ...
 I $D(DIRUT) G XIT
 S BMCSTYPE=Y
 ;BMC*2.0*2 12.11.03 IHS/ITSC/FCJ ADDED REQUEST TO SORT BY ALPHA
 S BMCSTYPA=""
 ...
 .Q:$D(DIRUT)
 .S BMCSTYPA=Y
 ;BMC*2.0*2 12.11.03 IHS/ITSC/FCJ END OF CHANGES
 ;
...
XIT ;EP - CALLED FROM BMCRR5
 ...
 K BMCD,BMCHRN,BMCSORT,BMCP,BMCSPAGE,BMCSTYPE
 K BMCTST ;BMC*2.0*2 11.13.03 IHS/ITSC/FCJ ADDED VAR
 Q
