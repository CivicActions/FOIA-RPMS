BMCRD ; IHS/PHXAO/TMJ -VISIT DISPLAY ;        [ 08/29/2006  3:46 PM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**2,3,8,9,12,15,16**;JAN 09, 2006;Build 168
 ...
 ;4.0 2/17/05 IHS/ITSC/FCJ ADDED N BMCCTYP
 ;     ADDED DISPLAY OF SUFFIX,REMOVED BOLD ON/OFF VARS
 ;4.0*2 8/21/06 IHS/OIT/FCJ CHG DISPLAY OF CHS INFO
 ;4.0*3 8.13.07 IHS.OIT.FCJ PRNT INS AUTH NO AND PRNT MED HX/BO COM FR SEC REF TO PRIM REF
 ;4.0*8 7.26.12 IHS.OIT.FCJ ADDED DISPLAYING OF DENIAL REASON OPTIONS
 ;4.0*9 ICD-10 CHANGE
 ;4.0*12 7.27.17 IHS.OIT.FCJ DISPLAY CALL IN INFO
 ;4.0*15 5.23.2023 IHS.OIT.FCJ ADD PREFERRED NAME FOR SCREEN DISPLAYS and CHG BO/CHS COM TO REFERRAL NOTES
...
BUILD ; build array
 ...
 S BMCSTR="",BMCCTR=0
 ;S BMCH="Patient Name",BMCV=$E($P(^DPT($P(BMCRREC,U,3),0),U),1,20) D BUILD1   ;BMC*4.0*15
 S BMCH="Patient Name",BMCV=$E($$GETPREF^AUPNSOGI($P(BMCRREC,U,3),"E",1),1,37) D BUILD1  ;BMC*4.0*15
...
REFERRAL ;
 ...
 .I F=".02" S:$P($G(^BMCREF(BMCRIEN,1)),U)="" BMCV=BMCV_$$CALLIN^BMCRLU(BMCRIEN)   ;BMC*4.0*16 ADDED CALLIN IDENT
 .I F=".03" S BMCV=$E($$GETPREF^AUPNSOGI($P(BMCRREC,U,3),"E",1),1,37)  ;BMC*4.0*15
 .D BUILD1
...
VF2 ;
 ...
 .;S BMCVNM=$S(BMCCTYP="M":"Medical Hx Comment",BMCCTYP="C":"Case Review Comment",BMCCTYP="D":"Discharge Comment",1:"Business/CHS Comment")  ;BMC*4.0*15
 .S BMCVNM=$S(BMCCTYP="M":"Medical Hx Comment",BMCCTYP="C":"Case Review Comment",BMCCTYP="D":"Discharge Comment",1:"Referral Note")    ;BMC*4.0*15
...
SEC ;SEC REF INFO ;4.0 FCJ
 ...
 ..F BMCCTYP="M","S" D
 ...S BMCVDFN="",BMCVI=1
 ...;S BMCVNM=$S(BMCCTYP="M":"Sec Ref-"_BMCSUF_" Medical Hx Comment",BMCCTYP="S":"Sec Ref-"_BMCSUF_" Business/CHS Comment",1:"") ;BMC 4.0*15
 ...S BMCVNM=$S(BMCCTYP="M":"Sec Ref-"_BMCSUF_" Medical Hx Comment",BMCCTYP="S":"Sec Ref-"_BMCSUF_" Referral Note",1:"") ;BMC 4.0*15
