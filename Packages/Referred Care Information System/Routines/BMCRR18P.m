BMCRR18P ; IHS/PHXAO/TMJ - PRNT BILL VSTS ;       [ 09/27/2006  2:05 PM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**1,16**;JAN 09, 2006;Build 168
...
PRINT1 ;
 ...
 ;W ?35,BMCRNUMB,$P($G(^BMCREF(BMCREF,1)),U)         ;BMC*4.0*16
 W ?35,BMCRNUMB,$P($G(^BMCREF(BMCREF,1)),U),$$CALLIN^BMCRLU(BMCREF)         ;BMC*4.0*16
