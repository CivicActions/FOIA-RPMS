BMCRRSPP ; IHS/PHXAO/TMJ - SECONDARY PROVIDER LETTER ;    
 ...
 ;BMC*4.0*15 5.5.2023 OIT.IHS.FCJ REMVD SSN PRINT AND CHANGE BO COM TO REFERRAL NOTES
 ;
...
LETTER ;Print Letter Information
 ;
 W !,"Referral Type: "_$$VAL^XBDIQ1(90001,BMCREF,.04)
...
BO ;Business office comments
 ...
 .;I Y=0 W !,"Business Office Comments:"   ;BMC*4.0*15
 .I Y=0 W !,"Referral Notes:"   ;BMC*4.0*15
