BMCCHS ; IHS/OIT/FCJ - CHS INTERFACE RTN 1 OF 2 ;         [ 09/22/2006  10:03 AM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**2,8,15**;JAN 09, 2006;Build 168
 ;
 ...
 ;4.0*15 4.11.23 IHS.OIT.FCJ CLOSE INP DENIAL REF
 ;
...
STATP ; SET CHS STATUS INFORMATION
 ...
 .;I $P($G(^BMCPARM(DUZ(2),4100)),U,3)="Y" D   ;BMC*4.0*15
 .I ($P($G(^BMCPARM(DUZ(2),4100)),U,3)="Y")!($P($G(^BMCPARM(DUZ(2),4100)),U,14)="Y") D   ;BMC*4.0*15 CLOSE BOTH INP AND OUT REF
 ..S BMCCHSX=.15
