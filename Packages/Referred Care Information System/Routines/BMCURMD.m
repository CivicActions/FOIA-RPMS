BMCURMD ; IHS/PHXAO/TMJ - ; 
 ;;4.0;REFERRED CARE INFO SYSTEM;**12,15**;JAN 09, 2006;Build 168
 ;4.0 IHS/OIT/FCJ REMOVED DATE LOOP AND ADDED SELECT OF INDIVIDUAL REFERRALS
 ;BMC*4.0*15 IHS/OIT/FCJ CHANGED LOOKUP VALUES FOR PNN
 ;
 ;
...
GETREF ;Screens out closed Referrals
 ...
 S DIC="^BMCREF(",DIC("S")="I $$FILTER^BMCFLTR(0,BMCCURFY,2)",DIC(0)="AEMQS",DIC("A")="Select RCIS REFERRAL by Patient or by Referral Date or #: "  ;BMC*4.0*15
 D DIC^BMCFMC
 Q:Y<1
 S BMCRIEN=+Y
 S BMCQ=0
