BMCFPIN ; IHS/ITSC/FCJ - PRINT IN-HOUSE REFERRAL FORM ;     
 ...
 ;4.0*16 12.15.2023 IHS.OIT.FCJ ADD "C1" SUFFIX FOR CALLIN, PRINT CASE NOTES AND DX;END DATE CHG
 ;
PRINT ;
 ;print referral form
 ...
 ;D REFTYP,REFTO,DATE,PURPOSE Q ;BMC*4.0*16
 D REFTYP,REFTO,DATE,PURPOSE    ;BMC*4.0*16
...
REFTYP ;REFERRAL TYPE
 ...
 W !
 ;S X="Referral Number: "_$$VAL^XBDIQ1(90001,BMCREF,.02),N=0,C=1,T=0 D W Q:BMCQUIT       ;BMC*4.0*16
 S X="Referral Number: "_$$VAL^XBDIQ1(90001,BMCREF,.02)_$$CALLIN^BMCRLU(BMCREF),N=0,C=1,T=0 D W Q:BMCQUIT      ;BMC*4.0*16
 Q
REFTO ;
 D L
...
DX ;BMC*4.0*16 PRINT DX REMOVED OLD CODE
