BMCFPRN2 ; IHS/OIT/FCJ - PRINT REFERRAL FORM-SECONDARY PROVIDER ;         [ 09/27/2006  2:27 PM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**1,2,12,15,16**;JAN 09, 2006;Build 168
 ;
 ...
 ;4.0*12 IHS.OIT.FCJ NO LONGER PRINTING SSN
 ;4.0*15 3.07.23 IHS.OIT.FCJ ADD CELL # AND PRINTING TEXT
 ;4.0*16 12.11.2023 IHS.OIT.FCJ CHG CHS TO PRC;ADD ICD CAT;PRINT CASE NOTES;END DATE CHG
 ;
PRINT ;
 ;print referral form
...
DATE ;
 ...
 I $P(BMCR1,U,14)="I" W !
 ;S X="Expected Ending Date: "_$$VAL^XBDIQ1(90001,BMCSRIEN,1107),C=0,T=40,N=0 D W Q:BMCQUIT  ;BMC*4.0*16
 S BMCEDOS=$$AVEOS^BMCRLU(BMCREF,"E") I BMCEDOS'="" S X="Ending Date: "_BMCEDOS,C=0,T=40,N=0 D W Q:BMCQUIT  ;BMC*4.0*16
 I $P(BMCR1,U,32)'="" S X="Priority Rating:  "_$$VAL^XBDIQ1(90001,BMCSRIEN,.32),C=0,T=0,N=1 D W Q:BMCQUIT   ;BMC*4.0*16
 D L
PURPOSE ;
 ...
 S X="ICD DX Category:"_$$VAL^XBDIQ1(90001,BMCSRIEN,.12),N=1,C=0,T=0 D W Q:BMCQUIT    ;BMC*4.0*16
...
TEXT ;
 ...
 ;I $P(BMCR1,U,4)="I"!($P(BMCR0,U,4)="N") W ! S BMCWP(1)="" ;BMC*4.0*15 3.07.23 IHS.OIT.FCJ;REMOVED TEST FOR INHOUSE AND PRIM REF
 ;
...
CASE ;PRNT CASE NOTES ;BMC*4.0*16
 D:$G(BMCPCSE) PRT^BMCFPRNN     ;BMC*4.0*16
 Q
W ;
 Q:X=""
 NEW %
...
WPTXT ;
 ...
 ;I $P(BMCR0,U,4)="C" D   ;BMC*4.0*15 3.07.23 IHS.OIT.FCJ TEST SECONDARY REF 
 I $P(BMCR1,U,4)="C" D    ;BMC*4.0*15 3.07.23 IHS.OIT.FCJ TEST SECONDARY REF
