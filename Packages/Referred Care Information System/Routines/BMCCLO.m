BMCCLO ; IHS/PHXAO/TMJ - CLOSE OUT A REFERRAL ;     [ 09/27/2006  1:32 PM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**1,2,8,9,15**;JAN 09, 2006;Build 168
 ;
...
REFERRAL ; GET REFERRAL TO CLOSE
 ...
 S DIC="^BMCREF(",DIC(0)="AEMQS" ;BMC*4.0*15 ADDED "S" TO DIC(0) AND SPLIT LINE
 S DIC("S")="I $$FILTER^BMCFLTR(2,BMCCURFY,2)",DIC("A")="Select RCIS REFERRAL by Patient or by Referral Date or #: "
 D DIC^BMCFMC
 ;Q:Y<1   ;BMC*4.0*8
