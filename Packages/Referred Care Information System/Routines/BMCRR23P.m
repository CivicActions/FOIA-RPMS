BMCRR23P ; IHS/OIT/FCJ - REPORT FOR CALL IN REFERRALS (2/2)  
 ;;4.0;REFERRED CARE INFO SYSTEM;**12,16**;JAN 09, 2006;Build 168
...
PRINT1 ;
 ...
 S:$P($G(^BMCREF(BMCREF,1)),U)="" ^XTMP(BMCJOB,"BMCRR23",BMCBTH,"FIL",BMCSORT,BMCRTOT,0)=^XTMP(BMCJOB,"BMCRR23",BMCBTH,"FIL",BMCSORT,BMCRTOT,0)_$$CALLIN^BMCRLU(BMCREF) ;BMC*4.0*16
