BMCAL1 ; IHS/OIT/FCJ-RCIS LIST FOR ALERT; 20-SEP-2007
 ;;4.0;REFERRED CARE INFO SYSTEM;**3,15**;JAN 09, 2006;Build 168
...
BOCOM ; PRINT BO COMMENTS
 ...
 ;S BMCVNM="Business/CHS Comment",BMCVIGR=BMCVDG_"""AD"",BMCRIEN,BMCVDFN)",BMCCTYP="B"   ;BMC*4.0*15
 S BMCVNM="Referral Notes",BMCVIGR=BMCVDG_"""AD"",BMCRIEN,BMCVDFN)",BMCCTYP="B"  ;BMC*4.0*15
