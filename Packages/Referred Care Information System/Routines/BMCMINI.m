BMCMINI ; IHS/PHXAO/TMJ - MINI ADD A NEW REFERRAL ;  
 ;;4.0;REFERRED CARE INFO SYSTEM;**9,15,16**;JAN 09, 2006;Build 168
 ;4.0*9 ITSC/IHS/FCJ MOVED REQ TO SND MSG AFTER ENTRY OF REF
 ;4.0*15 4.20.23 IHS.OIT.FCJ ADD PREFERRED NAME FOR SCREEN DISPLAYS
...
DX ; GET PROVISIONAL DIAGNOSES
 W:$D(IOF) @IOF
 ;W !?5,"Referral #: ",$$REFN^BMC    ;BMC*4.0*16
