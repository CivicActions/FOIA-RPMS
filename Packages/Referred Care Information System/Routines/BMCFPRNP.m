BMCFPRNP ; IHS/OIT/FCJ - PRINT PHYSICIAN CONSULT LETTER ;   [ 10/31/2006  2:40 PM ]
 ...
 ;4.0*16 12.14.2023 IHS.OIT.FCJ CASE COMMENTS AND DX DISPLAY CHANGE
 ;
...
DX ;BMC*4.0*9 REWROTE SECTION
 ...
 .;Q:$P($G(^BMCDX(DX,0)),U,4)'="P"    ;BMC*4.0*16 including all
 .S CT=CT+1,BMCDOS=$$AVDOS^BMCRLU(BMCREF,"N")
 .;I CT=1 S X="PROVISIONAL DIAGNOSIS: "_$P($$ICDDX^ICDEX(BMCD,BMCDOS,,"I"),U,2)_" - "_$E($P($$ICDDX^ICDEX(BMCD,BMCDOS,,"I"),U,4),1,50),C=0,T=0,N=2 D W Q  ;BMC*4.0*16
 .I CT=1 S X="ICD Diagnosis: "_$P($$ICDDX^ICDEX(BMCD,BMCDOS,,"I"),U,2)_" - "_$E($P($$ICDDX^ICDEX(BMCD,BMCDOS,,"I"),U,4),1,50),C=0,T=0,N=1 D W Q   ;BMC*4.0*16 REMV TITLE, CHG FF 2-1
 .E  S X=$P($$ICDDX^ICDEX(BMCD,BMCDOS,,"I"),U,2)_"-"_$E($P($$ICDDX^ICDEX(BMCD,BMCDOS,,"I"),U,4),1,50),C=0,T=15,N=1 D W Q   ;BMC*4.0*16 CHG TAB FR 23-0,FF 2-1
