BMCRL3 ; IHS/PHXAO/TMJ - MORE LISTER ;  [ 12/10/2003  6:32 PM ]
 ;;2.0;REFERRED CARE INFO SYSTEM;**2**;JAN 20, 2004
 ;LAB added help text to dir call
 ;2.0*2 11.14.03 IHS/ITSC/FCJ ADDED DTTST SUB FOR CANNED REPORTS
 ;2.0*2 12.4.03 IHS/ITSC/FCJ ADDED ABILITY TO SAVE TOT/SUBTOT RPTS
 ;2.0*2 12.10.03 IHS/ITSC/FCJ ADDED ABILITY TO SAVE CUSTOM TITLE
 ;
 ;
TITLE ;EP
 Q:BMCCTYP="T"  ;--- don't ask for title if total count only
 ;BMC*2.0*2 12.10.03 IHS/ITSC/FCJ TEST AND SAVE CUSTOM TITLE
 ;FCJ
...
SAVE ;EP
 ...
 ;BMC*2.0*2 12.4.03 IHS/ITSC/FCJ ADDED ABILITY TO SAVE TOT/SUBTOT RPTS
 ;Q:BMCCTYP'="D"  ;--- must be a detailed report to be saved ;BMC*2.0*2 12.4.03
 I BMCCTYP="N",BMCCTYP="R" Q  ;BMC*2.0*2 12.4.03
 S BMCSAVE=""
 ...
 G:$D(DIRUT) SAVE
 S BMCNAME=Y
 ;FCJ CHNG FOR CUSTOM TITLE
 ;BMC*2.0*2 12.10.03 IHS/ITSC/FCJ SAVE CUSTOM TITLE
 ;S DIE="^BMCRTMP(",DA=BMCRPT,DR=".02////1;.03///"_BMCNAME_";.06///"_BMCPTVS_";.05///"_BMCCTYP S:$D(BMCEP1) DR=DR_";.09///"_BMCPACK D ^DIE K DIE,DA,DR
...
NUMERIC ;
 ...
 D SORT
 Q
DTTST ;BMC*2.0*2 11.14.03 IHS/ITSC/FCJ ADDED DTTST SUB FOR CANNED REPORTS
 ...
 Q
 ;BMC*2.0*2 11.14.03 IHS/ITSC/FCJ END OF CHANGES
