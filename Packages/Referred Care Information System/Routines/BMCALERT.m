BMCALERT ; IHS/PHXAO/TMJ - RCIS ALERTS ; 02 Mar 2009  2:48 PM
 ;;4.0;REFERRED CARE INFO SYSTEM;**3,4,5,8,15**;JAN 09, 2006;Build 168
...
PALRT1 ;EP-ALERT FOR PHYS
 ...
 I '$G(BMCPPRV) W !,"Primary Care Provider is not defined.",?45,"***ALERT WAS NOT SENT***"    ;BMC*4.0*15
 I '$G(BMCRPRV) W !,"Referring Provider is not defined.",?45,"***ALERT WAS NOT SENT***"       ;BMC*4.0*15
