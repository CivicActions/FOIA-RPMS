BMCRR5P ; IHS/PHXAO/TMJ - PRNT BILL VSTS ;      [ 08/15/2006  11:54 AM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**2,9,14,15,16**;JAN 09, 2006;Build 168
...
BUILD ; build array
 ...
 ;S BMCSTR="Name: "_BMCSTR_" "_$$FMTE^XLFDT(AUPNDOB,"5D")_" "_$$VAL^XBDIQ1(9000001,DFN,1102.98)_" "_$$SSN^AUPNPAT(DFN) D SET Q:$D(BMCQUIT) ;BMC*4.0*14 REMOVE SSN
 S BMCSTR="Name: "_BMCSTR_" "_$$FMTE^XLFDT(AUPNDOB,"5D")_" "_$$VAL^XBDIQ1(9000001,DFN,1102.98) D SET Q:$D(BMCQUIT)    ;BMC*4.0*14 REMOVE SSN
 ;S X=$$VAL^XBDIQ1(90001,BMCREF,.02) W ?59,"Ref #:"_X_$P($G(^BMCREF(BMCREF,1)),U)         ;BMC*4.0*16
 S X=$$VAL^XBDIQ1(90001,BMCREF,.02) W ?59,"Ref #:"_X_$P($G(^BMCREF(BMCREF,1)),U) W:$P($G(^BMCREF(BMCREF,1)),U)="" $$CALLIN^BMCRLU(BMCREF)         ;BMC*4.0*16
