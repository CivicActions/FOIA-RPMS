...
ZIS ;call to XBDBQUE
 ...
 .S DIR(0)="S^P:PRINT Output;B:BROWSE Output on Screen;C:CSV Output",DIR("A")="Do you wish to",DIR("B")="P" K DA D ^DIR K DIR ;BMC*4.0*16
 ...
 I $G(BMCOPT)="C" D XPRTCSV,XIT Q  ;BMC*4.0*16 CSV FORMAT
 D ^XBDBQUE
 D XIT
 Q
