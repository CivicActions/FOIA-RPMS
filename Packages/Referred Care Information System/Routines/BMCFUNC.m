BMCFUNC ; IHS/PHXAO/TMJ - FIX UNCODED DX ;
 ;;4.0;REFERRED CARE INFO SYSTEM;**8,9,15,16**;JAN 09, 2006;Build 168
...
BMCDIE ;
 ...
 ;W !,"NAME: ",$P(^DPT(AUPNPAT,0),U),"  DOB: ",BMCDOB,"  SEX: ",AUPNSEX,"  HRN: ",$S(BMCHRN]"":BMCHRN,1:"NONE")    ;BMC*4.0*15
 W !,"NAME: ",$E($$GETPREF^AUPNSOGI(AUPNPAT,"E",1),1,37)," DOB: ",BMCDOB," SEX: ",AUPNSEX," HRN:",$S(BMCHRN]"":BMCHRN,1:"NONE")  ;BMC*4.0*15
 ;W !,"Referral: ",$P(^BMCREF(BMCRIEN,0),U,2),"  DX NAR: ",$P($G(^BMCREF(BMCRIEN,12)),U)   ;BMC*4.0*16
 W !,"Referral: ",$P(^BMCREF(BMCRIEN,0),U,2),$$CALLIN^BMCRLU(BMCRIEN) W !,"DX NAR: ",$P($G(^BMCREF(BMCRIEN,12)),U)
