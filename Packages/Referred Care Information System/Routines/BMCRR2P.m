BMCRR2P ; IHS/PHXAO/TMJ - PRNT BILL VSTS;INPATIENT REF LOG REPORT ;       [ 09/27/2006  2:07 PM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**1,2,3,9,16**;JAN 09, 2006;Build 168
...
PRINT1 ;
 ...
 ;W !,"Referral #: " W ?12,BMCRNUMB,$P($G(^BMCREF(BMCREF,1)),U)         ;BMC*4.0*16
 W !,"Referral #: " W ?12,BMCRNUMB,$P($G(^BMCREF(BMCREF,1)),U) W:$P($G(^BMCREF(BMCREF,1)),U)="" $$CALLIN^BMCRLU(BMCREF)         ;BMC*4.0*16
