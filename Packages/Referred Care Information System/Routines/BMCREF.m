BMCREF ; IHS/PHXAO/TMJ - SET REFERRAL VARIABLES ; 
 ;;4.0;REFERRED CARE INFO SYSTEM;**7,15**;JAN 09, 2006;Build 168
...
START ;
 ...
 S BMCRTYPE=$P(X,U,4)
 S BMCRIO=$P(X,U,14)
 ;S:$G(BMCDFN) BMCREC("PAT NAME")=$P(^DPT(BMCDFN,0),U)  ;BMC*4.0*15
 S:$G(BMCDFN) BMCREC("PAT NAME")=$E($$GETPREF^AUPNSOGI(BMCDFN,"E",1),1,37)  ;BMC*4.0*15
 ;
