BMCOSUT ; IHS/PHXAO/TMJ - PRINTING UTILITIES ;  [ 11/19/2003  3:04 PM ]
 ;;2.0;REFERRED CARE INFO SYSTEM;**2**;JAN 20, 2004
 ;;2.0*2 11.18.03 IHS/ITSC/FCJ ADDED DATE FORMAT FOR PRINTING
 ;
...
EOJ ;ENTRY POINT
 ...
 Q
DT ;ENTRY POINT;FORMAT DATE ;BMC*2.0*2 11.18.03 IHS/ITSC/FCJ NUMERIC DATE FORMAT FOR PRINTING 4 DIGIT YEAR
 S Y=$E(Y,4,5)_"/"_$E(Y,6,7)_"/"_$S($E(Y,1,3)>299:20_$E(Y,2,3),1:(19_$E(Y,2,3)))
 Q
DT1 ;ENTRY POINT;FORMAT DATE ;BMC*2.0*2 11.18.03 IHS/ITSC/FCJ NUMERIC DATE FORMAT FOR PRINTING 2 DIGIT YEAR
