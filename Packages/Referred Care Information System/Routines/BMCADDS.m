BMCADDS ;IHS/ITSC/FCJ - ADD SECONDARY REFERRAL;        [ 09/27/2006  1:31 PM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**1,2,3,8,12,15**;JAN 09, 2006;Build 168
 ;
...
GETREF ;Screens out closed Referrals
 ...
 S DIC="^BMCREF(",DIC(0)="AEMQS",DIC("A")="Select REFERRAL by Patient or by Referral Date or #: "  ;BMC*4.0*15 ADDED "S" TO DIC(0)
...
MEDHX ;EP;DISPLAY MED HX COMMENTS IF ANY AND ADD NEW COMMENTS TO SEC REF
 ...
 ;W !,$$CTR^BMC("REFERRAL: "_BMCRNUMB_"   PATIENT: "_BMCREC("PAT NAME"),80),!   ;BMC*4.0*15
