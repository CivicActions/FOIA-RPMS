BMCFDRC ; IHS/PHXAO/TMJ - CHS DRIVER TO PRINT REFERRAL FORM ;       [ 09/26/2006  4:01 PM ]
 ;;4.0;REFERRED CARE INFO SYSTEM;**2,3,4,15,16**;JAN 09, 2006;Build 168
 ...
 ;4.0*16 12.14.2023 IHS.OIT.FCJ CASE COMMENTS PROMPT
 ;
START ;
 S BMCPROUT=0
 W:$D(IOF) @IOF
...
ASKCON ;ASK TO PRINT CONSULT LETTER ;BMC*4.0*2 IHS/OIT/FCJ
 D ASKCON^BMCFDR
ASKCSE ;ASK TO PRINT CASE CMTS ;BMC*4.0*16 IHS/OIT/FCJ
 D ASKCSE^BMCFDR
ZIS ;
