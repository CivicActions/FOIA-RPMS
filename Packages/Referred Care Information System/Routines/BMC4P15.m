BMC4P15 ;IHS/OIT/FCJ - BMC 4.0 PATCH 15 ; 16 Feb 2011  2:54 PM
 ;;4.0;REFERRED CARE INFO SYSTEM;**15**;JAN 09, 2006;Build 138
 ;
...
P15G ;Add/update GEN RET options
 ...
 S DIC(0)="L" D ^DIC
 I +Y<0 D BMES^XPDUTL("Unable to add CHS PO Type item to General Retrieval Report list . . .") Q
 S DA=+Y
