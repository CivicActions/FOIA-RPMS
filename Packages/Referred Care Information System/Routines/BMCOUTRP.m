BMCOUTRP ; IHS/PHXAO/TMJ - OUTSIDE PROVIDER REFERRALS ;    
 ...
 ;BMC*4.0*15 5.5.2023 OIT.IHS.FCJ REMVD SSN PRINT AND CHG BO/CHS COM TO REFERRAL NOTES
...
PRINT1 ;
 ...
 ;W !,"Referral #: ",BMCRNUMB,$P($G(^BMCREF(BMCRIEN,1)),U)          ;BMC*4.0*16
 W !,"Referral #: ",BMCRNUMB,$P($G(^BMCREF(BMCRIEN,1)),U)_$$CALLIN^BMCRLU(BMCRIEN)         ;BMC*4.0*16
...
ALT ;Alternate Resource Letter Date
 ...
 ;W !,"Business Office Comments:"  ;BMC*4.0*15
 W !,"Referral Notes:"  ;BMC*4.0*15
