AUT98P32 ; IHS/OIT/FBD - AUT V98.1 PATCH 32 ENVIRONMENT CHECKS AND POST-INIT PROCESS ; 08/02/2022
 ;;98.1;IHS DICTIONARIES (POINTERS);**32**;NOV 25,1997;Build 1
 ;
 ;
 D:'$D(IOM) HOME^%ZIS
 ;
 ...
 S:'$$VCHK("AUT","98.1","31") XPDQUIT=2          ; IHS STANDARD DICTIONARIES
...
LAST(PKG,VER) ; EP - returns last patch applied for a Package, PATCH^DATE
 ...
 ;
PRE ; EP FR KIDS
 D BMES^XPDUTL("Beginning pre-install for AUT v98.1 patch 32...")
 ;
 ;N DIU,AUTDD
 ...
 ;
 ;
 D BMES^XPDUTL("AUT v98.1 patch 32 pre-install complete.")
 Q
 ;
POST ; EP FR KIDS
 D BMES^XPDUTL("Beginning post-install for AUT v98.1 patch 32...")
 ;
 D BMES^XPDUTL("Delivering "_$G(XPDNM)_" install message to select users...")
 D MAIL
 D BMES^XPDUTL("AUT v98.1 patch 32 post-install complete.")
