AUT98P33 ; IHS/OIT/FBD&NKD - AUT V98.1 PATCH 33 ENVIRONMENT CHECKS AND POST-INIT PROCESS ; 09/16/2024
 ;;98.1;IHS DICTIONARIES (POINTERS);**33**;NOV 25,1997;Build 1
 ;
 ;
 D:'$D(IOM) HOME^%ZIS
 ;
 ...
 S:'$$VCHK("AUT","98.1","32") XPDQUIT=2          ; IHS STANDARD DICTIONARIES
...
LAST(PKG,VER) ; EP - returns last patch applied for a Package, PATCH^DATE
 ...
 ;
PRE ; EP FR KIDS
 D BMES^XPDUTL("Beginning pre-install for AUT v98.1 patch 33...")
 ;
 ;
 D BMES^XPDUTL("AUT v98.1 patch 33 pre-install complete.")
 Q
 ;
POST ; EP FR KIDS
 D BMES^XPDUTL("Beginning post-install for AUT v98.1 patch 33...")
 ;
 D BMES^XPDUTL("Delivering "_$G(XPDNM)_" install message to select users...")
 D MAIL
 D BMES^XPDUTL("AUT v98.1 patch 33 post-install complete.")
