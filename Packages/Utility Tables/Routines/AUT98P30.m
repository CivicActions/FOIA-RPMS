AUT98P30 ; IHS/OIT/FBD&NKD - AUT V98.1 PATCH 30 ENVIRONMENT CHECKS AND POST-INIT PROCESS ; 03/17/2021
 ;;98.1;IHS DICTIONARIES (POINTERS);**30**;NOV 25,1997;Build 2
 ;
 ;
 D:'$D(IOM) HOME^%ZIS
 ;
 ...
 S:'$$VCHK("AUT","98.1","29") XPDQUIT=2          ; IHS STANDARD DICTIONARIES
...
LAST(PKG,VER) ; EP - returns last patch applied for a Package, PATCH^DATE
 ...
 ;
PRE ; EP FR KIDS
 D BMES^XPDUTL("Beginning pre-install for AUT v98.1 patch 30.")
 ;
 ;N DIU,AUTDD
 ...
 ;
 ;
 D BMES^XPDUTL("AUT v98.1 patch 30 pre-install complete.")
 Q
 ;
POST ; EP FR KIDS
 D BMES^XPDUTL("Beginning post-install for AUT v98.1 patch 30.")
 ;
 D BMES^XPDUTL("Delivering "_$G(XPDNM)_" install message to select users...")
 D MAIL
 D BMES^XPDUTL("AUT v98.1 patch 30 post-install complete.")
