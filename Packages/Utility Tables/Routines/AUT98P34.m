AUT98P34 ; IHS/OIT/NKD - AUT V98.1 PATCH 34 ENVIRONMENT CHECKS AND POST-INIT PROCESS ; 05/14/2025
 ;;98.1;IHS DICTIONARIES (POINTERS);**34**;NOV 25,1997;Build 1
 ;
 ;
 D:'$D(IOM) HOME^%ZIS
 ;
 ...
 S:'$$VCHK("AUT","98.1","33") XPDQUIT=2          ; IHS STANDARD DICTIONARIES
...
LAST(PKG,VER) ; EP - returns last patch applied for a Package, PATCH^DATE
 ...
 ;
PRE ; EP FR KIDS
 D BMES^XPDUTL("Beginning pre-install for AUT v98.1 patch 34...")
 ;
 ;
 D BMES^XPDUTL("AUT v98.1 patch 34 pre-install complete.")
 Q
 ;
POST ; EP FR KIDS
 D BMES^XPDUTL("Beginning post-install for AUT v98.1 patch 34...")
 ;
 D BMES^XPDUTL("Delivering "_$G(XPDNM)_" install message to select users...")
 D MAIL
 D BMES^XPDUTL("AUT v98.1 patch 34 post-install complete.")
