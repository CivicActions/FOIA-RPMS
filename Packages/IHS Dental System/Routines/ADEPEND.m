...
ZTM ;EP - TASKMAN PROCESSING ENTRY POINT
 ...
 . W !!,"   No ENDO visits were found",!   ;/IHS/OIT/GAB PATCH 38
 ...
 . ;/IHS/OIT/GAB PATCH 38 - Commented above 2 lines and added below 2 lines for File200 update
 . I ADEHDFNS="" S ADEHDFNS=ADEL,ADEHNAM(ADEL)=$P(^VA(200,ADEL,0),U) Q
 . S $P(ADEHDFNS,",",$L(ADEHDFNS,",")+1)=ADEL,ADEHNAM(ADEL)=$P(^VA(200,ADEL,0),U)
 S ADEPROV=1
