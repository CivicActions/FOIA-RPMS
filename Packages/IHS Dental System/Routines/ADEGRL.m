...
MOD4 ;------->Get Location, Provider, etc.
 ...
 ;IHS/OIT/GAB **38** File 3,6,16 Changes - comment out line above and added next line below for AUXILLIARY DENTIST
 S ADEPVNMD=$P(^ADEPCD(ADEDFN,0),U,5) I ADEPVNMD]"" S ADEPVNM=$P(^VA(200,ADEPVNMD,0),"^",1)
 ...
 ;IHS/OIT/GAB **38** File 3,6,16 Changes - comment out line above and added line below for REPORTING DENTIST
 S ADERDNMD=$P(^ADEPCD(ADEDFN,0),U,4) I ADERDNMD]"" S ADERDNM=$P(^VA(200,ADERDNMD,0),"^",1)
