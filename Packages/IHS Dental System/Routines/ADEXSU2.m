...
ERR12 ;EP
 ...
 ;IHS/OIT/GAB PATCH 38 - File 3,6,16 Removal, commented above line and added 1 line below
 I '$D(ADERR("RPD",ADEREPD)) W !," - INVALID DATA: MISSING SOCIAL SECURITY NUMBER IN 'NEW PERSON' FILE FOR ",$P(^VA(200,ADEREPD,0),U) S ADERR("RPD",ADEREPD)=1 D ERREND G END
END Q
