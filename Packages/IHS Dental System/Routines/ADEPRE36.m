ADEPRE36 ; IHS/OIT/GAB - ADEv6.0 PATCH 36 ENVIRONMENT CHECK [ 10/20/2021 13:42 PM ]
 ;;6.0;ADE IHS DENTAL;**36**;March 25, 1999;Build 86
 ;IHS/OIT/GAB 10/2021 Patch 36 ADA-CDT code updates for 2022
 ;
 S X="ADEPRE35" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.35k' MUST be installed!" D GETUP(ADEMSG,1)
