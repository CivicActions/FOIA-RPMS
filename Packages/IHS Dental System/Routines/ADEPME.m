ADEPME ; IHS/HQT/MJL - MEDICAID ELIGIBLES PT 1 ;08:33 PM  [ 03/24/1999   9:04 AM ]
 ...
 ;;IHS/OIT/GAB 11.2022 File 200 Update Patch 38
INIT ;
 ;------->GET DATE RANGE
 D DATE G:Y<0 END
 ;------->DEVICE
...
P3 Q:'$D(^ADEPCD(ADEDFN,0))
 ...
 ;/IHS/OIT/GAB PATCH 38 - Commented above 2 lines and added below 2 lines for File 3,6,16 removal, File200 update PROV NAME
 Q:'ADEPRV  Q:'$D(^VA(200,ADEPRV,0))
 S ADEPRV=$P(^VA(200,ADEPRV,0),U)
