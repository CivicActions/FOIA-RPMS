...
CHKY3 I '$D(^ADEPCD(ADEA,0)) G ERR1^ADEXER2
 ...
 ;/IHS/OIT/GAB PATCH 38 - Commented above 2 lines and added below 2 lines for File 3,6,16 removal, File200 update
 I '$D(^VA(200,ADEREPD,0)) G ERR6^ADEXER2
 I $P(^VA(200,ADEREPD,1),U,9)="" G ERR12^ADEXER2
 S ADERC=ADERC+1
 Q
