...
S3 ;EP
 ...
 ;/IHS/OIT/GAB PATCH 38 -  File 3,6,16 Changes commented above two lines and added below two lines for File 200 New Person file update
 G:'$D(^VA(200,ADEID,0)) ERR7^ADEFLEX1
 S ADESSN=$P(^VA(200,ADEID,1),U,9) G:ADESSN'?9N ERR8^ADEFLEX1 S ADEID=ADESSN
