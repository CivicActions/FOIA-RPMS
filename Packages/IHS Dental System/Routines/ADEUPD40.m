...
FILE  ;EP
 ...
 Q
 ;
DELETES(ADETGRTN,ADESETX,ADEDIK)  ;EP  Nothing inactivated for 2024, added "Q" for this update below
 Q
 F ADEI=1:1 S ADEX=$P($T(@$P(ADETGRTN,"^")+ADEI^@$P(ADETGRTN,"^",2)),";;",2) Q:ADEX="***END***"  D
 . D:ADESETX'="" @ADESETX
 . I ADEX'="" S DA=ADEX,DIE=ADEDIK,DR=".08////3230101" D ^DIE
 . Q
 Q
