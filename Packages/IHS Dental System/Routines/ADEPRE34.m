ADEPRE34 ; IHS/OIT/GAB - ADE6.0 PATCH 34 ENVIRONMENT CHECK [ 11/22/2019 13:42 PM ]
 ;;6.0;ADE*6.0*34;;March 25, 1999;Build 68
 ;IHS/OIT/GAB 11/2019 Patch 34 ADA-CDT code updates for 2020
 ;
 S X="ADEPRE34" X ^%ZOSF("TEST")
 I '$T S ADEMSG="Dental ADE v6.0 Patch 'ade_0600.33k' MUST be installed!" D GETUP(ADEMSG,1)
