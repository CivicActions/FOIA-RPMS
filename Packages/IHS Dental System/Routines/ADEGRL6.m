ADEGRL6 ; IHS/HQT/MJL - FILE DENTAL VISIT DATA ;10:12 PM  [ 03/24/1999   9:04 AM ]
 ;;6.0;ADE;**12,26,38**;MAR 25, 1999;Build 158
...
MSG Q:'$D(^ADEFOL(ADEMDFN,0))
 ...
 I $P(^ADEFOL(ADEMDFN,0),U,5)="u" S XMB(1)=$P(^DPT(ADEPAT,0),U),XMB(2)=ADEVDATE I $P(^ADEFOL(ADEMDFN,0),U,7)]"",$D(^VA(200,$P(^ADEFOL(ADEMDFN,0),U,7),0)) S XMB(3)=$P(^VA(200,$P(^ADEFOL(ADEMDFN,0),U,7),0),U)
 I $D(XMB) D
 . S XMB="ADECALL"
