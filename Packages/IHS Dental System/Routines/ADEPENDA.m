...
GRP ;EP - Sets up code and opsite groups
 ...
 ;S ADECOD("ACCESSED")=$$ADACOD("3330,3310,3320,3330")  ;/IHS/OIT/GAB Update ENDO CODES!!
...
DDS() ;EP
 ...
 ;/IHS/OIT/GAB PATCH 38 - Commented above line and added below line for File200 update, SEARCH PROVIDER CLASS in F200
 F  S ADEJ=$O(^VA(200,ADEJ)) Q:'+ADEJ  D
 . ; I $P(^DIC(6,ADEJ,0),U,4)]"",$D(^DIC(7,$P(^DIC(6,ADEJ,0),U,4),9999999)),+^DIC(7,$P(^DIC(6,ADEJ,0),U,4),9999999)=52 D  ;/IHS/OIT/GAB commented line for File 200 PATCH 38
 . I $P(^VA(200,ADEJ,"PS"),U,5)]"",$D(^DIC(7,$P(^VA(200,ADEJ,"PS"),U,5),9999999)),+^DIC(7,$P(^VA(200,ADEJ,"PS"),U,5),9999999)=52  D  ;/IHS/OIT/GAB Added for File 200 PATCH 38
 . . I ADEHYG="" S ADEHYG=ADEJ Q
 . . S $P(ADEHYG,",",$L(ADEHYG,",")+1)=ADEJ
 I ADEHYG="" Q 0
 ;F ADEJ=1:1:$L(ADEHYG,",") S ADEHNAM($P(ADEHYG,",",ADEJ))=$P(^DIC(16,$P(ADEHYG,",",ADEJ),0),U)
 ;/IHS/OIT/GAB PATCH 38 - Commented above line and added below line for File 3,6,16 removal, File200 update - Setup Array ADEHNAM(DFN)="PROV,NAME"
 F ADEJ=1:1:$L(ADEHYG,",") S ADEHNAM($P(ADEHYG,",",ADEJ))=$P(^VA(200,$P(ADEHYG,",",ADEJ),0),U)
 S ADEHYG="1^"_ADEHYG
 Q ADEHYG
 ;
