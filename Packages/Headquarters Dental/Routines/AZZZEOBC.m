AZZZEOBC ; IHS/ADC/GTH - AUTOMATICALLY DELETE EOBR FILES AT FACILITY ; [ 09/17/97   9:12 AM ]
...
FILDELF ;
 ...
 U IO(0)
 I '$$DIR^XBDIR("Y","Delete ALL FI EOBR FILES With Process Date BEFORE "_$$FMTE^XLFDT(ACHSDELD),"Y","","","",1) G FILDEND
...
FILDELK2 ;
 ...
 I '$$DEL^%ZISH($$IM^ACHS,ACHSZFN) U IO(0) W !!?10,ACHSZFN,"  has been DELETED" KILL ACHSUFLS("C",ACHSR,ACHSRR),ACHSUFLS(ACHSRR)
 G FILDELK1
 ;
FILDEND ;
 Q
...
REPORT ;EP - Print EOBR processing summary report.
 ...
 S IOP=ZTIO
 D ^%ZIS
 I POP S ACHSERR=1 S IOP=$I D ^%ZIS Q
 U IO
 D HDR
REPORT1 ;
