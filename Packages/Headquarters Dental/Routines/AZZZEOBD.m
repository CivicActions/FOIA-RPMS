AZZZEOBD ; IHS/ADC/GTH - SET NODES IN NON-PROCESSED EOBR FILE ; [ 09/17/97   9:12 AM ]
 ;;3.0;CONTRACT HEALTH MGMT SYSTEM;**10**;SEP 17, 1997
 ;
 I '$D(^ACHSEOBE(0)) S ^ACHSEOBE(0)="CHS NON-PROCESSED EOBRS^9002065^0^0"
 S ACHSNON=$P(^ACHSEOBE(0),U,3)+1,$P(^ACHSEOBE(0),U,3)=ACHSNON,ACHSNON1=$P(^ACHSEOBE(0),U,4)+1,$P(^ACHSEOBE(0),U,4)=ACHSNON1
 S ^ACHSEOBE(ACHSNON,0)=ACHSEOBR("A",12)_"^"_ACHSEOBR("A",1)_"^"_ACHSEOBR("A",2)_"^"_ACHSEOBR("A",5)_"^"_ACHSEOBR("A",8)
 S ^ACHSEOBE(ACHSNON,0)=^ACHSEOBE(ACHSNON,0)_"^"_ACHSEOBR("A",9)_"^"_ACHSEOBR("A",10)_"^"_ACHSEOBR("A",11)_"^"_ACHSEOBR("A",13)_"^"_ACHSEOBR("A",14)_"^"_ACHSEOBR("A",15)
 S ^ACHSEOBE(ACHSNON,1)=ACHSEOBR("B",8)_"^"_ACHSEOBR("B",9)_"^"_ACHSEOBR("B",10)_"^"_ACHSEOBR("B",11)_"^"_ACHSEOBR("B",12)
 S ^ACHSEOBE(ACHSNON,1)=^ACHSEOBE(ACHSNON,1)_"^"_ACHSEOBR("C",8)_"^"_ACHSEOBR("C",9)_"^"_ACHSEOBR("C",10)_"^"_ACHSEOBR("C",11)_"^"_ACHSEOBR("C",12)
 S ^ACHSEOBE(ACHSNON,1)=^ACHSEOBE(ACHSNON,1)_"^"_ACHSEOBR("C",14)_"^"_ACHSEOBR("C",15)_"^"_ACHSEOBR("C",16)_"^"_ACHSEOBR("C",13)
 S ^ACHSEOBE(ACHSNON,2)=ACHSEOBR("D",8)_"^"_ACHSEOBR("D",9)_"^"_ACHSEOBR("D",10)_"^"_ACHSEOBR("D",11)
 S ^ACHSEOBE(ACHSNON,2)=^ACHSEOBE(ACHSNON,2)_"^"_ACHSEOBR("E",8)_"^"_ACHSEOBR("E",9)_"^"_ACHSEOBR("E",10)
 S ^ACHSEOBE(ACHSNON,2)=^ACHSEOBE(ACHSNON,2)_"^"_ACHSEOBR("E",11)_"^"_ACHSEOBR("E",12)_"^"_ACHSEOBR("E",13)_"^"_ACHSEOBR("E",14)_"^"_ACHSEOBR("E",15)_"^"_ACHSEOBR("E",16)
 ...
 S ACHSCPT=$P(^ACHSEOBE(ACHSNON,3,0),U,3)
F ;
...
F3 ;
 ...
 S F=ACHSTEMP("F",10)_"^"_ACHSTEMP("F",8)_"^"_ACHSTEMP("F",9) ;ACHS*3*9
 S F=F_"^"_ACHSTEMP("F",11)_"^"_ACHSTEMP("F",12)_"^"_ACHSTEMP("F",13) ;ACHS*3*9
 S F=F_"^"_ACHSTEMP("F",14)_"^"_ACHSTEMP("F",15)_"^"_ACHSTEMP("F",16) ;ACHS*3*9
 ;END Y2K BLOCK
