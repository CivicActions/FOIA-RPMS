AZZZEOBY ; IHS/ADC/GTH - CHECK STATUS OF BCBS EOBR REPORTS ; [ 12/16/1998  11:36 AM ]
 ;;3.0;CONTRACT HEALTH MGMT SYSTEM;**10**;SEP 17, 1997
 ;
 I '$L($$AOP^ACHS(2,1)) D NODIR Q
 KILL ACHSUNMS,ACHSUFLS
 S ACHSLCTR=0
...
FILDELK3 ;
 ...
 I '$$DEL^%ZISH($$AOP^ACHS(2,1),ACHSZFN) U IO(0) W !!?10,ACHSZFN,"  has been DELETED" KILL ACHSUFLS("C",ACHSR,ACHSRR),ACHSUFLS(ACHSRR)
 G FILDELK1
 ;
FILDEND ;
 Q
