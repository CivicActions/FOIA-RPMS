AZZZEOBM ; IHS/ADC/GTH - BUILD CHS EOBR MESSAGE FILE ; [ 09/17/97   9:12 AM ]
...
A1 ; Read past the FI header info at the top of the file.
 U IO
 F  R ACHSEOBR:5 G:ACHSEOBR="" B0A S:ACHSISAO ACHSEOBR=$E(ACHSEOBR,3,85) S ACHSRCT=ACHSRCT+1 G:ACHSRCT>100 END1^AZZZEOB1 Q:$E(ACHSEOBR,1,2)="$$"
B0 ;
...
B2 ;
 ...
 U IO(0)
 W $J(ACHSMSG,10)
 KILL ^ACHSEOBM(DA,1) ; Remove old message text.
B3 ;
