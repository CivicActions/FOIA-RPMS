BGOIN033 ; IHS/MSC/PLS - BGO*1.1*33 ;09-Mar-2023 12:14;PLS
 ;;1.1;BGO COMPONENTS;**33**;Mar 20, 2007
EC Q
 ; Preinit
PRE ;
 Q
...
PARS ;Store system levels of new parameter
 D EN^XPAR("SYS","BGO HF START/END DATES",1,"CURRENT SMOKELESS")
 D EN^XPAR("SYS","BGO HF START/END DATES",2,"CURRENT SMOKER, SOME DAY")
 D EN^XPAR("SYS","BGO HF START/END DATES",3,"EXPOSURE TO ENVIRONMENTAL TOBACCO SMOKE")
 D EN^XPAR("SYS","BGO HF START/END DATES",4,"HEAVY TOBACCO SMOKER")
 D EN^XPAR("SYS","BGO HF START/END DATES",6,"LIGHT TOBACCO SMOKER")
 D EN^XPAR("SYS","BGO HF START/END DATES",7,"PREVIOUS (FORMER) SMOKELESS")
 D EN^XPAR("SYS","BGO HF START/END DATES",8,"PREVIOUS (FORMER) SMOKER")
 D EN^XPAR("SYS","BGO HF START/END DATES",9,"SMOKELESS TOBACCO, STATUS UNKNOWN")
 D EN^XPAR("SYS","BGO HF START/END DATES",10,"SMOKER IN HOME")
 D EN^XPAR("SYS","BGO HF START/END DATES",11,"TOBACCO (SMOKING)")
 Q
...
CLNMNU ;
 ...
 Q
VER ;;BEHIPL.IPL;1.1.25.2;521F75E237AEC12F5720905748A19847
 ;;IHSBGOEM.BGOEMCTRL;1.1.0.612;C6A3347BF33D5A5A3A29A982431BDEF9
 ;;
CHM ;;IHSBGOREPHISTORY.IHSBGOREPHISTCTRL;IhsBgoRepHist.chm;2023.3.8.205503;2C12F73C80169EBAE04F5DA36BF0E3BB
 ;;
BUSARPC ;;
 ;;
