BIEXPRT3 ;IHS/CMI/MWR - EXPORT IMMUNIZATION RECORDS; MAY 10, 2010 ; 23 Apr 2025  1:56 PM
 ;;8.5;IMMUNIZATION;**8,25,30**;OCT 24,2011;Build 125
...
HISTORY1(BIVIEN,BIDE,BIFMT,BIVTYPE,BIDATA,BIERR,BISTOR) ;EP
 ...
 S BIDATE=$$IMMDTT^BIUTL6(BIVPTR,$G(BI012),2)
 ;
...
BITXT N BITXT,BIFRM,BITO,BIINC,BIJ,BITMP
 S BITMP=BIDATA
 S BITXT=""
 S BIFRM=1
 S BITO=250
 S BIINC=250
 S ^BITMP($J,BISUB,BIDFN,BIVG,BIDATE,BIVIEN)=$E(BIDATA,BIFRM,BITO)
 S BIFRM=BIFRM+BIINC
 S BITO=BITO+BIINC
 F BIJ=1:1 D  Q:BITXT=""
 .S BITXT=$E(BITMP,BIFRM,BITO)
 .Q:BITXT=""
 .S ^BITMP($J,BISUB,BIDFN,BIVG,BIDATE,BIVIEN,BIJ)=BITXT
 .S BIFRM=BIFRM+BIINC
 .S BITO=BITO+BIINC
BITXTEND Q
