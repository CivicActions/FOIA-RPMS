BIEXPRT5 ;IHS/CMI/MWR - EXPORT IMMUNIZATION RECORDS; OCT 15, 2010
 ;;8.5;IMMUNIZATION;**5,29,30**;OCT 24,2011;Build 125
...
IMMSERV(BIFDT,BIDUZ2,BINF) ;EP
 ...
 .;VERSION 8.5 PATCH 30 -
BITXT .N BITXT,BIFRM,BITO,BIINC,BIJ
 .S BITXT=""
 .S BIFRM=1
 .S BITO=250
 .S BIINC=250
 .S ^BITMP($J,2,BIDFN,1,1,1)=$E(BITMP,BIFRM,BITO)
 .S BIFRM=BIFRM+BIINC
 .S BITO=BITO+BIINC
 .F BIJ=1:1 D  Q:BITXT=""
 ..S BITXT=$E(BITMP,BIFRM,BITO)
 ..Q:BITXT=""
 ..S ^BITMP($J,2,BIDFN,1,1,1,BIJ)=BITXT
 ..S BIFRM=BIFRM+BIINC
 ..S BITO=BITO+BIINC
BITXTEND Q
...
DOSES(Y,BIAGE,BITMP,BIDOSES) ;EP
 ...
 .;V8.5 PATCH 29 - FID-107546 Tdap age check
 .I "|20|115|138|139|"[("|"_$P(Y,U,2)_"|"),BIAGE>6 S BITMP=BITMP_U_-13 Q
 .;**********
 .;
 ...
 .I "|149|150|151|153|155|158|"[("|"_$P(Y,U,2)_"|")  S BITMP=BITMP_U_15 Q
 .;**********
 .;
