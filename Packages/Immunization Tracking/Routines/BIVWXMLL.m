BIVWXMLL   ; VEN/GPL MSC/DKA - XML templating utilities;07/07/16 13:30
...
QUERY(IARY,XPATH,OARY)  ; RETURNS THE XML ARRAY MATCHING THE XPATH EXPRESSION
 ...
 . D INDEX^BIVWXML1(IARY) ; GENERATE AN INDEX FOR THE XML
...
QUEUE(BLST,ARRAY,FIRST,LAST)    ; ADD AN ENTRY TO A BLIST
 ...
 D PUSH^BIVWXML1(BLST,ARRAY_";"_FIRST_";"_LAST)
 Q
 ;
...
INSERT(INSXML,INSNEW,INSXPATH)  ; INSERT INSNEW INTO INSXML AT THE
 ...
 . D CP^BIVWXMLL(INSNEW,INSXML) ; JUST COPY INTO THE OUTPUT
 ...
 . . I $G(MXMLDEBUG) D PARY^BIVWXMLL("INSBLD")
 ...
 . D CP^BIVWXMLL("INSTMP",INSXML) ; COPY BUFFER TO SOURCE
 Q
 ;
INSINNER(INNXML,INNNEW,INNXPATH)        ; INSERT THE INNER XML OF INNNEW
 ...
 . D QUEUE^BIVWXMLL("INNBLD",INNNEW,2,@INNNEW@(0)-1) ; JUST INNER
...
REPLACE(REXML,RENEW,REXPATH)    ; REPLACE THE XML AT THE XPATH POINT
 ...
 ; THE DELETED XML IS PUT IN ^TMP($J,"BI_REPLACE_OLD")
 N REBLD,XFIRST,XLAST,OLD,XNODE,RTMP
 S OLD=$NA(^TMP($J,"BI_REPLACE_OLD"))
 K @OLD
...
MISSING(IXML,OARY)      ; SEARTH THROUGH INXLM AND PUT ANY @@X@@ VARS IN OARY
 ...
 . . D PUSH^BIVWXML1(OARY,$P(@IXML@(I),"@@",2)) ; ADD TO OUTARY
 . . Q
 Q
 ;
...
H2ARY(IARYRTN,IHASH,IPRE) ; CONVERT IHASH TO RETURN ARRAY
 ...
 . . ; W $NA(@IHASH@(H2I)),!
 . . Q  ;
 . D PUSH^BIVWXML1(IARYRTN,IPRE_"^"_H2I_"^"_@IHASH@(H2I))
 . ; W @IARYRTN@(0),!
 Q
 ;
...
DXVARS(DXIN) ;DISPLAY ALL VARIABLES IN A TEMPLATE
 ...
 D PARY^BIVWXMLL("DVARS") ;AND DISPLAY THEM
 Q
 ;
