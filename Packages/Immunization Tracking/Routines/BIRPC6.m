BIRPC6 ;IHS/CMI/MWR - REMOTE PROCEDURE CALLS;MAY 30,2007
 ;;8.2;IMMUNIZATION;**1**;FEB 01,2008
...
CPTIMM ;EP
 ...
 ;S APCDVSIT=1902,APCDPAT=11,APCDDATE=3051017,X=90730,BICCPT=1776
 ;
 Q:'$G(X)
 ...
 ;Q:$D(^AUPNVIMM("AA",BIDFN,BIVAC,(9999999-BIDATE)))
