BILETVW1 ;IHS/CMI/MWR - VIEW/EDIT FORM LETTERS;
 ;;8.5;IMMUNIZATION;**27**;OCT 24,2011;Build 16
...
INIT ;EP
 ...
 ;V3.0 PATCH 27 - FID-
 N BIDL S BIDL=$P(^BILET(BIIEN,0),U,7)
 ;
 D SECTION(BIIEN,.BILINE,1,"top")
 D
 .I BIFF D FORECAST(BIIEN,.BILINE) Q
 .D:BIDL=2 HISTORY(BIIEN,.BILINE)
 D SECTION(BIIEN,.BILINE,2,"middle")
 D
 .I BIFF D:BIDL=2 HISTORY(BIIEN,.BILINE) Q
