BIVWXML1 ; VEN/GPL MSC/DKA - MXMLTMPL spill over;07/07/16 13:30
...
INDEX(IZXML,VDX,NOINX,TEMPLATE,REDUX) ; parse XML in IZXML and produce
 ...
 . . . . D PARY^BIVWXMLL("MXMLSTK") ; PRINT OUT THE STACK FOR DEBUGING
...
PUSHA(ADEST,ASRC) ; PUSH ASRC ONTO ADEST, BOTH PASSED BY NAME
 ...
 ;. D CP^BIVWXMLL("TMPXML",THEXML) ; REPLACE THE XML WITH THE COPY
 ;Q:$Q FOUND Q
 ;
