...
QDATE(BIQDT,BIRTN) ;EP
 ...
 S DIR(0)="DA^::PE"
 S DIR("A")="   Please enter a "_$S(BIRTN'="BIREPC":"Quarter",1:"")_" Ending Date: "
 D FULL^VALM1
 I BIRTN'="BIREPC" D TITLE^BIUTL5("SELECT QUARTER ENDING DATE")
 I BIRTN="BIREPC" D TITLE^BIUTL5("SELECT ENDING DATE")
 I BIRTN'="BIREPC" D TEXT2 W !
 I BIRTN="BIREPC" D TEXT9^BIOUTPT2 W !
 D ^DIR W !
 I $D(DIRUT) D @("RESET^"_BIRTN) Q
 S BIQDT=$P(Y,".")
 I $E(BIQDT,6,7)="00" D
