...
ZIS ;
 I APCLPREP'=2 S XBRP="^APCLD81P",XBRC="EAUDIT^APCLD810",XBRX="XIT^APCLD81",XBNS="APCL"
 I APCLPREP=2 S XBRP="",XBRC="EAUDIT^APCLD810",XBRX="XIT^APCLD81",XBNS="APCL"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(APCLJOB,APCLBTH,APCLDMRG,APCLADAT,APCLTYPE,APCLSTMP,APCLPCP,APCLCOM,APCLRAND,APCLRCNT,APCLCMS,APCLSTAT,APCLPREP,APCLFILE,APCLDSP,BDMGIEN,APCLSDPI,APCLSDPG) ;PEP - gui call
 ...
 N APCLOPT  ;maw
 S APCLOPT="Run the 2008 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S APCLNOW=$G(%)
 K DD,D0,DIC
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^APCLD81E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
