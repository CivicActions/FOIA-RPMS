APCLP519 ;IHS/CMI/LAB - 2003 DIABETES AUDIT;     
 ;;3.0;IHS PCC REPORTS;**16,17**;FEB 05, 1997
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2005 Pre-Diabetes Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^APCLP519",XBNS="",XBRX="XIT^APCLP519"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 W:$D(IOF) @IOF
 K APCLQUIT
 W !,"Checking for Taxonomies to support the 2005 Pre-Diabetes Audit...",!
 NEW A,APCLX,I,Y,Z,J
 K A
 ...
 W !!,"In order for the 2005 Pre-Diabetes Audit to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
