...
URIN ;
 ...
 S V=$G(^XTMP("APCLDM31",APCLJOB,APCLBTH,"AUDIT",APCLPD,92))
 S A=$G(^XTMP("APCLDM31",APCLJOB,APCLBTH,"AUDIT",APCLPD,94))
 ...
 .S V=$G(^XTMP("APCLDM31",APCLJOB,APCLBTH,"AUDIT",APCLPD,96))
...
EKG ;need date of last ekg
 ...
 S V=$$EKG^APCLD312(APCLPD,APCLRED,"I")
 I V]"" D
...
CREAT ;
 ...
 S V=$$CREAT^APCLD318(APCLPD,APCLRBD,APCLRED,"I")
...
TCHOL ;
 ...
 S V=$$CHOL^APCLD318(APCLPD,APCLRBD,APCLRED,"I")
...
LDL ;
 ...
 S V=$$LDL^APCLD318(APCLPD,APCLRBD,APCLRED,"I")
...
HDL ;
 ...
 S V=$$HDL^APCLD318(APCLPD,APCLRBD,APCLRED,"I")
...
TRIG ;
 ...
 S V=$$TRIG^APCLD318(APCLPD,APCLRBD,APCLRED,"I")
...
SELF ;
 ...
 S V=$G(^XTMP("APCLDM31",APCLJOB,APCLBTH,"AUDIT",APCLPD,98))
...
SDM  ;
 ...
 S V=$G(^XTMP("APCLDM31",APCLJOB,APCLBTH,"AUDIT",APCLPD,100))
 S P=$S($E(V)="Y":3,1:4)
...
CESS(P,B,D) ;EP - find any cessation hf in 12 months before E
 ...
 I 'T Q "No"
 S (X,G)=0 F  S X=$O(^ATXAX(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^APCLD317(P,9999999.09,$P(^ATXAX(T,21,X,0),U),B,D) S G=1
 I G Q "Refused"
 Q "No"
 ;
