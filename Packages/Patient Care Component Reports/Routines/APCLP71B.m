APCLP71B ;IHS/CMI/LAB -  get dm audit values
...
TD(P,EDATE) ;EP
 ...
 K C I T S C=$$CPT^APCLP712(P,B,E,T,3) D
 .I C="" Q
 .Q:LTD>$P(C,U)
 .S LTD=$P(C,U)
 I LTD]"" Q "Yes - "_$$FMTE^XLFDT(LTD)
 S C=$$FMTE^XLFDT(B) ;external form of beginning date
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:9,1:"02"),0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:1,1:"03"),0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:28,1:34),0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:20,1:42),0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:35,1:04),0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 I '$$BI Q "No"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",22,0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",50,0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",106,0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",107,0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLP717(P,9999999.14,$O(^AUTTIMM("C",110,0)),C,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
TDBI ;
