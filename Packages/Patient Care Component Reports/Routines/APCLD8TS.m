APCLD8TS ; IHS/CMI/LAB - DISPLAY IND LISTS ;   
...
EN ;EP -- main entry point for 
 D EN^VALM("APCLD8 TAXONOMY UPDATE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2008 DIABETES AUDIT REPORTING"
...
TAXS ;
 ...
 ;;DM AUDIT INCRETIN MIMETIC;;Incretin Mimetic Taxonomy
 ;;DM AUDIT DPP4 INHIBITOR DRUGS;;DPP4 Inhibitor Drugs
 ...
 ;;DM AUDIT A/C RATIO LOINC;;A/C RATIO Loinc Taxonomy
 ;;DM AUDIT P/C RATIO LOINC;;P/C RATIO Loinc Taxonomy
 ;;
LAB ;
 ...
 ;;DM AUDIT GLUCOSE TESTS TAX;;Glucose Tests lab taxonomy
 ;;
