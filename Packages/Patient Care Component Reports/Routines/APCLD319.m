APCLD319 ;IHS/CMI/LAB - 2003 DIABETES AUDIT;     [ 07/14/03  6:40 PM ]
 ;;3.0;IHS PCC REPORTS;**13,14,17**;FEB 05, 1997
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2003 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^APCLD319",XBNS="",XBRX="XIT^APCLD319"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 W:$D(IOF) @IOF
 K APCLQUIT
 W !,"Checking for Taxonomies to support the 2003 Audit...",!
 NEW A,APCLX,I,Y,Z,J
 K A
 ...
 W !!,"In order for the 2003 Diabetes Audit to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
TEXTD ;EP
 ...
 ;;**   2003 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
