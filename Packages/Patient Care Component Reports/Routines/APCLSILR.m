APCLSILR ;IHS/CMI/LAB - AGGREGATE ILI REPORT;
 ;;3.0;IHS PCC REPORTS;**24,26,27,28,29,30,33**;FEB 05, 1997;Build 38
 ;
START ;
 W:$D(IOF) @IOF
...
ILIDX1 ;
 ...
 .I $$ICD^APCLSILU(T,$O(^ATXAX("B","SURVEILLANCE CLI",0)),9) S C=C+1,Y(C)=$$VAL^XBDIQ1(9000010.07,X,.01) Q
 .I $$ICD^APCLSILU(T,$O(^ATXAX("B","SURVEILLANCE ILI",0)),9) S C=C+1,Y(C)=$$VAL^XBDIQ1(9000010.07,X,.01)
 S VAL=""
