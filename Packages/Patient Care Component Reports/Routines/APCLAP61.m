APCLAP61 ; IHS/CMI/LAB - PRIM CARE PROVIDERREPORT PROCESS ;
 ;;2.0;IHS PCC SUITE;**15,26**;MAY 14, 2009;Build 48
 ;
START ;
 S APCLBT=$H
...
V1 ;
 ...
 S APCLVDFN="" F  S APCLVDFN=$O(^AUPNVSIT("B",APCLODAT,APCLVDFN)) Q:APCLVDFN'=+APCLVDFN  I $D(^AUPNVSIT(APCLVDFN,0)),$P(^(0),U,9),'$P(^(0),U,11),"AORSM"[$P(^(0),U,7) S APCLVREC=^(0) D PROC
 Q
PROC ;
 K APCLSKIP
