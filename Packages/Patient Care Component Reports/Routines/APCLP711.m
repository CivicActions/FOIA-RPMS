APCLP711 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT    
...
EKG ;need date of last ekg
 ...
 S V=$$EKG^APCLP712(APCLPD,APCLRED,"I")
 I V]"" D
...
FAST ;
 ...
 S V=$$FGLUCOSE^APCLD718(APCLPD,$P(^DPT(APCLPD,0),U,3),APCLADAT,"I")
...
G75 ;
 ...
 S V=$$G75^APCLD718(APCLPD,$P(^DPT(APCLPD,0),U,3),APCLADAT,"I")
...
CESS(P,B,D) ;EP - find any cessation hf in 12 months before E
 ...
 I 'T Q "No"
 S (X,G)=0 F  S X=$O(^ATXAX(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^APCLP717(P,9999999.09,$P(^ATXAX(T,21,X,0),U),B,D) S G=1
 I G Q "Refused"
 Q "No"
 ;
