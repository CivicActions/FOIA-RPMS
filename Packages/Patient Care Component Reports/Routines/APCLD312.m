...
PAP(P,BDATE,EDATE) ; EP
 ...
 I T,$$REFUSAL^APCLD317(P,60,T,BDATE,EDATE) Q "Refused"
 ...
 Q $S(G:"Refused",1:"No")
CPT(P,BDATE,EDATE,T,F) ;PEP - CALLED FROM BDM return ien of CPT entry if patient had this CPT
 I '$G(P) Q ""
 I '$G(T) Q ""
 I '$G(F) S F=1
 I $G(EDATE)="" Q ""
...
EKG(P,EDATE,F) ;EP
 ...
 K APCL I T S APCL(1)=$$CPT^APCLD312(P,,ED,T,3) D
 .I APCL(1)="" K APCL Q
 .Q:LEKG>$P(APCL(1),U)
 .S LEKG=$P(APCL(1),U)
 K APCL I T S APCL(1)=$$RAD^APCLD312(P,,ED,T,3) D
 .I APCL(1)="" K APCL Q
 .Q:LEKG>$P(APCL(1),U)
 .S LEKG=$P(APCL(1),U)
