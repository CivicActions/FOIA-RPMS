APCLD814 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT     [ 03/17/2008  11:43 AM ]
...
TOB ;
 ...
 ;W !?9,"Counseled - Unk",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,3),$P(V,U,6))  ;cmi/maw 12/26/2007 DM2008
...
TX ;
 ...
 ;W !?7,"Insulin (monotherapy)",?53,$$C($P(V,U,4)),?65,$$P($P(V,U,2),$P(V,U,4))  cmi/maw 3/17/2008 removed
 W !?7,"Insulin",?53,$$C($P(V,U,4)),?65,$$P($P(V,U,2),$P(V,U,4))
 ;cmi/anch/maw 12/31/2007 mods below for DM2008
 ;W !?7,"Oral Med (monotherapy)"
 W !?7,"Sulfonylurea",?53,$$C($P(V,U,5)),?65,$$P($P(V,U,2),$P(V,U,5))
 W !?7,"Metformin",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,2),$P(V,U,6))
 W !?7,"Acarbose",?53,$$C($P(V,U,7)),?65,$$P($P(V,U,2),$P(V,U,7))
 W !?7,"Glitazone",?53,$$C($P(V,U,8)),?65,$$P($P(V,U,2),$P(V,U,8))
 W !?7,"DPP-4 inhibitor",?53,$$C($P(V,U,12)),?65,$$P($P(V,U,2),$P(V,U,12))  ;cmi/maw 12/26/2007 DM2008
 W !?7,"Incretin mimetic",?53,$$C($P(V,U,13)),?65,$$P($P(V,U,2),$P(V,U,13))  ;cmi/maw 12/26/2007 DM2008
 ;cmi/anch/maw 12/31/2007 end of mods
