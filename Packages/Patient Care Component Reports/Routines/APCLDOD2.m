APCLDOD2 ; IHS/CMI/LAB - INFANT FEEDING REPORT #1 ;
 ;;2.0;IHS PCC SUITE;**8,28**;MAY 14, 2009;Build 72
 ;
 ;IHS/CMI/LAB - PATCH 28 FIXED KILLING OF APCLTEXT to prevent error when queued
 ;
EP ;EP - called from option interactive
 D EOJ
 W:$D(IOF) @IOF
 S APCLT1="INTROT" F APCLJ=1:1 S APCLX=$T(@APCLT1+APCLJ) Q:$P(APCLX,";;",2)="END"  S APCLT=$P(APCLX,";;",2) W !,APCLT
WPAT ;
 S APCLALLD=""
