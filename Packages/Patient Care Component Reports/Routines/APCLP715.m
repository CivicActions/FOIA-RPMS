APCLP715 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT    
...
CUML ;EP
 ...
 ;
PROCESS ;
 S APCLPD=0 F  S APCLPD=$O(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD)) Q:APCLPD'=+APCLPD  D CUML1
 Q
 ;
CUML1 ;
GENDER ;
 ...
 S V=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,20))
...
BMI ;
 ...
 S V=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,112))
 S $P(APCLCUML(40),U,2)=$P(APCLCUML(40),U,2)+1
 D
 .I V="" S $P(APCLCUML(40),U,5)=$P(APCLCUML(40),U,5)+1 Q
 .I $$OW^APCLP714(APCLPD,V,APCLADAT) S $P(APCLCUML(40),U,3)=$P(APCLCUML(40),U,3)+1
 .I $$OB^APCLP714(APCLPD,V,APCLADAT) S $P(APCLCUML(40),U,4)=$P(APCLCUML(40),U,4)+1
...
TOBACCO ;
 ...
 S V=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,27))
 S V1=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,28))
...
DMTX ;diabetes treatment
 ...
 S V=$$THERAPY^APCLP716(APCLPD,APCL6MBD,APCLRED)
...
ASPIRIN ;
 ...
 S V=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,62))
...
ACE ;110 title^total pts^total pts with protein^# of those on ace^# with htn^# of those on ace"
 ...
 ;S P=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,94))
 S H=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,34))
 S A=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,60))
...
LIPID ;115
 S V=$G(^XTMP("APCLP71",APCLJOB,APCLBTH,"AUDIT",APCLPD,61))
