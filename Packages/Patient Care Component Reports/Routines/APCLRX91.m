APCLRX91 ; IHS/OHPRD/TMJ - RX'S DISPENSED BY DATE/TIME ;  [ 07/14/03  6:13 PM ]
 ;;3.0;IHS PCC REPORTS;**8,13,14**;FEB 05, 1997
 ;APCL1 = Before 8:00
 ;APCL2 = 8:00 - 8:59
 ;APCL3 = 9:00 - 9:59
 ;APCL4 = 10:00 - 10:59
...
V1 ;
 ...
 ;
 ;Commented above line and added lines below to look at both original
 ;fills and refills....dloz 8-23-01
 ;
 S APCLVIEN="" F  S APCLVIEN=$O(^PSRX("AL",APCLSD,APCLVIEN)) Q:APCLVIEN'=+APCLVIEN  D
 .S APCLVBZL="" F  S APCLVBZL=$O(^PSRX("AL",APCLSD,APCLVIEN,APCLVBZL)) Q:APCLVBZL=""  D
 ..I $D(^PSRX(APCLVIEN,0)) S APCLVREC=^(0)
 ..I APCLVBZL'=0 D PROC1 Q
 ..E  D PROC
 Q
 ;
PROC1 ;Captures refill release date stats
 I APCLLOC]"",APCLLOC'=$P(^PSRX(APCLVIEN,1,APCLVBZL,0),U,9) Q
 S DFN=$P(APCLVREC,U,2)
 Q:$P(^DPT(DFN,0),U)="DEMO,PATIENT"
 S APCLRXTM=$P(^PSRX(APCLVIEN,1,APCLVBZL,0),U,18)
 S APCLRXHR=$E(APCLRXTM,9,12)
 D DOCOUNT
 Q
 ;End of modifications...dloz
PROC ;
