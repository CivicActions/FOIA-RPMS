APCLBV ; IHS/CMI/LAB - print billable visits ;
 ;;2.0;IHS PCC SUITE;**26,28**;MAY 14, 2009;Build 72
START ;
...
SC1 S DIR(0)="9000010,.07",DIR("A")="Which Service Category" D ^DIR K DIR
 ...
 I "AHIOSM"'[Y W !!,$C(7),$C(7),"Sorry, we only display visits for the following service categories: ",!,"H-Hospitalizations, A-Ambulatory, I-In Hospital, O-Observation",!,"M-Telemedicine and S-Day Surgery. Please re-enter your choice.",! G SC1
...
DEMO ;
 ...
 Q
EOJ ;ENTRY POINT
 K POP,ZTSK,ZTQUEUED,DFN,%DT,%,X,Y,DIRUT,DTOUT,J,K,%XX,%YY,DDBN,DDBX,HS,C,IO("Q"),DIR,DIRUT,DIC,DA,DR,DIQ,H,M,S,TS
