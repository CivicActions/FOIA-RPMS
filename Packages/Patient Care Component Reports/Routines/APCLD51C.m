APCLD51C ;IHS/CMI/LAB - 2005 DIABETES AUDIT;     
 ;;3.0;IHS PCC REPORTS;**17,18**;FEB 05, 1997
 ;
GATHER ;
...
URIN ;EP
 ...
 S X=0 F  S X=$O(^ATXLAB(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^APCLD517(P,60,$P(^ATXLAB(T,21,X,0),U),BDATE,EDATE) S G=1
 I G Q "Refused"
 S G=0
