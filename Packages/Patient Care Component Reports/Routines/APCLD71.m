APCLD71 ; IHS/CMI/LAB - IHS Diabetes Audit 2007 ;     
...
IF ;PEP - called from BDM indivdual or epi
 ...
 .S APCLPPN=Y
ZIS ;
 I APCLPREP'=2 S XBRP="^APCLD71P",XBRC="^APCLD710",XBRX="XIT^APCLD71",XBNS="APCL"
 I APCLPREP=2 S XBRP="",XBRC="^APCLD710",XBRX="XIT^APCLD71",XBNS="APCL"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(APCLJOB,APCLBTH,APCLDMRG,APCLADAT,APCLTYPE,APCLSTMP,APCLPCP,APCLCOM,APCLRAND,APCLRCNT,APCLCMS,APCLSTAT,APCLPREP,APCLFILE,APCLDSP,BDMGIEN,APCLSDPI,APCLSDPG,APCLPPN) ;PEP - gui call
 ...
 N APCLOPT  ;maw
 S APCLOPT="2007 Diabetes Program Audit"
 D NOW^%DTC
 S APCLNOW=$G(%)
 K DD,D0,DIC
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^APCLD71",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
