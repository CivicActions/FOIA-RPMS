APCLD218 ;IHS/CMI/LAB - 2001 DIABETES AUDIT;    [ 08/19/02  2:03 PM ]
 ;;3.0;IHS PCC REPORTS;**10,11,12,20**;FEB 05, 1997
 ;
...
PPD(P,EDATE,F) ;EP
 ...
 .S X=EDATE,%DT="P" D ^%DT S BDATE=$$FMADD^XLFDT(Y,-365),BDATE=$$FMTE^XLFDT(BDATE),G=0 I $$REFUSAL^APCLD217(P,9999999.28,$O(^AUTTSK("B","PPD",0)),BDATE,EDATE) S G=1
