APCLD20A ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT  [ 07/05/01  9:31 AM ]
 ;;3.0;IHS PCC REPORTS;**8,10**;FEB 05, 1997
 ;
 ;
ASPIRIN ;
...
LIPID ;
 ...
 W !?7,"Use in pts with LDL chol > 160",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,5),$P(V,U,6))
EXAMS ;
 I $Y>(IOSL-5) D HEADER Q:APCLQUIT
...
URIN ;
 ...
 W !,"Proteinuria not tested/unknown",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,2),$P(V,U,6))
