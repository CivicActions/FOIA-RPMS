APCLVL4 ; IHS/OHPRD/TMJ - NO DESCRIPTION PROVIDED 25-JUN-1996 ;  [ 12/03/03  11:25 AM ]
 ;;3.0;IHS PCC REPORTS;**11,15,16,18,19,20**;FEB 05, 1997
 ;; ;
...
INIT ; -- init variables and list array
 ...
 S APCLHIGH=0,X=0 F  S X=$O(^APCLVSTS("C",X)) Q:X'=+X  S Y=$O(^APCLVSTS("C",X,"")) I $P(^APCLVSTS(Y,0),U,5)[APCLCNTL,$P(^(0),U,11)[APCLPTVS S APCLHIGH=APCLHIGH+1,APCLSEL(APCLHIGH)=Y
