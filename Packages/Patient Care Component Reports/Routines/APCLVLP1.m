...
SHOW ;
 ...
 .K APCLQ S APCLY="",C=0 K APCLQ F  S APCLY=$O(^APCLVRPT(APCLRPT,11,APCLI,11,"B",APCLY)) S C=C+1 W:C'=1&(APCLY'="") " ; " Q:APCLY=""!($D(APCLQ))  S X=APCLY,APCLZ=$O(^APCLVRPT(APCLRPT,11,APCLI,11,"B",APCLY,0)) X:$D(^APCLVSTS(APCLI,2)) ^(2) W X
 K APCLQ
SHOWP ;
