APCLP612 ;IHS/CMI/LAB - 2003 DIABETES AUDIT;     
...
PAP(P,BDATE,EDATE) ; EP
 ...
 I T,$$REFUSAL^APCLP617(P,60,T,BDATE,EDATE) Q "Refused"
 S T=$O(^ATXLAB("B","BGP PAP SMEAR TAX",0))
 I 'T Q "No"
 S G=0
 S X=0 F  S X=$O(^ATXLAB(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^APCLP617(P,60,$P(^ATXLAB(T,21,X,0),U),BDATE,EDATE) S G=1
 Q $S(G:"Refused",1:"No")
...
EKG(P,EDATE,F) ;EP
 ...
 K APCL I T S APCL(1)=$$CPT^APCLP612(P,,ED,T,3) D
 .I APCL(1)="" K APCL Q
 .Q:LEKG>$P(APCL(1),U)
 .S LEKG=$P(APCL(1),U)
 K APCL I T S APCL(1)=$$RAD^APCLP612(P,,ED,T,3) D
 .I APCL(1)="" K APCL Q
 .Q:LEKG>$P(APCL(1),U)
 .S LEKG=$P(APCL(1),U)
