APCLD618 ;IHS/CMI/LAB - 2006 DIABETES AUDIT;     
...
PPD(P,EDATE,F) ;EP
 ...
 .S X=EDATE,%DT="P" D ^%DT S BDATE=$$FMADD^XLFDT(Y,-365),BDATE=$$FMTE^XLFDT(BDATE),G=0 I $$REFUSAL^APCLD617(P,9999999.28,$O(^AUTTSK("B","PPD",0)),BDATE,EDATE) S G=1
