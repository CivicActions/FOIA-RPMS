APCLD51 ; IHS/CMI/LAB - IHS Diabetes Audit 2005 ;      [ 03/02/2007  1:35 PM ]
...
ZIS ;
 I APCLPREP'=2 S XBRP="^APCLD51P",XBRC="^APCLD510",XBRX="XIT^APCLD51",XBNS="APCL"
 I APCLPREP=2 S XBRP="",XBRC="^APCLD510",XBRX="XIT^APCLD51",XBNS="APCL"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(APCLJOB,APCLBTH,APCLDMRG,APCLADAT,APCLTYPE,APCLSTMP,APCLPCP,APCLCOM,APCLRAND,APCLRCNT,APCLCMS,APCLSTAT,APCLPREP,APCLFILE,APCLDSP,BDMGIEN,APCLSDPI,APCLSDPG) ;PEP - gui call
 ...
 N APCLOPT  ;maw
 S APCLOPT="2005 Diabetes Program Audit"
 D NOW^%DTC
 S APCLNOW=$G(%)
 K DD,D0,DIC
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^APCLD51",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
