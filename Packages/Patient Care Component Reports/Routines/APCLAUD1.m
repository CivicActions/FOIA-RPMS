...
I1 Q:'$D(^AUPNVPOV(APCLIDFN,0))
 I APCLPSD="P" Q:$$PRIMPOV^APCLV(APCLVDFN,5)'=APCLIDFN
...
I11 S:$D(APCLNOSP) APCLPNO="ALL"
 S ^XTMP("APCLAUD2",APCLJOB,APCLBT,APCLPNO,APCLIRNG,$$VAL^XBDIQ1(9000010.07,APCLIDFN,.01)_" ",APCLINO,APCLVDFN)=APCLPNO1_U_APCLIDFN
 Q:$D(APCLALLR)
