APCLD31A ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT    [ 07/14/03  6:09 PM ]
 ;;3.0;IHS PCC REPORTS;**13,14**;FEB 05, 1997
 ;
 ;
ASPIRIN ;
...
LIPID ;
 ...
 W !?7,"Use in pts with LDL chol > 130",?53,$$C($P(V,U,6)),?65,$$P($P(V,U,5),$P(V,U,6))
