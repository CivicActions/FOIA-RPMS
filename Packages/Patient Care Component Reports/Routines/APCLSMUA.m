APCLSMUA ;ihs/cmi/maw - APCLS 2015 CHIT continuation routine
...
PV2(V,PT) ;-- setup the PV2 segment
 ...
 . Q:CD=""
 . S DX=CD
 . S DXE=$P($$LOOKTABM^APCLSMUA("","SCT",CD,"^"),"^",2)
 . S ICDT="SCT"
 I $P(DX,".",2)="" S DX=$TR(DX,".")
 D SET(.ARY,"PV2",0)
...
BUSA(PTS) ;-- audit patient in BUSA
 D LOG^BUSAAPI("O","P","Q",$S($G(XQY0)]"":$P(XQY0,U),1:"APCLS SYNDROMIC SURVEILLANCE"),"SYNDROMIC SURVEILLANCE EXPORT",.PTS)
 Q
 ;
