APCLD613 ;IHS/CMI/LAB - 2006 DIABETES AUDIT;     
...
FLU(P,BDATE,EDATE) ;EP
 ...
 K APCL I T S APCL(1)=$$CPT^APCLD612(P,BD,ED,T,3) D
 .I APCL(1)="" K APCL Q
 .Q:LFLU>$P(APCL(1),U)
 .S LFLU=$P(APCL(1),U)
 I LFLU]"" Q "Yes  "_$$DATE(LFLU)
 ;
 NEW G S G=$$REFUSAL^APCLD617(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:88,1:12),0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD617(P,9999999.14,$O(^AUTTIMM("C",15,0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD617(P,9999999.14,$O(^AUTTIMM("C",16,0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD617(P,9999999.14,$O(^AUTTIMM("C",111,0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
...
PNEU(P,EDATE) ;EP
 ...
 S G=$$REFUSAL^APCLD617(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:33,1:19),0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 I '$$BI Q "No"
 S G=$$REFUSAL^APCLD617(P,9999999.14,$O(^AUTTIMM("C",100,0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD617(P,9999999.14,$O(^AUTTIMM("C",109,0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
...
INCHES ;
 NEW F,FI,Z
 S (X,Z)=$$LASTHT^APCLD613(APCLPD,APCLRED,"I")
 Q:X=""
 S X=X/12  ;get feet
 S F=$P(X,".")
