APCLREF1 ; IHS/CMI/LAB - list refusals ;
 ;;2.0;IHS PCC SUITE;**7,11,23**;MAY 14, 2009;Build 17
 ;
 ;
INFORM ;
 W !,$$CTR($$USR)
...
PROC ;
 ...
 .Q:'I   ;IHS/CMI/LAB - FIX FOR LESLIE 011017
 .I $G(APCLONE),I'=APCLONE Q
 .S P=$P(^BIPC(APCLX,0),U)
 .S ^XTMP("APCLREF1",APCLJ,APCLH,"REFUSALS",APCLIMM,$P(^AUTTIMM(I,0),U,2),$P(^DPT(P,0),U),APCLX)="I"
 ;
 Q
PRINT ;EP - called from xbdbque
 ...
 ....I APCLY="" W ?42,$P($$VAL^XBDIQ1(9000022,APCLR,.03),"@"),?55,$E(APCLT1,1,15),?71,$E($$VAL^XBDIQ1(9000022,APCLR,.07),1,7)
