APCLD201 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT  [ 08/22/01  3:49 PM ]
...
URIN ;
 ...
 S V=$G(^XTMP("APCLDM20",APCLJOB,APCLBTH,"AUDIT",APCLPD,92))
 S A=$G(^XTMP("APCLDM20",APCLJOB,APCLBTH,"AUDIT",APCLPD,94))
 ...
 .S V=$G(^XTMP("APCLDM20",APCLJOB,APCLBTH,"AUDIT",APCLPD,96))
...
EKG ;need date of last ekg
 ...
 S V=$$EKG^APCLD202(APCLPD,APCLRED,"I")
 I V]"" D
...
CREAT ;
 ...
 S V=$$CREAT^APCLD208(APCLPD,APCLRBD,APCLRED,"I")
...
TCHOL ;
 ...
 S V=$$CHOL^APCLD208(APCLPD,APCLRBD,APCLRED,"I")
...
LDL ;
 ...
 S V=$$LDL^APCLD208(APCLPD,APCLRBD,APCLRED,"I")
...
HDL ;
 ...
 S V=$$HDL^APCLD208(APCLPD,APCLRBD,APCLRED,"I")
...
TRIG ;
 ...
 S V=$$TRIG^APCLD208(APCLPD,APCLRBD,APCLRED,"I")
...
SELF ;
 ...
 S V=$G(^XTMP("APCLDM20",APCLJOB,APCLBTH,"AUDIT",APCLPD,98))
 S P=$S($E(V)="Y":3,1:4)
...
SDM  ;
 ...
 S V=$G(^XTMP("APCLDM20",APCLJOB,APCLBTH,"AUDIT",APCLPD,100))
 S P=$S($E(V)="Y":3,1:4)
...
CESS(P,B,D) ;EP - find any cessation hf in 12 months before E
 ...
 I 'T Q "No"
 S (X,G)=0 F  S X=$O(^ATXAX(T,21,X)) Q:X'=+X!(G)  I $$REFUSAL^APCLD207(P,9999999.09,$P(^ATXAX(T,21,X,0),U),B,D) S G=1
 I G Q "Refused"
 Q "No"
 ;
