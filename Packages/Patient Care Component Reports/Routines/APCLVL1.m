APCLVL1 ; IHS/OHPRD/TMJ - PROCESS VISIT LIST ;  [ 11/30/04  11:11 AM ]
 ;;3.0;IHS PCC REPORTS;**11,15,16**;FEB 05, 1997
 ;
 ;
 ;
START ;
...
VS ; Run by visit date
 ...
 ;
PP ;
 S APCLVIEN=0 F  S APCLVIEN=$O(^DPT(APCLVIEN)) Q:APCLVIEN'=+APCLVIEN  I '$P(^DPT(APCLVIEN,0),U,19) D PROC
 Q
 ;
PS ;
...
END ;
 ...
 Q
V1 ;
 S APCLVIEN="" F  S APCLVIEN=$O(^AUPNVSIT("B",APCLODAT,APCLVIEN)) Q:APCLVIEN'=+APCLVIEN  I $D(^AUPNVSIT(APCLVIEN,0)),$P(^(0),U,9),'$P(^(0),U,11) D PROC
 Q
PROC ;
 K APCLSPEC
