APCLD513 ;IHS/CMI/LAB - 2005 DIABETES AUDIT;     
 ;;3.0;IHS PCC REPORTS;**16,17,20**;FEB 05, 1997
 ;LORI - ADD V04,81
 ;
...
FLU(P,BDATE,EDATE) ;EP
 ...
 K APCL I T S APCL(1)=$$CPT^APCLD512(P,BD,ED,T,3) D
 .I APCL(1)="" K APCL Q
 .Q:LFLU>$P(APCL(1),U)
 .S LFLU=$P(APCL(1),U)
 I LFLU]"" Q "Yes  "_$$FMTE^XLFDT(LFLU)
 ;
 NEW G S G=$$REFUSAL^APCLD517(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:88,1:12),0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD517(P,9999999.14,$O(^AUTTIMM("C",15,0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD517(P,9999999.14,$O(^AUTTIMM("C",16,0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD517(P,9999999.14,$O(^AUTTIMM("C",111,0)),BD,EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
...
PNEU(P,EDATE) ;EP
 ...
 .Q:LPN>$P(C,U)
 .S LPN=$P(C,U)
 I LPN]"" Q "Yes - "_$$FMTE^XLFDT(LPN)
 S G=$$REFUSAL^APCLD517(P,9999999.14,$O(^AUTTIMM("C",$S($$BI:33,1:19),0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 I '$$BI Q "No"
 S G=$$REFUSAL^APCLD517(P,9999999.14,$O(^AUTTIMM("C",100,0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
 S G=$$REFUSAL^APCLD517(P,9999999.14,$O(^AUTTIMM("C",109,0)),$$DOB^AUPNPAT(P,"E"),EDATE)
 I G,$P(G,U,2)'="N" Q "Refused"
 I G Q "No - Not Medically Indicated"
...
INCHES ;
 NEW F,FI,Z
 S (X,Z)=$$LASTHT^APCLD513(APCLPD,APCLRED,"I")
 Q:X=""
 S X=X/12  ;get feet
 S F=$P(X,".")
