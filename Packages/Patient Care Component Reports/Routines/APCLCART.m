APCLCART ;IHS/CMI/LAB - SET UP TAX CALIF ;  [ 02/04/2008  2:37 PM ]
 ;;3.0;IHS PCC REPORTS;**12,14,15,16,21**;FEB 05, 1997
 ;
 ;
 ;
POST ;EP
...
SETTAX ;
 ...
 S APCLDA=0 S APCLDA=$O(^ATXAX("B",APCLTN,APCLDA)) I APCLDA S DA=APCLDA,DIK="^ATXAX(" D ^DIK
 ...
 S APCLTX=+Y,$P(^ATXAX(APCLTX,0),U,2)=APCLTN,$P(^(0),U,5)=DUZ,$P(^(0),U,8)=0,$P(^(0),U,9)=DT,$P(^(0),U,12)=210,$P(^(0),U,13)=0,$P(^(0),U,15)=7,^ATXAX(APCLTX,21,0)="^9002226.02101A^0^0"
