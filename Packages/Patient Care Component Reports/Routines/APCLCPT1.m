...
PROC1 ;
 ...
 Q:X=""
 Q:"AIHSOM"'[X
 I APCLOI="O",X'="A",X'="S",X'="O",X'="M" Q  ;want only outpt and it's not a A,O or S
...
SETP .;
 ...
 Q
SET ;
 I "AOSM"[$P(APCLVREC,U,7) S ^XTMP("APCLCPT1",APCLJ,APCLH,"CPTS",APCLPN,APCLY,APCLDISC,"OUTPATIENT",APCLC,APCLN)=$G(^XTMP("APCLCPT1",APCLJ,APCLH,"CPTS",APCLPN,APCLY,APCLDISC,"OUTPATIENT",APCLC,APCLN))+APCLQ
 ...
 I "AOSM"[$P(APCLVREC,U,7) S ^XTMP("APCLCPT1",APCLJ,APCLH,"OUTPATIENT",APCLPN,APCLY,APCLDISC)=$G(^XTMP("APCLCPT1",APCLJ,APCLH,"OUTPATIENT",APCLPN,APCLY,APCLDISC))+1
