APCLD719 ;IHS/CMI/LAB - 2007 DIABETES AUDIT;     
 ;;3.0;IHS PCC REPORTS;**19**;FEB 05, 1997
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2007 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^APCLD719",XBNS="",XBRX="XIT^APCLD719"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 W:$D(IOF) @IOF
 K APCLQUIT
 W !,"Checking for Taxonomies to support the 2007 Audit...",!
 NEW A,APCLX,I,Y,Z,J
 K A
 ...
 W !!,"In order for the 2007 Diabetes Audit to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
LASTHF(P,C,BDATE,EDATE,F) ;EP - get last factor in category C for patient P
 ...
 Q 1
 ;;
BANNER ;EP - banner for 2007 audit menu
