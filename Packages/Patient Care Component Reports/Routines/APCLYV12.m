...
END ;
 ...
 K APCLVDT,APCLVDFN,APCLFAC,J,APCLDSCH,X,APCLIP,APCLOP,APCLBENP,APCLIDFN,APCLSTR,APCLCFLG
...
WRITE ;print line
 ...
 W:APCLSUB=0 !,$E(APCLNAME,1,20),?23,$J(APCLHRCN,6),?48,APCLBENP
...
HEAD ;print page heading
 ...
 W !?132-$L(X)/2,X,!
 F J=1:1:132 W "-"
 W !,"Patient Name",?23,"Chart #",?45,"CO or Dep"
 W ?58,"Sponsor"
