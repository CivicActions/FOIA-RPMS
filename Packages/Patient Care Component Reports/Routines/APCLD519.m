APCLD519 ;IHS/CMI/LAB - 2005 DIABETES AUDIT;     
 ;;3.0;IHS PCC REPORTS;**16,17**;FEB 05, 1997
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2005 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^APCLD519",XBNS="",XBRX="XIT^APCLD519"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 W:$D(IOF) @IOF
 K APCLQUIT
 W !,"Checking for Taxonomies to support the 2005 Audit...",!
 NEW A,APCLX,I,Y,Z,J
 K A
 ...
 W !!,"In order for the 2005 Diabetes Audit to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
LASTHF(P,C,BDATE,EDATE,F) ;EP - get last factor in category C for patient P
 ...
 Q 1
 ;;
BANNER ;EP - banner for 2005 audit menu
...
TEXTD ;EP
 ...
 ;;**   2005 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
