...
REGASK ;
 ...
 W !!,"This option is used to run the 2006 Electronic Diabetes Audit for a"
...
ZIS ;
 I APCLPREP'=2 S XBRP="^APCLD61P",XBRC="EAUDIT^APCLD610",XBRX="XIT^APCLD61",XBNS="APCL"
 I APCLPREP=2 S XBRP="",XBRC="EAUDIT^APCLD610",XBRX="XIT^APCLD61",XBNS="APCL"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(APCLJOB,APCLBTH,APCLDMRG,APCLADAT,APCLTYPE,APCLSTMP,APCLPCP,APCLCOM,APCLRAND,APCLRCNT,APCLCMS,APCLSTAT,APCLPREP,APCLFILE,APCLDSP,BDMGIEN,APCLSDPI,APCLSDPG) ;PEP - gui call
 ...
 N APCLOPT  ;maw
 S APCLOPT="Run the 2006 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S APCLNOW=$G(%)
 K DD,D0,DIC
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^APCLD61E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
