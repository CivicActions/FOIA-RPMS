PSN4P79D ;BIR/DMA-post install routine to load data ;31 Aug 99 / 11:32 AM
 ;;4.0; NATIONAL DRUG FILE;**79**; 30 Oct 98
 ;
 ...
 .I FILE=50.68,$P(DIA,"^",3)="14,.01" S ^TMP($J,$P(DIA,"^"))=""
 S JJ=0 F  S JJ=$O(^TMP($J,JJ)) Q:'JJ  S DA=$P(JJ,",",2),DA(1)=+JJ D ING^PSNXREF
 ;
...
LOAD1 ;BUILD THE MESSAGE
 ...
 F J=1:1 S X=$P($T(TEXT+J),";;",2,200) Q:X=""  S ^TMP("PSN",$J,LINE,0)=X,LINE=LINE+1
