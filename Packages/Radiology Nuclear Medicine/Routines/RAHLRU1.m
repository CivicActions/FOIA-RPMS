RAHLRU1 ;HISC/PB,GJC - utilities for HL7 messaging ;1/28/00  11:03
 ;;5.0;Radiology/Nuclear Medicine;**47,114,1009**;Mar 16, 1998;Build 21
 ;
...
PID(RADFN) ;compile the PID segment
 ...
 D MAG(.RA0X,.RAPID)
 ;cmi/maw patch 1009 20210519 CR9041
 I $G(RAPID(20))="""" S RAPID(20)=""  ;send this blank and not with quotes
 ;end of patch
