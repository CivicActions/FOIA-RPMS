RAEDCN1 ;HISC/GJC-Utility routine for RAEDCN ; Feb 18, 2020@15:18:21
 ;;5.0;Radiology/Nuclear Medicine;**18,45,93,106,113,124,166,1007,1009**;Mar 16, 1998;Build 21
...
ASKDEL R !!,"Do you wish to delete this exam? NO// ",X:DTIME S:'$T!(X="")!(X["^") X="N" G DEL1:"Nn"[$E(X) I "Yy"'[$E(X) W:X'["?" $C(7) W !!,"Enter 'YES' to delete this exam, or 'NO' not to." G ASKDEL
 ...
 . Q
 ;
 ;IHS/CMI/DAY - Patch 1007 - Add hang to let HL7 msgs get created
 ;  Also, the DELETE portion of RA IHS HOOK is not always invoked
 ;
 I $G(RADTE)="" S RADTE=9999999.9999-RADTI
 D DELETE^BRAPCC
 U 0 W !,"Beginning deletion - please wait" H 24
 ;End patch
 ;
