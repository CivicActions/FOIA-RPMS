RAZPCC ; IHS/ADC/PDW - RADIOLOGY PCC LINK ;     [ 05/09/2000  7:19 AM ]
 ;;4.0;RADIOLOGY;**2,3,4,5,6**;NOV 20, 1997
...
VISIT ;---> CREATE OR MODIFY VISIT IN VISIT FILE.
 ...
 S:X (APCDALVR("APCDTCLN"),APCDALVR("APCDCLN"))="`"_X K X ; APCDCLN is required for the visit file
 ;
 ...
 D:$P(^DD(9000010.22,1202,0),U,3)="DIC(6,"  ; RA*4*5 IHS/HQW/JDH If noPCC conversion to file 200, convert to file 6
 .N Y
 .S Y=^VA(200,X,0)
...
STORE(RAFLD,RAVALUE) ;---> STORE VISIT AND V RAD IEN'S IN RADIOLOGY EXAMS FILE #70
 N RAFDA,RAOK
 S RAOK=1
 S:'RAVALUE RAOK=0 ; If pointer fields were defined for tghe PCC node, this klude would not be needed.
 D:RAOK
