RAEDCN ;HISC/CAH,FPT,GJC,SS AISC/MJK,RMO IHS/OIT/NST-Edit Exams by Case Number ;02 Jan 2025 2:03 PM
 ;;5.0;Radiology/Nuclear Medicine;**5,13,10,18,28,31,34,45,85,97,124,1009,1012**;Mar 16, 1998;Build 21
 ;
...
START1 ;
 ...
 N BRACLIND
 S BRACLIND=""
 S BRAPCCVR=$P($G(^RADPT(RADFN,"DT",RADTI,"P",RACNI,"PCC")),U,2)
 D EDIT^BRANCLNI(.BRACLIND,RADFN,RADTI,RACNI,RAPRI)
 ; IHS/OIT/NST BRA*5.0*1012 - end
 ; 
 ;IHS/CMI/LAB - PATCH 1009 CR#8978 UPDATE V RAD/VISIT WHEN EXAM IS EDITED
 I RADR="[RA EXAM EDIT]" D EN^XBNEW("EDITEX^BRAPCC1","RADFN;RADTI;RACNI")
 ;IHS/CMI/LAB - end patch
 ...
 ;
 ; IHS/OIT/NST BRA*5.0*1012
 I (BRACLIND'="NOT REQUIRED"),(RADR="[RA EXAM EDIT]") D
 . D UVRAD^BRANCLNI(RADFN,RADTI,RACNI,BRACLIND)
 . Q
 ; IHS/OIT/NST BRA*5.0*1012 - end
 ;
