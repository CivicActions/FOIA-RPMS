XQ ; SEA/MJM - Menu driver (Part 1) ;01/10/13  13:41
 ;;8.0;KERNEL;**9,46,94,103,157,570,593,614,1019**;Jul 10, 1995;Build 27
...
M0 I XQY=-1 S XQDIC=$O(^DIC(19,"B","XUCOMMAND",0)) S:XQDIC="" XQDIC=-1 D DIC^XQ71 G:'XQY D S:XQY>0 XQPSM="PXU" I XQY=-1 G M3:XQUR="HALT",NOFIND
 ...
 G:XQY=-2 NOFIND K XQAA S XQY=+XQY,XQCH=XQUR D OSLOG^XUSBUSA("XQ",XQY) G M ; GDIT/HS/BEE 12/14/17 - XU*8.0*1019 - Audit option access
 ;
