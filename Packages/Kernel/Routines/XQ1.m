XQ1 ; SEA/MJM - DRIVER FOR MENUMAN (PART 2) ;08/28/08  13:20
 ;;8.0;KERNEL;**1,15,59,67,46,151,170,242,446,1019**;Jul 10, 1995;Build 27
 ;Per VHA Directive 2004-038, this routine should not be modified.
 ; GDIT/HS/BEE 12/14/17 - XU*8.0*1019 - Audit option access
 ;
 ;S DIC=19,DIC(0)="AEQM" D ^DIC Q:Y<0  S (XQDIC,XQY)=+Y K DIC,XQUR,Y,^VA(200,DUZ,202.1)
 S DIC=19,DIC(0)="AEQM" D ^DIC Q:Y<0  S (XQDIC,XQY)=+Y D OSLOG^XUSBUSA("XQ1",XQY) K DIC,XQUR,Y,^VA(200,DUZ,202.1) ; GDIT/HS/BEE 12/14/17 - XU*8.0*1019 - Audit option access
 D INIT^XQ12
 G M^XQ
 ;
