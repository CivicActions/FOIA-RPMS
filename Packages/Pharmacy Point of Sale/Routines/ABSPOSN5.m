ABSPOSN5 ; IHS/FCS/DRS - NCPDP Forms for ILC A/R ;  [ 09/12/2002  10:16 AM ]
 ;;1.0;PHARMACY POINT OF SALE;**3,54**;JUN 01, 2001;Build 131
 Q
EN(TITLE,PFLAG) ;EP
 ;
...
RPT ;
 ...
 . S PAT=$P($G(^DPT(PAT,0)),U,1)_$$PPN1^ABSPUTL(PAT)  ;IHS/GDIT/AEF 3240110 - ABSP*1.0*54 FID 77888 IS THIS ONE NECESSARY?
