...
ABSUD004 ;;1.0;PHARMACY POINT OF SALE;**3**;JUN 21, 2001;Build 131
 ;----------------------------------------------------------------------
 ;----------------------------------------------------------------------
...
HEADER N LINE
 W @IOF,!
 D:STITLE'="" WCENTER^ABSPOSU9(STITLE,IOM)
 D:STITLE'="" WCENTER^ABSPOSU9($TR($J("",$L(STITLE))," ","-"),IOM)
 ;
...
INIT N CNSPACES,CNAMES,CDEF,INDEX,COLUMNS
 ...
 . D IMPOSS^ABSPOSUE("P","TI","0 lines indicated in "_LROOT,,"INIT",$T(+0))
 ...
 ..S CHEAD1=CHEAD1_$S(INDEX=1:"",1:$J("",CNSPACES))_$$LJBF^ABSPOSU9($P(CDEF,":",1),$P(CDEF,":",2))
