...
IMPOSS(UETYPE,UEOPT,UEMSG,UEMSG2,UELOC,UEROU,UENOLOG) ;EP - deal with impossible errors - called from many places
 ...
 ;IHS/SD/RLT - 04/10/06 - Patch 17 - begin
...
QD ;
 ...
 I UECHOICE="T" G HALT
 H $R(10)+1 ; could help various things (locks, database conditions)
...
HALT ; halt
 ...
 Q:$Q  Q ""  ; <DPARM> error gets you back into programmer mode
TEST ;
 N MYEXMSG,I F I=1:1:4 S MYEXMSG(I)="my extra msg line "_I
 N X S X=$$IMPOSS^ABSPOSUE("P","TIR","Additional Message",.MYEXMSG,"point 1","MYROU")
 W !,"returned value = ",X,!
 Q
