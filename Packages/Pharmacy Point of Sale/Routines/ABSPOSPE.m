ABSPOSPE ; IHS/OIT/RAN - Pharmacy EXPENSE report modeled after ABSPOSEX Patient Expense report
 ;;1.0;PHARMACY POINT OF SALE;**38,40,44,54**;JUN 01, 2001;Build 131
  Q
    ;
MAIN(ABSPTRNS) ;PHAREX
 ...
 S ABSPPNAM=$P(^DPT(ABSPPIEN,0),U,1)_$$PPN1^ABSPUTL(ABSPPIEN)  ;IHS/GDIT/AEF 3240110 - ABSP*1.0*54 FID 77888
