ABSPOSRY  ;IHS/OIT/SCR - COLLECTION PRODUCTIVITY REPORT ;/IHS/OIT/CNI/RAN REWRITTEN TO NOT USE REPORT MASTER
 ;;1.0;PHARMACY POINT OF SALE;**38,40,54**;JUN 01, 2001;Build 131
...
EN ;  EP
 ...
 N ABSPY  ;New line ;IHS/GDIT/AEF 3231002 ABSP*1.0*54 FID 77362
 S ABSPDONE=0
 S ABSPQUIT=0
 F  Q:ABSPDONE=1  D
 .S ABSPSTRT=$$BDT()
 ...
 .S Y=$P(ABSPSDAT,".")
 .D DD^%DT
 .S ABSPY=Y   ;New line ;IHS/GDIT/AEF 3231002 ABSP*1.0*54 FID 77362
 .;IHS/OIT/CNI/RAN 05042010 patch 38 - When printing to screen, use paging
 .;S ABSPQUIT=$$WRITE^ABSPOSUU("!!?10,""RELEASED DATE: ""_Y")
 .S ABSPQUIT=$$WRITE^ABSPOSUU("!!?10,""RELEASED DATE: ""_ABSPY")  ;IHS/GDIT/AEF 3231002 ABSP*1.0*54 FID 77362
 .Q:ABSPQUIT
 ...
 ...S ABSPY=Y   ;New line ;IHS/GDIT/AEF 3231006 ABSP*1.0*54 FID77362
 ...;IHS/OIT/CNI/RAN 05042010 patch 38 - When printing to screen, use paging
 ...;S ABSPQUIT=$$WRITE^ABSPOSUU("!?5,""TRANSACTION DATE: ""_Y,?40,""RECOVERED BY: ""_$P(ABSPTMP(ABSPSDAT,ABSPPHRM,ABSPPRXI),U,5)")
 ...S ABSPQUIT=$$WRITE^ABSPOSUU("!?5,""TRANSACTION DATE: ""_ABSPY,?40,""RECOVERED BY: ""_$P(ABSPTMP(ABSPSDAT,ABSPPHRM,ABSPPRXI),U,5)")  ;IHS/GDIT/AEF 3231006 ABSP*1.0*54 FID 77362
 ...Q:ABSPQUIT
