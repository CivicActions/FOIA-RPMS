ADS1P04 ;IHS/GDIT/AEF-ADS Version 1.0 Patch 4 Post Install
...
ENV ;EP - Environmental Checking Routine
 ...
 ;
 ;Check for ADS*1.0*3
 I '$$INSTALLD("ADS*1.0*3") D BMES^XPDUTL("Version 1.0 Patch 3 of ADS is required!") S XPDQUIT=2 Q
 ;
