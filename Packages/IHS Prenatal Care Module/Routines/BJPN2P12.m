BJPN2P12 ;GDIT/HS/BEE-Prenatal Care Module 2.0 Patch 12 Post Install ; 11 May 2021  12:00 PM
 ;;2.0;PRENATAL CARE MODULE;**12**;Feb 24, 2015;Build 2
 ;
ENV ;EP - Environmental Checking Routine
 ;
 N VERSION,EXEC,BMWDT,EIEN,VRSN
 ;
 ;Check for BJPN*2.0*11
 I '$$INSTALLD("BJPN*2.0*11") D BMES^XPDUTL("Version 2.0 Patch 11 of BJPN is required!") S XPDQUIT=2 Q
 ;
 ;Check for EHRp31 (contains BGO*1.1*29)
 I '$$INSTALLD("BGO*1.1*29") D BMES^XPDUTL("EHR Version 1.1 Patch 31 is required!") S XPDQUIT=2 Q
 ;
 ;Check for XU*8.0*1018
 I '$$INSTALLD("XU*8.0*1018") D BMES^XPDUTL("XU Version 8.0 Patch 1018 or later is required!") S XPDQUIT=2 Q
 ;
 ;Check for DI*22.0*1018
 I '$$INSTALLD("DI*22.0*1018") D BMES^XPDUTL("DI Version 22.0 Patch 1018 or later is required!") S XPDQUIT=2 Q
 ;
 Q
 ;
PST ;EP - Prenatal 2.0 Patch 12 Post Installation Code
 ;
 ...
 . ;
 . ;MD5 CHECKSUM
 . I $P(TEXT,";")["IHS.PN.EHR.PRENATALPROBLEMLIST.PIPCOMPONENT" S OBJUPD(19930.2,OIEN_",",7)="2C1DE0CFE898FEA9A15B14610EC08687"
 . ;
 . ;Update entry
...
OBJ ;;
 ;;IHS.PN.EHR.PRENATALPROBLEMLIST.PIPCOMPONENT;Pregnancy Issues and Problems List;2.0.12.0;IHS.PN.EHR.PrenatalProblemList.dll;;;IHS.PN.EHR.PrenatalProblemList.chm;0;1;0;0;0;0;0;0;;1;;;;{B5416178-ECD8-4515-A700-2980BCAA6CAA};300;640;
 ;;END;
 ;;
 ;
INSTALLD(BJPNSTAL) ;EP - Determine if patch BJPNSTAL was installed, where
 ;BJPNSTAL is the name of the INSTALL.  E.g "BJPN*2.0*11".
 ;
 NEW DIC,X,Y,D
 S X=$P(BJPNSTAL,"*",1)
