BDMDI14 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 14 Oct 2014 9:54 AM ; 
...
NUMMEDS ;
 ...
 W !!?6,"DPP4 inhibitor [alogliptin (Nesina), ",?49,$$C($P(V,U,7)),?61,$$C($P(V,U,2)),?73,$$P($P(V,U,2),$P(V,U,7)),!?6,"linagliptin (Tradjenta), saxagliptin (Onglyza), ",!?6,"sitagliptin (Januvia)]"
 ...
 W !!?6,"GLP-1 receptor agonist [dulaglutide  ",!?6,"(Trulicity), exenatide (Byetta, Bydureon), ",?49,$$C($P(V,U,8)),?61,$$C($P(V,U,2)),?73,$$P($P(V,U,2),$P(V,U,8)),!?6,"liraglutide (Victoza), lixisenatide (Adlyxin),"
 W !?6,"semaglutide (Ozempic, Rybelsus)]"
...
CVD ;
 ...
 W !?6,"CVD and aspirin or other",?49,$$C($P(V,U,12)),?61,$$C($P(V,U,8)),?73,$$P($P(V,U,8),$P(V,U,12)),!?9,"antiplatelet/anticoagulant therapy currently prescribed"
...
HEADER1 ;
 ...
 N BDMDIDR
 S BDMDIDR="Audit Report for 2021 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"
 W $$CTR(BDMDIDR,80),!
 ;W $$CTR("AUDIT REPORT FOR 2021 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"),!
