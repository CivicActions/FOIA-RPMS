BDMDK14 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 14 Oct 2014 9:54 AM ; 
...
BPC ;
 ...
 ;W !?3,"----------------------------------"  ;PATCH 16
 ;W !?3,"If age >=60 years, <150/<90",?49,$$C($P(V,U,10)),?61,$$C($P(V,U,9)),?73,$$P($P(V,U,9),$P(V,U,10))  ;PATCH 16
 ;
HTN ;
 I $Y>(BDMIOSL-7) D HEADER Q:BDMQUIT
 S V=$G(BDMCUML(410))
...
TOB ;
 ...
 W !?9,"In current users, cessation",!?9,"counseling/education received"
...
NUMMEDS ;
 ...
 ;GLP-1 receptor agonist [dulaglutide (Trulicity), exenatide (Byetta, Bydureon), liraglutide (Victoza), lixisenatide (Adlyxin), semaglutide (Ozempic, Rybelsus)]
...
HEADER1 ;
 ...
 N BDMDKDR
 S BDMDKDR="Audit Report for 2023 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"
 W $$CTR(BDMDKDR,80),!
 ;W $$CTR("AUDIT REPORT FOR 2023 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"),!
