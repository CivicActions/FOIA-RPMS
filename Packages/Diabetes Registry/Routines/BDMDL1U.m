BDMDL1U ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 22 Feb 2014 3:43 PM ; 
...
IMM ;
 ...
 I $Y>(BDMIOSL-5) D HEADER Q:BDMQUIT
 W !!,$P(BDMCUML(120),U)
 W !?5,$P(BDMCUML(120,1),U),?49,$$C($P(BDMCUML(120,1),U,2)),?61,$$C($P(BDMCUML(120,1),U,3)),?73,$$P($P(BDMCUML(120,1),U,3),$P(BDMCUML(120,1),U,2)),!?5,$P(BDMCUML(120,2),U,1)
 ;TD
 I $Y>(BDMIOSL-5) D HEADER Q:BDMQUIT
 W !!,$P(BDMCUML(130),U)
...
LIPID ;
 ...
 W !?5,$P(BDMCUML(140,3),U)
 W !?5,$P(BDMCUML(140,4),U)
NUTR ;
 I $Y>(BDMIOSL-5) D HEADER Q:BDMQUIT
 W !!,$P(BDMCUML(150),U)
...
TB ;
 I $Y>(BDMIOSL-5) D HEADER Q:BDMQUIT
 W !!,$P(BDMCUML(180),U)
 W !?5,$P(BDMCUML(180,1),U),?49,$$C($P(BDMCUML(180,1),U,2)),?61,$$C($P(BDMCUML(180,1),U,3)),?73,$$P($P(BDMCUML(180,1),U,3),$P(BDMCUML(180,1),U,2)),!?5,$P(BDMCUML(180,2),U,1)
 Q
EXIT ;
...
HEADER1 ;
 ...
 N BDMDNDR
 S BDMDNDR="SDPI Required Key Measures Report for 2026 ("_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"
 W $$CTR(BDMDNDR,80),!
