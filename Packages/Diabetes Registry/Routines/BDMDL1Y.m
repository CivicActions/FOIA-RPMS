BDMDL1Y ; IHS/CMI/LAB - IHS Diabetes Audit 2026 ;
...
IF ;
 S BDMSTP=0
 S BDMPREP=6
 D QUALCHK^BDMDL1J G:BDMSTP TYPE
ZIS ;
DEMO ;
 S BDMDEMO="I"
 I BDMTYPE'="P" D DEMOCHK^BDMUTL(.BDMDEMO) I BDMDEMO=-1 G TYPE
...
FLAT ;EP
 ...
 W "It is the same directory that the data export files are placed."
...
WRITEF ;EP write flat file
 ...
 K ^XTMP("BDMDM26",BDMJOB,BDMBTH),BDMJOB,BDMBTH
 Q
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPDP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMPPN,BDMDUZ2,BDMDEMO,BDMBEN,BDMDQ,BDMACTI,BDMPTAX,BDMRTYPE) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="2026 Data Quality Report"
 S BDMPREP=6
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
