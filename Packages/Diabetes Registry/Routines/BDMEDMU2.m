BDMEDMU2 ; IHS/CMI/LAB - EDITS FOR AUPNVSIT (VISIT:9000010) 24-MAY-1993 ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**7,10,13,14**;JUN 14, 2007;Build 80
 ;
PPD ;EP
 K BDMEVSIT
...
MED1 ;
 ...
 S APCDALVR("APCDTSIG")=$P($G(^BDMEDMUP(BDMEDA,14,BDMEEDU,0)),U,4)
 D ^APCDALVR
...
ENDS(A) ;EP - called from screen
 ...
 NEW B S B=$O(^AUTTHF("C","C019",0)) I 'B Q 0
 I $P(^AUTTHF(A,0),U,3)'=B Q 0
 Q 1
