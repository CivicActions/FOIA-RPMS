BDMDK18 ; IHS/CMI/LAB - 2023 DIABETES AUDIT ;
...
TBINH(P,EDATE) ;EP
 I $P($$TBDX(P,EDATE),U,1)=1 Q $E($$TBTX^BDMDK12(P,EDATE))
 I $E($P($$PPD(P,EDATE),"||",2))=1 Q $E($$TBTX^BDMDK12(P,EDATE))
 Q ""
...
PPDSPL ;CHECK PL
 ...
 .;now check SNOMED
 .I 'G S S=$$VAL^XBDIQ1(9000011,X,80001) I S]"",$$SNOMED^BDMUTL(2023,"PXRM BQI TUBERCULOSIS",S) S G=1
 .I 'G Q
 ...
 .I '$$SNOMED^BDMUTL(2023,"PXRM BQI TUBERCULOSIS",S) Q
