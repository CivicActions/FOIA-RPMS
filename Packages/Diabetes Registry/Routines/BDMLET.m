BDMLET ; IHS/CMI/LAB - VIEW PT RECORD LT ; 05 Dec 2016  2:14 PM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**1,3,4,5,10,13**;JUN 14, 2007;Build 66
...
PATLET ;EP;TO SELECT AND PROCESS PATIENT LETTER
 ...
 Q:'$G(BDMLDA)
 D ZIS
 ;LOG LETTER print in BUSA
 NEW BDMDETAL
 S BDMDETAL(1)=DFN_U_U
 D LOG^BUSAAPI("O","P","P",$S($G(XQY0)]"":$P(XQY0,U),1:"PATLET~BDMLET"),"PRINT/DISPLAY PATIENT LETTER","BDMDETAL")
 Q
LIST ;LIST LETTERS
 K BDMTMP
...
REGISTER ;EP;TO PRINT PROVIDER NAME IN A LETTER
 S BDMRPDA=""
 I $G(BDMRDA) S BDMRPDA=$G(^ACM(41,"AC",DFN,BDMRDA))
 I 'BDMRPDA S Z="" Q
