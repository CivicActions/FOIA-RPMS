BDMDL1E ; IHS/CMI/LAB - IHS Diabetes Audit 2026 ;
...
REGASK ;
 ...
 W !!,"This option is used to run the 2026 Electronic Diabetes Audit for a"
...
ZIS ;
 ...
 I BDMPREP'=2 S XBRP="^BDMDL1P",XBRC="EAUDIT^BDMDL10",XBRX="XIT^BDMDL1",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMDL10",XBRX="XIT^BDMDL1",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPDP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMDUZ2,BDMDEMO,BDMDQ,BDMPTAX) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2026 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=DUZ_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMDL1E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
...
TEST ;
 ...
 F X=1:1:10 S ^XTMP("BDMDM26",BDMJOB,BDMBTH,"PATS",X)=""
 D BDMG^BDMDL1(BDMJOB,BDMBTH,1,DT,"P","","","","","","","",4,"TESTEPI",.BDMIEN)
 Q
