BDMVRL6 ; IHS/CMI/LAB - REPORTS INTERFACE ; [ 02/23/2009 9:13 AM ]
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**2,4,10,12,13**;JUN 14, 2007;Build 66
...
PSR ;EP;TO PRINT PATIENT AND STATISTICAL REPORTS
 ...
 D ^ACMQK
 K ACMPP
 D LOG^BUSAAPI("O","P","P",$S($G(XQY0)]"":$P(XQY0,U),1:"PSR~BDMVRL6"),"DM PT/STAT REPORTS")
...
GENRET ;EP;TO ACCESS GENERAL RETRIEVAL (LISTER)
 ...
 K ACMPP
 D ^ACMRL
 D LOG^BUSAAPI("O","P","P",$S($G(XQY0)]"":$P(XQY0,U),1:"GENRET~BDMVRL6"),"DM GENERAL RETRIEVAL")
