BDMDH1H ; IHS/CMI/LAB - 2020 DIABETES AUDIT 15 Dec 2016 3:06 PM ; 
...
1 ;
 ...
 .S R=$P(BDM(D,C),U,2)
 .I $E(R)=">" S R=999
 .S R=$$STV^BDMDH18(R,8) S:R="." R="" I R]"" S G="1  Yes  "_U_$P(BDM(D,C),U,2)_U_$$DATE^BDMS9B1($P(BDM(D,C),U))_U_$P(BDM(D,C),U,3)_U_1_U_R,$P(G,U,12)=$$VAL^XBDIQ1(9000010.09,+$P(BDM(D,C),U,4),1101)
 .;S R=$$STV^BDMDH18(R,8)
 .I R="" D  Q
 ..S (E,X,J,L)=""
