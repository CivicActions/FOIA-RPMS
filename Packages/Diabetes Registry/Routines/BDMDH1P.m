BDMDH1P ; IHS/CMI/LAB - 2020 DIABETES AUDIT PRINT 15 Dec 2016 3:05 PM ; 24 Oct 2019  3:42 PM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**13**;JUN 14, 2007;Build 66
 ;
 ;
 D LOG^BUSAAPI("O","P","P",$S($G(XQY0)]"":$P(XQY0,U),1:"BDMDH1P"),"DM 2020 AUDIT REPORT "_$S(BDMPREP=6:"QUALITY CHECK RPT",1:""))
 S BDMQUIT=0,BDMPG=0,BDMIOSL=$S($G(BDMGUI):57,1:IOSL)
 I BDMPREP=3 G CUML
 I BDMPREP=5 G CUML
 I BDMPREP=6 G CUML
 ;print ind audits first
 S BDMPD=0,BDMGUIC=0 F  S BDMPD=$O(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .I $G(BDMGUI),BDMGUIC W !,"ZZZZZZZ",!  ;maw
 .I BDMGUIC W:$D(IOF) @IOF
 .S BDMGUIC=1
 .S BDMPG=BDMPG+1 W:$G(BDMGUI) !! W "IHS Diabetes Care and Outcomes Audit, 2020    DATE RUN: "_$$DATE^BDMS9B1(DT)_"   Page: "_BDMPG
 ...
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !?4,"If 'Current user', tobacco cessation counseling/education received ",!?4,"(during Audit period): " W $$I(28)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .W !!,"Vital Statistics"
 .S X=$$I(30)
 .W !!?2,"Height (last ever): ",X  ;$J($P(X," "),2,0)_" "_$P(X," ",2,99)  ;ROUND HT KS 1208 2 DECIMALS THROUGHOUT 2020 PER K SHEFF
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !?2,"Foot (comprehensive or ""complete"", including evaluation of ",!?2,"sensation and vascular status):",?38,$$I(38)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .W !!,"Mental Health"
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !?2,"Depression an active problem/diagnosis:  ",$$I(200)
 ...
 .W !?3,$$I(53),?6,"4 Sulfonylurea [glipizide, glyburide, others]"
 .W !?3,$$I(59),?6,"5 DPP4 inhibitor [Alogliptin (Nesina), Linagliptin (Tradjenta),",!?8,"Saxagliptin (Onglyza), Sitagliptin (Januvia)]"
 .W !?3,$$I(100),?6,"6 GLP-1 agonist [Dulaglutide (Trulicity), Exenatide (Byetta, Bydureon), ",!?8,"Liraglutide (Victoza), Lixisenatide (Adlyxin), Semaglutide (Ozempic)]"
 ...
 .W !?4,"ACE Inhibitors: Benazepril (Lotensin), Enalapril (Vasotec, Epaned),"
 .W !?6,"Fosinopril (Monopril), Lisinopril (Prinivil, Zestril), Ramipril (Altace)"
 .W !?4,"ARBs: Irbesartan (Avapro), Losartan (Cozaar), Telmisartan (Micardis),"
 ...
 .I $Y>(IOSL-6) D PAGE Q:BDMQUIT
 .W !!?2,"Commonly prescribed medications include:"
 .W !?4,"Anticoagulants: Apixaban (Eliquis), Dabigatran (Pradaxa), "
 .W !?6,"Rivaroxaban (Xarelto), Warfarin (Coumadin)"
 .W !?4,"Antiplatelets: Cilostazol (Pletal), Clopidogrel (Plavix), "
 .W !?6,"Prasugrel (Effient), Ticagrelor (Brilinta) "
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !!,"Statin Therapy"
 ...
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !?4,"If TB result 'Positive', treatment complete (isoniazid, others): " I $$I(72)]"" W !?8,$P($$I(72),U),"  ",$P($$I(72),U,2)
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !?4,"If TB result 'Negative', test date: ",?33,$$DATE^BDMS9B1($$I(114))
 .I $Y>(BDMIOSL-7) D PAGE Q:BDMQUIT
 .W !!,"Hepatitis C (HCV)"
 .W !?2,"HCV diagnosed (ever): ",$$I(222)
 .I $E($$I(222))'=1 W !?4,"If not diagnosed with HCV, screened for HCV at least once (ever): " W:$E($$I(223))=1 !?10 W $$I(223)
 .I $Y>(BDMIOSL-3) D PAGE Q:BDMQUIT
 .W !!,"Retinopathy"
 ...
 .I $$AGE^AUPNPAT(BDMPD,BDMADAT)<40!($E($G(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD,300)))=3) W !?5,"This is only calculated for patients 40 years of age and older without",!?5,"a statin allegry or intolerance." I 1
...
N1 .W !!,"Local Questions ",$$LOCN^BDMDH10(BDMPD,BDMDMRG)
 .W !!?2,"Select one:"
 .W !?2,"Text: ",$$LOCT^BDMDH10(BDMPD,BDMDMRG)
 .I $E(IOST,1,2)'="P-" W !! S DIR(0)="E" D ^DIR K DIR
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMDH14
 I BDMPREP=5 D SDPI16^BDMDH1U
 I BDMPREP=6 D QUALCHK^BDMDH1V
DONE ;
 K ^TMP($J)
 ...
 Q
I(I) ;
 Q $G(^XTMP("BDMDM20",BDMJOB,BDMBTH,"AUDIT",BDMPD,I))
 ;
PAGE ;
 Q:$G(BDMDSP)
 ...
 I $G(BDMGUI) W !!
 S BDMPG=BDMPG+1
 W "IHS Diabetes Care and Outcomes Audit, 2020    DATE RUN: "_$$DATE^BDMS9B1(DT)_"   Page: "_BDMPG
