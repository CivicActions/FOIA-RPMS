BDMDO1C ; IHS/CMI/LAB - 2025 DIABETES AUDIT 09 Nov 2015 11:34 AM ; 31 Oct 2022  11:59 AM
...
GATHER ;
 ...
 ...S R=$P(^AUPNVLAB(X,0),U,4),R=$$STV^BDMDO18(R,8,1) I R="" Q  ;no numeric result 
...
COMBINED(P,BDMBDAT,BDMADAT,BDM6MBD) ;EP
 ...
 S G=0,ALL=""
 ;S A1C=$P(^XTMP("BDMDM25",BDMJOB,BDMBTH,"AUDIT",P,78),U,2)
 S A1C=$P($$HGBA1C^BDMDO18(BDMPD,BDMBDAT,BDMADAT),U,2)
 S V=A1C
 ...
 S G=G+S
CSTAT ;
 ;S STATIN=+^XTMP("BDMDM25",BDMJOB,BDMBTH,"AUDIT",P,300)
 S STATIN=+$$STATIN^BDMDO16(BDMPD,BDM6MBD,BDMADAT)
 S ALL=ALL_"; statin prescribed: "_$S(STATIN=1:"Yes",1:"No")
 I STATIN=1 S G=G+1
BP ;
 S S=$$SYSMEAN^BDMDO15(P,BDMRBD,BDMRED)
 S D=$$DIAMEAN^BDMDO15(P,BDMRBD,BDMRED)
 D
 .I S=""!(D="") Q
...
EGFRUACR(P,BD,ED,F) ;EP - 
 ...
 S F=$G(F)
 NEW G,R
 S G=$$GFR^BDMDO1C(BDMPD,BD,ED)
 S R=$$URIN^BDMDO18(BDMPD,BD,ED)
