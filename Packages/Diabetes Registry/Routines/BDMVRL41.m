...
GFR S BDM("FOLLOW-UP TYPE")="ESTIMATED GFR"
 ...
 .S BDM("IEN",X)=""
 Q
UACR S BDM("FOLLOW-UP TYPE")="Quant A/C RATIO"
...
HEPB S (Z,BDM("FOLLOW-UP TYPE"))="HEPB"
 Q
SHIN ;
 S (Z,BDM("FOLLOW-UP TYPE"))="SHINGRIX"
 Q
RSV ;
 S (Z,BDM("FOLLOW-UP TYPE"))="RSV"
 Q
...
APCLEXAM ;EP;LAST EXAM
 ...
 .S Z=$$DFE^BDMDL17(DFN,"","","D",1)
 I BDMFU="EYE" D
 .S BDM("FOLLOW-UP TYPE")="EYE EXAM"
 .S Z=$P($$EYE^BDMDL17(DFN,"","","D",1),U,1)
 I BDMFU="DENT" D
 .S BDM("FOLLOW-UP TYPE")="DENTAL EXAM"
 .S Z=$$LASTDENT^BDMDL19(DFN)
 I BDMFU="DEP" D
 .S BDM("FOLLOW-UP TYPE")="DEPRESSION SCR"
 .S Z=$$DEPSCR^BDMDL12(DFN,"","","D",1)
 ;I BDMFU="EKG" D
 ;.S BDM("FOLLOW-UP TYPE")="EKG"
 ;.S Z=$$EKG^BDMDL12(DFN,DT,"D")
...
FLUC ;EP
 ...
 S Z=$$FLU^BDMDL13(DFN,$$DOB^AUPNPAT(DFN),DT,1,"D")
 I Z="" D FUNO^BDMVRL4 Q
 S Z=9999999-Z
 K X2
 D FULAST^BDMVRL4
...
SHINC ;EP
 S (Z,BDM("FOLLOW-UP TYPE"))="SHINGRIX"
 ;age 50 and over
 I $$AGE^AUPNPAT(DFN,DT)<50 Q  ;
 S Z=$$SHINGRIX^BDMDL19(DFN,$$DOB^AUPNPAT(DFN),DT,1)
 I Z="" D FUNO^BDMVRL4 Q
 I $E(Z)=2 D FUNO^BDMVRL4 Q
 ;S Z=9999999-Z
 I $E(Z)=1 Q
...
RSVC ;EP
 ...
 ;age 50 and over
 I $$AGE^AUPNPAT(DFN,DT)<50 Q  ;
 S Z=$$RSV^BDMDL19(DFN,$$DOB^AUPNPAT(DFN),DT,1)
 I Z="" D FUNO^BDMVRL4 Q
 I $E(Z)=2 D FUNO^BDMVRL4 Q
 ;S Z=9999999-Z
 I $E(Z)=1 Q
