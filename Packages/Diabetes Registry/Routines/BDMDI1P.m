BDMDI1P ; IHS/CMI/LAB - 2021 DIABETES AUDIT PRINT 15 Dec 2016 3:05 PM ; 24 Oct 2019  3:42 PM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**14**;JUN 14, 2007;Build 80
 ;
 ;
 D LOG^BUSAAPI("O","P","P",$S($G(XQY0)]"":$P(XQY0,U),1:"BDMDI1P"),"DM 2021 AUDIT REPORT "_$S(BDMPREP=6:"QUALITY CHECK RPT",1:""))
 S BDMQUIT=0,BDMPG=0,BDMIOSL=$S($G(BDMGUI):57,1:IOSL)
 I BDMPREP=3 G CUML
 I BDMPREP=5 G CUML
 I BDMPREP=6 G CUML
 ;print ind audits first
 S BDMPD=0,BDMGUIC=0 F  S BDMPD=$O(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .I $G(BDMGUI),BDMGUIC W !,"ZZZZZZZ",!  ;maw
 .I BDMGUIC W:$D(IOF) @IOF
 .S BDMGUIC=1
 .S BDMPG=BDMPG+1 W:$G(BDMGUI) !! W "IHS Diabetes Care and Outcomes Audit, 2021    DATE RUN: "_$$DATE^BDMS9B1(DT)_"   Page: "_BDMPG
 ...
 .W !?4,"Screened for ENDS use (during Audit period): " S Y=$$I(31) W:$E(Y)=1 !?10 W Y
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !?4,"ENDS use status (most recent): " S Y=$$I(33) W Y," ",$P($$I(33),U,3)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 .W !!,"Vital Statistics"
 .S X=$$I(30)
 .W !!?2,"Height (last ever): ",X  ;$J($P(X," "),2,0)_" "_$P(X," ",2,99)  ;ROUND HT KS 1208 2 DECIMALS THROUGHOUT 2021 PER K SHEFF
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .W !?3,$$I(100),?6,"6 GLP-1 receptor agonist [dulaglutide (Trulicity), exenatide (Byetta, ",!?8,"Bydureon), liraglutide (Victoza), lixisenatide (Adlyxin), ",!?8,"semaglutide (Ozempic, Rybelsus)]"
 ...
 .W !?3,$P($$I(99),U),?6,"11 Pramlintide [Symlin]"
 ...
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !?4,"If TB diagnosis documented or TB result 'Positive', treatment initiated ",!?4,"(isoniazid, rifampin, rifapentin, others): " I $$I(72)]"" W $P($$I(72)," ",1,7) ;," ",$P($$I(72),U,2)
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 ...
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 .W !?2,"Pneumovax/PPSV23 (ever): ",?45,$$I(66)
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 ...
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 .W !?2,"Shingrix complete series (ever):  ",?45,$P($$I(73),U,1)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .S BDMUTT=$P($$I(92),U,5)
 .I $Y>(BDMIOSL-2) D PAGE Q:BDMQUIT
 .W !?2,"UACR: " I BDMUTT=1 W ?28,$P($$I(92),U,2)_" "_$P($$I(92),U,12),?43,$P($$I(92),U,3),?60,$E($P($$I(92),U,4),1,19)
 .I $Y>(BDMIOSL-5) D PAGE Q:BDMQUIT
 .W !!,"COMBINED: Meets ALL: A1C <8.0, statin prescribed, mean BP <140/<90"
 .I $$AGE^AUPNPAT(BDMPD,BDMADAT)<40!($E($G(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD,300)))=3) W !?5,"This is only calculated for patients 40 years of age and older without",!?5,"a statin allergy or intolerance." I 1
...
N1 .W !!,"Local Questions ",$$LOCN^BDMDI10(BDMPD,BDMDMRG)
 .W !!?2,"Select one:"
 .W !?2,"Text: ",$$LOCT^BDMDI10(BDMPD,BDMDMRG)
 .I $E(IOST,1,2)'="P-" W !! S DIR(0)="E" D ^DIR K DIR
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMDI14
 I BDMPREP=5 D SDPI16^BDMDI1U
 I BDMPREP=6 D QUALCHK^BDMDI1V
DONE ;
 K ^TMP($J)
 ...
 Q
I(I) ;
 Q $G(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",BDMPD,I))
 ;
PAGE ;
 Q:$G(BDMDSP)
 ...
 I $G(BDMGUI) W !!
 S BDMPG=BDMPG+1
 W "IHS Diabetes Care and Outcomes Audit, 2021    DATE RUN: "_$$DATE^BDMS9B1(DT)_"   Page: "_BDMPG
