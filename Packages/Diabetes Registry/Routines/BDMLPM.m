BDMLPM ; IHS/CMI/LAB - CALCULATE LAST PAP MAM ; 20 Oct 2017  1:17 PM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**1,2,8,9,10,11,12,13**;JUN 14, 2007;Build 66
 ;
 ;
...
OTHEDUC(P,BDATE,EDATE) ;EP
 ...
 ...I $P(J,"-",1)="DM" S G=D Q
 ...I $P(J,"-",1)="DMC" S G=D Q
 ...I $P(J,"-",1)]"",$$SNOMED^BDMUTL(2020,"PXRM DIABETES",$P(J,"-",1)) S G=D Q
 ...N CODE
 ...
 ...I $P(J,"-",1)]"",$$SNOMED^BDMUTL(2020,"PXRM DIABETES",$P(J,"-",1)) S G=$$VD^APCLV($P(^AUPNVPED(I,0),U,3))
 Q G
