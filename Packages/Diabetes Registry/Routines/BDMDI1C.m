BDMDI1C ; IHS/CMI/LAB - 2021 DIABETES AUDIT 09 Nov 2015 11:34 AM ; 
...
GATHER ;
 ...
 ...S R=$P(^AUPNVLAB(X,0),U,4),R=$$STV^BDMDI18(R,8,1) I R="" Q  ;no numeric result 
...
GFR(P,BDATE,EDATE,NOCALC) ;EP - Estimated GFR
 ...
 ...Q
 I '$D(BDM(1)),NOCALC Q ""
 I '$D(BDM(1)),'NOCALC S X=$$CALCGFR^BDMDI18(P,BDATE,EDATE) D  Q X
 .I X="" Q
...
COMBINED(P,BDMBDAT,BDMADAT,BDM6MBD) ;EP
 ...
 S G=0,ALL=""
 ;S A1C=$P(^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",P,78),U,2)
 S A1C=$P($$HGBA1C^BDMDI18(BDMPD,BDMBDAT,BDMADAT),U,2)
 S V=A1C
 ...
 S G=G+S
CSTAT ;
 ;S STATIN=+^XTMP("BDMDM21",BDMJOB,BDMBTH,"AUDIT",P,300)
 S STATIN=+$$STATIN^BDMDI16(BDMPD,BDM6MBD,BDMADAT)
 S ALL=ALL_"; statin prescribed: "_$S(STATIN=1:"Yes",1:"No")
 I STATIN=1 S G=G+1
BP ;
 S S=$$SYSMEAN^BDMDI15(P,BDMRBD,BDMRED)
 S D=$$DIAMEAN^BDMDI15(P,BDMRBD,BDMRED)
 D
 .I S=""!(D="") Q
...
EGFRUACR(P,BD,ED,F) ;EP - 
 ...
 S F=$G(F)
 NEW G,R
 S G=$$GFR^BDMDI1C(BDMPD,BD,ED)
 S R=$$URIN^BDMDI18(BDMPD,BD,ED)
