BDMDITS ; IHS/CMI/LAB - DISPLAY IND LISTS ;
...
EN ;EP -- main entry point for 
 D EN^VALM("BDMDI TAXONOMY UPDATE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2021 DIABETES AUDIT REPORTING"
