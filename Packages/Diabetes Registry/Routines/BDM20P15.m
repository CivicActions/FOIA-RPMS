BDM20P15 ; IHS/CMI/LAB - BDM V2.0 patch 15 environment check 
 ...
 I '$$INSTALLD("BDM*2.0*14") D SORRY(2)
 I '$$INSTALLD("ATX*5.1*39") D SORRY(2)
 I +$$VERSION^XPDUTL("BGP")<21.1 D MES^XPDUTL($$CJ^XLFSTR("Version 21.1 of the IHS CLINICAL REPORTING is required.  Not installed.",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Version 21.1 of IHS CLINICAL REPORTING is installed.",80))
 ;
 Q
 ;
PRE ;
