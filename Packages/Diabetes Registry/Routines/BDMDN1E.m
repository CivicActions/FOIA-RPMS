BDMDN1E ; IHS/CMI/LAB - IHS Diabetes Audit 2024 ;
...
REGASK ;
 ...
 W !!,"This option is used to run the 2024 Electronic Diabetes Audit for a"
...
ZIS ;
 ...
 I BDMPREP'=2 S XBRP="^BDMDN1P",XBRC="EAUDIT^BDMDN10",XBRX="XIT^BDMDN1",XBNS="BDM"
 I BDMPREP=2 S XBRP="",XBRC="EAUDIT^BDMDN10",XBRX="XIT^BDMDN1",XBNS="BDM"
 D ^XBDBQUE
 D XIT
 Q
P ;
...
BDMG(BDMJOB,BDMBTH,BDMDMRG,BDMADAT,BDMTYPE,BDMSTMP,BDMPDP,BDMCOM,BDMRAND,BDMRCNT,BDMCMS,BDMSTAT,BDMPREP,BDMFILE,BDMDSP,BDMGIEN,BDMSDPI,BDMSDPG,BDMDUZ2,BDMDEMO,BDMDQ,BDMPTAX) ;PEP - gui call
 ...
 N BDMOPT  ;maw
 S BDMOPT="Run the 2024 Audit w/predefined set of Pts"  ;maw
 D NOW^%DTC
 S BDMNOW=$G(%)
 K DD,D0,DIC
 S X=DUZ_"."_BDMBTH
 ...
 S ZTIO="",ZTDTH=$$NOW^XLFDT,ZTRTN="GUIEP^BDMDN1E",ZTDESC="GUI DM AUDIT" D ^%ZTLOAD
 D XIT
 Q
...
TEST ;
 ...
 F X=1:1:10 S ^XTMP("BDMDM24",BDMJOB,BDMBTH,"PATS",X)=""
 D BDMG^BDMDN1(BDMJOB,BDMBTH,1,DT,"P","","","","","","","",4,"TESTEPI",.BDMIEN)
 Q
