BDMDJ18 ; IHS/CMI/LAB - 2022 DIABETES AUDIT ;
...
TBINH(P,EDATE) ;EP
 I $P($$TBDX(P,EDATE),U,1)=1 Q $E($$TBTX^BDMDJ12(P,EDATE))
 I $E($P($$PPD(P,EDATE),"||",2))=1 Q $E($$TBTX^BDMDJ12(P,EDATE))
 Q ""
...
PPDSPL ;CHECK PL
 ...
 .;now check SNOMED
 .I 'G S S=$$VAL^XBDIQ1(9000011,X,80001) I S]"",$$SNOMED^BDMUTL(2022,"PXRM BQI TUBERCULOSIS",S) S G=1
 .I 'G Q
 ...
 .I '$$SNOMED^BDMUTL(2022,"PXRM BQI TUBERCULOSIS",S) Q
...
CALCGFRZ(P,BDATE,EDATE) ;EP
 NEW R,C,X,Y,Z,D
 S R=$$CREAT^BDMDJ18(P,BDATE,EDATE,"I"),D=$P(R,U,2),R=$P(R,U,1)
 I R="" Q ""
 ;CALCULATE IT
