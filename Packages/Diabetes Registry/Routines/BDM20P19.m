BDM20P19 ; IHS/CMI/LAB - BDM V2.0 patch 19 environment check  ; 26 Sep 2023  3:59 PM
 ...
 I '$$INSTALLD("BDM*2.0*18") D SORRY(2)
 I '$$INSTALLD("ATX*5.1*66") D SORRY(2)
 I +$$VERSION^XPDUTL("BGP")<25.1 D MES^XPDUTL($$CJ^XLFSTR("Version 25.1 of the IHS CLINICAL REPORTING is required.  Not installed.",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Version 25.1 of IHS CLINICAL REPORTING is installed.",80))
 ;
 Q
 ;
PRE ;
