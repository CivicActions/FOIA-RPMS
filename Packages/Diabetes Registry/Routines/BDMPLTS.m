BDMPLTS ; IHS/CMI/LAB - DISPLAY IND LISTS ; 16 Nov 2021  10:40 AM
...
EN ;EP -- main entry point for 
 D EN^VALM("BDMPL TAXONOMY UPDATE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2026 PREDIABETES REPORTING"
...
INIT ;EP -- init variables and list array
 ...
 .Q:'$P(^BDMTAXS(BDMYR,11,BDMY,0),U,7)
 .S J=J+1
