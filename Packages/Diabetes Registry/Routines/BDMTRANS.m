...
MESS W !!?10,"Transfer of patients is complete."
 ...
 W !
 I BDMDETAC>0 D
 .D LOG^BUSAAPI("O","P","A",$S($G(XQY0)]"":$P(XQY0,U),1:"BDMTRANS"),"Adds from Template "_BDMTRNA_" to register "_BDMREGNM,"BDMDETAL")
 D EN^XBVK("BDM")
 D PAUSE^BDMFMENU
 Q
TRANS ;
 ...
 K BDMRG,BDMRGNA,BDMU,BDMTRN,BDMTRNX,BDMRGTP,BDMX,BDMI,BDMSLCT,DIC,DIE,DA,DR,DD
 S ZTREQ="@"
 Q
MOVE Q:$D(^ACM(41,"AC",BDMU,BDMRG))
 ...
 S BDMDETAL(BDMDETAC)=BDMU_U_U_BDMSTAT(0)
 Q
