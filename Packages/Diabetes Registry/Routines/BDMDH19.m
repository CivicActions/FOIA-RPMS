BDMDH19 ; IHS/CMI/LAB - 2020 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**13**;JUN 14, 2007;Build 66
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2020 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDH19",XBNS="",XBRX="XIT^BDMDH19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2020 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
