BDM20P14 ; IHS/CMI/LAB - BDM V2.0 patch 14 environment check 
 ...
 I '$$INSTALLD("BDM*2.0*13") D SORRY(2)
 I '$$INSTALLD("ATX*5.1*35") D SORRY(2)
 I +$$VERSION^XPDUTL("BGP")<20.1 D MES^XPDUTL($$CJ^XLFSTR("Version 20.1 of the IHS CLINICAL REPORTING is required.  Not installed.",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Version 20.1 of IHS CLINICAL REPORTING is installed.",80))
 ;
 Q
 ;
PRE ;
