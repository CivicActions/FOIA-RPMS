BDMDK1G ; IHS/CMI/LAB - calc indicators 16 Jan 2007 8:13 PM ;
...
V1DM(P,D,EDATE) ;
 ...
 .S (D,Y)=0 F  S Y=$O(^AUPNVPOV("AD",V,Y)) Q:Y'=+Y!(D)  I $D(^AUPNVPOV(Y,0)) S %=$P(^AUPNVPOV(Y,0),U) I $$ICD^BDMUTL(%,$P(^ATXAX(T,0),U),9) S D=1  ;cmi/maw 05/15/2014 p8
 .Q:'D
