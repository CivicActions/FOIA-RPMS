BDMDJ1C ; IHS/CMI/LAB - 2022 DIABETES AUDIT 09 Nov 2015 11:34 AM ; 
...
GATHER ;
 ...
 ...S R=$P(^AUPNVLAB(X,0),U,4),R=$$STV^BDMDJ18(R,8,1) I R="" Q  ;no numeric result 
...
GFR(P,BDATE,EDATE,NOCALC) ;EP - Estimated GFR
 ...
 ...Q
 I '$D(BDM(1)),NOCALC Q ""
 I '$D(BDM(1)),'NOCALC S X=$$CALCGFR^BDMDJ18(P,BDATE,EDATE) D  Q X
 .I X="" Q
...
COMBINED(P,BDMBDAT,BDMADAT,BDM6MBD) ;EP
 ...
 S G=0,ALL=""
 ;S A1C=$P(^XTMP("BDMDM22",BDMJOB,BDMBTH,"AUDIT",P,78),U,2)
 S A1C=$P($$HGBA1C^BDMDJ18(BDMPD,BDMBDAT,BDMADAT),U,2)
 S V=A1C
 ...
 S G=G+S
CSTAT ;
 ;S STATIN=+^XTMP("BDMDM22",BDMJOB,BDMBTH,"AUDIT",P,300)
 S STATIN=+$$STATIN^BDMDJ16(BDMPD,BDM6MBD,BDMADAT)
 S ALL=ALL_"; statin prescribed: "_$S(STATIN=1:"Yes",1:"No")
 I STATIN=1 S G=G+1
BP ;
 S S=$$SYSMEAN^BDMDJ15(P,BDMRBD,BDMRED)
 S D=$$DIAMEAN^BDMDJ15(P,BDMRBD,BDMRED)
 D
 .I S=""!(D="") Q
...
EGFRUACR(P,BD,ED,F) ;EP - 
 ...
 S F=$G(F)
 NEW G,R
 S G=$$GFR^BDMDJ1C(BDMPD,BD,ED)
 S R=$$URIN^BDMDJ18(BDMPD,BD,ED)
