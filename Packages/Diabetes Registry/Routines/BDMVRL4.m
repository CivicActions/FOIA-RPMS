BDMVRL4 ; IHS/CMI/LAB - VIEW PT RECORD CON'T ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**1,3,5,6,7,8,9,10,11,12,13,17,18,19**;JUN 14, 2007;Build 159
...
FUPRINT ;EP;TO DISPLAY THE FOLLOW-UP REPORT
 ...
 D LOG^BUSAAPI("O","P","P",$S($G(XQY0)]"":$P(XQY0,U),1:"BDMVRL4"),"DM F/U RPT")
 Q
FUGET ;EP;GET DATA
 S BDMP=0
...
FUPAT ;EP;TO GATHER FOLLOW-UP INFO ON A PATIENT
 ...
 E  I BDMFU="SHIN" D SHINC^BDMVRL41 I 1
 E  I BDMFU="RSV" D RSVC^BDMVRL41 I 1
 E  D FIND I 1
 ;INDEPENDENT LOOKUPS
 K BDMQUIT
 Q
...
FIND ;FIND PATIENTS WITHOUT SPECIFIED ITEM
 ...
 I X="FLU"!(X="PNEU")!(X="TD")!(X="SHIN")!(X="RSV") S Y="^AUPNVIMM"
 I X="PPD" S Y="^AUPNVSK"
...
FUNO ;EP Followup Entry
 I BDM("FOLLOW-UP TYPE")="SHINGRIX" S X="*NO* SHINGRIX SERIES on record." G FUOUT
 I BDM("FOLLOW-UP TYPE")="HEP B" S X="*NO* HEP B SERIES on record." G FUOUT
