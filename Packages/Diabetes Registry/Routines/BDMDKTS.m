BDMDKTS ; IHS/CMI/LAB - DISPLAY IND LISTS ;
...
EN ;EP -- main entry point for 
 D EN^VALM("BDMDK TAXONOMY UPDATE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2023 DIABETES AUDIT REPORTING"
...
INIT ;EP -- init variables and list array
 ...
 .Q:'$P(^BDMTAXS(BDMYR,11,BDMY,0),U,6)
 .S J=J+1
