BDMPI11 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT ;
...
EKG ;need date of last ekg
 ...
 S V=$$EKG^BDMPI12(BDMPG,BDMRED,"I")
 I V]"" D
...
TCHOL ;
 ...
 S V=$$CHOL^BDMDI18(BDMPG,BDMBDAT,BDMADAT,"I")
...
LDL ;
 ...
 S V=$$LDL^BDMDI18(BDMPG,BDMBDAT,BDMADAT,"I")
...
HDL ;
 ...
 S V=$$HDL^BDMDI18(BDMPG,BDMBDAT,BDMADAT,"I")
...
TRIG ;
 ...
 S V=$$TRIG^BDMDI18(BDMPG,BDMBDAT,BDMADAT,"I")
...
FAST ;
 ...
 S V=$$FGLUCOSE^BDMDI18(BDMPG,$P(^DPT(BDMPG,0),U,3),BDMADAT,"I")
...
G75 ;
 ...
 S V=$$G75^BDMDI18(BDMPG,$P(^DPT(BDMPG,0),U,3),BDMADAT,"I")
