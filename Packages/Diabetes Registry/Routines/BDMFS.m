BDMFS ; IHS/CMI/LAB - DMS FLOW SHEET MANAGEMENT UTILITY ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**2,13**;JUN 14, 2007;Build 66
...
FSADD ;EP;ENTER A NEW FLOW SHEET
 ...
 S BDMSDA=+Y
 I 'BDMSDA D TABACK Q
 ;BUSA LOG ADD FLOW SHEET
 D LOG^BUSAAPI("O","O","A",$S($G(XQY0)]"":$P(XQY0,U),1:"FSADD~BDMFS"),"ADDED FLOWSHEET "_$P(^APCHSFLC(BDMSDA,0),U,1))
 D FSCEDIT
 D FSCLIST
TABACK S BDMGO="FS"
 D BACK
...
FSCEDIT ;EP;EDIT A FLOW SHEET COMPONENT
 ...
 D DDS^BDMDIC
 ;BUSA LOG EDIT OF EXISTING SPREADSHEET
 D LOG^BUSAAPI("O","O","E",$S($G(XQY0)]"":$P(XQY0,U),1:"FSCEDIT~BDMFS"),"EDITED FLOWSHEET "_$P(^APCHSFLC(BDMSDA,0),U,1))
 S BDMGO="FSC"
 D BACK
 Q
