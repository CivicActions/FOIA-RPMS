BDMDK1A ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 14 Dec 2016 11:59 AM ; 22 Sep 2021  10:07 AM
...
EXAMS ;
 ...
 W !?3,"Eye exam - dilated exam or retinal imaging",?49,$$C($P(V,U,4)),?61,$$C($P(V,U,2)),?73,$$P($P(V,U,2),$P(V,U,4)) ;,?71,"( ",$$P($P(V,U,2),$P(V,U,7))," )"
...
IMM ;
 ...
 W !?3,"Pneumococcal vaccine (PCV15, PCV20,",?49,$$C($P(V,U,4)),?61,$$C($P(V,U,2)),?73,$$P($P(V,U,2),$P(V,U,4)),!?9,"or PPSV23) - ever"
...
URIN ;
 ...
 S V=$G(BDMCUML(145))
 W !!?3,"Urine Albumin-to-Creatinine Ratio (UACR) ",?49,$$C($P(V,U,3)),?61,$$C($P(V,U,2)),?73,$$P($P(V,U,2),$P(V,U,3))
 W !?3,"to assess kidney damage"
...
COMBINED ;
 ...
 W !?3,"following criteria:  A1C <8.0, Statin currently ",!?3,"prescribed* and mean BP <140/<90"
...
SDM ;
 ...
 I $Y>(BDMIOSL-4) D HEADER Q:BDMQUIT
 W !?3,"GLP-1 receptor agonists = glucagon-like peptide-1 receptor agonists"
