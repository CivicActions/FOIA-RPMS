BDMDI1V ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 22 Feb 2014 3:43 PM ; 
...
PRINT ;
 ...
 K BDMSUM
 D HEADER
 I '$D(^XTMP("BDMDM21 ERRORS",BDMJOB,BDMBTH,"PATS")) W !,"No Errors to Report." Q
 D PRINT1 ;print each indicator
 D EXIT
 Q
 ;
PRINT1 ;
 S BDMS1="" F  S BDMS1=$O(^XTMP("BDMDM21 ERRORS",BDMJOB,BDMBTH,"PATS",BDMS1)) Q:BDMS1=""!(BDMQUIT)  D
 .S DFN="" F  S DFN=$O(^XTMP("BDMDM21 ERRORS",BDMJOB,BDMBTH,"PATS",BDMS1,DFN)) Q:DFN=""!(BDMQUIT)  D PRINT2
 ;NOW PRINT SUMMARY
 ...
 Q
PRINT2 ;
 S BDME=0 F  S BDME=$O(^XTMP("BDMDM21 ERRORS",BDMJOB,BDMBTH,"PATS",BDMS1,DFN,BDME)) Q:BDME'=+BDME!(BDMQUIT)  D
 .I $Y>(BDMIOSL-4) D HEADER Q:BDMQUIT
 .S T=^XTMP("BDMDM21 ERRORS",BDMJOB,BDMBTH,"PATS",BDMS1,DFN,BDME)
...
HEADER1 ;
 ...
 N BDMDIDR
 S BDMDIDR="Audit Date "_$$DATE^BDMS9B1(BDMADAT)_" ("_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"
 W $$CTR(BDMDIDR,80),!
