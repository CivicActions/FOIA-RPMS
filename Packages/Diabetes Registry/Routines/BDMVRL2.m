BDMVRL2 ; cmi/anch/maw - DEMO/APPTS ACTION ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**12,13,19**;JUN 14, 2007;Build 159
 ;
 ;
...
NEWPAT ;EP;CREATE ENTRY FOR NEW REGISTER PATIENT
 ...
 I +Y<1 S BDMQUIT="" Q
 S BDMRPDA=+Y
 ;BUSA LOG ADDING NEW PATIENT TO REGISTER
 NEW BDMDETAL
 S BDMDETAL(1)=DFN_U_U_"Added Patient to "_$$VAL^XBDIQ1(9002241.1,BDMRDA,.01)_" register."
 D LOG^BUSAAPI("O","P","A",$S($G(XQY0)]"":$P(XQY0,U),1:"NEWPAT~BDMVRL2"),"ADDED PATIENT TO REGISTER","BDMDETAL")
 Q
