BDMPO19 ; IHS/CMI/LAB - 2003 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**18**;JUN 14, 2007;Build 147
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2025 Prediabetes Assessment of Care ",!,"Report.  Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMPO19",XBNS="",XBRX="XIT^BDMPO19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2025 Prediabetes Assessment of Care Report to find ",!,"all necessary data, several taxonomies must be established.  The following",!,"taxonomies are missing or have no entries:",!
