BDMDO19 ; IHS/CMI/LAB - 2025 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**18**;JUN 14, 2007;Build 147
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2025 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDO19",XBNS="",XBRX="XIT^BDMDO19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2025 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
TEXTD ;EP
 ...
 ;;**   2025 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
...
SHINGRIX(P,BDATE,EDATE,NR) ;EP
 ...
 .S G=$$REFUSAL^BDMDN17(P,9999999.14,$O(^AUTTIMM("C",BDMCVX,0)),$$DOB^AUPNPAT(P),DT,"N")
 .I G I '$D(BDMREF(9999999-$P(G,U,7))) S BDMREF((9999999-$P(G,U,7)))=1_U_$P(G,U,3)_U_$P(G,U,5)
 .S G=$$REFUSAL^BDMDN17(P,9999999.14,$O(^AUTTIMM("C",BDMCVX,0)),$$DOB^AUPNPAT(P),DT,"P")
 .I G I '$D(BDMREF(9999999-$P(G,U,7))) S BDMREF((9999999-$P(G,U,7)))=1_U_$P(G,U,3)_U_$P(G,U,5)
 .S G=$$REFUSAL^BDMDN17(P,9999999.14,$O(^AUTTIMM("C",BDMCVX,0)),$$DOB^AUPNPAT(P),DT,"U")
 .I G I '$D(BDMREF(9999999-$P(G,U,7))) S BDMREF((9999999-$P(G,U,7)))=1_U_$P(G,U,3)_U_$P(G,U,5)
 ...
 ;NMI, PROV DISCONTINUED, CONSIDERED AND NOT DONE 
 S BDMCVX="",G="" F  S BDMCVX=$O(S(BDMCVX)) Q:BDMCVX=""  D
 .S G=$$REFUSAL^BDMDN17(P,9999999.14,$O(^AUTTIMM("C",BDMCVX,0)),BD,DT,"R")
 .I G I '$D(BDMREF(9999999-$P(G,U,7))) S BDMREF((9999999-$P(G,U,7)))=1_U_$P(G,U,3)_U_$P(G,U,5)
...
LASTDENT(P) ;EP FOR FOLLOW UP REPORT
 ...
 ..S Y=+$P(BDMG(X),U,4)
 ..Q:'$$DVADA^BDMDO17($$VAL^XBDIQ1(9000010.05,Y,.01))
 ..S D=$$VD^APCLV(V)
 ..I D>LASTD S LASTD=D
