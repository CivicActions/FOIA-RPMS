BDMGRG ; IHS/CMI/LAB - BDM DMS GUI Reports ; 09 Feb 2010  7:38 AM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**7,8,9,16**;JUN 14, 2007;Build 122
 ;
...
MASTER(RETVAL,BDMSTR)  ;EP - master list
 ...
 N REG,REGI,AGET,AGER,ST,STAT,CT,COMM,CMT,CM,WFT,WF,PSV,SSV,GENDER,TOR,ST,STI,DEMO,BDMI,DEC
 S P="|",R="~"
 S BDMI=0
 K ^BDMTMP($J)
 S RETVAL="^BDMTMP("_$J_")"
 ...
 S DEC=$P(BDMSTR,P,18)
 D BDMG^BDMRML(.BDMERR,REGI,AGER,.BSTAT,CT,.BCOMM,GENDER,.BCM,.BWF,PSV,SSV,TOR,DEMO,$G(STI),DEC)
