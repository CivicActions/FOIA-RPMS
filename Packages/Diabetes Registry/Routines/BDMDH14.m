BDMDH14 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 14 Oct 2014 9:54 AM ; 
...
NUMMEDS ;
 ...
 W !!?6,"GLP-1 agonist [Dulaglutide (Trulicity), ",?49,$$C($P(V,U,8)),?61,$$C($P(V,U,2)),?73,$$P($P(V,U,2),$P(V,U,8)),!?6,"Exenatide (Byetta, Bydureon), ",!?6,"Liraglutide (Victoza), Semaglutide (Ozempic)]"
...
HEADER1 ;
 ...
 N BDMDHDR
 S BDMDHDR="Audit Report for 2020 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"
 W $$CTR(BDMDHDR,80),!
 ;W $$CTR("AUDIT REPORT FOR 2020 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"),!
