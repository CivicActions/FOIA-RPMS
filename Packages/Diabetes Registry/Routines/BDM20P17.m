BDM20P17 ; IHS/CMI/LAB - BDM V2.0 patch 17 environment check  ; 26 Sep 2023  3:59 PM
 ...
 I '$$INSTALLD("BDM*2.0*16") D SORRY(2)
 I '$$INSTALLD("ATX*5.1*50") D SORRY(2)
 I +$$VERSION^XPDUTL("BGP")<23.1 D MES^XPDUTL($$CJ^XLFSTR("Version 23.1 of the IHS CLINICAL REPORTING is required.  Not installed.",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Version 23.1 of IHS CLINICAL REPORTING is installed.",80))
 ;
 Q
 ;
PRE ;
...
POST ;
 ...
 D BMXPO
 D MEDTAX
 S X=$$ADD^XPDMENU("BDM PREDIABETES MENU","ACM INSTALL PRE DM","PDIR",90)
 S BDMX=0 F  S BDMX=$O(^ACM(44.1,BDMX)) Q:BDMX'=+BDMX  D
 .I $P($G(^ACM(44.1,BDMX,0)),U,1)="PRE-DIABETES" S DA=BDMX,DIE="^ACM(44.1,",DR=".01///PREDIABETES" D ^DIE K DA,DR,DIE
 ;
