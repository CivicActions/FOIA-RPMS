BDMDHTS ; IHS/CMI/LAB - DISPLAY IND LISTS ;
...
EN ;EP -- main entry point for 
 D EN^VALM("BDMDH TAXONOMY UPDATE")
 D CLEAR^VALM1
 D FULL^VALM1
 W:$D(IOF) @IOF
 D EOJ
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT 2020 DIABETES AUDIT REPORTING"
