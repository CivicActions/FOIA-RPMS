BDMDN19 ; IHS/CMI/LAB - 2024 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**17**;JUN 14, 2007;Build 138
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2024 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDN19",XBNS="",XBRX="XIT^BDMDN19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2024 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
TEXTD ;EP
 ...
 ;;**   2024 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
