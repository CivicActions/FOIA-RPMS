BDMDO17 ; IHS/CMI/LAB - 2025 DIABETES AUDIT 03 Nov 2015 9:29 AM ; 
...
OTHEDUC(P,BDATE,EDATE) ;EP
 ...
 .I $P(T,"-",1)]"",$$SNOMED^BDMUTL(2025,"PXRM DIABETES",$P(T,"-",1)) S G="1  Yes "_T_"  "_$$DATE^BDMS9B1($$VD^APCLV($P(^AUPNVPED(I,0),U,3),"I"))
 I G Q G
