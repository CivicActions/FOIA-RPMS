BDMPI12 ; IHS/CMI/LAB - 2003 DIABETES AUDIT ;
...
EKG(P,EDATE,F) ;EP
 ...
 K BDM I T S BDM(1)=$$CPT^BDMPI12(P,,ED,"DM AUDIT EKG CPTS",3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
 K BDM I T S BDM(1)=$$RAD^BDMPI12(P,,ED,"DM AUDIT EKG CPTS",3) D
 .I BDM(1)="" K BDM Q
 .Q:LEKG>$P(BDM(1),U)
 .S LEKG=$P(BDM(1),U)
