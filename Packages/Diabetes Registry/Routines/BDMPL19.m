BDMPL19 ; IHS/CMI/LAB - 2003 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**19**;JUN 14, 2007;Build 159
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2026 Prediabetes Assessment of Care ",!,"Report.  Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMPL19",XBNS="",XBRX="XIT^BDMPL19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2026 Prediabetes Assessment of Care Report to find ",!,"all necessary data, several taxonomies must be established.  The following",!,"taxonomies are missing or have no entries:",!
