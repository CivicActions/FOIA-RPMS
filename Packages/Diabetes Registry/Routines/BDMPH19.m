BDMPH19 ; IHS/CMI/LAB - 2003 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**13**;JUN 14, 2007;Build 66
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2020 Pre-Diabetes Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMPH19",XBNS="",XBRX="XIT^BDMPH19"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 W:$D(IOF) @IOF
 K BDMQUIT
 W !,"Checking for Taxonomies to support the 2020 Pre-Diabetes Audit...",!
 ...
 ..Q:$P(^ATXLAB(I,0),U)="BGP PAP SMEAR TAX"
 ...
 W !!,"In order for the 2020 Diabetes Audit to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing, have",!,"no entries or contain a panel test and should not:",!
...
TEXTD ;EP
 ...
 ;;**   2020 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
