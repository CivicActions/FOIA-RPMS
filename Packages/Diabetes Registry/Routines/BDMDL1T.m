BDMDL1T ; IHS/CMI/LAB - 2026 DIABETES AUDIT ;
...
TOBACCO(P,BDATE,EDATE) ;EP
 ...
 .;I BDMXPHD]"" S $P(BDMRET,U,2)="1  Yes PAT ED: "_$P(BDMXPHD,U,1)_" "_$$DATE^BDMS9B1($P(BDMXPHD,U,2))_U_$P(BDMXPHD,U,2) Q
...
PED(P,BDATE,EDATE) ;EP
 ...
 .I $P(T,"-")]"",$$SNOMED^BDMUTL(2026,"PXRM BGP TOBACCO SCREENED",$P(T,"-")) S I=1 S %=T_U_$P(BDMG(X),U) Q
...
DX(P,BDATE,EDATE) ;EP  - WAS THERE SCREENING?
 ...
 .Q
 I G]"" Q G
 S G=$$IPLSNOID^BDMDLDU(P,"PXRM BGP TOBACCO SCREENED",BDATE,EDATE) I G S G=$P(G,U,2)_U_$P(G,U,3) Q G
 Q G
DXSL(P,BDATE,EDATE) ;EP - WAS THERE A SMOKELESS USER DX?
 ...
 .Q
 I G]"" Q G
 S G=$$IPLSNOID^BDMDLDU(P,"PXRM BGP TOBACCO SMOKELESS",BDATE,EDATE) I G S G=$P(G,U,2)_U_$P(G,U,3) Q G
 Q G
 ;
DXU(P,BDATE,EDATE) ;EP - WAS THERE A USER DX?
 ...
 .Q
 I G]"" Q G
 S G=$$IPLSNOID^BDMDLDU(P,"PXRM BGP CURRENT TOBACCO",BDATE,EDATE) I G S G=$P(G,U,2)_U_$P(G,U,3) Q G
 Q G
DXS(P,BDATE,EDATE) ;EP - WAS THERE A SMOKING USER DX?
 ...
 .Q
 I G]"" Q G
 S G=$$IPLSNOID^BDMDLDU(P,"PXRM BGP TOBACCO SMOKER",BDATE,EDATE) I G S G=$P(G,U,2)_U_$P(G,U,3) Q G
 Q G
 ;
...
CPTSM(P,BDATE,EDATE) ;EP - did pat have TOBACCO SCREENING cpt?
 NEW X
 S X=$$CPT^BDMDLDU(P,BDATE,EDATE,$O(^ATXAX("B","BGP TOBACCO SCREEN CPTS",0)),5)
