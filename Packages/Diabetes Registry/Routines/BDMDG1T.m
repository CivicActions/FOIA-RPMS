BDMDG1T ; IHS/CMI/LAB - 2019 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**12,13**;JUN 14, 2007;Build 66
 ;
 ;
...
ENDS(P,BD,ED) ;EP
 I $G(P)="" Q ""
 NEW X
 S X=$$LASTHF^BDMSMU(P,"C019","B",BD,ED)
 I X="" Q "2^3"
 I $P(X,U,1)["CURRENT"!($P(X,U,1)["CESSATION") Q "1^1^"_X
 I $P(X,U,1)["PREVIOUS"!($P(X,U,1)["NEVER")!($P(X,U,1)["FORMER") Q "1^2^"_X
 Q ""
ENDSIC(P,BD,ED) ;EP
 I $G(P)="" Q ""
 NEW X,V
 ...
 I $P(X,U,1)["CURRENT"!($P(X,U,1)["CESSATION") S V=1
 I $P(X,U,1)["PREVIOUS"!($P(X,U,1)["NEVER")!($P(X,U,1)["FORMER") S V=2
 Q V_"  "_X
LASTENDS(P,BD,ED) ;EP
 I $G(P)="" Q ""
 NEW X
 ...
 S X=$$LASTHF^BDMSMU(P,"C019","B",BD,ED)
 I X="" Q "3^Not documented"
 I $P(X,U,1)["CURRENT"!($P(X,U,1)["CESSATION") Q "1^"_X
 I $P(X,U,1)["PREVIOUS"!($P(X,U,1)["NEVER")!($P(X,U,1)["FORMER") Q "2^"_X
 Q ""
