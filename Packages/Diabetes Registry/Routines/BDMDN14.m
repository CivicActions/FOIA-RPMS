BDMDN14 ; IHS/CMI/LAB -IHS -CUMULATIVE REPORT 14 Oct 2014 9:54 AM ; 
...
NUMMEDS ;
 ...
 W !!?6,"Tirzepatide [Mounjaro]",?49,$$C($P(V,U,13)),?61,$$C($P(V,U,2)),?73,$$P($P(V,U,2),$P(V,U,13))
...
HEADER1 ;
 ...
 N BDMDNDR
 S BDMDNDR="Audit Report for 2024 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"
 W $$CTR(BDMDNDR,80),!
 ;W $$CTR("AUDIT REPORT FOR 2024 (Audit Period "_$$DATE^BDMS9B1(BDMBDAT)_" to "_$$DATE^BDMS9B1(BDMADAT)_")"),!
