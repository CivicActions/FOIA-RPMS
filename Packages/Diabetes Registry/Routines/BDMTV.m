BDMTV ; IHS/CMI/LAB - DISPLAY IND LISTS ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**11,12,16,17,19**;JUN 14, 2007;Build 159
 ;; ;
...
PAUSE ;EP
 ...
 Q
HDR ; -- header code
 S VALMHDR(1)="TAXONOMIES TO SUPPORT "_BDMYRE_" DIABETES AUDIT REPORTING"
...
P1 K ^TMP($J,"BDMTAXDSP")
 ...
 I BDMFILE'=50.67,BDMFILE'=9999999.64,BDMFILE'=95.3,BDMFILE'=60,BDMFILE'=9999999.14,BDMFILE'=200 D BLDTAX^ATXAPI(BDMTAXN,F,$O(^ATXAX("B",BDMTAXN,0))) I 1
...
P11 S BDMX="" F  S BDMX=$O(^TMP($J,"BDMTAXDSP",BDMX)) Q:BDMX=""  D
 ...
 .S BDMC2=35,BDMC3=65
 .I BDMFILE=200 S BDM1=$$GET1^DIQ(BDMFILE,BDMX,.01),BDMC2=50,BDM2=$$VAL^XBDIQ1(200,BDMX,53.5)
