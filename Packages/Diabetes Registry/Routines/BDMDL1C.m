BDMDL1C ; IHS/CMI/LAB - 2026 DIABETES AUDIT 09 Nov 2015 11:34 AM ; 31 Oct 2022  11:59 AM
...
GATHER ;
 ...
 ...S R=$P(^AUPNVLAB(X,0),U,4),R=$$STV^BDMDL18(R,8,1) I R="" Q  ;no numeric result 
...
COMBINED(P,BDMBDAT,BDMADAT,BDM6MBD) ;EP
 ...
 S G=0,ALL=""
 ;S A1C=$P(^XTMP("BDMDM26",BDMJOB,BDMBTH,"AUDIT",P,78),U,2)
 S A1C=$P($$HGBA1C^BDMDL18(BDMPD,BDMBDAT,BDMADAT),U,2)
 S V=A1C
 ...
 S G=G+S
CSTAT ;
 ;S STATIN=+^XTMP("BDMDM26",BDMJOB,BDMBTH,"AUDIT",P,300)
 S STATIN=+$$STATIN^BDMDL16(BDMPD,BDM6MBD,BDMADAT)
 S ALL=ALL_"; statin prescribed: "_$S(STATIN=1:"Yes",1:"No")
 I STATIN=1 S G=G+1
BP ;
 S S=$$SYSMEAN^BDMDL15(P,BDMRBD,BDMRED)
 S D=$$DIAMEAN^BDMDL15(P,BDMRBD,BDMRED)
 D
 .I S=""!(D="") Q
 .I S<130&(D<80) S G=G+1 Q
...
EGFRUACR(P,BD,ED,F) ;EP - 
 ...
 S F=$G(F)
 NEW G,R
 S G=$$GFR^BDMDL1C(BDMPD,BD,ED)
 S R=$$URIN^BDMDL18(BDMPD,BD,ED)
