BDM20P18 ; IHS/CMI/LAB - BDM V2.0 patch 18 environment check  ; 26 Sep 2023  3:59 PM
 ...
 I '$$INSTALLD("BDM*2.0*17") D SORRY(2)
 I '$$INSTALLD("ATX*5.1*57") D SORRY(2)
 I +$$VERSION^XPDUTL("BGP")<24.1 D MES^XPDUTL($$CJ^XLFSTR("Version 24.1 of the IHS CLINICAL REPORTING is required.  Not installed.",80)) D SORRY(2) I 1
 E  D MES^XPDUTL($$CJ^XLFSTR("Version 24.1 of IHS CLINICAL REPORTING is installed.",80))
 ;
 Q
 ;
PRE ;
