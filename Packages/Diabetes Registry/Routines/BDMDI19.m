BDMDI19 ; IHS/CMI/LAB - 2021 DIABETES AUDIT ;
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**14**;JUN 14, 2007;Build 80
 ;
 ;
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the 2021 Audit. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BDMDI19",XBNS="",XBRX="XIT^BDMDI19"
 D ^XBDBQUE
 D XIT
 Q
...
GUICHK ;EP
 ...
 W !!,"In order for the 2021 DM AUDIT Report to find all necessary data, several",!,"taxonomies must be established.  The following taxonomies are missing or have",!,"no entries:"
...
TEXTD ;EP
 ...
 ;;**   2021 Diabetes Audit Report Menu  **
 ;;****************************************
 ;;QUIT
PAGE ;
