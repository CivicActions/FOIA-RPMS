BDMDK1P ; IHS/CMI/LAB - 2023 DIABETES AUDIT PRINT 15 Dec 2016 3:05 PM ; 24 Oct 2019  3:42 PM
 ;;2.0;DIABETES MANAGEMENT SYSTEM;**16**;JUN 14, 2007;Build 122
 ;
 ;
 D LOG^BUSAAPI("O","P","P",$S($G(XQY0)]"":$P(XQY0,U),1:"BDMDK1P"),"DM 2023 AUDIT REPORT "_$S(BDMPREP=6:"QUALITY CHECK RPT",1:""))
 S BDMQUIT=0,BDMPG=0,BDMIOSL=$S($G(BDMGUI):57,1:IOSL)
 I BDMPREP=3 G CUML
 I BDMPREP=5 G CUML
 I BDMPREP=6 G CUML
 ;print ind audits first
 S BDMPD=0,BDMGUIC=0 F  S BDMPD=$O(^XTMP("BDMDM23",BDMJOB,BDMBTH,"AUDIT",BDMPD)) Q:BDMPD'=+BDMPD!(BDMQUIT)  D
 .I $G(BDMGUI),BDMGUIC W !,"ZZZZZZZ",!  ;maw
 .I BDMGUIC W:$D(IOF) @IOF
 .S BDMGUIC=1
 .S BDMPG=BDMPG+1 W:$G(BDMGUI) !! W "IHS Diabetes Care and Outcomes Audit, 2023    DATE RUN: "_$$DATE^BDMS9B1(DT)_"   Page: "_BDMPG
 ...
 .W !!,"Vital Statistics"
 .S X=$$I(30)
 .W !!?2,"Height (last ever): ",X  ;$J($P(X," "),2,0)_" "_$P(X," ",2,99)  ;ROUND HT KS 1208 2 DECIMALS THROUGHOUT 2023 PER K SHEFF
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .W !?3,$$I(58),?6,"9 Tirzepatide [Mounjaro]"
 ...
 .W !?2,"Influenza vaccine (during Audit period): ",?50,$$I(64)
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 .W !?2,"Pneumococcal [PCV15, PCV20, or PPSV23] (ever): ",?50,$$I(66)
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 .W !?2,"Td, Tdap, DTaP, or DT (in past 10 years): ",?50,$$I(68)
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 .W !?2,"Tdap (ever): ",?50,$$I(216)
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 .W !?2,"Hepatitis B complete series (ever):  ",?50,$$I(115)
 .I $Y>(BDMIOSL-1) D PAGE Q:BDMQUIT
 .W !?2,"Shingrix/RZV complete series (ever):  ",?50,$P($$I(73),U,1)
 .I $Y>(BDMIOSL-4) D PAGE Q:BDMQUIT
 ...
 .I $$AGE^AUPNPAT(BDMPD,BDMADAT)<40!($E($G(^XTMP("BDMDM23",BDMJOB,BDMBTH,"AUDIT",BDMPD,300)))=3) W !?5,"This is only calculated for patients 40 years of age and older without",!?5,"a statin allergy or intolerance." I 1
...
N1 .W !!,"Local Questions ",$$LOCN^BDMDK10(BDMPD,BDMDMRG)
 .W !!?2,"Select one:"
 .W !?2,"Text: ",$$LOCT^BDMDK10(BDMPD,BDMDMRG)
 .I $E(IOST,1,2)'="P-" W !! S DIR(0)="E" D ^DIR K DIR
CUML ;
 I BDMPREP=4!(BDMPREP=3) D CUML^BDMDK14
 I BDMPREP=5 D SDPI16^BDMDK1U
 I BDMPREP=6 D QUALCHK^BDMDK1V
DONE ;
 K ^TMP($J)
 ...
 Q
I(I) ;
 Q $G(^XTMP("BDMDM23",BDMJOB,BDMBTH,"AUDIT",BDMPD,I))
 ;
PAGE ;
 Q:$G(BDMDSP)
 ...
 I $G(BDMGUI) W !!
 S BDMPG=BDMPG+1
 W "IHS Diabetes Care and Outcomes Audit, 2023    DATE RUN: "_$$DATE^BDMS9B1(DT)_"   Page: "_BDMPG
