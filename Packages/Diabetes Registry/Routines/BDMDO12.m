BDMDO12 ; IHS/CMI/LAB - 2025 DIABETES AUDIT ;
...
INSULIN(P,BDATE,EDATE) ;EP
 ...
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT INSULIN DRUGS",0)),ED)
 Q BDM
 ;
SULF(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT SULFONYLUREA DRUGS",0)),ED)
 Q BDM
 ;
SULFLIKE(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT SULFONYLUREA-LIKE",0)),ED)
 Q BDM
MET(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT METFORMIN DRUGS",0)),ED)
 Q BDM
 ;
ACAR(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT ACARBOSE DRUGS",0)),ED)
 Q BDM
 ;
 ;
TROG(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT GLITAZONE DRUGS",0)),ED)
 Q BDM
 ;
SGLT2(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT SGLT-2 INHIBITOR DRUG",0)),ED)
 Q BDM
 ;
DPP4(P,BDATE,EDATE) ;EP  
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT DPP4 INHIBITOR DRUGS",0)),ED)
 Q BDM
 ;
...
AMYLIN(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT AMYLIN ANALOGUES",0)),ED)
 Q BDM
 ;
GLP1(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT GLP-1 ANALOG DRUGS",0)),ED)
 I BDM="X" Q BDM
 Q BDM
 ;
BROM(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT BROMOCRIPTINE DRUGS",0)),ED)
 Q BDM
 ;
COLE(P,BDATE,EDATE) ;EP
 ...
 I $D(BDM(1)) Q "X"
 K %DT S %DT="P",X=EDATE D ^%DT S ED=Y
 S BDM=$$PRES^BDMDO18(P,$O(^ATXAX("B","DM AUDIT COLESEVELAM DRUGS",0)),ED)
 Q BDM
 ;
...
LASTDEPS(BDMLPDFN,BDMLBD,BDMLED,BDMLFORM) ;PEP - return last depression screen
 ...
 D E
 S BDMLVAL=$$CPT^BDMDODU(BDMLPDFN,$S($P(BDMLLAST,U)]"":$P(BDMLLAST,U),1:BDMLBD),BDMLED,$O(^ATXAX("B","BGP DEPRESSION SCREEN CPTS",0)),5)
 D E
