BDM20P13 ; IHS/CMI/LAB - BDM V2.0 patch 11 environment check 
 ...
 I '$$INSTALLD("BDM*2.0*12") D SORRY(2)
...
POST ;
 D ^BDMDHZ
 NEW DA,DIE
 S DA=$O(^DIC(19,"B","BDMEEDMUPD",0))
 I DA S DIE="^DIC(19,",DR="2///@" D ^DIE K DA,DIE,DR
 ;BDM DM REG APPT CLN
 S DA=$O(^DIC(19,"B","BDM DM REG APPT CLN",0))
 I DA S DIE="^DIC(19,",DR="2///@" D ^DIE K DA,DIE,DR
 D BMXPO
