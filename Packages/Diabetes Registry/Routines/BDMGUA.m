BDMGUA ; cmi/anch/maw - BDM DMS GUI Utilities ; 
 ;;2.0;BDM DIABETES MANAGEMENT SYSTEM;**1,3,5,6,7,8,9,10,11,12,13,15,16,17,18,19**;JUN 14, 2007;Build 159
 ;
 ;
 ;
...
TAXCHK(RETVAL,BDMSTR) ;-- check taxonomies
 ...
 Q
 ;
UPDTAX(BDMRET,BDMSTR) ;upd taxonomies
 S X="MERR^BDMGU",@^%ZOSF("TRAP")
 N P,BDMOPT,BDMI
 S P="|"
 S BDMI=0
 ...
 S BDMOPT=$P(BDMSTR,P)
 I BDMOPT="Upd DM Audit P 21" D
 . D INIT^BDMPITS
 I BDMOPT="Upd DM Audit 21" D
 . D INIT^BDMDITS
 I BDMOPT="Upd DM Audit P 22" D
 . D INIT^BDMPJTS
 I BDMOPT="Upd DM Audit 22" D
 . D INIT^BDMDJTS
 I BDMOPT="Upd DM Audit 23" D
 . D INIT^BDMDNTS
 I BDMOPT="Upd DM Audit 24" D
 . D INIT^BDMDNTS
 I BDMOPT="Upd DM Audit P 24" D
 . D INIT^BDMPNTS
 I BDMOPT="Upd DM Audit 25" D
 . D INIT^BDMDOTS
 I BDMOPT="Upd DM Audit P 25" D
 . D INIT^BDMPOTS
 I BDMOPT="Upd DM Audit 26" D
 . D INIT^BDMDLTS
 I BDMOPT="Upd DM Audit P 26" D
 . D INIT^BDMPLTS
 N BDMDA,BDMT
 ...
 Q
 ;
CHTDATA(BDMRET,BDMSTR) ;-- get lab, bp or wt data
 S X="MERR^BDMGU",@^%ZOSF("TRAP")
 ...
 Q
 ;
WEIGHT(BD,ED,PIEN,PAT,CHT,INST,LAB,EL) ;
 ...
 Q
 ;
BP(BD,ED,PIEN,PAT,CHT,INST,LAB,EL) ;
 ...
 Q
 ;
LAB(BD,ED,PIEN,PAT,CHT,INST,LAB,EL) ;
...
ADDPRB(BDMRET,BDMSTR) ;
 ...
 Q
 ;
DELPR(BDMRET,BDMSTR) ;-- delete prob
 S X="MERR^BDMGU",@^%ZOSF("TRAP")
 S R="~"
