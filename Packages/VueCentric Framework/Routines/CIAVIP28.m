CIAVIP28 ;MSC/IND/PLS - EHR v1.1p28 Inits;03-Jun-2020 16:53;PLS
 ;;1.1;VUECENTRIC FRAMEWORK;**28**;23-Oct-2006
 ;;Copyright 2000-2015, Medsphere Systems Corporation
 ;=================================================================
EC ;EP - Environment check
 D CHKINS^CIAOINIT("EHR*1.1*27",2)
 Q
PRE ;EP - Preinit
 Q
...
BEHMSR(X,Y) ;
 ...
 D FILE^DIE(,"FDA")
 Q
VER ;;BEHQOWIZARD.QOWIZARD;1.1.6.16;166A6FB6123B473178691764C1496D96
 ;;BEHINFOBTNSVC.INFOBTNSVC;1.1.7362.19588;1028AB4E26B10E227D623C5A83CA9B8E
 ;;BEHESIGSERVICE.ESIGSERVICE;20.1.5.3;DF383B33DC1729C00C68643EBF65DD9C
 ;;
CHM ;;BEHMEDS.MEDMANAGEMENT;BEHMeds.chm;2020.5.12.190414;55A0C633935D15AE057E4D3742F29B7A
 ;;
