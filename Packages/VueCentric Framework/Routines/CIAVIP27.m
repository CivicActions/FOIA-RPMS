CIAVIP27 ;MSC/IND/PLS - EHR v1.1p26 Inits;17-Apr-2020 09:15;PLS
 ;;1.1;VUECENTRIC FRAMEWORK;**27**;23-Oct-2006
 ;;Copyright 2000-2015, Medsphere Systems Corporation
 ;=================================================================
EC ;EP - Environment check
 D CHKINS^CIAOINIT("EHR*1.1*26",2)
 Q
PRE ;EP - Preinit
 Q
...
REGRPC ;EP-
 I $$REGRPC^CIAURPC("MAGGUSERKEYS","CIAV VUECENTRIC")
 Q
...
BEHMSR(X,Y) ;
 ...
 D FILE^DIE(,"FDA")
 Q
VER ;;BEH2FA.AUTHSVC;1.0.7349.15753;8D6AE3E5C52584D4B087708626AF5565
 ;;
CHM ;;
 ;;
