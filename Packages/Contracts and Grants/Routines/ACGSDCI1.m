ACGSDCI1 ;IHS/OIRM/DSD/THL,AEF - CONTROL CIS FIELDS AND EXPORT VARIABLES CON'T; [ 10/27/2004   4:19 PM ]
 ;;2.0t1;CONTRACT INFORMATION SYSTEM;**13**;FEB 16, 2000
 ;;CONTROL CIS FIELDS AND EXPORT VARIABLES - CON'T
 ;IHS/ITSC/MRS:ACR*2.1*13.02 IM13574
...
36 S X=$E($P(ACGDT2,U),1,10),ACGSIGN=$S($E(X)="-":"-",1:""),ACGX=""
 ...
 D Y
 K ACGX
 S ACGFY=$E($P(ACGDT3,U,16),2)  ;                 ACR*2.1*13.02 IM13574
 ...
 D Y
 S X=$P(ACGDT2,U,3),ACGSIGN=$S($E(X)="-":"-",1:""),ACGX=""  ; ACR*2.1*13.02 IM13574
 S:ACGSIGN="-" X=$P(X,"-",2)
 S:10-$L(ACGSIGN)-$L(X) $P(ACGX,"0",10-$L(ACGSIGN)-$L(X))="" S X=ACGSIGN_ACGX_X
 D Y
 K ACGX
...
41 S ACGFY=$E($P(ACGDT3,U,18),2)
 ...
 D Y
 S X=$P(ACGDT2,U,7),ACGSIGN=$S($E(X)="-":"-",1:""),ACGX=""  ; ACR*2.1*13.02 IM13574
 S:ACGSIGN="-" X=$P(X,"-",2)
 S:10-$L(ACGSIGN)-$L(X) $P(ACGX,"0",10-$L(ACGSIGN)-$L(X))="" S X=ACGSIGN_ACGX_X
 D Y
 S X=$P(ACGDT2,U,8),ACGSIGN=$S($E(X)="-":"-",1:""),ACGX=""  ; ACR*2.1*13.02 IM13574
 S:ACGSIGN="-" X=$P(X,"-",2)
 S:10-$L(ACGSIGN)-$L(X) $P(ACGX,"0",10-$L(ACGSIGN)-$L(X))="" S X=ACGSIGN_ACGX_X
 D Y
 S X=$P(ACGDT2,U,9),ACGSIGN=$S($E(X)="-":"-",1:""),ACGX=""  ; ACR*2.1*13.02 IM13574
 S:ACGSIGN="-" X=$P(X,"-",2)
 S:10-$L(ACGSIGN)-$L(X) $P(ACGX,"0",10-$L(ACGSIGN)-$L(X))="" S X=ACGSIGN_ACGX_X
 D Y
...
50 S X=$P(ACGDT2,U,15),ACGSIGN=$S($E(X)="-":"-",1:""),ACGX=""
 ...
 D Y
 S X=$E($P(ACGDT3,U,2)),X=$S(X]"":X,1:" ")  ; ACR*2.1*13.02 IM13574
 D Y
 S X=$E($P(ACGDT3,U,3)),X=$S(X]"":X,1:" ")  ; ACR*2.1*13.02 IM13574
 D Y
 S X=$P(ACGDT3,U,4),ACGSIGN=$S($E(X)="-":"-",1:""),ACGX=""  ; ACR*2.1*13.02 IM13574
 S:ACGSIGN="-" X=$P(X,"-",2)
 S:10-$L(ACGSIGN)-$L(X) $P(ACGX,"0",10-$L(ACGSIGN)-$L(X))="" S X=ACGSIGN_ACGX_X
 D Y
60 S X=$E($P(ACGDT3,U,5)),X=$S(X]"":X,1:" ")
 D Y
 S X=$E($P(ACGDT3,U,6),1,4),X=$S(X]"":"MULT",1:"    ")  ; ACR*2.1*13.02 IM13574
 D Y
