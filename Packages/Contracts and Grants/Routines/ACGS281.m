ACGS281 ;IHS/OIRM/DSD/THL,AEF - UTILITY TO PRINT THE SMALL PURCHASE 281 REPORT; [ 09/22/2005  5:49 PM ]
...
ZIS ;S ACGDUZ=$P(^VA(200,DUZ,0),U),ACGDUZ=$P($P(ACGDUZ,",",2)," ")_" "_$P(ACGDUZ,",")  ;ACR*2.1*19.02 IM16848
 S ACGDUZ=$$NAME2^ACRFUTL1(DUZ),ACGDUZ=$P($P(ACGDUZ,",",2)," ")_" "_$P(ACGDUZ,",")  ;ACR*2.1*19.02 IM16848
