ACGSMENU ;IHS/OIRM/DSD/THL,AEF - CONTROL CIS HEADINGS AND MENUS; [ 09/22/2005  8:45 AM ]
 ;;2.0t1;CONTRACT INFORMATION SYSTEM;**19**;FEB 16, 2000
...
HEAD1 S ACGPARA=^ACGPARA(ACGPODA,0),ACG4=$P(ACGPARA,U,3)
 ...
 D H1
 D HDVS
 ;I DUZ S ACGX=$P(^VA(200,DUZ,0),U),ACGX=$P($P(ACGX,",",2)," ")_" "_$P(ACGX,","),ACGX="CURRENT USER: "_ACGX W !?80-$L(ACGX)\2,ACGX K ACGX  ;ACR*2.1*19.02 IM16848
 I DUZ S ACGX=$$NAME2^ACRFUTL1(DUZ),ACGX=$P($P(ACGX,",",2)," ")_" "_$P(ACGX,","),ACGX="CURRENT USER: "_ACGX W !?80-$L(ACGX)\2,ACGX K ACGX  ;ACR*2.1*19.02 IM16848
 Q
