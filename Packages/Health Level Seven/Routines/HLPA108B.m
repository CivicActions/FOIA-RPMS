HLPA108B ;CIOFO-SF/RJH - HL7 PATCH 108 PRE&POST-INIT ;02/25/04  17:21
 ;;1.6;HEALTH LEVEL SEVEN;**108**;Oct 13, 1995
 ;
 ; Part III of Pre-install and Post-install
 ; Entries: EVN, MSG, SEG, DELETE, and IDOFF, are called from HLPAT108
 Q
...
DELETE ; delete duplicate entries in file #779.001, #771.2 and #771.3
 ...
 ;
 Q
IDOFF ; disable identifier for file #779.001, #771.2 and #771.3
 K ^DD(779.001,0,"ID")
 K ^DD(771.2,0,"ID")
 K ^DD(771.3,0,"ID")
 K ^DD(779.005,0,"ID")
