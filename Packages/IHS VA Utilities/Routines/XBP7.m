XBP7 ; IHS/ADC/GTH - XB/ZIB V 3.0 PATCH 7 ; [ 07/13/1999  11:32 AM ]
 ;;3.0;IHS/VA UTILITIES;**7**;FEB 07, 1997
 ;
...
HELP(L) ;EP - Display text at label L.
 ...
 ;
INTRO ;
 ;;This is Patch 7 to XB/ZIB utilities.  Please see the routines of the
...
Q2 ;
 ...
 ;
DESC ;
 ;;XB/ZIB v 3.0, Patch 7 Announcement.
 ;;  
 ;;+++++++++++++++ XB/ZIB 3.0 Patch 7 Announcement +++++++++++++++++
 ...
 ;;-----------------------------------------------------------------
 ;;  
 ;;(1) Routines ZIBER1, XBFORM, XBARRAY, XBSUMBLD and XBVLINE were
 ;;modified for y2k compliance. Changes were limited to date displays
 ;;and input.
 ;; 
 ;;++++++++++++++++++++ end of Patch 7 announcement ++++++++++++++++
 ;;###
 ;
