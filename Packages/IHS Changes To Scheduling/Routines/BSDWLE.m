BSDWLE ; IHS/OIT/LJF - WAITING LIST DATA ENTRY
 ;;5.3;PIMS;**1004,1007,1010,1013,1022**;MAY 28, 2004;Build 18
...
INIT ; -- init variables and list array
 ...
 . . D GETS^DIQ(FILE,IENS,".01;.013;.02:.05;.06;1","RI","BSDATAI")  ;cmi/anch/maw 2/21/2007 added .01 PATCH 1007 item 1007.33
 ...
 . . S LINE=$$PAD(LINE,62)_$$DTS^BSDU3(BSDATAI(FILE,IENS,"RECALL DATE","I"))
 . . S LINE=$$PAD(LINE,72)_BSDATA(FILE,IENS,"PRIORITY")
 . . S LINE=$$PAD(LINE,83)_$E(BSDATA(FILE,IENS,"PROVIDER"),1,12)
 . . S LINE=$$PAD(LINE,97)_$G(BSDATA(FILE,IENS,"COMMENTS",1))
...
EDIT ;EP - called by BSDWL EDIT protocol
 ...
 D GETONE I BSDN="" D RETURN(0) Q
 ;202307 77892 maw p1022 PPN
 W !!,$$GETPREF^AUPNSOGI($$GET1^DIQ(9009017.11,BSDN_","_BSDWLN,.01,"I"),"E",1)  ;display patient name
