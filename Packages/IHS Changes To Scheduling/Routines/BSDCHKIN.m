BSDCHKIN ;cmi/anch/maw - BSD CheckIn Auto Refresh 1/25/2007 1:06:21 PM
 ;;5.3;PIMS;**1007,1009,1022**;MAY 28, 2004;Build 18
 ;
...
BLD1 ; -- scan apts
 ...
 .. I $D(^SC(SDCLN,"S",SDT,1,SDDA,0)) D
 ... S DFN=+$G(^SC(SDCLN,"S",SDT,1,SDDA,0))
 ... D PID^VADPT
 ... I $D(^DPT(DFN,"S",SDT,0)),$$VALID^SDAM2(DFN,SDCLN,SDT,SDDA) S SDATA=^DPT(DFN,"S",SDT,0),SDCL=SDCLN,SDNAME=VA("BID")_" "_$E($$GETPREF^AUPNSOGI(DFN,"E",1),1,30) D:SDCLN=+SDATA BLD1^BSDCHKI1
