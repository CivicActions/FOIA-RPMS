...
IO ;Input Transform for Package field in Possible Dose multiple
 I (X'?1"I")&(X'?1"O")&(X'?1"IO")&(X'?1"OI") K X Q
 ...
 .D EN^DDIOL("Unit/Dose Form combination cannot be converted for Inpatient Medications")
 I X["O",'$D(^PS(50.606,"ACONO",+$G(PSS14),+$G(PSS13))) D  K X D IOK Q
 .D EN^DDIOL("Unit/Dose Form combination cannot be converted for Outpatient Pharmacy")
 D IOK
 Q
IOK ;
