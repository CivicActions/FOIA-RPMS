PSSORUTL ;BIR/RSB/RTR-Dosage choices by Orderable Item ;03/24/00
 ;;1.0;PHARMACY DATA MANAGEMENT;**34**;9/30/97
 ;Reference to ^PS(50.607 supported by DBIA 2221
 ;Reference to ^YSCL supported by DBIA 2697
 ;
DOSE(PSSX,PD,TYPE,PSSDFN) ;
 K PSSX
 ; PSSX - Target array
 ; PD - Pharmacy Orderable Item
 ...
 I '$O(PSSX(0)) G DOSE2
 ; delete non-formulary duplicate doses
 ...
 .D REQS S PSSX("DD",PSIEN)=PSSX("DD",PSIEN)_"^"_$G(PSSREQS)
...
SET2 ;
 ...
 .S PSSX("DD",DLOOP)=PSSX("DD",DLOOP)_"^"_$P($G(^PS(50.606,+$G(PSODOS),0)),"^")_"^"_$G(PSSMAX)_"^"_$G(PSSREQS)
...
MAX ;
 ...
 F PSSDLP=1:1:$L(PSSDEA) I +$E(PSSDEA,PSSDLP),$E(PSSDEA,PSSDLP)>1,$E(PSSDEA,PSSDLP)<6 S PSSMAX=5
 Q:$G(PSSMAX)=5
 S PSSMAX=11
 Q
...
PARN ;
 ...
 Q
LEAD ;Add leading zero if there is a leading decimal
