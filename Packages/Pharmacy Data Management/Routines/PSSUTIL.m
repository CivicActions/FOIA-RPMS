...
EN2(PSSDIEN,PSSTALK) ;Receive Drug entries matched to NDF
 ...
 I $G(PSSTALK) W !!,"Resetting Possible Dosages..",!!,"Use the 'Dosages Enter/Edit' option to review newly created dosages for",!,$P($G(^PSDRUG(PSSDIEN,0)),"^"),! K DIR S DIR(0)="E",DIR("A")="Press Return to continue" D ^DIR K DIR
 S PSSBOTH=1
...
LOC ;Set local possible dosages
 N PSSOITEM,PSSOID,PSSLTOT,PSSLTOTX,PSDUPDPT,PSNOUN,PSNOUNPA,PSNOUNPT,PSALL,PSDOD,PSSLPT,PSSLPTX,PSSLPNO,PSSLP
