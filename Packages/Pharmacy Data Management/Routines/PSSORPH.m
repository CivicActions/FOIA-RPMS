...
DOSE(PSSX,PD,TYPE,PSSDFN,PSSUPD) ;
 ...
 ; TYPE - Type of drug, single letter (O:Outpt, U:Unit Dose, I:IV) h
 ; PSSDFN - Patient IEN
 ...
 N PSSDOSE,PSSUNTS,PSSUDOS,PSSMD,PSSMD1,PSSMDN
 ...
 .D REQS S PSSX("DD",PSIEN)=PSSX("DD",PSIEN)_"^"_$G(PSSREQS)_"^"_$G(PSNNN)_"^"_$G(PSSVERB)
 K PSSHOLD
 D LEAD
 Q
DOSE2 ;Local Dose
...
SET2 ;
 ...
 S PSSX(PSOCT)=PSSX(PSOCT)_"^"_$P($G(^PS(50.606,+$G(PSODOS),"MISC")),"^",4)
 I '$D(PSSX("DD",DLOOP)) D
 .D REQS
 ...
 .S PSSX("DD",DLOOP)=PSSX("DD",DLOOP)_"^"_$G(PSSLDN)_"^"_$G(PSSLDV)
 S PSOCT=PSOCT+1
 Q
ZSET ;
 K PSSLDN,PSSLNV
