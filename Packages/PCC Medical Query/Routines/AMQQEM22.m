AMQQEM22 ; OHPRD/GIS,DWG - EM2 OVERFLOW ;  [ 01/31/2008   5:08 PM ]
...
VISIT N %,A,B,X,Y,Z
 ...
 .Q
 S Z=Z_(C+1)_":"_"OTHER VISIT ATTRIBUTE;",C("OTHER")=C+1
 S Z=Z_(C+2)_":EDIT A PREVIOUSLY SELECTED FIELD;",C("EDIT")=C+2
 S AMQQEMZ="SO^"_Z K A,B,Z
