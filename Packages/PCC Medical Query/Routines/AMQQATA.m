AMQQATA ;IHS/CMI/THL - GETS ATTRIBUTE ;
 ;;2.0;IHS PCC SUITE;**2,25**;MAY 14, 2009;Build 37
 ;-----
EN ; - ENTRY POINT -
...
EXAM ;ALIGN EXAM TYPE IEN'S
 ...
 W !!
 S C=0
 S X=$$VXAMR^AUPNCIX(Z,"ZZ")
 S Y=0 F  S Y=$O(ZZ(Y)) Q:Y'=+Y  W !?5,Y,")  ",$P(ZZ(Y),U,1),?13,$P(ZZ(Y),U,2) S C=C+1
 S XXXX=C+1
 W !!?5,XXXX,")  ALL Results"
 S DIR(0)="N^1:"_XXXX_":0",DIR("A")="Which Results",DIR("B")=XXXX KILL DA D ^DIR KILL DIR
 I $D(DIRUT) S AMQQVXAM="" Q
 I +Y=XXXX S AMQQVXAM="ALL" Q
 S AMQQVXAM=$P(ZZ(+Y),U,1)
 Q
