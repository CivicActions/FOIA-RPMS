AMQQTXG1 ; OHPRD/DG - LOOKUP FOR TAX ;  [ 01/31/2008   5:08 PM ]
 ;;2.0;PCC QUERY UTILITY;**8,14,17,18,20,21**;FEB 07, 2007
...
PLOOKUP ; ENTRY POINT FROM AMQQTXG
 ...
 Q
 ;
PLK1 S:$G(AMQQLINK)=32 X=$P(Y,U,2) ;IHS/CMI/THL PATCH 17
