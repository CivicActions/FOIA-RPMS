AMQQEM1 ; OHPRD/GIS,DWG - GETS DOS/UNIX PATH AND FILE NAME ;  [ 01/31/2008   5:08 PM ]
 ;;2.0;PCC QUERY UTILITY;**18,20,21**;FEB 07, 2007
 ;;IHS/CIM/THL PATCH 18 TO MAKE EXPORT CACHE COMPATIBLE
 I $G(^DD("OS"))'=8&($G(^DD("OS"))'=18) S AMQQEM("FORMAT")="MUMPS" Q  ;IHS/CIM/THL PATCH 18
...
VAR ;EP; OS VARIABLES
 ...
 I ^DD("OS")=18 D  Q   ;IHS/CIM/THL PATCH 18
