AMQQATAL ; IHS/OHPRD/JCM - SETS TEMP METADICTIONARY ENTRY FOR LAB TESTS ;  [ 01/31/2008   5:08 PM ]
 ;;2.0;PCC QUERY UTILITY;**6,17,18,20,21**;FEB 07, 2007
 ; All hard sets in this routine are for temporary purposes only
SETLAB ; ENTRY POINT
 N X,%,Y,A
 S %=$G(^AMQQ(5,+AMQQATN,4))
 Q:%=""
 S AMQQLTYP=$P(%,U),AMQQLDFN=$P(%,U,2),AMQQLSIT=$P(%,U,3),AMQQLHED=$P(%,U,4),AMQQLHDL=$P(%,U,5),AMQQLUNT=$P(%,U,6),AMQQLOUT=$P(%,U,7),AMQQLINK=AMQQATN,AMQQNOL=""
...
EN1 ; ENTRY POINT FROM AMQQSQA0
 ...
 Q
 ;
OKATTRIB(AMQQATN) ;EP; ;IHS/CMI/THL PATCH 17
 ...
 S AMQQNOL=""
 D:AMQQLDFN OK ;IHS/CIM/THL PATCH 18
 I '$D(AMQQNOL)
 Q
