AMQQMULC ; CMI/MIC/GIS/CIA/PLS - COLLECTS MULTIPLE VALUES FOR COLORECTAL PROCEDURES;
 ;;2.0;PCC QUERY UTILITY;**20,21**;FEB 07, 2007
 ;
VAR F I=1:1:19 S X=$P("GR;ID;ST;FIN;LAST;VAL1;SPEC;UATN;MLT;T;NVAR;FVAR;ITR;NNA;STRT;MSS;MPC;MULZ;USQN",";",I) S @("AMQQ"_X)=$P(AMQQX,";",I)
 ...
 S AMQQVAL1=+AMQQVAL1,AMQQMPC=3,AMQQMSS=0
...
INCITEM S AMQQVNO=$O(@AMQQ@(AMQQVDAT,AMQQVNO))
 ...
 I $D(@%),$D(^(0)) S AMQQVALU=$P(^(AMQQMSS),U,AMQQMPC),AMQQVSIT=0 D SET I 1 ; CMI/MIC/GIS 11/24/98
 E  G INCITEM
