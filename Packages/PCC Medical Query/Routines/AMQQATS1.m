AMQQATS1 ; IHS/OHPRD/JCM - SETS MULTIPLES ;  [ 01/31/2008   5:08 PM ]
 ;;2.0;PCC QUERY UTILITY;**4,5,18,20,21**;FEB 07, 2007
MULT S %=$P(Q,U,9)
...
RANGE S %=$P(AMQQCOMP,";",4),Y=$P(%,":"),Z=$P(%,":",2),N=.00000001
 ...
 I $P(%,":",4) S X=(Z-N)_":"_($P(%,":",4)+.00000001) Q  ;IHS/CIM/THL PATCH 18
 S X=-999999999
 I Y="<" S X=X_":"_(Z-N) Q
 I Y="'>" S X=X_":"_Z Q
 S X=999999999
