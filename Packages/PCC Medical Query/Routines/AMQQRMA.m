AMQQRMA ; IHS/OHPRD/JCM - RMAN AGE CATEGORY REPORT ;  [ 01/31/2008   5:08 PM ]
 ;;2.0;PCC QUERY UTILITY;**4,18,20,21**;FEB 07, 2007
 ; CALLS TASKMAN
 ; IHS/CIM/THL Patch 18 terminology changes
...
CURR W @IOF
 ...
 W ! D LIST
ASK W !,"Do you want to define a new set of age groups" S %=2 D YN^DICN
...
NEWDATE ; Get new date
 ...
 Q
 ;
NEWAGE S %="",A=-1 W !,"If you exceed 8 groups, the display will wrap...",!!
