AMQQGTX0(X,AMQQGTX,Y) ; OHPRD/DG - PROGRAMMER CALL TO CREATE TAXONOMIES AND/OR HAVE ARRAYS OF VALUES RETURNED ; [ 01/31/2008   5:08 PM ]
 ;;2.0;PCC QUERY UTILITY;**17,18,20,21**;JUN 10, 1993
 ;
 ;
