AMQQMGR5 ; IHS/OHPRD/JCM - SECURE DEVICES ;  [ 01/31/2008   5:08 PM ]
 ;;2.0;PCC QUERY UTILITY;**1,18,19,20,21**;FEB 07, 2007
...
EDIT ;I '$D(^AMQQ(8,DUZ(2),1,1)) W !!,"Sorry, there are no devices in the file to edit.",!!,*7 Q
 I '$O(^AMQQ(8,DUZ(2),1,0)) W !!,"Sorry, there are no devices in the file to edit.",!!,*7 Q  ;IHS/CIM/THL PATCH 19
